...
url: https://redis.io/docs/latest/develop/clients/redis-py/scaniter/
retrieved_utc: '2026-04-09T20:45:58.697820+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/redis-py/scaniter/index.html.md
---
...
-   [`HSCAN`]() retrieves keys and optionally,
    their values from a
    [hash]() object.
-   [`SSCAN`]() retrieves keys from a
    [set]() object.
-   [`ZSCAN`]() retrieves keys and their score values from a
    [sorted set]() object.
