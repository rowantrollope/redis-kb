...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/actions/migrate/
retrieved_utc: '2026-04-09T20:46:05.696612+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/actions/migrate/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-post-multi-request","title":"Request {#post-multi-request}"},{"id":"response-post-multi-response","title":"Response {#post-multi-response}"},{"id":"status-codes-post-multi-status-codes","title":"Status codes {#post-multi-status-codes}"}],"id":"migrate-multiple-shards-post-multi-shards","title":"Migrate multiple shards {#post-multi-shards}"},{"children":[{"id":"request-post-request","title":"Request {#post-request}"},{"id":"response-post-response","title":"Response {#post-response}"},{"id":"status-codes-post-status-codes","title":"Status codes {#post-status-codes}"}],"id":"migrate-shard-post-shard","title":"Migrate shard {#post-shard}"}]}
