...
url: https://redis.io/docs/latest/operate/rs/security/access-control/ldap/enable-role-based-ldap/
retrieved_utc: '2026-04-09T20:45:56.007578+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/access-control/ldap/enable-role-based-ldap/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"ldap-server-settings","title":"LDAP server settings"},{"id":"bind-credentials","title":"Bind credentials"},{"id":"authentication-query","title":"Authentication query"},{"id":"authorization-query","title":"Authorization query"},{"id":"authentication-timeout","title":"Authentication timeout"}],"id":"set-up-ldap-connection","title":"Set up LDAP connection"},{"id":"more-info","title":"More info"}]}
