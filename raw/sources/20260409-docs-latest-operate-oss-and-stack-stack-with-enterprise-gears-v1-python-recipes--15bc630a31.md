...
retrieved_utc: '2026-04-09T20:45:59.262414+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/python/recipes/write-behind/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"install-oracle-driver-optional","title":"Install Oracle driver (optional)"},{"id":"import-requirements","title":"Import requirements"},{"id":"register-the-functions","title":"Register the functions"}],"id":"install-the-write-behind-recipe","title":"Install the write-behind recipe"},{"children":[{"id":"secret-management","title":"Secret management"}],"id":"write-behind-caching-with-redisgears","title":"Write-behind caching with RedisGears"}]}
