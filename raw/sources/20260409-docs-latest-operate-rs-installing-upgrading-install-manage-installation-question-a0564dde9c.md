...
url: https://redis.io/docs/latest/operate/rs/installing-upgrading/install/manage-installation-questions/
retrieved_utc: '2026-04-09T20:45:56.027714+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/installing-upgrading/install/manage-installation-questions/index.html.md
---
...
{
  "title": "Manage installation questions",
  "description": "Describes Redis Software installation questions and how to answer them automatically.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"installation-questions","title":"Installation questions"},{"children":[{"id":"answer-yes-to-all-questions","title":"Answer yes to all questions"},{"id":"configure-file-to-answer","title":"Configure file to answer"}],"id":"answer-install-questions-automatically","title":"Answer install questions automatically"}]}
...
- **Firewall ports** - `Would you like to open RedisLabs cluster ports on the default firewall zone [Y/N]?`
    ...
    Redis Software requires that all nodes have [specific network ports]() open.
