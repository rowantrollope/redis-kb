...
retrieved_utc: '2026-04-09T20:45:59.172533+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/dotnet/produsage/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"checklist","title":"Checklist"},{"children":[{"id":"event-handling","title":"Event handling"},{"id":"timeouts","title":"Timeouts"},{"id":"exception-handling","title":"Exception handling"},{"id":"retries","title":"Retries"}],"id":"recommendations","title":"Recommendations"}]}
