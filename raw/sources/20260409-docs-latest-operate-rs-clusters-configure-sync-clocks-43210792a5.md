...
url: https://redis.io/docs/latest/operate/rs/clusters/configure/sync-clocks/
retrieved_utc: '2026-04-09T20:45:56.564132+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/configure/sync-clocks/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"ubuntu-1804-and-ubuntu-2004","title":"Ubuntu 18.04 and Ubuntu 20.04"},{"id":"rhel-7","title":"RHEL 7"},{"id":"rhel-8-and-rhel-9","title":"RHEL 8 and RHEL 9"},{"id":"amazon-linux-2","title":"Amazon Linux 2"}],"id":"set-up-ntp-synchronization","title":"Set up NTP synchronization"}]}
