...
url: https://redis.io/docs/latest/operate/rs/databases/configure/replica-ha/
retrieved_utc: '2026-04-09T20:45:58.194817+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/configure/replica-ha/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"configure-cluster-policy-for-replica-ha","title":"Configure cluster policy for replica HA"},{"id":"turn-off-replica-ha-for-a-database","title":"Turn off replica HA for a database"}],"id":"configure-high-availability-for-replica-shards","title":"Configure high availability for replica shards"},{"children":[{"id":"grace-period","title":"Grace period"},{"id":"shard-priority","title":"Shard priority"},{"id":"cooldown-periods","title":"Cooldown periods"},{"id":"alerts","title":"Alerts"}],"id":"configuration-options","title":"Configuration options"},{"id":"limitations","title":"Limitations"}]}
