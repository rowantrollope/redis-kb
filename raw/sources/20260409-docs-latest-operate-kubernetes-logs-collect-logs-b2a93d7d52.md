---
title: Collect logs
url: https://redis.io/docs/latest/operate/kubernetes/logs/collect-logs/
retrieved_utc: '2026-04-09T20:46:00.185020+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/logs/collect-logs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"collect-logs","title":"Collect logs"},{"id":"options","title":"Options"}]}
