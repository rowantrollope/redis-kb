---
title: Manage logs
url: https://redis.io/docs/latest/operate/rs/clusters/logging/log-security/
retrieved_utc: '2026-04-09T20:45:58.034503+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/logging/log-security/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"send-logs-to-a-remote-logging-server","title":"Send logs to a remote logging server"},{"id":"log-rotation","title":"Log rotation"}]}

,
  "codeExamples": []
}
```Redis Software comes with [a set of logs]() on the server and available through the user interface to assist users in investigating actions taken on the server and to troubleshoot issues.
