...
url: https://redis.io/docs/latest/integrate/new-relic-with-redis-cloud/
retrieved_utc: '2026-04-09T20:45:53.585263+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/new-relic-with-redis-cloud/index.html.md
---
...
{
  "title": "New Relic with Redis Cloud",
  "description": "To collect, view, and monitor metrics data from your databases and other cluster components, you can connect New Relic to your Redis Cloud cluster using the Redis New Relic Integration.",
  "categories": ["docs","integrate","rs"],
  "group": "observability",
  "tableOfContents": {"sections":[{"id":"install-redis-new-relic-integration-for-redis-cloud","title":"Install Redis' New Relic Integration for Redis Cloud"},{"id":"view-metrics","title":"View metrics"},{"id":"monitor-metrics","title":"Monitor metrics"}]}
