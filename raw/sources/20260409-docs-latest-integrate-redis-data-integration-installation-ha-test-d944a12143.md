...
url: https://redis.io/docs/latest/integrate/redis-data-integration/installation/ha-test/
retrieved_utc: '2026-04-09T20:46:01.260982+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/installation/ha-test/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"setup","title":"Setup"},{"id":"performing-the-ha-failover-testing","title":"Performing the HA Failover Testing"},{"id":"cleanup","title":"Cleanup"}]}
