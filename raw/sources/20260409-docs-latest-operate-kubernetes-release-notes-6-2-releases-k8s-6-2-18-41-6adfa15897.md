...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-18-41/
retrieved_utc: '2026-04-09T20:45:58.389865+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-18-41/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"openshift-images","title":"OpenShift images"}],"id":"images","title":"Images"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"compatibility-notes","title":"Compatibility notes"},{"id":"before-upgrading","title":"Before upgrading"},{"children":[{"id":"large-clusters","title":"Large clusters"}],"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.2.18-65 release notes]().
