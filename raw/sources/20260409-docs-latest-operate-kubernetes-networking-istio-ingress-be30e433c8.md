...
url: https://redis.io/docs/latest/operate/kubernetes/networking/istio-ingress/
retrieved_utc: '2026-04-09T20:45:55.593120+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/networking/istio-ingress/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install-and-configure-istio-for-redis-enterprise","title":"Install and configure Istio for Redis Enterprise"},{"children":[{"id":"gateway-custom-resource","title":"Gateway custom resource"},{"id":"virtualservice-custom-resource","title":"VirtualService custom resource"}],"id":"create-custom-resources","title":"Create custom resources"},{"id":"test-your-external-access-to-the-database","title":"Test your external access to the database"}]}
...
1. [Deploy the operator](), Redis Enterprise Cluster (REC), and Redis Enterprise Database (REDB) on the same namespace as the gateway and virtual service.
