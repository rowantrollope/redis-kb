---
title: Quickstart
url: https://redis.io/docs/latest/integrate/redis-data-integration/quick-start-guide/
retrieved_utc: '2026-04-09T20:45:54.455800+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/quick-start-guide/index.html.md
---
...
```json metadata
{
  ...
  "categories": ["redis-di"],
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"install-postgresql","title":"Install PostgreSQL"},{"id":"install-rdi","title":"Install RDI"},{"id":"prepare-the-pipeline","title":"Prepare the pipeline"},{"id":"create-a-context-optional-create-context","title":"Create a context (optional) {#create-context}"},{"id":"deploy-the-pipeline","title":"Deploy the pipeline"},{"id":"view-rdis-response-to-data-changes","title":"View RDI's response to data changes"}],"id":"overview","title":"Overview"}]}
...
[Pipelines]() for more information). Use Redis Insight to open
