...
retrieved_utc: '2026-04-09T20:45:54.503429+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/reference/config-yaml-reference/index.html.md
---
...
```json metadata
{
  ...
  "categories": ["redis-di"],
  "tableOfContents": {"sections":[{"children":[{"id":"sourceslogging-logging-configuration","title":"sources\\.logging: Logging configuration"},{"id":"sourcestables-tables-to-capture","title":"sources\\.tables: Tables to capture"},{"id":"sourcesschemas-schema-names","title":"sources\\.schemas\\[\\]: Schema names"},{"id":"sourcesdatabases-database-names","title":"sources\\.databases\\[\\]: Database names"},{"id":"sourcesadvanced-advanced-configuration","title":"sources\\.advanced: Advanced configuration"}],"id":"sources-source-collectors","title":"sources: Source collectors"},{"children":[{"id":"processorslogging-logging-configuration","title":"processors\\.logging: Logging configuration"},{"id":"processorsadvanced-advanced-configuration","title":"processors\\.advanced: Advanced configuration"}],"id":"processors-data-processing-configuration","title":"processors: Data processing configuration"},{"id":"targets-target-connections","title":"targets: Target connections"},{"children":[{"id":"secret-providersparameters-provider-parameters","title":"secret\\-providers\\.parameters: Provider parameters"}],"id":"secret-providers-secret-providers","title":"secret\\-providers: Secret providers"}]}
