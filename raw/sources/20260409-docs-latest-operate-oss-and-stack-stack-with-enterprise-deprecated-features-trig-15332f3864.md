---
title: Debugging
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/debugging/
retrieved_utc: '2026-04-09T20:45:53.128395+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/debugging/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"use-redislog","title":"Use redis.log"},{"id":"use-redis-pubsub","title":"Use Redis pub/sub"}],"id":"overview","title":"Overview"}]}
