...
retrieved_utc: '2026-04-09T20:46:04.898274+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/info/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"section","multiple":true,"name":"section","optional":true,"type":"string"}],
...
,
  "codeExamples": [{"codetabsId":"cmds_servermgmt-stepinfo","description":"Foundational: Get server information and statistics using INFO (supports optional section filtering, returns key-value pairs)","difficulty":"beginner","id":"info","languages":[{"id":"redis-cli","panelId":"panel_redis-cli_cmds_servermgmt-stepinfo"},{"clientId":"redis-py","clientName":"redis-py","id":"Python","langId":"python","panelId":"panel_Python_cmds_servermgmt-stepinfo"},{"id":"Node-js","panelId":"panel_Nodejs_cmds_servermgmt-stepinfo"},{"clientId":"jedis","clientName":"Jedis","id":"Java-Sync","langId":"java","panelId":"panel_Java-Sync_cmds_servermgmt-stepinfo"},{"clientId":"go-redis","clientName":"go-redis","id":"Go","langId":"go","panelId":"panel_Go_cmds_servermgmt-stepinfo"}]}]
}
...
*   `acl_access_denied_tls_cert`: Number of failed TLS certificateâbased authentication attempts
...
|:----------------------|:-----------------|:------|
| <span title="Supported">&#x2705; Standard</span><br /><span title="Supported"><nobr>&#x2705; Active-Active</nobr></span> | <span title="Supported">&#x2705; Standard</span><br /><span title="Supported"><nobr>&#x2705; Active-Active</nobr></span> | In Redis Software, `INFO` returns a different set of fields than Redis Open Source.<br />Not supported for [scripts](). |
