...
retrieved_utc: '2026-04-09T20:45:51.658230+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/reference/internals/internals-rediseventlib/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"why-is-an-event-library-needed-at-all","title":"Why is an Event Library needed at all?"},{"id":"the-redis-event-library","title":"The Redis event library"}]}
