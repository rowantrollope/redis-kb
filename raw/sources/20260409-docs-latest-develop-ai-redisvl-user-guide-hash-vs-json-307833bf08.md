...
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/hash_vs_json/
retrieved_utc: '2026-04-09T20:45:53.129951+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/hash_vs_json/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"working-with-hashes","title":"Working with Hashes"},{"id":"working-with-json","title":"Working with JSON"}],"id":"hash-or-json-how-to-choose","title":"Hash or JSON -- how to choose?"},{"children":[{"id":"as-an-example","title":"As an example:"}],"id":"cleanup","title":"Cleanup"}]}
...
```
    ...
    â bytes_per_record_avg        â 40.2954559 â
    â doc_table_size_mb           â 7.27653503 â
    â inverted_sz_mb              â 0.00169086 â
    â key_table_size_mb           â 2.48908996 â
    â offset_bits_per_record_avg  â 8          â
    â offset_vectors_sz_mb        â 8.58306884 â
    â offsets_per_term_avg        â 0.20454545 â
    â records_per_doc_avg         â 6.28571414 â
    â sortable_values_size_mb     â 0          â
    â total_indexing_time         â 0.25799998 â
    â total_inverted_index_blocks â 18         â
    â vector_index_sz_mb          â 0.02023315 â
    â°ââââââââââââââââââââââââââââââ´âââââââââââââ¯
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  7.23it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 12.93it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 14.10it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 11.72it/s]
