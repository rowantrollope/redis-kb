...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/develop/data-types/hyperloglog/
retrieved_utc: '2026-04-09T20:46:04.799502+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/develop/data-types/hyperloglog/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"hyperloglog-in-redis","title":"HyperLogLog in Redis"},{"id":"the-del-wins-approach","title":"The DEL-wins approach"},{"id":"hll-in-active-active-databases-versus-hll-in-redis-open-source","title":"HLL in Active-Active databases versus HLL in Redis Open source"}]}
