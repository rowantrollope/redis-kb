...
url: https://redis.io/docs/latest/commands/redis-8-0-commands/
retrieved_utc: '2026-04-09T20:45:52.732804+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/redis-8-0-commands/index.html.md
---
...
**Syntax:** `LCS key1 key2 [LEN] [IDX] [MINMATCHLENÂ min-match-len] [WITHMATCHLEN]`
...
**Syntax:** `HEXPIRE key seconds [NX | XX | GT | LT] FIELDSÂ numfields field
  [field ...]`
...
**Syntax:** `HEXPIREAT key unix-time-seconds [NX | XX | GT | LT] FIELDSÂ numfields
  field [field ...]`
...
**Syntax:** `HEXPIRETIME key FIELDSÂ numfields field [field ...]`
...
<details>
<summary><strong><a href="/commands/hgetdel/">HGETDEL</a></strong> - Returns the value of a field and deletes it from the hash. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>

**Syntax:** `HGETDEL key FIELDSÂ numfields field [field ...]`
...
<details>
<summary><strong><a href="/commands/hgetex/">HGETEX</a></strong> - Get the value of one or more fields of a given hash key, and optionally set their expiration. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>

**Syntax:** `HGETEX key [EXÂ seconds | PXÂ milliseconds | EXATÂ unix-time-seconds |
...
**Syntax:** `HPERSIST key FIELDSÂ numfields field [field ...]`
...
**Syntax:** `HPEXPIRE key milliseconds [NX | XX | GT | LT] FIELDSÂ numfields field
  [field ...]`
...
**Syntax:** `HPEXPIRETIME key FIELDSÂ numfields field [field ...]`
...
**Syntax:** `HPTTL key FIELDSÂ numfields field [field ...]`
...
<details>
<summary><strong><a href="/commands/hsetex/">HSETEX</a></strong> - Set the value of one or more fields of a given hash key, and optionally set their expiration. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>

**Syntax:** `HSETEX key [FNX | FXX] [EXÂ seconds | PXÂ milliseconds |
...
**Syntax:** `HTTL key FIELDSÂ numfields field [field ...]`
...
**Syntax:** `BLMPOP timeout numkeys key [key ...] <LEFT | RIGHT> [COUNTÂ count]`
...
**Syntax:** `LMPOP numkeys key [key ...] <LEFT | RIGHT> [COUNTÂ count]`
...
**Syntax:** `SINTERCARD numkeys key [key ...] [LIMITÂ limit]`
...
**Syntax:** `BZMPOP timeout numkeys key [key ...] <MIN | MAX> [COUNTÂ count]`
...
**Syntax:** `ZINTERCARD numkeys key [key ...] [LIMITÂ limit]`
...
**Syntax:** `ZMPOP numkeys key [key ...] <MIN | MAX> [COUNTÂ count]`
...
<details>
<summary><strong><a href="/commands/vadd/">VADD</a></strong> - Add a new element to a vector set, or update its vector if it already exists. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vcard/">VCARD</a></strong> - Return the number of elements in a vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vdim/">VDIM</a></strong> - Return the dimension of vectors in the vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vemb/">VEMB</a></strong> - Return the vector associated with an element. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vgetattr/">VGETATTR</a></strong> - Retrieve the JSON attributes of elements. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vinfo/">VINFO</a></strong> - Return information about a vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vismember/">VISMEMBER</a></strong> - Check if an element exists in a vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vlinks/">VLINKS</a></strong> - Return the neighbors of an element at each layer in the HNSW graph. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vrandmember/">VRANDMEMBER</a></strong> - Return one or multiple random members from a vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vrem/">VREM</a></strong> - Remove an element from a vector set. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vsetattr/">VSETATTR</a></strong> - Associate or remove the JSON attributes of elements. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
<details>
<summary><strong><a href="/commands/vsim/">VSIM</a></strong> - Return elements by vector similarity. <span style="color: #e74c3c;">â­ New in 8.0</span></summary>
...
**Syntax:** `FUNCTION LIST [LIBRARYNAMEÂ library-name-pattern] [WITHCODE]`
...
**Syntax:** `CLIENT SETINFO <LIB-NAMEÂ libname | LIB-VERÂ libver>`
...
**Syntax:** `COMMAND LIST [FILTERBYÂ <MODULEÂ module-name | ACLCATÂ category |
  PATTERNÂ pattern>]`
...
**Syntax:** `MODULE LOADEX path [CONFIGÂ name value [CONFIG name value ...]]
  [ARGSÂ args [args ...]]`
...
**Syntax:** `SORT RO key [BYÂ pattern] [LIMITÂ offset count] [GETÂ pattern [GET
