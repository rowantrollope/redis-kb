...
url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/
retrieved_utc: '2026-04-09T20:45:57.098754+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"children":[{"id":"pipeline-lifecycle","title":"Pipeline lifecycle"}],"id":"how-a-pipeline-works","title":"How a pipeline works"},{"children":[{"id":"1-prepare-the-source-database","title":"1. Prepare the source database"},{"id":"2-configure-the-pipeline","title":"2. Configure the pipeline"},{"id":"3-create-job-files-optional","title":"3. Create job files (optional)"},{"id":"4-deploy-the-pipeline","title":"4. Deploy the pipeline"}],"id":"using-a-pipeline","title":"Using a pipeline"},{"id":"more-information","title":"More information"}]}
...
[hashes]() or
[JSON objects]() for the target with a
