...
retrieved_utc: '2026-04-09T20:45:57.820172+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/logging/diagnostic-logging/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"view-diagnostic-logs","title":"View diagnostic logs"},{"id":"view-log-collector-settings","title":"View log collector settings"},{"id":"change-log-collector-settings","title":"Change log collector settings"},{"id":"turn-off-log-collectors","title":"Turn off log collectors"},{"id":"log-collectors","title":"Log collectors"}]}
...
To turn off a log collector, set its `cron_expression` to an empty string when you [update the diagnostic logging service configuration]() with the REST API.
