...
url: https://redis.io/docs/latest/operate/kubernetes/flex/plan/
retrieved_utc: '2026-04-09T20:45:54.420822+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/flex/plan/index.html.md
---
...
Redis Flex databases consist of shardsâindependent data partitions that handle a portion of the dataset and request load. Each shard runs as a self-contained Redis process with dedicated memory, CPU, and Flash resources.
...
For example, a 1 TB dataset requires 20 shards (20 Ã 50 GB).
