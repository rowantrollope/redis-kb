...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/
retrieved_utc: '2026-04-09T20:46:02.085671+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"},{"id":"example-requests","title":"Example requests"}],"id":"get-all-databases-get-all-bdbs","title":"Get all databases {#get-all-bdbs}"},{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-a-database-get-bdbs","title":"Get a database {#get-bdbs}"},{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-put-request","title":"Request {#put-request}"},{"id":"response-put-response","title":"Response {#put-response}"},{"id":"status-codes-put-status-codes","title":"Status codes {#put-status-codes}"}],"id":"update-database-configuration-put-bdbs","title":"Update database configuration {#put-bdbs}"},{"children":[{"id":"request-put-request-action","title":"Request {#put-request-action}"},{"id":"response-put-response-action","title":"Response {#put-response-action}"}],"id":"update-database-and-perform-action-put-bdbs-action","title":"Update database and perform action {#put-bdbs-action}"},{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-post-request-v1","title":"Request {#post-request-v1}"},{"id":"response-post-response-v1","title":"Response {#post-response-v1}"}],"id":"create-database-v1-post-bdbs-v1","title":"Create database v1 {#post-bdbs-v1}"},{"children":[{"id":"request-post-request-v2","title":"Request {#post-request-v2}"},{"id":"response-post-response-v2","title":"Response {#post-response-v2}"}],"id":"create-database-v2-post-bdbs-v2","title":"Create database v2 {#post-bdbs-v2}"},{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-delete-request","title":"Request {#delete-request}"},{"id":"response-delete-response","title":"Response {#delete-response}"},{"id":"status-codes-delete-status-codes","title":"Status codes {#delete-status-codes}"}],"id":"delete-database-delete-bdbs","title":"Delete database {#delete-bdbs}"}]}
...
| Code | Description |
|------|-------------|
| rack_awareness_violation | â¢ Non rack-aware cluster.<br />â¢ Not enough nodes in unique racks. |
...
| bad_shards_blueprint | The sharding blueprint is broken or doesnât fit the BDB. |
...
| rack_awareness_violation | â¢ Rack awareness violation.<br/>â¢ Not enough nodes in unique racks. |
| invalid_certificate | SSL client certificate is missing or malformed. |
| certificate_expired | SSL client certificate has expired. |
| duplicated_certs | An SSL client certificate appears more than once. |
| replication_violation | CRDT database must use replication. |
