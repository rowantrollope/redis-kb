...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/known_limitations/
retrieved_utc: '2026-04-09T20:45:53.731430+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/known_limitations/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"limited-write-options","title":"Limited write options"},{"id":"exclusive-access-to-the-keyspace","title":"Exclusive access to the keyspace"},{"id":"javascript-variables","title":"JavaScript variables"},{"id":"sandboxed","title":"Sandboxed"}]}
...
This feature is sandboxed, meaning, from within a function, itâs not possible to make calls to external services, including other Redis databases, or APIs.
