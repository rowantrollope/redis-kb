...
url: https://redis.io/docs/latest/operate/rs/databases/create/
retrieved_utc: '2026-04-09T20:45:54.092064+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/create/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"quick-database","title":"Quick database"},{"id":"create-database-with-additional-configuration-create-db-ui","title":"Create database with additional configuration {#create-db-ui}"}],"id":"cluster-manager-ui-method","title":"Cluster Manager UI method"},{"id":"rest-api-method","title":"REST API method"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"}]}
...
1. [Test client connectivity]().



For databases with Active-Active replication for geo-distributed locations,
see [Create an Active-Active database](). To create and manage Active-Active databases, use the legacy UI.
...
1. Select the database type:
    ...
    - **Active-Active database** - Multiple participating Redis Software clusters can host instances of the same [Active-Active database]() in different geographic locations. Every instance can receive write operations, which are synchronized across all instances without conflict.
