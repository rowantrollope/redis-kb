...
url: https://redis.io/docs/latest/operate/kubernetes/re-clusters/connect-prometheus-operator/
retrieved_utc: '2026-04-09T20:46:00.473869+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/re-clusters/connect-prometheus-operator/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-a-servicemonitor-custom-resource","title":"Create a ServiceMonitor custom resource"},{"id":"more-info","title":"More info"}]}
