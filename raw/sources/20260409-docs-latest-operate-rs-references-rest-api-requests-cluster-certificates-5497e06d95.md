...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/cluster/certificates/
retrieved_utc: '2026-04-09T20:46:02.386799+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/cluster/certificates/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-cluster-certificates-get-cluster-certificates","title":"Get cluster certificates {#get-cluster-certificates}"},{"children":[{"id":"request-put-certificates-request","title":"Request {#put-certificates-request}"},{"id":"response-put-certificates-response","title":"Response {#put-certificates-response}"},{"id":"status-codes-put-certificates-status-codes","title":"Status codes {#put-certificates-status-codes}"}],"id":"update-cluster-certificates-put-cluster-certificates","title":"Update cluster certificates {#put-cluster-certificates}"},{"children":[{"id":"request-put-request","title":"Request {#put-request}"},{"id":"response-put-response","title":"Response {#put-response}"},{"id":"status-codes-put-status-codes","title":"Status codes {#put-status-codes}"}],"id":"update-cluster-certificate-put-cluster-updatecert","title":"Update cluster certificate {#put-cluster-update_cert}"},{"children":[{"id":"request-delete-request","title":"Request {#delete-request}"},{"id":"response-delete-response","title":"Response {#delete-response}"},{"id":"status-codes-delete-status-codes","title":"Status codes {#delete-status-codes}"}],"id":"delete-cluster-certificate-delete-cluster-certificate","title":"Delete cluster certificate {#delete-cluster-certificate}"}]}
