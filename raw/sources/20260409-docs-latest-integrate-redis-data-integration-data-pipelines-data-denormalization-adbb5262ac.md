...
retrieved_utc: '2026-04-09T20:45:56.302804+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/data-denormalization/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"joining-one-to-one-relationships","title":"Joining one-to-one relationships"},{"children":[{"id":"using-nesting","title":"Using nesting"}],"id":"joining-one-to-many-relationships","title":"Joining one-to-many relationships"}]}
