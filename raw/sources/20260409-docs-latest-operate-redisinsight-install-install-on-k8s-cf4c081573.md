...
url: https://redis.io/docs/latest/operate/redisinsight/install/install-on-k8s/
retrieved_utc: '2026-04-09T20:45:52.667249+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/redisinsight/install/install-on-k8s/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"create-the-redis-insight-deployment-and-service","title":"Create the Redis Insight deployment and service"},{"id":"create-the-redis-insight-deployment-with-persistant-storage","title":"Create the Redis Insight deployment with persistant storage"},{"id":"create-the-redis-insight-deployment-without-a-service","title":"Create the Redis Insight deployment without a service."},{"id":"run-redis-insight","title":"Run Redis Insight"}]}
