...
url: https://redis.io/docs/latest/develop/ai/featureform/training-sets-and-feature-views/
retrieved_utc: '2026-04-09T20:45:58.744906+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/featureform/training-sets-and-feature-views/index.html.md
---
...
```json metadata
{
  ...
  "categories": null,
  "tableOfContents": {"sections":[{"id":"register-metadata-first","title":"Register metadata first"},{"id":"training-sets","title":"Training sets"},{"id":"feature-views","title":"Feature views"},{"id":"serve-feature-values","title":"Serve feature values"},{"id":"common-point-of-confusion","title":"Common point of confusion"},{"id":"best-practices","title":"Best practices"},{"id":"what-to-read-next","title":"What to read next"}]}
