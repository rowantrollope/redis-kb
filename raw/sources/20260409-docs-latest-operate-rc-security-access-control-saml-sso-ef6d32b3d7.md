...
url: https://redis.io/docs/latest/operate/rc/security/access-control/saml-sso/
retrieved_utc: '2026-04-09T20:45:55.731002+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/security/access-control/saml-sso/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"idp-initiated-sso","title":"IdP-initiated SSO"},{"id":"sp-initiated-sso","title":"SP-initiated SSO"},{"id":"multi-factor-authentication","title":"Multi-factor authentication"}],"id":"saml-sso-overview","title":"SAML SSO overview"},{"children":[{"id":"verify-domain-ownership-in-redis-cloud-verify-domain","title":"Verify domain ownership in Redis Cloud {#verify-domain}"},{"id":"set-up-saml-app-set-up-app","title":"Set up SAML app {#set-up-app}"},{"id":"configure-saml-in-redis-cloud-configure-idp","title":"Configure SAML in Redis Cloud {#configure-idp}"},{"id":"download-service-provider-metadata-download-sp","title":"Download service provider metadata {#download-sp}"},{"id":"activate-saml-sso-activate-saml-sso","title":"Activate SAML SSO {#activate-saml-sso}"}],"id":"set-up-saml-sso","title":"Set up SAML SSO"},{"id":"update-configuration-update-config","title":"Update configuration {#update-config}"},{"id":"link-other-accounts","title":"Link other accounts"},{"id":"deactivate-saml-sso","title":"Deactivate SAML SSO"},{"id":"deprovision-saml-users","title":"Deprovision SAML users"}]}
...
1. Enter the domain name and select  to save it, or select  to cancel.
...
1. After you save the domain name, its status is **Pending**. Select **Verify** to verify it. 
    ...
    Select  to delete a domain if it was added by mistake.
...
When you have revoked a userâs access to Redis Cloud, they cannot access the Redis Cloud console, but their API keys remain active. You can [delete an API key]() to remove access.
