...
url: https://redis.io/docs/latest/develop/reference/gopher/
retrieved_utc: '2026-04-09T20:45:54.218496+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/gopher/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"how-it-works","title":"How it works"},{"id":"security-warning","title":"SECURITY WARNING"}]}
