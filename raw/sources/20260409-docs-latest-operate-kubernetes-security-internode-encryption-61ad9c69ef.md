...
url: https://redis.io/docs/latest/operate/kubernetes/security/internode-encryption/
retrieved_utc: '2026-04-09T20:46:01.075428+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/internode-encryption/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"enable-internode-encryption","title":"Enable internode encryption"},{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-secrets-for-internode-encryption-certificates","title":"Create secrets for internode encryption certificates"},{"id":"configure-certificates-in-rec-spec","title":"Configure certificates in REC spec"},{"id":"certificate-rotation","title":"Certificate rotation"},{"id":"certificate-lifecycle","title":"Certificate lifecycle"}],"id":"use-custom-certificates-for-internode-encryption","title":"Use custom certificates for internode encryption"},{"id":"more-info","title":"More info"}]}
...
- [Manage REC certificates]() - General certificate management for Redis Enterprise clusters
- [Configuration secrets]() - Best practices for storing configuration in Kubernetes secrets
- [Internode encryption for Redis Enterprise Software]() - Detailed information about how internode encryption works
