---
title: YAML examples
url: https://redis.io/docs/latest/operate/kubernetes/reference/yaml/
retrieved_utc: '2026-04-09T20:45:59.933038+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/reference/yaml/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"download-and-customize","title":"Download and customize"},{"id":"configuration-storage","title":"Configuration storage"},{"id":"applying-yaml-files","title":"Applying YAML files"},{"id":"monitoring-deployment","title":"Monitoring deployment"}],"id":"how-to-use-these-examples","title":"How to use these examples"},{"id":"example-categories","title":"Example categories"},{"id":"best-practices","title":"Best practices"},{"id":"related-documentation","title":"Related documentation"}]}
