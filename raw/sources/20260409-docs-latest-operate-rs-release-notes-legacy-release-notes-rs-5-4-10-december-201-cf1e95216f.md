...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-10-december-2019/
retrieved_utc: '2026-04-09T20:45:59.805959+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-10-december-2019/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"synchronization-mechanism-in-active-active-redis-and-replica-of","title":"Synchronization mechanism in Active-Active Redis and Replica-of"},{"id":"rs-on-rhel-7-supports-openssl-102-and-up","title":"RS on RHEL 7 supports OpenSSL 1.0.2 and up"}],"id":"new-features","title":"New features"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"information","title":"Information"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"upgrade","title":"Upgrade"},{"id":"cluster-api","title":"Cluster API"},{"id":"discovery-service","title":"Discovery service"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
- The titles of the ârladmin status nodesâ command output were updated from âRAMâ to âFREE_RAMâ (the amount of RAM in the node that is currently not used) and from âAVAILABLE_RAMâ to âPROVISIONAL_RAMâ (the amount of RAM in the node that can be provisioned).
...
- RS31477 - Fixed wrong calculation of nodeâs âAVAILABLE_RAMâ (âPROVISIONAL_RAMâ) as displayed the output of ârladmin status nodesâ command
...
- RS27327 - Improved the backup timing when using the database parameter of âbackup_interval_offsetâ through the REST API
