...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/jvm/recipes/write-behind/
retrieved_utc: '2026-04-09T20:45:59.100695+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/jvm/recipes/write-behind/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"differences-from-rgsync","title":"Differences from RGSync"},{"children":[{"id":"register-rghibernate-jar","title":"Register rghibernate JAR"},{"id":"configure-database-connection","title":"Configure database connection"},{"id":"configure-data-mapping","title":"Configure data mapping"}],"id":"set-up-write-behind-and-read-through","title":"Set up write-behind and read-through"},{"children":[{"id":"connector-xml","title":"Connector XML"},{"id":"mapping-xml","title":"Mapping XML"}],"id":"example-configuration","title":"Example configuration"},{"children":[{"id":"command-list","title":"Command list"},{"id":"syncregisterconnector","title":"SYNC.REGISTERCONNECTOR"},{"id":"syncregistersource","title":"SYNC.REGISTERSOURCE"}],"id":"commands","title":"Commands"}]}
...
| policy | WriteBehind/WriteThrough/ReadThrough: <br></br>â¢ On WriteThrough, an extra argument is WriteTimeout <br></br>â¢ On ReadThrough, an extra argument is expire (0 for no expire) |
