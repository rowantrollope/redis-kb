...
retrieved_utc: '2026-04-09T20:45:52.665797+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/programmability/lua-api/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"global-variables-and-functions","title":"Global variables and functions"},{"id":"imported-lua-modules","title":"Imported Lua modules"}],"id":"sandbox-context","title":"Sandbox context"},{"children":[{"id":"the-redis-singleton","title":"The redis singleton"},{"id":"the-keys-global-variable-the-keys-global-variable","title":"The KEYS global variable {#the-keys-global-variable}"},{"id":"the-argv-global-variable-the-argv-global-variable","title":"The ARGV global variable {#the-argv-global-variable}"}],"id":"runtime-globals","title":"Runtime globals"},{"children":[{"id":"rediscallcommand-arg-rediscall","title":"redis.call(command [,arg...]) {#redis.call}"},{"id":"redispcallcommand-arg-redispcall","title":"redis.pcall(command [,arg...]) {#redis.pcall}"},{"id":"rediserrorreplyx-rediserrorreply","title":"redis.errorreply(x) {#redis.errorreply}"},{"id":"redisstatusreplyx-redisstatusreply","title":"redis.statusreply(x) {#redis.statusreply}"},{"id":"redissha1hexx-redissha1hex","title":"redis.sha1hex(x) {#redis.sha1hex}"},{"id":"redisloglevel-message-redislog","title":"redis.log(level, message) {#redis.log}"},{"id":"redissetrespx-redissetresp","title":"redis.setresp(x) {#redis.setresp}"},{"id":"redissetreplx-redissetrepl","title":"redis.setrepl(x) {#redis.setrepl}"},{"id":"redisreplicatecommands-redisreplicatecommands","title":"redis.replicatecommands() {#redis.replicatecommands}"},{"id":"redisbreakpoint-redisbreakpoint","title":"redis.breakpoint() {#redis.breakpoint}"},{"id":"redisdebugx-redisdebug","title":"redis.debug(x) {#redis.debug}"},{"id":"redisaclcheckcmdcommand-arg-redisaclcheckcmd","title":"redis.aclcheckcmd(command [,arg...]) {#redis.aclcheckcmd}"},{"id":"redisregisterfunction-redisregisterfunction","title":"redis.registerfunction {#redis.registerfunction}"},{"id":"redisredisversion-redisredisversion","title":"redis.REDISVERSION {#redis.redisversion}"},{"id":"redisredisversionnum-redisredisversionnum","title":"redis.REDISVERSIONNUM {#redis.redisversionnum}"}],"id":"redis-object-redisobject","title":"redis object {#redis_object}"},{"children":[{"id":"resp2-to-lua-type-conversion","title":"RESP2 to Lua type conversion"}],"id":"data-type-conversion","title":"Data type conversion"},{"children":[{"id":"resp3-to-lua-type-conversion","title":"RESP3 to Lua type conversion"},{"id":"lua-to-resp3-type-conversion","title":"Lua to RESP3 type conversion"}],"id":"lua-to-resp2-type-conversion","title":"Lua to RESP2 type conversion"},{"children":[{"id":"using-select-inside-scripts","title":"Using SELECT inside scripts"}],"id":"additional-notes-about-scripting","title":"Additional notes about scripting"},{"children":[{"id":"os-library-os-library","title":"os library {#os-library}"},{"id":"struct-library-struct-library","title":"struct library {#struct-library}"},{"id":"cjson-library-cjson-library","title":"cjson library {#cjson-library}"},{"id":"cmsgpack-library-cmsgpack-library","title":"cmsgpack library {#cmsgpack-library}"},{"id":"bit-library-bitop-library","title":"bit library {#bitop-library}"}],"id":"runtime-libraries","title":"Runtime libraries"}]}
...
The _KEYS_ global variable is available only for [ephemeral scripts]().
...
The _ARGV_ global variable is available only in [ephemeral scripts]().
...
This function allows the executing script to switch between [Redis Serialization Protocol (RESP)]() versions for the replies returned by [`redis.call()`](#redis.call) and [`redis.pcall()`](#redis.pcall).
...
* [RESP2 status reply]() -> Lua table with a single _ok_ field containing the status string
* [RESP2 error reply]() -> Lua table with a single _err_ field containing the error string
...
[RESP3](https://github.com/redis/redis-specifications/blob/master/protocol/RESP3.md) is a newer version of the [Redis Serialization Protocol]().
