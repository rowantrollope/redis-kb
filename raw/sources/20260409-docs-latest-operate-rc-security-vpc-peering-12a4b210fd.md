...
url: https://redis.io/docs/latest/operate/rc/security/vpc-peering/
retrieved_utc: '2026-04-09T20:45:59.706161+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/security/vpc-peering/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"configure-vpc-peering-config-aws-vpc-peering","title":"Configure VPC peering {#config-aws-vpc-peering}"},{"id":"approve-vpc-peering-request-approve-aws-vpc-peering","title":"Approve VPC peering request {#approve-aws-vpc-peering}"},{"id":"update-route-tables-update-route-tables","title":"Update route tables {#update-route-tables}"}],"id":"aws-vpc-peering","title":"AWS VPC peering"},{"children":[{"id":"configure-vpc-peering-config-gcp-vpc-peering","title":"Configure VPC peering {#config-gcp-vpc-peering}"},{"id":"approve-vpc-peering-request-approve-gcp-vpc-peering","title":"Approve VPC peering request {#approve-gcp-vpc-peering}"}],"id":"google-cloud-vpc-peering-gcp-vpc-peering","title":"Google Cloud VPC peering {#gcp-vpc-peering}"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"}]}
