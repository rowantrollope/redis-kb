...
retrieved_utc: '2026-04-09T20:45:57.021653+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"high-availability","title":"High availability"},{"id":"multi-primary-replication","title":"Multi-primary replication"},{"id":"syncer","title":"Syncer"},{"id":"conflict-resolution","title":"Conflict resolution"},{"id":"strong-eventual-consistency","title":"Strong eventual consistency"},{"id":"next-steps","title":"Next steps"}]}
...
Other Redis Software features can also be used to enhance the performance, scalability, or durability of your Active-Active database. These include [data persistence](), [multiple active proxies](), [distributed synchronization](), [OSS Cluster API](), and [rack-zone awareness]().
...
- Review [disaster recovery strategies for Active-Active databases]()