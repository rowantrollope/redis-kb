...
retrieved_utc: '2026-04-09T20:45:38.263697+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/xinfo-stream/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"key_spec_index":0,"name":"key","type":"key"},{"arguments":[{"name":"full","token":"FULL","type":"pure-token"},{"name":"count","optional":true,"token":"COUNT","type":"integer"}],"name":"full-block","optional":true,"type":"block"}],
  "syntax_fmt": "XINFO STREAM key [FULL [COUNTÂ count]]",
  "complexity": "O(1)",
  "group": "stream",
...
When IDMP is configured for the stream using [`XCFGSET`](), the following additional fields are included:
