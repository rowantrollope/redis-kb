...
url: https://redis.io/docs/latest/develop/ai/featureform/quickstart/
retrieved_utc: '2026-04-09T20:45:55.693683+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/featureform/quickstart/index.html.md
---
...
```json metadata
{
  ...
  "categories": null,
  "tableOfContents": {"sections":[{"id":"before-you-begin","title":"Before you begin"},{"id":"connect-to-featureform","title":"Connect to Featureform"},{"id":"register-providers","title":"Register providers"},{"id":"register-a-dataset-and-transformation","title":"Register a dataset and transformation"},{"id":"define-an-entity-and-features","title":"Define an entity and features"},{"id":"register-metadata-then-materialize","title":"Register metadata, then materialize"},{"id":"serve-features","title":"Serve features"},{"id":"what-to-read-next","title":"What to read next"}]}
