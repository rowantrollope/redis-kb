...
retrieved_utc: '2026-04-09T20:45:52.332300+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/install/archive/install-stack/mac-os/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"first-time-redis-installation","title":"First-time Redis installation"},{"id":"existing-redis-installation","title":"Existing Redis installation"},{"id":"start-redis-stack-server","title":"Start Redis Stack Server"}],"id":"install-using-homebrew","title":"Install using Homebrew"},{"id":"installing-redis-after-installing-redis-stack","title":"Installing Redis after installing Redis Stack"},{"id":"uninstall-redis-stack","title":"Uninstall Redis Stack"},{"id":"connect-to-redis","title":"Connect to Redis"},{"id":"next-steps","title":"Next steps"}]}
