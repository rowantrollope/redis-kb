...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-2/
retrieved_utc: '2026-04-09T20:46:01.418517+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-2/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.12.2 (July 2025)",
  "description": "RDI Collector API now properly supports MariaDB. Extend adding custom labels and annotations to all resources in the RDI Helm chart.",
