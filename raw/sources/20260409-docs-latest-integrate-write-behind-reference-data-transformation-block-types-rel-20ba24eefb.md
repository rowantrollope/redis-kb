...
url: https://redis.io/docs/latest/integrate/write-behind/reference/data-transformation-block-types/relational_write/
retrieved_utc: '2026-04-09T20:45:54.871318+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/write-behind/reference/data-transformation-block-types/relational_write/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"keys-business-keys-to-use-in-case-of-loadstrategy-is-upsert-or-working-with-opcodefield","title":"keys\\[\\]: Business keys to use in case of \\loadstrategy\\ is UPSERT or working with \\opcodefield\\"},{"id":"mapping-fields-to-write","title":"mapping\\[\\]: Fields to write"},{"id":"inactiverecordmapping-used-for-type2-loadstrategy-the-columns-mapping-to-use-to-close-out-an-active-record","title":"inactiverecordmapping\\[\\]: Used for \\TYPE2\\ load_strategy\\. The columns mapping to use to close out an active record"}]}
