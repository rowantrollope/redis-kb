---
title: "Enable private and\xC2\_public database endpoints"
url: https://redis.io/docs/latest/operate/rs/networking/private-public-endpoints/
retrieved_utc: '2026-04-09T20:46:06.373101+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/networking/private-public-endpoints/index.html.md
---
...
```Each node in Redis Software can be configured with [private and external IP addresses](). By default, Redis Software databases expose a single endpoint, e.g. cluster.com (FQDN), using the external IP addresses, making it available to the public network (e.g. the internet). Additionally, the cluster can be configured to expose a private FQDN, which utilizes the private IP addresses for access from the private network only (e.g. VPC or an internal network).
