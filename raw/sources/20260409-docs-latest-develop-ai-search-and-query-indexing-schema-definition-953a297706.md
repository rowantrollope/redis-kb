...
url: https://redis.io/docs/latest/develop/ai/search-and-query/indexing/schema-definition/
retrieved_utc: '2026-04-09T20:45:51.960394+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/indexing/schema-definition/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"more-schema-definition-examples","title":"More schema definition examples"}]}
