...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-8-dec23/
retrieved_utc: '2026-04-09T20:45:58.318867+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-8-dec23/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"feature-enhancements","title":"Feature enhancements"}],"id":"new-in-this-release","title":"New in this release"},{"id":"upgrade-considerations","title":"Upgrade considerations"},{"children":[{"id":"images","title":"Images"}],"id":"compatibility","title":"Compatibility"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2-103 release notes]().