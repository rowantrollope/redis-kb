...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/disaster-recovery/proxy-based/
retrieved_utc: '2026-04-09T20:45:55.667914+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/disaster-recovery/proxy-based/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"avoid-concurrent-access-across-replicas","title":"Avoid concurrent access across replicas"},{"id":"co-locate-to-reduce-latency-and-improve-scalability","title":"Co-locate to reduce latency and improve scalability"},{"id":"pool-proxies-for-scalability","title":"Pool proxies for scalability"}]}
