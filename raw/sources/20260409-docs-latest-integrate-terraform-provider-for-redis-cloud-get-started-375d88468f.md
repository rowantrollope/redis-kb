...
retrieved_utc: '2026-04-09T20:46:04.390824+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/terraform-provider-for-redis-cloud/get-started/index.html.md
---
...
```json metadata
{
  ...
  "group": "provisioning",
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"install-the-redis-cloud-provider","title":"Install the Redis Cloud provider"},{"id":"create-a-redis-cloud-subscription-with-terraform","title":"Create a Redis Cloud subscription with Terraform"},{"id":"more-info","title":"More info"}]}
