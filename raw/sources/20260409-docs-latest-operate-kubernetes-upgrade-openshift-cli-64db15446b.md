...
url: https://redis.io/docs/latest/operate/kubernetes/upgrade/openshift-cli/
retrieved_utc: '2026-04-09T20:45:55.629444+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/upgrade/openshift-cli/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"upgrade-with-helm-charts","title":"Upgrade with Helm charts"},{"children":[{"id":"download-the-bundle","title":"Download the bundle"},{"id":"apply-the-bundle","title":"Apply the bundle"},{"id":"reapply-the-admission-controller-webhook-reapply-webhook","title":"Reapply the admission controller webhook {#reapply-webhook}"},{"id":"verify-the-operator-is-running","title":"Verify the operator is running"}],"id":"upgrade-the-operator","title":"Upgrade the operator"},{"id":"security-context-constraints","title":"Security context constraints"},{"children":[{"id":"edit-redisenterpriseimagespec","title":"Edit redisEnterpriseImageSpec"},{"id":"reapply-roles-and-role-bindings","title":"Reapply roles and role bindings"},{"id":"monitor-the-upgrade","title":"Monitor the upgrade"},{"id":"upgrade-databases","title":"Upgrade databases"}],"id":"upgrade-the-redis-enterprise-cluster","title":"Upgrade the Redis Enterprise cluster"},{"children":[{"id":"invalid-module-version","title":"Invalid module version"},{"id":"invalid-database-version","title":"Invalid database version"}],"id":"troubleshooting","title":"Troubleshooting"}]}
