...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/actions/failover/
retrieved_utc: '2026-04-09T20:46:03.961478+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/actions/failover/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-post-multi-request","title":"Request {#post-multi-request}"},{"id":"response-post-multi-response","title":"Response {#post-multi-response}"},{"id":"status-codes-post-multi-status-codes","title":"Status codes {#post-multi-status-codes}"},{"id":"error-codes-put-multi-error-codes","title":"Error codes {#put-multi-error-codes}"}],"id":"fail-over-multiple-shards-post-multi-shards","title":"Fail over multiple shards {#post-multi-shards}"},{"children":[{"id":"request-post-request","title":"Request {#post-request}"},{"id":"response-post-response","title":"Response {#post-response}"},{"id":"status-codes-post-status-codes","title":"Status codes {#post-status-codes}"},{"id":"error-codes-put-error-codes","title":"Error codes {#put-error-codes}"}],"id":"fail-over-shard-post-shard","title":"Fail over shard {#post-shard}"}]}
