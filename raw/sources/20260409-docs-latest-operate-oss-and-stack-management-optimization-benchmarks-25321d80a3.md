...
retrieved_utc: '2026-04-09T20:45:51.549278+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/benchmarks/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"how-fast-is-redis","title":"How fast is Redis?"},{"id":"benchmark-results-on-bare-metal-servers-across-different-redis-versions","title":"Benchmark results on bare-metal servers across different Redis versions"},{"id":"other-redis-benchmarking-tools","title":"Other Redis benchmarking tools"}]}
