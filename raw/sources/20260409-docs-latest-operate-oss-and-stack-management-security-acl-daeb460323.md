...
retrieved_utc: '2026-04-09T20:45:51.506868+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/security/acl/index.html.md
---
...
,
  "codeExamples": [{"id":"admin"},{"id":"bitmap"},{"id":"blocking"},{"id":"bloom"},{"id":"cms"},{"id":"connection"},{"id":"cuckoo"},{"id":"dangerous"},{"id":"fast"},{"id":"geo"},{"id":"hash"},{"id":"hyperloglog"},{"id":"json"},{"id":"keyspace"},{"id":"list"},{"id":"pubsub"},{"id":"read"},{"id":"scripting"},{"id":"search"},{"id":"set"},{"id":"sortedset"},{"id":"slow"},{"id":"stream"},{"id":"string"},{"id":"tdigest"},{"id":"timeseries"},{"id":"topk"},{"id":"transaction"},{"id":"write"}]
}
```
...
1. <a name="cmd-note-1"></a> See the [Redis 8 release notes]() for more information about these command categories, which may introduce breaking changes to your Redis deployments.
