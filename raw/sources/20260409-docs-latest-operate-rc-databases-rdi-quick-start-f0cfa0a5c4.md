...
url: https://redis.io/docs/latest/operate/rc/databases/rdi/quick-start/
retrieved_utc: '2026-04-09T20:45:51.849731+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/rdi/quick-start/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-a-data-pipeline","title":"Create a data pipeline"},{"id":"create-the-source-database-and-network-resources","title":"Create the source database and network resources"},{"id":"define-source-connection","title":"Define source connection"},{"id":"define-data-pipeline","title":"Define data pipeline"},{"id":"delete-sample-resources","title":"Delete sample resources"}]}
...
See [Define data pipeline]() for detailed steps on defining your data pipeline.
