...
url: https://redis.io/docs/latest/operate/kubernetes/active-active/create-reaadb/
retrieved_utc: '2026-04-09T20:45:56.296120+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/active-active/create-reaadb/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-rerc-custom-resources-create-rerc","title":"Create RERC custom resources {#create-rerc}"},{"id":"create-the-reaadb-create-reaadb","title":"Create the REAADB {#create-reaadb}"},{"id":"example-values","title":"Example values"}]}
