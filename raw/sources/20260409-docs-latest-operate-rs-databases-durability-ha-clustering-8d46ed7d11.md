...
retrieved_utc: '2026-04-09T20:45:54.028265+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/durability-ha/clustering/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"terminology","title":"Terminology"},{"id":"when-to-use-clustering-sharding","title":"When to use clustering (sharding)"},{"id":"number-of-shards","title":"Number of shards"},{"children":[{"id":"standard-hashing-policy","title":"Standard hashing policy"},{"id":"custom-hashing-policy","title":"Custom hashing policy"},{"id":"custom-hashing-policy-notes-and-limitations","title":"Custom hashing policy notes and limitations"}],"id":"supported-hashing-policies","title":"Supported hashing policies"},{"id":"change-the-hashing-policy","title":"Change the hashing policy"},{"id":"multi-key-operations-multikey-operations","title":"Multi-key operations {#multikey-operations}"}]}
...
When using the standard hashing policy, a clustered Redis Software database behaves similarly to a standard [Redis Open Source cluster](#hash-tags), except when using multiple hash tags in a key's name. We recommend using only a single hash tag in a key name for hashing in Redis Software.
