...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/openshift-cli/
retrieved_utc: '2026-04-09T20:45:58.635043+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/openshift-cli/index.html.md
---
...
{
  "title": "Deployment with OpenShift CLI for Redis Enterprise for Kubernetes",
  "description": "Redis Enterprise for Kubernetes and cluster can be installed via CLI tools OpenShift",
  "categories": ["docs","operate","kubernetes"],
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"deploy-the-operator","title":"Deploy the operator"},{"id":"security-context-constraints","title":"Security context constraints"},{"id":"create-a-redis-enterprise-cluster-custom-resource","title":"Create a Redis Enterprise cluster custom resource"},{"children":[{"id":"limit-the-webhook-to-relevant-namespaces","title":"Limit the webhook to relevant namespaces"},{"id":"verify-admission-controller-installation","title":"Verify admission controller installation"}],"id":"configure-the-admission-controller","title":"Configure the admission controller"},{"id":"create-a-redis-enterprise-database-custom-resource","title":"Create a Redis Enterprise database custom resource"},{"id":"more-info","title":"More info"}]}
