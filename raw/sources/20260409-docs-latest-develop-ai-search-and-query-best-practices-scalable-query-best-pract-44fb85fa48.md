...
url: https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/scalable-query-best-practices/
retrieved_utc: '2026-04-09T20:45:51.901445+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/scalable-query-best-practices/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"checklist","title":"Checklist"},{"children":[{"id":"general","title":"General"},{"id":"non-threaded-search","title":"Non-threaded search"},{"id":"threaded-query-performance-factor-or-qpf-search","title":"Threaded (query performance factor or QPF) search"}],"id":"indexing-considerations","title":"Indexing considerations"},{"id":"query-optimization","title":"Query optimization"},{"id":"validate-performance-ftprofile","title":"Validate performance (FT.PROFILE)"},{"children":[{"id":"anti-pattern-index-schema","title":"Anti-pattern index schema"},{"id":"anti-pattern-query","title":"Anti-pattern query"},{"id":"improved-index-schema","title":"Improved index schema"},{"id":"improved-query","title":"Improved query"}],"id":"anti-patterns","title":"Anti-patterns"}]}
...
- Favor [`TAG`]() over [`TEXT`]() for use cases that donât require full-text capabilities (pure match).

### Non-threaded search
- Put only those fields used in your queries in the index.
- Only make fields [`SORTABLE`]() if they are used in [`SORTBY`]()
queries.
- Use [`DIALECT 2`]().
...
You can analyze [`FT.PROFILE`]() output to gain insights about query execution.
...
Hereâs an optimized schema that adheres to best practices for vertical scaling:
...
- [`DIALECT 2`](): enables the latest Redis Search syntax and features, ensuring compatibility with modern capabilities.
