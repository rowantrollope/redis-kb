...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/previous-releases/k8s-5-4-10-8/
retrieved_utc: '2026-04-09T20:45:59.931765+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/previous-releases/k8s-5-4-10-8/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"new-features","title":"New features"},{"id":"information","title":"Information"},{"id":"known-limitations","title":"Known limitations"}]}
...
- Rack Awareness - Support for the [Redis Software Rack Awareness][] feature was introduced to the Kubernetes deployment. It enables deploying nodes to different zones, in a multi-zone Kubernetes cluster. Databases that are rack-aware will have the cluster populate their master shard and replica shards in different nodes, across different zones or failure domains. This enables maintaining data persistence in case of zone failure.
