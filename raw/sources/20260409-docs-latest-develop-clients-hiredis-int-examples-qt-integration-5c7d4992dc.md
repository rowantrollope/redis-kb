...
url: https://redis.io/docs/latest/develop/clients/hiredis/int-examples/qt-integration/
retrieved_utc: '2026-04-09T20:45:58.193150+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/hiredis/int-examples/qt-integration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install-qt","title":"Install Qt"},{"id":"create-a-simple-app","title":"Create a simple app"},{"id":"add-hiredis-files","title":"Add hiredis files"},{"children":[{"id":"header-file","title":"Header file"},{"id":"implementation-file","title":"Implementation file"},{"id":"main-program","title":"Main program"}],"id":"add-code-to-access-redis","title":"Add code to access Redis"},{"id":"run-the-code","title":"Run the code"},{"id":"key-information","title":"Key information"}]}
