...
retrieved_utc: '2026-04-09T20:45:52.337876+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/programmability/eval-intro/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"getting-started","title":"Getting started"},{"id":"script-parameterization","title":"Script parameterization"},{"id":"interacting-with-redis-from-a-script","title":"Interacting with Redis from a script"},{"children":[{"id":"cache-volatility","title":"Cache volatility"},{"id":"evalsha-in-the-context-of-pipelining","title":"EVALSHA in the context of pipelining"},{"id":"script-cache-semantics","title":"Script cache semantics"}],"id":"script-cache","title":"Script cache"},{"id":"the-script-command","title":"The SCRIPT command"},{"children":[{"id":"replicating-commands-instead-of-scripts","title":"Replicating commands instead of scripts"},{"id":"scripts-with-deterministic-writes","title":"Scripts with deterministic writes"}],"id":"script-replication","title":"Script replication"},{"id":"debugging-eval-scripts","title":"Debugging Eval scripts"},{"id":"execution-under-low-memory-conditions","title":"Execution under low memory conditions"},{"id":"eval-flags","title":"Eval flags"}]}
