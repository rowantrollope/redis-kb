...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-may-2020/
retrieved_utc: '2026-04-09T20:45:59.572468+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-may-2020/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"upgrade-instructions","title":"Upgrade instructions"},{"id":"end-of-life","title":"End of life"}],"id":"version-information","title":"Version information"},{"children":[{"id":"open-source-redis-6","title":"Open source Redis 6"},{"id":"access-control-list-acl","title":"Access control list (ACL)"},{"id":"role-based-access-control-rbac","title":"Role-based access control (RBAC)"},{"id":"active-active-support-for-redis-streams","title":"Active-Active support for Redis Streams"}],"id":"new-features","title":"New features"},{"id":"redis-modules","title":"Redis modules"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"active-active-databases","title":"Active-Active databases"},{"id":"installation-limitations","title":"Installation limitations"},{"id":"upgrade","title":"Upgrade"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
For more information, check out the [Redis Enterprise Software user management documentation]().
...
RS 6.0 adds support for Redis streams on Active-Active geo-distributed databases using conflict-free replicated data type (CRDT). You can now use all Redis streams commands including consumer groups on Active-Active databases. To enable it, [upgrade your Active-Active database]() featureset version to the latest (featureset version = 2) as part of the upgrade process.
For more information, check out [Redis Streams on Active Active databases]().

## Redis modules

The following GA releases of Redis Modules are bundled in RS 6.0:

- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.2]() (updated)
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.11]() (updated)
- [RedisJson](https://redislabs.com/redis-enterprise/redis-json/), version [1.0.4]()
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.12]() (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.5]() (updated)
...
- The crdb-cli tool was updated so it is now displaying the Active-Active databaseâs featureset version and the protocol version per instance. For example:
...
- RS26448 - Fixed âram overheadâ metric calculation for ROF databases using AOF.
- RS31190 - Fixed a bug that causes databases with OSS Cluster API enabled to override the âpreferred IP typeâ attribute from âexternalâ to âinternalâ (the default value).
