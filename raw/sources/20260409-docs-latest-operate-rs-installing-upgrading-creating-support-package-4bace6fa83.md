...
url: https://redis.io/docs/latest/operate/rs/installing-upgrading/creating-support-package/
retrieved_utc: '2026-04-09T20:46:03.550174+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/installing-upgrading/creating-support-package/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"create-support-package","title":"Create support package"},{"children":[{"id":"database-support-package-files","title":"Database support package files"},{"id":"node-support-package-files","title":"Node support package files"}],"id":"support-package-files","title":"Support package files"},{"id":"related-info","title":"Related info"}]}
...
You can use `debuginfo` [REST API]() requests to create and download support packages.
...
| node_<node_uid>_sys_info.txt | Node's system information including:<br />â¢ Socket files list<br />â¢ Log files list<br />â¢ Processes running on the node<br />â¢ Disk usage<br />â¢ Persistent files list<br />â¢ Memory usage<br />â¢ Network interfaces<br />â¢ Installed packages<br />â¢ Active iptables<br />â¢ OS and platform<br />â¢ Network connection<br />â¢ Status of Redis processes |
