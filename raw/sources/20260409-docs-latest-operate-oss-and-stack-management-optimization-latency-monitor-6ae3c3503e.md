...
retrieved_utc: '2026-04-09T20:45:51.703343+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/latency-monitor/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"events-and-time-series","title":"Events and time series"},{"id":"how-to-enable-latency-monitoring","title":"How to enable latency monitoring"},{"id":"report-information-with-the-latency-command","title":"Report information with the LATENCY command"}]}
