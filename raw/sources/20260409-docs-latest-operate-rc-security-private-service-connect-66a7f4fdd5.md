...
url: https://redis.io/docs/latest/operate/rc/security/private-service-connect/
retrieved_utc: '2026-04-09T20:45:59.653565+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/security/private-service-connect/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"considerations","title":"Considerations"},{"children":[{"id":"configure-psc-configure-psc","title":"Configure PSC {#configure-psc}"},{"id":"create-endpoints-create-endpoints","title":"Create endpoints {#create-endpoints}"},{"id":"accept-psc-connection-accept-psc","title":"Accept PSC connection {#accept-psc}"},{"id":"connect-to-database-connect-db","title":"Connect to database {#connect-db}"}],"id":"set-up-private-service-connect-setup-psc","title":"Set up Private Service Connect {#setup-psc}"},{"id":"deactivate-private-service-connect-deactivate-psc","title":"Deactivate Private Service Connect {#deactivate-psc}"},{"id":"limitations","title":"Limitations"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"}]}
...
- Although Redis Cloud supports using Private Service Connect with Enterprise clustering, you cannot use the [Cluster API]() with Private Service Connect enabled.
- The pre-handoff feature of [Smart client handoffs]() is not currently supported with Private Service Connect, but relaxed timeouts are available and enabled by default.
