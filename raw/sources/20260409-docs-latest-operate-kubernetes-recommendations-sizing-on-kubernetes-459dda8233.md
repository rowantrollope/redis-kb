...
url: https://redis.io/docs/latest/operate/kubernetes/recommendations/sizing-on-kubernetes/
retrieved_utc: '2026-04-09T20:45:58.230682+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/recommendations/sizing-on-kubernetes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"setting-the-number-of-cluster-nodes","title":"Setting the number of cluster nodes"},{"id":"scaling-out","title":"Scaling out"},{"id":"sizing-compute-resources","title":"Sizing compute resources"},{"id":"scaling-up-node-compute-resources","title":"Scaling up node compute resources"}],"id":"sizing-and-scaling-cluster-nodes","title":"Sizing and scaling cluster nodes"}]}
...
- limits â specifies the maximum compute resources for a Redis node
- requests â specifies the minimum compute resources for a Redis node
