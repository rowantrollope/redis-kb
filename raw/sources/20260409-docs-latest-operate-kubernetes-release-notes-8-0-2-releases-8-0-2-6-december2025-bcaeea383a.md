...
retrieved_utc: '2026-04-09T20:45:51.498483+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/8-0-2-6-december2025/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"enhancements","title":"Enhancements"},{"children":[{"id":"api-changes","title":"API changes"}],"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"modules-in-redis-8","title":"Modules in Redis 8"},{"id":"breaking-changes","title":"Breaking changes"},{"id":"deprecations","title":"Deprecations"}],"id":"version-changes","title":"Version changes"},{"id":"supported-distributions","title":"Supported distributions"},{"children":[{"id":"openshift-downloads","title":"Openshift downloads"}],"id":"downloads","title":"Downloads"},{"id":"known-limitations","title":"Known limitations"}]}
...
For additional breaking changes related to Redis Software 8.0.2-41, see [Redis 8 breaking changes]().
