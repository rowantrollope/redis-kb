...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-2-4-releases/7-2-4-2/
retrieved_utc: '2026-04-09T20:45:56.734003+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-2-4-releases/7-2-4-2/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"enhancements","title":"Enhancements"},{"id":"resolved-issues","title":"Resolved issues"},{"id":"api-changes","title":"API changes"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"deprecations","title":"Deprecations"},{"id":"supported-distributions","title":"Supported distributions"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"children":[{"id":"new-limitations","title":"New limitations"},{"id":"existing-limitations","title":"Existing limitations"}],"id":"known-limitations","title":"Known limitations"}]}
...
<span title="Warning icon">&#x26A0;&#xFE0F;</span> Deprecated â This distribution is still supported for this version of Redis Enterprise Software for Kubernetes, but support will be removed in a future release.
...
It is not possible to upgrade your OLM deployment to version 7.2.4 from version 6.2.4-8 (November release). Uninstall 6.2.4-8 and perform a fresh install of 7.2.4.
