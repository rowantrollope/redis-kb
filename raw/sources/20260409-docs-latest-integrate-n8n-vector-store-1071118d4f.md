...
url: https://redis.io/docs/latest/integrate/n8n-vector-store/
retrieved_utc: '2026-04-09T20:45:52.672777+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/n8n-vector-store/index.html.md
---
...
```json metadata
{
  ...
  "group": "library",
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"available-operations","title":"Available operations"},{"id":"example-workflows","title":"Example workflows"}]}
...
See the [Redis Cloud quickstart guide]()
or the [Redis Open Source installation guide]()
