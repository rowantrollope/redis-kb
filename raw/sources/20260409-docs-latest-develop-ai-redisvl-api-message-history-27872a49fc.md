...
url: https://redis.io/docs/latest/develop/ai/redisvl/api/message_history/
retrieved_utc: '2026-04-09T20:46:05.433308+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/message_history/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-semanticmessagehistoryname-sessiontagnone-prefixnone-vectorizernone-distancethreshold03-redisclientnone-redisurlredislocalhost6379-connectionkwargs-overwritefalse-kwargs","title":"class SemanticMessageHistory(name, sessiontag=None, prefix=None, vectorizer=None, distancethreshold=0.3, redisclient=None, redisurl='redis://localhost:6379', connection_kwargs={}, overwrite=False, **kwargs)"}],"id":"semanticmessagehistory","title":"SemanticMessageHistory"},{"children":[{"id":"class-messagehistoryname-sessiontagnone-prefixnone-redisclientnone-redisurlredislocalhost6379-connectionkwargs-kwargs","title":"class MessageHistory(name, sessiontag=None, prefix=None, redisclient=None, redisurl='redis://localhost:6379', connectionkwargs={}, **kwargs)"}],"id":"messagehistory","title":"MessageHistory"}]}

,
  "codeExamples": [{"id":"semantic-message-history-api"},{"id":"message-history-api"}]
}
```
...
* **Parameters:**
  ...
  * **session_tag** (*Optional* *[* *str* *]*) â Tag to be added to entries to link to a specific
    conversation session. Defaults to instance ULID.
  * **prefix** (*Optional* *[* *str* *]*) â Prefix for the keys for this message data.
    Defaults to None and will be replaced with the index name.
  * **vectorizer** (*Optional* *[* *BaseVectorizer* *]*) â The vectorizer used to create embeddings.
  * **distance_threshold** (*float*) â The maximum semantic distance to be
    included in the context. Defaults to 0.3.
  * **redis_client** (*Optional* *[* *Redis* *]*) â A Redis client instance. Defaults to
    None.
...
* **Parameters:**
  * **message** (*Dict* *[* *str* *,**str* *]*) â The user prompt or LLM response.
  * **session_tag** (*Optional* *[* *str* *]*) â Tag to be added to entry to link to a specific
    conversation session. Defaults to instance ULID.
* **Return type:**
  None
...
* **Parameters:**
  * **messages** (*List* *[* *Dict* *[* *str* *,* *str* *]* *]*) â The list of user prompts and LLM responses.
  * **session_tag** (*Optional* *[* *str* *]*) â Tag to be added to entries to link to a specific
    conversation session. Defaults to instance ULID.
* **Return type:**
  None
...
* **Parameters:**
  **id** (*Optional* *[* *str* *]*) â The id of the message entry to delete.
...
* **Parameters:**
  * **top_k** (*int*) â The number of previous exchanges to return. Default is 5.
  * **as_text** (*bool*) â Whether to return the conversation as a single string,
    or list of alternating prompts and responses.
  * **raw** (*bool*) â Whether to return the full Redis hash entry or just the
    prompt and response
  * **session_tag** (*Optional* *[* *str* *]*) â Tag of the entries linked to a specific
    conversation session. Defaults to instance ULID.
  * **role** (*Optional* *[* *Union* *[* *str* *,* *List* *[* *str* *]* *]* *]*) â Filter messages by role(s).
...
* **Return type:**
  Union[str, List[str]]
* **Raises:**
  **ValueError** â if top_k is not an integer greater than or equal to 0,
...
* **Parameters:**
  * **prompt** (*str*) â The message text to search for in message history
  * **as_text** (*bool*) â Whether to return the prompts and responses as text
  * **JSON.** (*or as*)
  * **top_k** (*int*) â The number of previous messages to return. Default is 5.
  * **session_tag** (*Optional* *[* *str* *]*) â Tag of the entries linked to a specific
    conversation session. Defaults to instance ULID.
  * **distance_threshold** (*Optional* *[* *float* *]*) â The threshold for semantic
    vector distance.
  * **fall_back** (*bool*) â Whether to drop back to recent conversation history
...
* **Parameters:**
  * **prompt** (*str*) â The user prompt to the LLM.
  * **response** (*str*) â The corresponding LLM response.
  * **session_tag** (*Optional* *[* *str* *]*) â Tag to be added to entries to link to a specific
    conversation session. Defaults to instance ULID.
* **Return type:**
  None
...
* **Parameters:**
  ...
  * **session_tag** (*Optional* *[* *str* *]*) â Tag to be added to entries to link to a specific
    conversation session. Defaults to instance ULID.
  * **prefix** (*Optional* *[* *str* *]*) â Prefix for the keys for this conversation data.
    Defaults to None and will be replaced with the index name.
  * **redis_client** (*Optional* *[* *Redis* *]*) â A Redis client instance. Defaults to
    None.
  * **redis_url** (*str* *,* *optional*) â The redis url. Defaults to redis://localhost:6379.
