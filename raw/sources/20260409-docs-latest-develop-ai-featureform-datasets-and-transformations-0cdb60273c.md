...
url: https://redis.io/docs/latest/develop/ai/featureform/datasets-and-transformations/
retrieved_utc: '2026-04-09T20:45:57.109629+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/featureform/datasets-and-transformations/index.html.md
---
...
```json metadata
{
  ...
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"warehouse-tables","title":"Warehouse tables"},{"id":"delta-tables","title":"Delta tables"},{"id":"apache-iceberg-tables","title":"Apache Iceberg tables"},{"id":"file-based-datasets","title":"File-based datasets"}],"id":"register-datasets","title":"Register datasets"},{"id":"sql-transformations","title":"SQL transformations"},{"id":"dataframe-transformations","title":"DataFrame transformations"},{"id":"chaining-transformations","title":"Chaining transformations"},{"id":"accessing-transformation-data","title":"Accessing transformation data"},{"id":"apply-registrations","title":"Apply registrations"},{"id":"best-practices","title":"Best practices"},{"id":"what-to-read-next","title":"What to read next"}]}
