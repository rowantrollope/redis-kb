...
retrieved_utc: '2026-04-09T20:45:58.142139+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/programmability/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"background","title":"Background"},{"id":"running-scripts","title":"Running scripts"},{"id":"read-only-scripts","title":"Read-only scripts"},{"id":"sandboxed-script-context","title":"Sandboxed script context"},{"id":"maximum-execution-time","title":"Maximum execution time"}]}
