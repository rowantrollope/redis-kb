...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-0/
retrieved_utc: '2026-04-09T20:46:01.425583+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-0/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.12.0 (June 2025)",
  "description": "Enhanced CLI command for HA topology information. Automatic DLQ routing for key errors. Enhanced transformation job validation in the PATCH and POST /api/v1/pipelines endpoints. Added `xml_to_dict` transformation function.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"headlines","title":"Headlines"},{"id":"detailed-changes","title":"Detailed changes"},{"id":"limitations","title":"Limitations"}]}
