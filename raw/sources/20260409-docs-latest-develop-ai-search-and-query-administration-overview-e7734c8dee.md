...
url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/overview/
retrieved_utc: '2026-04-09T20:45:51.991224+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/overview/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"abstract","title":"Abstract"},{"id":"main-features","title":"Main features"},{"id":"indexing-documents","title":"Indexing documents"},{"id":"searching","title":"Searching"},{"children":[{"id":"index-and-document-metadata","title":"Index and document metadata"},{"id":"inverted-index","title":"Inverted index"},{"id":"numeric-index","title":"Numeric index"},{"id":"tag-index","title":"Tag index"},{"id":"geo-index","title":"Geo index"},{"id":"autocomplete","title":"Autocomplete"}],"id":"data-structures","title":"Data structures"},{"children":[{"id":"complex-query-examples","title":"Complex query examples"}],"id":"query-language","title":"Query language"},{"id":"scoring-model","title":"Scoring model"},{"id":"sortable-fields","title":"Sortable fields"},{"id":"result-highlighting-and-summarization","title":"Result highlighting and summarization"},{"id":"autocomplete","title":"Autocomplete"},{"children":[{"id":"the-redis-module-api","title":"The Redis module API"},{"id":"query-execution-engine","title":"Query execution engine"},{"id":"concurrent-updates-and-searches","title":"Concurrent updates and searches"},{"id":"index-garbage-collection","title":"Index garbage collection"},{"id":"extension-model","title":"Extension model"}],"id":"search-engine-internals","title":"Search engine internals"},{"id":"scalable-distributed-search","title":"Scalable distributed search"}]}
...
See the [autocomplete page]() for more information and examples.

## Search engine internals

### The Redis module API

Redis Search is implemented using the [Redis module API]() and is loaded into Redis as an extension module at start-up.
...
Traditional clusters map different keys to different shards to achieve this. However, with search indexes this approach is not practical. If each wordâs index was mapped to a different shard, it would be necessary to intersect records from different servers for multi-term queries. 
