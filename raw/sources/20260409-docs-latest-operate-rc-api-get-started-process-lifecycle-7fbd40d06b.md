...
retrieved_utc: '2026-04-09T20:45:58.425340+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/api/get-started/process-lifecycle/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"use-tasks-to-track-requests","title":"Use tasks to track requests"},{"id":"task-process-states","title":"Task process states"}],"id":"task-processing","title":"Task processing"},{"children":[{"id":"provisioning-state-values","title":"Provisioning state values"}],"id":"task-provisioning-phase","title":"Task provisioning phase"},{"id":"process-limitations","title":"Process limitations"}]}
