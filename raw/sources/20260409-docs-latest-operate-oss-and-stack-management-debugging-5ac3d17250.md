---
title: Debugging
url: https://redis.io/docs/latest/operate/oss_and_stack/management/debugging/
retrieved_utc: '2026-04-09T20:45:54.141347+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/debugging/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"what-is-gdb","title":"What is GDB?"},{"id":"compiling-redis-without-optimizations","title":"Compiling Redis without optimizations"},{"id":"attaching-gdb-to-a-running-process","title":"Attaching GDB to a running process"},{"id":"after-the-crash","title":"After the crash"},{"id":"obtaining-the-stack-trace","title":"Obtaining the stack trace"},{"id":"obtaining-the-core-file","title":"Obtaining the core file"},{"id":"what-to-send-to-developers","title":"What to send to developers"},{"id":"thank-you","title":"Thank you"}]}
