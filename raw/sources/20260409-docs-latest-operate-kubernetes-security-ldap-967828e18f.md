...
url: https://redis.io/docs/latest/operate/kubernetes/security/ldap/
retrieved_utc: '2026-04-09T20:46:00.684360+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/ldap/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"ldap-support-for-redis-enterprise-software","title":"LDAP support for Redis Enterprise Software"},{"children":[{"id":"bind-credentials","title":"Bind credentials"},{"id":"ldaps-or-starttls-protocols","title":"LDAPS or STARTTLS protocols"},{"id":"ca-certificate","title":"CA certificate"},{"id":"client-certificates","title":"Client certificates"}],"id":"enable-ldap","title":"Enable LDAP"},{"id":"known-limitations","title":"Known limitations"},{"id":"next-steps","title":"Next steps"}]}
