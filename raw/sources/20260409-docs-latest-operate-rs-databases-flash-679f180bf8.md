...
url: https://redis.io/docs/latest/operate/rs/databases/flash/
retrieved_utc: '2026-04-09T20:45:58.187503+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/flash/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"redis-flex-versus-auto-tiering","title":"Redis Flex versus Auto Tiering"},{"id":"use-cases","title":"Use cases"},{"id":"where-is-my-data","title":"Where is my data?"},{"id":"ram-to-flash-ratio","title":"RAM to Flash ratio"},{"children":[{"id":"cloud-environments","title":"Cloud environments"},{"id":"on-premises-environments","title":"On-premises environments"}],"id":"flash-memory","title":"Flash memory"},{"id":"size-limits-for-keys-and-values","title":"Size limits for keys and values"},{"id":"next-steps","title":"Next steps"}]}
...
Inactive or infrequently accessed data is referred to as "warm data" and stored in flash memory. When more space is needed in RAM, warm keys and values are moved from RAM to flash storage.
 ...
 When using Auto Tiering with Redis Search, indexes are also stored in RAM. Redis Flex does not support Redis Search.
...
|-------------------|--------------|----------------------|
| [Active-Active databases]() | <span title="Not supported">&#x274c;</span> |<span title="Supported">&#x2705;</span> Requires Redis<br />technical team's approval |
| [JSON]() | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
| [Probabilistic data structures]() | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
| [Redis Search]() | <span title="Not supported">&#x274c;</span> | <span title="Supported">&#x2705;</span> |
| Standard [Redis data types]() | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
| [Time series]() | <span title="Not supported">&#x274c;</span> | <span title="Supported">&#x2705;</span> |

 Redis Flex is not supported running on network attached storage (NAS), storage area network (SAN), or with local HDD drives. 
