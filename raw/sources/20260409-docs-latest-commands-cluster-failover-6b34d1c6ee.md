...
retrieved_utc: '2026-04-09T20:46:02.876353+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/cluster-failover/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"arguments":[{"display_text":"force","name":"force","token":"FORCE","type":"pure-token"},{"display_text":"takeover","name":"takeover","token":"TAKEOVER","type":"pure-token"}],"name":"options","optional":true,"type":"oneof"}],
