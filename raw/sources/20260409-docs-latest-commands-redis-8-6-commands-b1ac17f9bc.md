...
url: https://redis.io/docs/latest/commands/redis-8-6-commands/
retrieved_utc: '2026-04-09T20:45:51.294338+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/redis-8-6-commands/index.html.md
---
...
<details>
<summary><strong><a href="/commands/xcfgset/">XCFGSET</a></strong> - Sets the IDMP configuration parameters for a stream. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
**Syntax:** `XTRIM key <MAXLEN | MINID> [= | ~] threshold [LIMITÂ count] [KEEPREF | DELREF | ACKED]`
...
**Syntax:** `FT.CREATE index [ONÂ <HASH | JSON>] [PREFIXÂ count prefix [prefix
  ...
  [SKIPINITIALSCAN] [INDEXALL <ENABLE | DISABLE>] SCHEMA field name [ASÂ alias] <TEXT | TAG |
  NUMERIC | GEO | VECTOR> [WITHSUFFIXTRIE] [INDEXEMPTY]
  [INDEXMISSING] [SORTABLE [UNF]] [NOINDEX] [field name [ASÂ alias]
...
**Syntax:** `TS.ADD key timestamp value [RETENTIONÂ retentionPeriod]
  [ENCODINGÂ <UNCOMPRESSED | COMPRESSED>] [CHUNK SIZEÂ size]
...
**Syntax:** `TS.ALTER key [RETENTIONÂ retentionPeriod] [CHUNK SIZEÂ size]
  [DUPLICATE POLICYÂ <BLOCK | FIRST | LAST | MIN | MAX | SUM>] [LABELSÂ label value
  [label value ...]]`
...
**Syntax:** `TS.CREATE key [RETENTIONÂ retentionPeriod] [ENCODINGÂ <UNCOMPRESSED |
  COMPRESSED>] [CHUNK SIZEÂ size] [DUPLICATE POLICYÂ <BLOCK | FIRST |
  LAST | MIN | MAX | SUM>] [LABELSÂ label value [label value ...]]`
...
**Syntax:** `TS.DECRBY key value [TIMESTAMPÂ timestamp]
  [RETENTIONÂ retentionPeriod] [UNCOMPRESSED] [CHUNK SIZEÂ size]
  [LABELSÂ label value [label value ...]]`
...
<details>
<summary><strong><a href="/commands/hotkeys/">HOTKEYS</a></strong> - A container for hotkeys tracking commands. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-get/">HOTKEYS GET</a></strong> - Returns lists of top K hotkeys depending on metrics chosen in HOTKEYS START command. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-reset/">HOTKEYS RESET</a></strong> - Release the resources used for hotkey tracking. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-start/">HOTKEYS START</a></strong> - Starts hotkeys tracking. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
<details>
<summary><strong><a href="/commands/hotkeys-stop/">HOTKEYS STOP</a></strong> - Stops hotkeys tracking. <span style="color: #e74c3c;">â­ New in 8.6</span></summary>
...
**Syntax:** `CLUSTER MIGRATION <IMPORTÂ start-slot end-slot
  [start-slot end-slot ...] | CANCELÂ <IDÂ task-id | ALL> |
  STATUSÂ <[IDÂ task-id] | [ALL]>>`
