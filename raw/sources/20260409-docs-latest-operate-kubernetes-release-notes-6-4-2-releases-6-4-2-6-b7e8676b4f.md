...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-6/
retrieved_utc: '2026-04-09T20:45:58.345620+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-6/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"openshift-images","title":"OpenShift images"},{"id":"openshift-olm-bundles","title":"OpenShift OLM bundles"}],"id":"images","title":"Images"},{"id":"new-features","title":"New features"},{"id":"feature-improvements","title":"Feature improvements"},{"id":"fixed-bugs","title":"Fixed bugs"},{"id":"api-changes","title":"API changes"},{"children":[{"id":"deprecated-features","title":"Deprecated features"},{"id":"supported-distributions","title":"Supported distributions"}],"id":"compatibility-notes","title":"Compatibility notes"},{"id":"before-upgrading","title":"Before upgrading"},{"children":[{"id":"new-limitations","title":"New limitations"},{"id":"existing-limitations","title":"Existing limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
* The following custom resources definitions were added:
  * [`RedisEnterpriseRemoteCluster` (RERC) API]()
  * [`RedisEnterpriseActiveActiveDatabase` (REAADB) API]()
