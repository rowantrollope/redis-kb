---
title: Install
url: https://redis.io/docs/latest/integrate/redis-mcp/install/
retrieved_utc: '2026-04-09T20:45:54.277921+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-mcp/install/index.html.md
---
...
```json metadata
{
  ...
  "group": "service",
  "tableOfContents": {"sections":[{"id":"quick-start-with-pypi","title":"Quick Start with PyPI"},{"id":"run-from-github","title":"Run from GitHub"},{"id":"install-the-server-from-source","title":"Install the server from source"},{"id":"install-using-docker","title":"Install using Docker"},{"children":[{"id":"environment-variables","title":"Environment variables"},{"id":"command-line-options","title":"Command line options"},{"id":"entraid-authentication","title":"EntraID authentication"}],"id":"configuration","title":"Configuration"},{"id":"redis-cloud-mcp","title":"Redis Cloud MCP"},{"id":"next-steps","title":"Next steps"}]}
...
for Azure Managed Redis, enabling OAuth-based authentication with automatic token management. This uses redis-py's [redis-entra-id]() library to offer:
