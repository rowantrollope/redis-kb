...
url: https://redis.io/docs/latest/operate/rs/databases/import-export/replica-of/create/
retrieved_utc: '2026-04-09T20:45:54.112873+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/import-export/replica-of/create/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"same-redis-software-cluster-same-cluster","title":"Same Redis Software cluster {#same-cluster}"},{"id":"different-redis-software-cluster-different-cluster","title":"Different Redis Software cluster {#different-cluster}"},{"id":"redis-open-source-cluster-source-available-cluster","title":"Redis Open Source cluster {#source-available-cluster}"}],"id":"configure-replica-of","title":"Configure Replica Of"},{"children":[{"id":"encrypt-source-database-traffic","title":"Encrypt source database traffic"},{"id":"encrypt-replica-database-traffic","title":"Encrypt replica database traffic"}],"id":"configure-tls-for-replica-of","title":"Configure TLS for Replica Of"}]}
