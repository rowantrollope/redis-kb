...
retrieved_utc: '2026-04-09T20:45:58.130606+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/lettuce/produsage/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"checklist","title":"Checklist"},{"id":"recommendations","title":"Recommendations"},{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"setting-timeouts","title":"Setting timeouts"},{"id":"setting-timeouts-in-spring-data-redis","title":"Setting timeouts in Spring Data Redis"}],"id":"timeouts","title":"Timeouts"},{"id":"cluster-topology-refresh","title":"Cluster topology refresh"},{"id":"dns-cache-and-redis","title":"DNS cache and Redis"},{"id":"exception-handling","title":"Exception handling"},{"id":"connection-and-execution-reliability","title":"Connection and execution reliability"},{"id":"smart-client-handoffs","title":"Smart client handoffs"}]}
