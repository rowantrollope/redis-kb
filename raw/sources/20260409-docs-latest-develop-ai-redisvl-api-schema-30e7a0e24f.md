---
title: Schema
url: https://redis.io/docs/latest/develop/ai/redisvl/api/schema/
retrieved_utc: '2026-04-09T20:46:07.231447+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/schema/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-indexschema-index-fieldsfactory-version010","title":"class IndexSchema(*, index, fields=\u003cfactory\u003e, version='0.1.0')"}],"id":"indexschema","title":"IndexSchema"},{"id":"index-level-stopwords-configuration","title":"Index-Level Stopwords Configuration"},{"id":"defining-fields","title":"Defining Fields"},{"children":[{"id":"text-fields","title":"Text Fields"},{"id":"class-textfield-name-typefieldtypestext-pathnone-attrsfactory","title":"class TextField(*, name, type=FieldTypes.TEXT, path=None, attrs=\u003cfactory\u003e)"},{"id":"class-textfieldattributes-sortablefalse-indexmissingfalse-noindexfalse-weight1-nostemfalse-withsuffixtriefalse-phoneticmatchernone-indexemptyfalse-unffalse","title":"class TextFieldAttributes(*, sortable=False, indexmissing=False, noindex=False, weight=1, nostem=False, withsuffixtrie=False, phoneticmatcher=None, index_empty=False, unf=False)"},{"id":"tag-fields","title":"Tag Fields"},{"id":"class-tagfield-name-typefieldtypestag-pathnone-attrsfactory","title":"class TagField(*, name, type=FieldTypes.TAG, path=None, attrs=\u003cfactory\u003e)"},{"id":"class-tagfieldattributes-sortablefalse-indexmissingfalse-noindexfalse-separator-casesensitivefalse-withsuffixtriefalse-indexemptyfalse","title":"class TagFieldAttributes(*, sortable=False, indexmissing=False, noindex=False, separator=',', casesensitive=False, withsuffixtrie=False, indexempty=False)"},{"id":"numeric-fields","title":"Numeric Fields"},{"id":"class-numericfield-name-typefieldtypesnumeric-pathnone-attrsfactory","title":"class NumericField(*, name, type=FieldTypes.NUMERIC, path=None, attrs=\u003cfactory\u003e)"},{"id":"class-numericfieldattributes-sortablefalse-indexmissingfalse-noindexfalse-unffalse","title":"class NumericFieldAttributes(*, sortable=False, indexmissing=False, noindex=False, unf=False)"},{"id":"geo-fields","title":"Geo Fields"},{"id":"class-geofield-name-typefieldtypesgeo-pathnone-attrsfactory","title":"class GeoField(*, name, type=FieldTypes.GEO, path=None, attrs=\u003cfactory\u003e)"},{"id":"class-geofieldattributes-sortablefalse-indexmissingfalse-noindexfalse","title":"class GeoFieldAttributes(*, sortable=False, indexmissing=False, noindex=False)"}],"id":"basic-field-types","title":"Basic Field Types"},{"children":[{"id":"common-vector-attributes","title":"Common Vector Attributes"},{"id":"class-basevectorfieldattributes-dims-algorithm-datatypevectordatatypefloat32-distancemetricvectordistancemetriccosine-initialcapnone-indexmissingfalse","title":"class BaseVectorFieldAttributes(*, dims, algorithm, datatype=VectorDataType.FLOAT32, distancemetric=VectorDistanceMetric.COSINE, initialcap=None, index_missing=False)"},{"id":"hnsw-vector-fields","title":"HNSW Vector Fields"},{"id":"when-to-use-hnsw-performance-details","title":"When to use HNSW \u0026 Performance Details"},{"id":"class-hnswvectorfield-name-typevector-pathnone-attrs","title":"class HNSWVectorField(*, name, type='vector', path=None, attrs)"},{"id":"class-hnswvectorfieldattributes-dims-algorithmvectorindexalgorithmhnsw-datatypevectordatatypefloat32-distancemetricvectordistancemetriccosine-initialcapnone-indexmissingfalse-m16-efconstruction200-efruntime10-epsilon001","title":"class HNSWVectorFieldAttributes(*, dims, algorithm=VectorIndexAlgorithm.HNSW, datatype=VectorDataType.FLOAT32, distancemetric=VectorDistanceMetric.COSINE, initialcap=None, indexmissing=False, m=16, efconstruction=200, ef_runtime=10, epsilon=0.01)"},{"id":"svs-vamana-vector-fields","title":"SVS-VAMANA Vector Fields"},{"id":"when-to-use-svs-vamana-detailed-guide","title":"When to use SVS-VAMANA \u0026 Detailed Guide"},{"id":"class-svsvectorfield-name-typefieldtypesvector-pathnone-attrs","title":"class SVSVectorField(*, name, type=FieldTypes.VECTOR, path=None, attrs)"},{"id":"class-svsvectorfieldattributes-dims-algorithmvectorindexalgorithmsvsvamana-datatypevectordatatypefloat32-distancemetricvectordistancemetriccosine-initialcapnone-indexmissingfalse-graphmaxdegree40-constructionwindowsize250-searchwindowsize20-epsilon001-compressionnone-reducenone-trainingthresholdnone","title":"class SVSVectorFieldAttributes(*, dims, algorithm=VectorIndexAlgorithm.SVSVAMANA, datatype=VectorDataType.FLOAT32, distancemetric=VectorDistanceMetric.COSINE, initialcap=None, indexmissing=False, graphmaxdegree=40, constructionwindowsize=250, searchwindowsize=20, epsilon=0.01, compression=None, reduce=None, training_threshold=None)"},{"id":"flat-vector-fields","title":"FLAT Vector Fields"},{"id":"when-to-use-flat-performance-details","title":"When to use FLAT \u0026 Performance Details"},{"id":"class-flatvectorfield-name-typefieldtypesvector-pathnone-attrs","title":"class FlatVectorField(*, name, type=FieldTypes.VECTOR, path=None, attrs)"},{"id":"class-flatvectorfieldattributes-dims-algorithmvectorindexalgorithmflat-datatypevectordatatypefloat32-distancemetricvectordistancemetriccosine-initialcapnone-indexmissingfalse-blocksizenone","title":"class FlatVectorFieldAttributes(*, dims, algorithm=VectorIndexAlgorithm.FLAT, datatype=VectorDataType.FLOAT32, distancemetric=VectorDistanceMetric.COSINE, initialcap=None, indexmissing=False, blocksize=None)"}],"id":"vector-field-types","title":"Vector Field Types"},{"children":[{"id":"compressionadvisor","title":"CompressionAdvisor"},{"id":"class-compressionadvisor","title":"class CompressionAdvisor"},{"id":"examples","title":"Examples"},{"id":"examples","title":"Examples"},{"id":"examples","title":"Examples"},{"id":"svsconfig","title":"SVSConfig"},{"id":"class-svsconfig-algorithmsvs-vamana-datatypenone-compressionnone-reducenone-graphmaxdegreenone-constructionwindowsizenone-searchwindowsizenone","title":"class SVSConfig(*, algorithm='svs-vamana', datatype=None, compression=None, reduce=None, graphmaxdegree=None, constructionwindowsize=None, searchwindowsize=None)"}],"id":"svs-vamana-configuration-utilities","title":"SVS-VAMANA Configuration Utilities"},{"children":[{"id":"algorithm-selection-guide","title":"Algorithm Selection Guide"},{"id":"when-to-use-each-algorithm","title":"When to Use Each Algorithm"},{"id":"performance-characteristics","title":"Performance Characteristics"},{"id":"migration-considerations","title":"Migration Considerations"}],"id":"vector-algorithm-comparison","title":"Vector Algorithm Comparison"}]}

,
  "codeExamples": [{"id":"indexschema-api"},{"id":"vector-algorithm-comparison"}]
}
```
...
* **Parameters:**
  **field_inputs** (*Dict* *[* *str* *,* *Any* *]*) â A field to add.
* **Raises:**
  **ValueError** â If the field name or type are not provided or if the name
...
* **Parameters:**
  **fields** (*List* *[* *Dict* *[* *str* *,* *Any* *]* *]*) â A list of fields to add.
* **Raises:**
  **ValueError** â If a field with the same name already exists in the
      schema.
...
* **Parameters:**
  **data** (*Dict* *[* *str* *,* *Any* *]*) â The index schema data.
* **Returns:**
  The index schema.
* **Return type:**
...
* **Parameters:**
  **file_path** (*str*) â The path to the YAML file.
* **Returns:**
  The index schema.
* **Return type:**
  [IndexSchema](#indexschema)
...
* **Parameters:**
  **field_name** (*str*) â The name of the field to be removed.
...
* **Parameters:**
  * **file_path** (*str*) â The path to the YAML file.
  * **overwrite** (*bool*) â Whether to overwrite the file if it already exists.
* **Raises:**
  **FileExistsError** â If the file already exists and overwrite is False.
* **Return type:**
  None
...
- Cross-platform deployments where hardware-specific optimizations arenât available
...
The indexing algorithm (fixed as âhnswâ)
...
: - Redis >= 8.2.0 with RediSearch >= 2.8.10
  - datatype must be âfloat16â or âfloat32â (float64/bfloat16 not supported)
...
- **Platform considerations**: Intelâs proprietary LVQ and LeanVec optimizations are not available in Redis Open Source. On non-Intel platforms and Redis Open Source, SVS-VAMANA with compression falls back to basic 8-bit scalar quantization.
...
The indexing algorithm (fixed as âflatâ)
...
* **Parameters:**
  * **compression** (*str*) â Compression type (e.g., "LVQ4", "LeanVec4x8")
  * **dims** (*int*) â Original vector dimensionality
  * **reduce** (*int* *|* *None*) â Reduced dimensionality (for LeanVec compression)
* **Returns:**
...
* **Parameters:**
  * **dims** (*int*) â Vector dimensionality (must be > 0)
  * **priority** (*Literal* *[* *'speed'* *,*  *'memory'* *,*  *'balanced'* *]*) â Optimization priority:
    - "memory": Maximize memory savings
    - "speed": Optimize for query speed
    - "balanced": Balance between memory and speed
  * **datatype** (*str* *|* *None*) â Override datatype (default: float16 for high-dim, float32 for low-dim)
* **Returns:**
