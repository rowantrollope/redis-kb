...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/8-0-2-2-october2025/
retrieved_utc: '2026-04-09T20:45:51.493292+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/8-0-2-2-october2025/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"resolved-issues","title":"Resolved issues"},{"id":"api-changes","title":"API changes"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"modules-in-redis-8","title":"Modules in Redis 8"},{"id":"breaking-changes","title":"Breaking changes"},{"id":"deprecations","title":"Deprecations"}],"id":"version-changes","title":"Version changes"},{"id":"supported-distributions","title":"Supported distributions"},{"children":[{"id":"openshift-downloads","title":"Openshift downloads"}],"id":"downloads","title":"Downloads"},{"id":"known-limitations","title":"Known limitations"}]}
...
| [Active-Active]() | [Search and query]()<br />[JSON]() |
