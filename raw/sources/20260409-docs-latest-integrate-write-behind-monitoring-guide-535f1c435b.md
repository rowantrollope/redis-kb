...
retrieved_utc: '2026-04-09T20:45:59.157367+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/write-behind/monitoring-guide/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"console-metrics","title":"Console metrics"},{"children":[{"id":"test-write-behind-metrics-exporter","title":"Test Write-behind metrics exporter"}],"id":"prometheus-integration","title":"Prometheus integration"},{"id":"configure-prometheus","title":"Configure Prometheus"},{"id":"test-the-prometheus-scraper","title":"Test the Prometheus scraper"},{"id":"use-grafana-to-analyze-metrics","title":"Use Grafana to analyze metrics"},{"id":"write-behind-metrics","title":"Write-behind metrics"}]}
