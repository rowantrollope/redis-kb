...
url: https://redis.io/docs/latest/develop/ai/search-and-query/vectors/svs-compression/
retrieved_utc: '2026-04-09T20:45:52.441288+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/vectors/svs-compression/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"lvq-locally-adaptive-vector-quantization","title":"LVQ (Locally-adaptive Vector Quantization)"},{"id":"leanvec-lvq-with-dimensionality-reduction","title":"LeanVec (LVQ with dimensionality reduction)"}],"id":"quantization-and-compression-techniques","title":"Quantization and compression techniques"},{"id":"choosing-a-compression-type","title":"Choosing a compression type"},{"children":[{"id":"naming-convention-lvqbxb","title":"Naming convention: LVQ\u003cBâ\u003ex\u003cBâ\u003e"}],"id":"two-level-compression","title":"Two-level compression"},{"children":[{"id":"what-does-this-mean-in-practice","title":"What does this mean in practice?"}],"id":"learning-compression-parameters-from-vector-data","title":"Learning compression parameters from vector data"},{"children":[{"id":"build-redis-open-source","title":"Build Redis Open Source"}],"id":"build-redis-open-source-with-intel-svs-support","title":"Build Redis Open Source with Intel SVS support"}]}
...
### Naming convention: LVQ<Bâ>x<Bâ>

* **Bâ:** Number of bits per dimension used in the first-level quantization.
* **Bâ:** Number of bits per dimension used in the second-level quantization (residual encoding).
