...
url: https://redis.io/docs/latest/integrate/redisom-for-net/
retrieved_utc: '2026-04-09T20:45:53.851572+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redisom-for-net/index.html.md
---
...
```json metadata
{
  ...
  "group": "library",
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"skip-to-the-code","title":"Skip to the code"},{"id":"run-redis-stack","title":"Run Redis Stack"},{"id":"create-the-project","title":"Create the project"},{"children":[{"id":"connection-string-specification","title":"Connection string specification"}],"id":"configure-the-app","title":"Configure the app"},{"id":"create-the-model","title":"Create the model"},{"id":"create-the-index","title":"Create the Index"},{"id":"inject-the-redisconnectionprovider","title":"Inject the RedisConnectionProvider"},{"children":[{"id":"inject-the-redisconnectionprovider","title":"Inject the RedisConnectionProvider"},{"id":"add-route-for-creating-a-person","title":"Add route for creating a Person"},{"id":"add-route-to-filter-by-age","title":"Add route to filter by age"},{"id":"filter-by-geolocation","title":"Filter by GeoLocation"},{"id":"filter-by-exact-string","title":"Filter by exact string"},{"id":"filter-with-a-full-text-search","title":"Filter with a full-text search"},{"id":"filter-by-array-membership","title":"Filter by array membership"},{"id":"updating-a-person","title":"Updating a person"},{"id":"delete-a-person","title":"Delete a person"}],"id":"create-the-peoplecontroller","title":"Create the PeopleController"},{"id":"run-the-app","title":"Run the app"},{"id":"viewing-data-in-with-redis-insight","title":"Viewing data in with Redis Insight"},{"id":"resources","title":"Resources"}]}
