...
url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/migrate/
retrieved_utc: '2026-04-09T20:46:05.688411+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/migrate/index.html.md
---
...
{
  "title": "rladmin migrate",
  "description": "Moves Redis Software shards or endpoints to a new node in the same cluster.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"migrate-allmastershards","title":"migrate allmastershards"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"migrate-allshards","title":"migrate all_shards"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"migrate-allslaveshards","title":"migrate allslaveshards"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"migrate-endpointtoshards","title":"migrate endpointtoshards"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"migrate-shard","title":"migrate shard"}]}
