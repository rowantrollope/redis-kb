...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redistimeseries/redistimeseries-1.12-release-notes/
retrieved_utc: '2026-04-09T20:46:00.585743+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redistimeseries/redistimeseries-1.12-release-notes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"requirements","title":"Requirements"},{"id":"v1129-october-2025","title":"v1.12.9 (October 2025)"},{"id":"v1126-april-2025","title":"v1.12.6 (April 2025)"},{"id":"v1125-january-2025","title":"v1.12.5 (January 2025)"},{"children":[{"id":"headlines","title":"Headlines"},{"id":"whats-new-in-112","title":"What's new in 1.12"},{"id":"details","title":"Details"}],"id":"v112-ga-v1122-july-2024","title":"v1.12 GA (v1.12.2) (July 2024)"}]}
...
- [#1543](https://github.com/RedisTimeSeries/RedisTimeSeries/pull/1543) insertion-filter for close samples:
  ...
  - For each call to `TS.ADD`, if the following conditions are met:
      ...
      - `timestamp` â¥ `max_timestamp`
      - `timestamp` - `max_timestamp` â¤ `ignoreMaxTimeDiff`
      - abs(`value` - `value_at_max_timestamp`) â¤ `ignoreMaxValDiff`))
