...
retrieved_utc: '2026-04-09T20:45:36.015222+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/ts.mrange/index.html.md
---
...
- [Array reply](): timestamp-value pairs ([Integer reply](), [Simple string reply]()) representing all samples/aggregations matching the range
...
- [Array reply](): either a single pair ([Bulk string reply](), [Bulk string reply]()): the `GROUPBY` label argument and value, or empty array
...
- [Array reply](): timestamp-value pairs ([Integer reply](), [Double reply]()) representing all samples/aggregations matching the range
