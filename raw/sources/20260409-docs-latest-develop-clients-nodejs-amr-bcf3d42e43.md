...
url: https://redis.io/docs/latest/develop/clients/nodejs/amr/
retrieved_utc: '2026-04-09T20:45:52.110596+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/nodejs/amr/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install","title":"Install"},{"children":[{"id":"provider-parameters","title":"Provider parameters"},{"id":"authenticate-with-a-service-principal","title":"Authenticate with a service principal"},{"id":"authenticate-with-a-managed-identity","title":"Authenticate with a managed identity"},{"id":"auth-code-flow-with-pkce","title":"Auth code flow with PKCE"},{"id":"authenticate-with-defaultazurecredential-def-az-cred","title":"Authenticate with DefaultAzureCredential {#def-az-cred}"}],"id":"create-a-credentials-provider-instance","title":"Create a credentials provider instance"},{"id":"connect","title":"Connect"},{"id":"resp2-pubsub-limitations","title":"RESP2 PUB/SUB limitations"},{"id":"note-about-transactions","title":"Note about transactions"}]}
