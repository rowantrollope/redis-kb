...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/disaster-recovery/network-based/
retrieved_utc: '2026-04-09T20:45:54.408939+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/disaster-recovery/network-based/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"global-traffic-manager","title":"Global traffic manager"},{"id":"global-load-balancer","title":"Global load balancer"}],"id":"cross-region-availability","title":"Cross-region availability"},{"id":"cross-zone-availability","title":"Cross-zone availability"},{"id":"advantages","title":"Advantages"},{"id":"considerations","title":"Considerations"}]}
