...
retrieved_utc: '2026-04-09T20:46:03.099997+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/cluster-setslot/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"slot","name":"slot","type":"integer"},{"arguments":[{"display_text":"node-id","name":"importing","token":"IMPORTING","type":"string"},{"display_text":"node-id","name":"migrating","token":"MIGRATING","type":"string"},{"display_text":"node-id","name":"node","token":"NODE","type":"string"},{"display_text":"stable","name":"stable","token":"STABLE","type":"pure-token"}],"name":"subcommand","type":"oneof"}],
  "syntax_fmt": "CLUSTER SETSLOT slot \u003cIMPORTINGÂ node-id | MIGRATINGÂ node-id |\n  NODEÂ node-id | STABLE\u003e",
  "complexity": "O(1)",
  "group": "cluster",
  ...
  "since": "3.0.0",
  "arity": -4,
  "tableOfContents": {"sections":[{"id":"cluster-setslot-slot-migrating-destination-node-id","title":"CLUSTER SETSLOT \u003cslot\u003e MIGRATING \u003cdestination-node-id\u003e"},{"id":"cluster-setslot-slot-importing-source-node-id","title":"CLUSTER SETSLOT \u003cslot\u003e IMPORTING \u003csource-node-id\u003e"},{"id":"cluster-setslot-slot-stable","title":"CLUSTER SETSLOT \u003cslot\u003e STABLE"},{"id":"cluster-setslot-slot-node-node-id","title":"CLUSTER SETSLOT \u003cslot\u003e NODE \u003cnode-id\u003e"},{"id":"redis-cluster-live-resharding-explained","title":"Redis Cluster live resharding explained"},{"id":"redis-software-and-redis-cloud-compatibility","title":"Redis Software and Redis Cloud compatibility"},{"id":"return-information","title":"Return information"}]}
