...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-4-2-releases/
retrieved_utc: '2026-04-09T20:45:59.320475+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-4-2-releases/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"detailed-release-notes","title":"Detailed release notes"},{"children":[{"id":"ubuntu-1604","title":"Ubuntu 16.04"},{"id":"active-active-database-persistence","title":"Active-Active database persistence"},{"id":"tls-10-and-tls-11","title":"TLS 1.0 and TLS 1.1"},{"id":"3des-encryption-cipher","title":"3DES encryption cipher"}],"id":"deprecations","title":"Deprecations"},{"children":[{"id":"feature-limitations","title":"Feature limitations"},{"id":"installation-limitations","title":"Installation limitations"},{"id":"upgrade-limitations","title":"Upgrade limitations"},{"id":"operating-system-limitations","title":"Operating system limitations"}],"id":"known-limitations","title":"Known limitations"}]}
...
- RS97971 - [Resharding fails for rack-aware databases with no replication](#resharding-fails-for-rack-aware-databases-with-no-replication) (fixed and resolved as part of [v6.4.2-61]()).
