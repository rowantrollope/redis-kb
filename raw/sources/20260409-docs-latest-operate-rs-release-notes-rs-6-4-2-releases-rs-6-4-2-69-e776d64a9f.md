...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-4-2-releases/rs-6-4-2-69/
retrieved_utc: '2026-04-09T20:45:59.032071+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-4-2-releases/rs-6-4-2-69/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"new-features-and-enhancements","title":"New features and enhancements"},{"children":[{"id":"deprecations","title":"Deprecations"}],"id":"version-changes","title":"Version changes"},{"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"feature-limitations","title":"Feature limitations"},{"id":"operating-system-limitations","title":"Operating system limitations"}],"id":"known-limitations","title":"Known limitations"}]}
...
- Added `failure_detection_sensitivity` policy to [cluster policy REST API requests](). See the [`watchdog_profile` deprecation notice](#watchdog_profile) for more details.
