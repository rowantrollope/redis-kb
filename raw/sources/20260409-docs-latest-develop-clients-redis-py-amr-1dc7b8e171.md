...
url: https://redis.io/docs/latest/develop/clients/redis-py/amr/
retrieved_utc: '2026-04-09T20:45:55.965499+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/redis-py/amr/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install","title":"Install"},{"children":[{"id":"credentialprovider-for-a-service-principal","title":"CredentialProvider for a service principal"},{"id":"credentialprovider-for-a-managed-identity","title":"CredentialProvider for a managed identity"}],"id":"create-a-credentialprovider-instance","title":"Create a CredentialProvider instance"},{"id":"connect","title":"Connect"}]}
...
[Connect with TLS]() for more information).
