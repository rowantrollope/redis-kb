...
retrieved_utc: '2026-04-09T20:45:56.814481+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/expiration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"expiration-times","title":"Expiration times"},{"id":"active-expiration","title":"Active expiration"},{"id":"passive-expiration","title":"Passive expiration"}],"id":"key-expiration","title":"Key expiration"},{"children":[{"id":"expiration-times","title":"Expiration times"},{"id":"active-expiration","title":"Active expiration"},{"id":"passive-expiration","title":"Passive expiration"}],"id":"field-expiration","title":"Field expiration"},{"id":"best-practices","title":"Best practices"},{"id":"related-commands","title":"Related commands"}]}
...
- [`HEXPIRE`]() - Set expiration time for hash fields
- [`FT.SEARCH`]() - Search queries affected by expiration behavior
- [`FT.AGGREGATE`]() - Aggregation queries affected by expiration behavior
