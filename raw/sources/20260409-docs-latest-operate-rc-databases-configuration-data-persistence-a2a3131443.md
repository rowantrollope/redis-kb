...
retrieved_utc: '2026-04-09T20:46:03.566740+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/configuration/data-persistence/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"persistence-options","title":"Persistence options"},{"id":"configure-data-persistence","title":"Configure data persistence"}]}
