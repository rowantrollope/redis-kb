...
retrieved_utc: '2026-04-09T20:45:37.464786+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/waitaof/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"numlocal","name":"numlocal","type":"integer"},{"display_text":"numreplicas","name":"numreplicas","type":"integer"},{"display_text":"timeout","name":"timeout","type":"integer"}],
  "syntax_fmt": "WAITAOF numlocal numreplicas timeout",
  "complexity": "O(1)",
  "group": "generic",
  "command_flags": ["blocking"],
  "acl_categories": ["@slow","@blocking","@connection"],
  "since": "7.2.0",
  "arity": 4,
