...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-6-272/
retrieved_utc: '2026-04-09T20:45:58.442796+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-6-272/index.html.md
---
...
- [RedisGraph v2.10](): RedisGraph end-of-life has been announced and will be removed in a future release. See the [RedisGraph end-of-life announcement](https://redis.io/blog/redisgraph-eol/) for more details.
...
4. <a name="table-note-4"></a>[Docker images]() of Redis Enterprise Software are certified for development and testing only.
