...
retrieved_utc: '2026-04-09T20:45:55.661432+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/hiredis/transpipe/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"execute-a-pipeline","title":"Execute a pipeline"},{"id":"transactions","title":"Transactions"}]}
...
you can implement them yourself using the [`MULTI`](),
[`EXEC`](), and [`WATCH`]()
commands as you would from [`redis-cli`]().
See [Transactions]()
for more information.
