...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-18-releases/rs-6-2-18-43/
retrieved_utc: '2026-04-09T20:45:59.378200+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-18-releases/rs-6-2-18-43/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"new-features-and-enhancements","title":"New features and enhancements"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"prerequisites-and-notes","title":"Prerequisites and notes"},{"id":"deprecations","title":"Deprecations"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"}],"id":"version-changes","title":"Version changes"},{"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"feature-limitations","title":"Feature limitations"},{"id":"upgrade-limitations","title":"Upgrade limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
The snapshot option for [data persistence on Active-Active databases](manage/#data-persistence) will be deprecated in a future version of Redis Enterprise Software.  If you have an Active-Active database using snapshot persistence, we strongly encourage you to switch to AOF persistence.  Use `crdb-cli` to do so:
```text
