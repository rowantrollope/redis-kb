---
title: Connect
url: https://redis.io/docs/latest/develop/clients/hiredis/connect/
retrieved_utc: '2026-04-09T20:45:51.606764+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/hiredis/connect/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"basic-synchronous-connection","title":"Basic synchronous connection"},{"id":"asynchronous-connection","title":"Asynchronous connection"}]}
...
[Construct asynchronous commands]() for more
information.
