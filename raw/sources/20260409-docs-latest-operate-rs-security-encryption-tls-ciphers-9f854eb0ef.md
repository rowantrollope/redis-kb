...
url: https://redis.io/docs/latest/operate/rs/security/encryption/tls/ciphers/
retrieved_utc: '2026-04-09T20:45:58.484888+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/encryption/tls/ciphers/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"tls-12-cipher-suites","title":"TLS 1.2 cipher suites"},{"id":"tls-13-cipher-suites","title":"TLS 1.3 cipher suites"},{"children":[{"id":"edit-cipher-suites-in-the-ui-edit-ciphers-ui","title":"Edit cipher suites in the UI {#edit-ciphers-ui}"},{"id":"control-plane-cipher-suites-control-plane-ciphers-tls-1-2","title":"Control plane cipher suites {#control-plane-ciphers-tls-1-2}"},{"id":"data-plane-cipher-suites-data-plane-ciphers-tls-1-2","title":"Data plane cipher suites {#data-plane-ciphers-tls-1-2}"},{"id":"discovery-service-cipher-suites-discovery-service-ciphers-tls-1-2","title":"Discovery service cipher suites {#discovery-service-ciphers-tls-1-2}"}],"id":"configure-cipher-suites","title":"Configure cipher suites"}]}
...
| sentinel_cipher_suites_tls_1_3 | <span title="No">&#x274c; No</span> | Cipher list for [discovery service]() (Sentinel) TLS 1.3 communications |

## Configure cipher suites

You can configure ciphers with the [Cluster Manager UI](#edit-ciphers-ui), [`rladmin`](), or the [REST API]().
...
- Redis Software doesn't support static [DiffieâHellman (`DH`) key exchange](https://en.wikipedia.org/wiki/Diffie%E2%80%93Hellman_key_exchange) ciphers.

- Support for Ephemeral DiffieâHellman (ECDHE) key exchange ciphers depends on the operating system version and security policy.
...
Sentinel service cipher suites use the golang.org OpenSSL format for [discovery service]() TLS connections in Redis Software version 6.0.20 or later. See their documentation for a list of [available configurations](https://golang.org/src/crypto/tls/cipher_suites.go).
