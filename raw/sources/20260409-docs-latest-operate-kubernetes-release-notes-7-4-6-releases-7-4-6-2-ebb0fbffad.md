...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-6-releases/7-4-6-2/
retrieved_utc: '2026-04-09T20:45:56.159886+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-6-releases/7-4-6-2/index.html.md
---
...
{
  "title": "Redis Enterprise for Kubernetes 7.4.6-2 (July 2024) release notes",
  "description": "This is a feature release with a new version of Redis Enterprise Software 7.4.6.",
  "categories": ["docs","operate","kubernetes"],
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"enhancements","title":"Enhancements"},{"id":"api-changes","title":"API changes"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"supported-distributions","title":"Supported distributions"}],"id":"version-changes","title":"Version changes"},{"children":[{"id":"openshift-images","title":"OpenShift images"},{"id":"olm-bundle","title":"OLM bundle"}],"id":"downloads","title":"Downloads"},{"id":"known-limitations","title":"Known limitations"}]}
