...
url: https://redis.io/docs/latest/develop/ai/search-and-query/indexing/field-and-type-options/
retrieved_utc: '2026-04-09T20:45:52.235089+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/indexing/field-and-type-options/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"numeric-fields","title":"Numeric fields"},{"id":"geo-fields","title":"Geo fields"},{"id":"geoshape-fields","title":"Geoshape fields"},{"id":"vector-fields","title":"Vector fields"},{"id":"tag-fields","title":"Tag fields"},{"id":"text-fields","title":"Text fields"},{"id":"unicode-considerations","title":"Unicode considerations"}]}
...
\* New syntax as of RediSearch v2.10. Requires [`DIALECT 2`](#dialect-2). 
...
[`FT.CREATE`]() using the following syntax:
