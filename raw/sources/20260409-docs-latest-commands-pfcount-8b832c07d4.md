...
retrieved_utc: '2026-04-09T20:46:06.197247+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/pfcount/index.html.md
---
...
```json metadata
{
  ...
  "since": "2.8.9",
  "arity": -2,
  "key_specs": [{"RW":true,"access":true,"begin_search":{"spec":{"index":1},"type":"index"},"find_keys":{"spec":{"keystep":1,"lastkey":-1,"limit":0},"type":"range"},"notes":"RW because it may change the internal representation of the key, and propagate to replicas"}],
