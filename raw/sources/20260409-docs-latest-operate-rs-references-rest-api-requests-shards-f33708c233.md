...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/
retrieved_utc: '2026-04-09T20:46:07.450509+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/shards/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"},{"id":"status-codes-get-all-status-codes","title":"Status codes {#get-all-status-codes}"}],"id":"get-all-shards-get-all-shards","title":"Get all shards {#get-all-shards}"},{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-shard-get-shard","title":"Get shard {#get-shard}"},{"children":[{"id":"client-keys","title":"Client keys"},{"id":"memory-keys","title":"Memory keys"},{"id":"persistence-keys","title":"Persistence keys"},{"id":"replication-keys","title":"Replication keys"},{"id":"server-keys","title":"Server keys"},{"id":"statistics-keys","title":"Statistics keys"}],"id":"extrainfokeys","title":"extrainfokeys"}]}
...
|-------|------|-------------|
| extra_info_keys | list of strings | An optional list of extra keys to be fetched from the Redis [`INFO`]() command. See [extra_info_keys](#extra_info_keys) for common keys to include. |
...
You can include any Redis [`INFO`]() command key for shard requests using the `extra_info_keys` query parameter. The requested keys are returned in the `redis_info` object of the response.
