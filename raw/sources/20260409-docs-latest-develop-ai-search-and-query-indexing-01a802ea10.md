...
retrieved_utc: '2026-04-09T20:45:52.660629+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/indexing/index.html.md
---
...
FT.SEARCH products '@category:{Gaming}'  # â Finds the document
```
...
FT.SEARCH products '@category:{Gaming}'           # â Does NOT find the document
FT.SEARCH products '@category:{Electronics,Gaming,PC}'  # â Finds the document
```
...
# Result: Creates 3 separate tags: "Electronics", "Gaming", "PC"
FT.SEARCH products '@category:{Gaming}'  # â Now finds the document
```
