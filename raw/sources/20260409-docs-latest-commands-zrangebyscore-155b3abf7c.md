...
retrieved_utc: '2026-04-09T20:45:39.112316+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/zrangebyscore/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"key","key_spec_index":0,"name":"key","type":"key"},{"display_text":"min","name":"min","type":"double"},{"display_text":"max","name":"max","type":"double"},{"display_text":"withscores","name":"withscores","optional":true,"since":"2.0.0","token":"WITHSCORES","type":"pure-token"},{"arguments":[{"display_text":"offset","name":"offset","type":"integer"},{"display_text":"count","name":"count","type":"integer"}],"name":"limit","optional":true,"token":"LIMIT","type":"block"}],
  "syntax_fmt": "ZRANGEBYSCORE key min max [WITHSCORES] [LIMITÂ offset count]",
  ...
  "tableOfContents": {"sections":[{"id":"exclusive-intervals-and-infinity","title":"Exclusive intervals and infinity"},{"id":"examples","title":"Examples"},{"id":"pattern-weighted-random-selection-of-an-element","title":"Pattern: weighted random selection of an element"},{"id":"redis-software-and-redis-cloud-compatibility","title":"Redis Software and Redis Cloud compatibility"},{"id":"return-information","title":"Return information"}]}
