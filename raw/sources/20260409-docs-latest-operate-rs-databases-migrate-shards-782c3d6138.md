...
url: https://redis.io/docs/latest/operate/rs/databases/migrate-shards/
retrieved_utc: '2026-04-09T20:45:56.814257+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/migrate-shards/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"use-cases-for-shard-migration","title":"Use cases for shard migration"},{"id":"considerations-for-shard-migration","title":"Considerations for shard migration"},{"id":"migrate-specific-shard","title":"Migrate specific shard"},{"id":"migrate-multiple-shards","title":"Migrate multiple shards"},{"id":"migrate-all-shards-from-a-node","title":"Migrate all shards from a node"},{"id":"migrate-primary-shards","title":"Migrate primary shards"},{"id":"migrate-replica-shards","title":"Migrate replica shards"}]}
