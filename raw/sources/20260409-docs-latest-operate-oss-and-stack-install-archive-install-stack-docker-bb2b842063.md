...
retrieved_utc: '2026-04-09T20:45:52.840226+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/install/archive/install-stack/docker/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"redisredis-stack-server","title":"redis/redis-stack-server"},{"id":"redisredis-stack","title":"redis/redis-stack"}],"id":"getting-started","title":"Getting started"},{"id":"connect-with-redis-cli","title":"Connect with redis-cli"},{"children":[{"id":"persistence-in-docker","title":"Persistence in Docker"},{"id":"ports","title":"Ports"},{"id":"config-files","title":"Config files"},{"id":"environment-variables","title":"Environment variables"}],"id":"configuration","title":"Configuration"}]}
