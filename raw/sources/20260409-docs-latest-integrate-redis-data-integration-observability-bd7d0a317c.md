---
title: Observability
url: https://redis.io/docs/latest/integrate/redis-data-integration/observability/
retrieved_utc: '2026-04-09T20:45:57.261286+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/observability/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"children":[{"id":"vm-installation","title":"VM Installation"},{"id":"helm-installation","title":"Helm installation"}],"id":"accessing-the-metrics","title":"Accessing the metrics"},{"id":"collector-metrics","title":"Collector metrics"},{"id":"stream-processor-metrics","title":"Stream processor metrics"},{"children":[{"id":"operator-metric-types","title":"Operator metric types"},{"id":"understanding-operator-metrics","title":"Understanding operator metrics"},{"id":"accessing-operator-metrics","title":"Accessing operator metrics"}],"id":"operator-metrics","title":"Operator metrics"},{"children":[{"id":"critical-alerts-immediate-response-required","title":"Critical alerts (immediate response required)"},{"id":"important-monitoring-but-not-alerts","title":"Important monitoring (but not alerts)"},{"id":"key-principles-for-rdi-alerting","title":"Key principles for RDI alerting"},{"id":"monitoring-best-practices","title":"Monitoring best practices"}],"id":"recommended-alerting-strategy","title":"Recommended alerting strategy"},{"id":"rdi-logs","title":"RDI logs"},{"id":"dump-support-package","title":"Dump support package"}]}
