---
title: Bulk loading
url: https://redis.io/docs/latest/develop/clients/patterns/bulk-loading/
retrieved_utc: '2026-04-09T20:45:51.564275+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/patterns/bulk-loading/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"generating-redis-protocol","title":"Generating Redis Protocol"},{"id":"how-the-pipe-mode-works-under-the-hood","title":"How the pipe mode works under the hood"}],"id":"bulk-loading-using-the-redis-protocol","title":"Bulk loading using the Redis protocol"}]}
