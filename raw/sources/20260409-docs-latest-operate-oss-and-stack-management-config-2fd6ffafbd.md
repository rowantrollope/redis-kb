...
retrieved_utc: '2026-04-09T20:45:52.092012+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/config/index.html.md
---
...
The list of configuration directives, along with comments describing their meaning and intended usage, is available in the self-documented sampleÂ files `redis.conf`Â andÂ `redis-full.conf`Â files shipped with the Redis distributions.
