...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-15-1/
retrieved_utc: '2026-04-09T20:46:01.395143+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-15-1/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.15.1 (November 2025)",
  "description": "Fixes support package generation and masking to simplify troubleshooting and log collection. Improves processor throughput during initial sync via parallel processing and new stream tuning parameters. Adds an advanced configuration option to pass custom Java options to the Debezium collector.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"whats-new-in-1151","title":"What's New in 1.15.1"},{"id":"limitations","title":"Limitations"}]}
