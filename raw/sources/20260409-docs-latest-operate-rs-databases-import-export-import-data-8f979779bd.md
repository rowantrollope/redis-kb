...
url: https://redis.io/docs/latest/operate/rs/databases/import-export/import-data/
retrieved_utc: '2026-04-09T20:45:54.260391+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/import-export/import-data/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"cluster-manager-ui-method","title":"Cluster Manager UI method"},{"id":"rest-api-method","title":"REST API method"}],"id":"import-data-into-a-database","title":"Import data into a database"},{"children":[{"id":"ftp-server","title":"FTP server"},{"id":"local-mount-point","title":"Local mount point"},{"id":"sftp-server","title":"SFTP server"},{"id":"aws-simple-storage-service-aws-s3","title":"AWS Simple Storage Service {#aws-s3}"},{"id":"google-cloud-storage","title":"Google Cloud Storage"},{"id":"azure-blob-storage","title":"Azure Blob Storage"}],"id":"supported-storage-locations-supported-storage-services","title":"Supported storage locations {#supported-storage-services}"},{"id":"importing-into-an-active-active-database","title":"Importing into an Active-Active database"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"}]}
...
To import data into a database using the REST API, send an [import database request]():
...
When importing from a local mount point or a cloud provider, import locations need to be available to [the group and user]() running Redis Software, `redislabs:redislabs` by default.  
...
Example [import database REST API request]():
