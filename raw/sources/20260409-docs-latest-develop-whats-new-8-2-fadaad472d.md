---
title: Redis 8.2
url: https://redis.io/docs/latest/develop/whats-new/8-2/
retrieved_utc: '2026-04-09T20:45:53.030487+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/whats-new/8-2/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"security-improvements","title":"Security improvements"},{"children":[{"id":"enhanced-redis-streams","title":"Enhanced Redis Streams"},{"id":"cluster-monitoring-improvements","title":"Cluster monitoring improvements"},{"id":"vector-search-enhancements","title":"Vector search enhancements"},{"id":"enhanced-bitmap-operations","title":"Enhanced bitmap operations"},{"id":"improved-keyspace-notifications","title":"Improved keyspace notifications"}],"id":"new-features","title":"New features"},{"children":[{"id":"performance-optimizations","title":"Performance optimizations"},{"id":"memory-efficiency-improvements","title":"Memory efficiency improvements"},{"id":"vector-search-performance","title":"Vector search performance"},{"id":"enhanced-metrics","title":"Enhanced metrics"}],"id":"improvements","title":"Improvements"},{"id":"component-versions","title":"Component versions"}]}
