...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/diagnostics/
retrieved_utc: '2026-04-09T20:46:03.723600+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/diagnostics/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-diagnostic-logging-service-configuration-get-diagnostics","title":"Get diagnostic logging service configuration {#get-diagnostics}"},{"children":[{"id":"request-put-request","title":"Request {#put-request}"},{"id":"response-put-response","title":"Response {#put-response}"}],"id":"update-diagnostic-logging-service-configuration-put-diagnostics","title":"Update diagnostic logging service configuration {#put-diagnostics}"}]}
