...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-16-0/
retrieved_utc: '2026-04-09T20:46:01.381950+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-16-0/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.16.0 (January 2026)",
  "description": "Enhanced disaster recovery for Cloud Spanner with Redis Active-Active, plus better performance and resilience in the Spanner collector. New RDI API v2 dry-run, info, and metrics endpoints for safer rollouts and improved observability. Improved deployment, installation, and troubleshooting, including disk space preflight checks, and broader stability fixes.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"children":[{"id":"rdi-api-changes","title":"RDI API Changes"},{"id":"spanner-integration-with-flink-collector","title":"Spanner Integration with Flink Collector"},{"id":"bug-fixes-and-stability-improvements","title":"Bug Fixes and Stability Improvements"}],"id":"whats-new-in-1160","title":"What's New in 1.16.0"},{"id":"limitations","title":"Limitations"}]}
