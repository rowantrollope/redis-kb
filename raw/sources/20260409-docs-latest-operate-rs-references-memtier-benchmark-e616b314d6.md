...
retrieved_utc: '2026-04-09T20:46:02.098571+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/memtier-benchmark/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"benchmark-and-performance-test-considerations","title":"Benchmark and performance test considerations"},{"children":[{"id":"creating-a-three-node-cluster-creating-a-threenode-rs-cluster","title":"Creating a three-node cluster {#creating-a-threenode-rs-cluster}"}],"id":"test-environment-and-cluster-setup","title":"Test environment and cluster setup"},{"id":"prepare-the-flash-memory","title":"Prepare the flash memory"},{"id":"set-up-the-load-generation-tool","title":"Set up the load generation tool"},{"children":[{"id":"create-a-auto-tiering-test-database","title":"Create a Auto Tiering test database"}],"id":"database-configuration-parameters","title":"Database configuration parameters"},{"children":[{"id":"populate-the-benchmark-dataset","title":"Populate the benchmark dataset"}],"id":"data-population","title":"Data population"},{"children":[{"id":"with-replication-centralize-with-repl","title":"With replication {#centralize-with-repl}"},{"id":"without-replication-centralize-wo-repl","title":"Without replication {#centralize-wo-repl}"}],"id":"centralize-the-keyspace","title":"Centralize the keyspace"},{"children":[{"id":"generate-load","title":"Generate load"}],"id":"test-runs","title":"Test runs"},{"children":[{"id":"monitor-the-test-results","title":"Monitor the test results"},{"id":"expected-results","title":"Expected results"}],"id":"test-results","title":"Test results"}]}
...
- [Redis Software quickstart]() for a test installation
...
To populate the database with N itemsÂ of 500 Bytes each in size, on the load generation instance run:
...
|  Number of items<br/>(âkey-maximum) | With replication: 75 Million<br/>Without replication: 150 Million |
