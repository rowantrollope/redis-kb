...
retrieved_utc: '2026-04-09T20:45:52.391216+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/postgresql/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"amazon-rds-for-postgresql","title":"Amazon RDS for PostgreSQL"},{"children":[{"id":"plug-in-differences","title":"Plug-in differences"}],"id":"install-the-logical-decoding-output-plug-in","title":"Install the logical decoding output plug-in"},{"id":"configure-the-postgresql-server","title":"Configure the PostgreSQL server"},{"id":"set-up-permissions","title":"Set up permissions"},{"id":"set-privileges-for-debezium-to-create-postgresql-publications-with-pgoutput","title":"Set privileges for Debezium to create PostgreSQL publications with pgoutput"},{"id":"configure-postgresql-for-replication-with-the-debezium-connector-host","title":"Configure PostgreSQL for replication with the Debezium connector host"},{"id":"supported-postgresql-topologies","title":"Supported PostgreSQL topologies"}]}

,
  "codeExamples": [{"id":"1-set-the-instance-parameter-rdslogicalreplication-to-1"},{"id":"2-check-that-the-wal_level-parameter-is-set-to-logical"},{"id":"3-set-the-debezium-pluginname-parameter-to-pgoutput"},{"id":"4-initiate-logical-replication-from-an-aws-account-that-has-the-rdsreplication-role"},{"id":"1-create-the-replication-group"},{"id":"2-add-the-original-owner-of-the-table-to-the-group"},{"id":"3-add-the-debezium-replication-user-to-the-group"},{"id":"4-transfer-ownership-of-the-table-to-the-replication-group"}]
}
```
...
The PostgreSQL connector uses one of Debeziumâs supported logical decoding
...
PostgreSQLâs logical decoding uses replication slots. These are guaranteed to retain all the WAL
