...
retrieved_utc: '2026-04-09T20:45:35.903272+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/ts.revrange/index.html.md
---
...
* [Array reply]() of ([Integer reply](), [Simple string reply]()) pairs representing (timestamp, value) in reverse chronological order.
* [Simple error reply]() in these cases: invalid filter value, wrong key type, key does not exist, etc.

**RESP3:**

One of the following:
* [Array reply]() of ([Integer reply](), [Double reply]()) pairs representing (timestamp, value) in reverse chronological order.
* [Simple error reply]() in these cases: invalid filter value, wrong key type, key does not exist, etc.
