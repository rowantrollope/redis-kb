...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/objects/statistics/cluster-metrics/
retrieved_utc: '2026-04-09T20:46:02.980671+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/objects/statistics/cluster-metrics/index.html.md
---
...
{
  "title": "Cluster metrics",
  "description": "Documents the cluster metrics used with Redis Software REST API calls.",
