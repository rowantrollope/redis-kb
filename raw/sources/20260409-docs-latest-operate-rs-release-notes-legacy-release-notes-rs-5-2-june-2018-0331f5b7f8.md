...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-2-june-2018/
retrieved_utc: '2026-04-09T20:46:00.416158+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-2-june-2018/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"active-active-redis-crdb-supports-sorted-sets-and-lists-activeactive-redis-crdb-supports-sorted-sets-and-lists","title":"Active-Active Redis (CRDB) supports sorted sets and lists {#activeactive-redis-crdb-supports-sorted-sets-and-lists}"},{"id":"causal-consistency-in-active-active-redis-crdb-causal-consistency-in-activeactive-redis-crdb","title":"Causal consistency in Active-Active Redis (CRDB) {#causal-consistency-in-activeactive-redis-crdb}"},{"id":"enhanced-security-features","title":"Enhanced security features"}],"id":"new-features","title":"New features"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"information","title":"Information"},{"id":"important-fixes","title":"Important fixes"},{"id":"known-limitations","title":"Known limitations"}]}
...
use cases, with seamless conflict resolution. [Click here](develop/develop-for-aa/)
...
whether Â the action succeeded.
...
With this feature, you can restrict REST API Â access to only those
