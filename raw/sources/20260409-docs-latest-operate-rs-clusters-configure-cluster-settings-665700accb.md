...
url: https://redis.io/docs/latest/operate/rs/clusters/configure/cluster-settings/
retrieved_utc: '2026-04-09T20:45:54.028717+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/configure/cluster-settings/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"upload-cluster-license-key","title":"Upload cluster license key"},{"id":"view-max-number-of-allowed-shards","title":"View max number of allowed shards"},{"id":"view-cluster-name","title":"View cluster name"},{"id":"set-time-zone","title":"Set time zone"}],"id":"general-configuration-tab","title":"General configuration tab"},{"children":[{"id":"configure-email-server-settings","title":"Configure email server settings"}],"id":"alert-settings-tab","title":"Alert settings tab"}]}
