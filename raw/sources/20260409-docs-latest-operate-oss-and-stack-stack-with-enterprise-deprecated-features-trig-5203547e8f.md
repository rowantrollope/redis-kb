...
retrieved_utc: '2026-04-09T20:45:52.503097+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/concepts/triggers/stream_triggers/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"register-a-stream-consumer","title":"Register a stream consumer"},{"id":"enable-trimming-and-set-window","title":"Enable trimming and set window"},{"id":"data-processing-guarantees","title":"Data processing guarantees"},{"id":"upgrades","title":"Upgrades"}]}
