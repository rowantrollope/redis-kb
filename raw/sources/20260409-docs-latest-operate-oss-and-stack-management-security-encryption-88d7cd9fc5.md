...
retrieved_utc: '2026-04-09T20:45:51.997464+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/security/encryption/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"building","title":"Building"},{"id":"tests","title":"Tests"},{"id":"running-manually","title":"Running manually"},{"id":"certificate-configuration","title":"Certificate configuration"},{"id":"tls-listening-port","title":"TLS listening port"},{"id":"client-certificate-authentication","title":"Client certificate authentication"},{"id":"replication","title":"Replication"},{"id":"cluster","title":"Cluster"},{"id":"sentinel","title":"Sentinel"},{"id":"additional-configuration","title":"Additional configuration"},{"id":"performance-considerations","title":"Performance considerations"},{"id":"limitations","title":"Limitations"}],"id":"getting-started","title":"Getting Started"}]}
