...
url: https://redis.io/docs/latest/operate/rs/networking/multi-ip-ipv6/
retrieved_utc: '2026-04-09T20:46:05.577368+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/networking/multi-ip-ipv6/index.html.md
---
...
{
  "title": "Manage IP addresses",
  "description": "Information and requirements for using multiple IP addresses or IPv6 addresses with Redis Software.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"traffic-overview","title":"Traffic overview"},{"id":"multiple-ip-addresses","title":"Multiple IP addresses"},{"id":"enable-ipv6-for-internal-traffic","title":"Enable IPv6 for internal traffic"},{"id":"change-internal-ip-address","title":"Change internal IP address"},{"id":"configure-external-ip-addresses","title":"Configure external IP addresses"},{"id":"known-limitations","title":"Known limitations"}]}

,
  "codeExamples": []
}
```Redis SoftwareÂ supports servers, instances, and VMs with
...
To use IPv6 for internal traffic on a machine with both IPv4 and IPv6 interfaces, set `use_internal_ipv6` to `true` when you create a cluster using the [bootstrap REST API request]():
...
1. From a different cluster node, use [`rladmin node addr set`]() to update the first node's IP address:
