...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-3-beta-july-2018/
retrieved_utc: '2026-04-09T20:46:00.224616+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-3-beta-july-2018/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"new-features","title":"New features"},{"id":"preview-considerations","title":"Preview considerations"},{"id":"known-limitations","title":"Known limitations"}]}
