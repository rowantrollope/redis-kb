...
url: https://redis.io/docs/latest/operate/kubernetes/active-active/global-config/
retrieved_utc: '2026-04-09T20:45:57.973630+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/active-active/global-config/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"edit-global-configurations","title":"Edit global configurations"},{"id":"edit-global-configuration-secrets","title":"Edit global configuration secrets"},{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"add-role-permissions-to-reaadb","title":"Add role permissions to REAADB"},{"id":"troubleshooting-role-permissions","title":"Troubleshooting role permissions"}],"id":"configure-role-permissions","title":"Configure role permissions"}]}
...
You must manually create the specified roles and Redis ACLs on all participating clusters before configuring role permissions. The operator only propagates the role permissions configurationâit does not create the underlying roles and ACLs. If roles or ACLs are missing on any cluster, the operator will log errors and dispatch an Event associated with the REAADB object until they are manually created.
