...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-18/
retrieved_utc: '2026-04-09T20:46:00.079025+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-18/index.html.md
---
...
- Certificate-based authentication for the REST API
    ...
    - To set up certificate-based authentication, use [REST API]() requests to do the following:
