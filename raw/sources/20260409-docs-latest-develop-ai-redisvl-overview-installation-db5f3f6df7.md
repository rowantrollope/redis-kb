...
url: https://redis.io/docs/latest/develop/ai/redisvl/overview/installation/
retrieved_utc: '2026-04-09T20:46:04.904128+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/overview/installation/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"id":"install-redisvl-with-pip","title":"Install RedisVL with Pip"},{"id":"install-redisvl-from-source","title":"Install RedisVL from Source"},{"children":[{"id":"redis-cloud","title":"Redis Cloud"},{"id":"redis-stack-local-development","title":"Redis Stack (local development)"},{"id":"redis-software-self-hosted","title":"Redis Software (self-hosted)"},{"id":"redis-sentinel","title":"Redis Sentinel"}],"id":"installing-redis","title":"Installing Redis"}]}
