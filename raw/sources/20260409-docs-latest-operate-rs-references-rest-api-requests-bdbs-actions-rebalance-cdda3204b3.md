...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/actions/rebalance/
retrieved_utc: '2026-04-09T20:46:06.548492+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/actions/rebalance/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-put-request","title":"Request {#put-request}"},{"id":"response-put-response","title":"Response {#put-response}"}],"id":"rebalance-database-shards-put-bdbs-actions-rebalance","title":"Rebalance database shards {#put-bdbs-actions-rebalance}"}]}
