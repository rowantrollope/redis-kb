...
url: https://redis.io/docs/latest/operate/oss_and_stack/reference/signals/
retrieved_utc: '2026-04-09T20:45:53.778867+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/reference/signals/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"sigterm-and-sigint","title":"SIGTERM and SIGINT"},{"id":"sigsegv-sigbus-sigfpe-and-sigill","title":"SIGSEGV, SIGBUS, SIGFPE and SIGILL"},{"id":"what-happens-when-a-child-process-gets-killed","title":"What happens when a child process gets killed"},{"id":"kill-the-rdb-file-without-errors","title":"Kill the RDB file without errors"}]}
