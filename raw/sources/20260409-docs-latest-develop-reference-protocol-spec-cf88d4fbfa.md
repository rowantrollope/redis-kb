...
retrieved_utc: '2026-04-09T20:45:52.920080+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/protocol-spec/index.html.md
---
...
However, interactive clients, such as command line interfaces (e.g., [`redis-cli`]()), can use this type and know that their output should be presented to the human user as is and without quoting the string.
