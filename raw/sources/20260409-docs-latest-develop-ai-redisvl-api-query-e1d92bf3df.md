---
title: Query
url: https://redis.io/docs/latest/develop/ai/redisvl/api/query/
retrieved_utc: '2026-04-09T20:46:06.471156+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/query/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-vectorqueryvector-vectorfieldname-returnfieldsnone-filterexpressionnone-dtypefloat32-numresults10-returnscoretrue-dialect2-sortbynone-inorderfalse-hybridpolicynone-batchsizenone-efruntimenone-epsilonnone-searchwindowsizenone-usesearchhistorynone-searchbuffercapacitynone-normalizevectordistancefalse","title":"class VectorQuery(vector, vectorfieldname, returnfields=None, filterexpression=None, dtype='float32', numresults=10, returnscore=True, dialect=2, sortby=None, inorder=False, hybridpolicy=None, batchsize=None, efruntime=None, epsilon=None, searchwindowsize=None, usesearchhistory=None, searchbuffercapacity=None, normalizevector_distance=False)"},{"id":"examples","title":"Examples"}],"id":"vectorquery","title":"VectorQuery"},{"children":[{"id":"class-vectorrangequeryvector-vectorfieldname-returnfieldsnone-filterexpressionnone-dtypefloat32-distancethreshold02-epsilonnone-searchwindowsizenone-usesearchhistorynone-searchbuffercapacitynone-numresults10-returnscoretrue-dialect2-sortbynone-inorderfalse-hybridpolicynone-batchsizenone-normalizevectordistancefalse","title":"class VectorRangeQuery(vector, vectorfieldname, returnfields=None, filterexpression=None, dtype='float32', distancethreshold=0.2, epsilon=None, searchwindowsize=None, usesearchhistory=None, searchbuffercapacity=None, numresults=10, returnscore=True, dialect=2, sortby=None, inorder=False, hybridpolicy=None, batchsize=None, normalizevector_distance=False)"},{"id":"examples","title":"Examples"}],"id":"vectorrangequery","title":"VectorRangeQuery"},{"children":[{"id":"class-hybridqueryargs-kwargs","title":"class HybridQuery(args, *kwargs)"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"}],"id":"hybridquery","title":"HybridQuery"},{"children":[{"id":"class-textquerytext-textfieldname-textscorerbm25std-filterexpressionnone-returnfieldsnone-numresults10-returnscoretrue-dialect2-sortbynone-inorderfalse-paramsnone-stopwordsenglish-textweightsnone","title":"class TextQuery(text, textfieldname, textscorer='BM25STD', filterexpression=None, returnfields=None, numresults=10, returnscore=True, dialect=2, sortby=None, inorder=False, params=None, stopwords='english', textweights=None)"},{"id":"examples","title":"Examples"}],"id":"textquery","title":"TextQuery"},{"children":[{"id":"class-filterqueryfilterexpressionnone-returnfieldsnone-numresults10-dialect2-sortbynone-inorderfalse-paramsnone","title":"class FilterQuery(filterexpression=None, returnfields=None, numresults=10, dialect=2, sortby=None, in_order=False, params=None)"},{"id":"examples","title":"Examples"}],"id":"filterquery","title":"FilterQuery"},{"children":[{"id":"class-countqueryfilterexpressionnone-dialect2-paramsnone","title":"class CountQuery(filter_expression=None, dialect=2, params=None)"},{"id":"examples","title":"Examples"}],"id":"countquery","title":"CountQuery"},{"children":[{"id":"class-multivectorqueryvectors-returnfieldsnone-filterexpressionnone-numresults10-dialect2","title":"class MultiVectorQuery(vectors, returnfields=None, filterexpression=None, num_results=10, dialect=2)"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"},{"id":"parameters","title":"Parameters"}],"id":"multivectorquery","title":"MultiVectorQuery"}]}
...
* **Parameters:**
  ...
  * **vector_field_name** (*str*) â The name of the vector field to search
    against in the database.
  * **return_fields** (*List* *[* *str* *]*) â The declared fields to return with search
    results.
  * **filter_expression** (*Union* *[* *str* *,* [*FilterExpression*]() *]* *,* *optional*) â A filter to apply
    along with the vector search. Defaults to None.
  * **dtype** (*str* *,* *optional*) â The dtype of the vector. Defaults to
    "float32".
  * **num_results** (*int* *,* *optional*) â The top k results to return from the
    vector search. Defaults to 10.
  * **return_score** (*bool* *,* *optional*) â Whether to return the vector
    distance. Defaults to True.
  * **dialect** (*int* *,* *optional*) â The RediSearch query dialect.
    Defaults to 2.
  * **sort_by** (*Optional* *[* *SortSpec* *]*) â The field(s) to order the results by. Can be:
  ...
  * **in_order** (*bool*) â Requires the terms in the field to have
    the same order as the terms in the query filter, regardless of
    the offsets between them. Defaults to False.
  * **hybrid_policy** (*Optional* *[* *str* *]*) â Controls how filters are applied during vector search.
  ...
  * **batch_size** (*Optional* *[* *int* *]*) â When hybrid_policy is "BATCHES", controls the number
  ...
  * **ef_runtime** (*Optional* *[* *int* *]*) â Controls the size of the dynamic candidate list for HNSW
  ...
  * **epsilon** (*Optional* *[* *float* *]*) â The range search approximation factor for HNSW and SVS-VAMANA
  ...
  * **search_window_size** (*Optional* *[* *int* *]*) â The size of the search window for SVS-VAMANA KNN searches.
  ...
  * **use_search_history** (*Optional* *[* *str* *]*) â For SVS-VAMANA indexes, controls whether to use the
  ...
  * **search_buffer_capacity** (*Optional* *[* *int* *]*) â Tuning parameter for SVS-VAMANA indexes using
  ...
  * **normalize_vector_distance** (*bool*) â Redis supports 3 distance metrics: L2 (euclidean),
...
* **Raises:**
  **TypeError** â If filter_expression is not of type redisvl.query.FilterExpression
...
* **Parameters:**
  **language** (*str*) â The language (e.g. chinese or english)
* **Return type:**
  *Query*
...
* **Parameters:**
  * **\*fields** â Variable number of field names to return.
  * **skip_decode** (*str* *|* *List* *[* *str* *]*  *|* *None*) â Optional field name or list of field names that should not be
...
* **Return type:**
  self
* **Raises:**
  **TypeError** â If skip_decode is not a string, list, or None.
...
* **Parameters:**
  **scorer** (*str*) â The scoring function to use
...
* **Parameters:**
  **batch_size** (*int*) â The batch size to use when hybrid_policy is "BATCHES".
* **Raises:**
  * **TypeError** â If batch_size is not an integer
  * **ValueError** â If batch_size is not positive
...
* **Parameters:**
  **ef_runtime** (*int*) â The EF_RUNTIME value to use for HNSW algorithm.
  Higher values improve recall at the expense of slower search.
* **Raises:**
  * **TypeError** â If ef_runtime is not an integer
  * **ValueError** â If ef_runtime is not positive
...
* **Parameters:**
  **epsilon** (*float*) â The range search approximation factor for HNSW and SVS-VAMANA
  ...
  expense of run time.
* **Raises:**
  * **TypeError** â If epsilon is not a float or int
  * **ValueError** â If epsilon is negative
...
* **Parameters:**
  **filter_expression** (*Optional* *[* *Union* *[* *str* *,* [*FilterExpression*]() *]* *]* *,* *optional*) â The filter
  expression or query string to use on the query.
* **Raises:**
  **TypeError** â If filter_expression is not a valid FilterExpression or string.
...
* **Parameters:**
  **hybrid_policy** (*str*) â The hybrid policy to use. Options are "BATCHES"
  or "ADHOC_BF".
* **Raises:**
  **ValueError** â If hybrid_policy is not one of the valid options
...
* **Parameters:**
  **search_buffer_capacity** (*int*) â Tuning parameter for SVS-VAMANA indexes using
...
* **Raises:**
  * **TypeError** â If search_buffer_capacity is not an integer
  * **ValueError** â If search_buffer_capacity is not positive
...
* **Parameters:**
  **search_window_size** (*int*) â The size of the search window for SVS-VAMANA KNN searches.
  Increasing this value generally yields more accurate but slower search results.
* **Raises:**
  * **TypeError** â If search_window_size is not an integer
  * **ValueError** â If search_window_size is not positive
...
* **Parameters:**
  **use_search_history** (*str*) â For SVS-VAMANA indexes, controls whether to use the
  search buffer or entire search history. Options are "OFF", "ON", or "AUTO".
* **Raises:**
  * **TypeError** â If use_search_history is not a string
  * **ValueError** â If use_search_history is not one of "OFF", "ON", or "AUTO"
...
* **Parameters:**
  * **sort_spec** (*str* *|* *Tuple* *[* *str* *,* *str* *]*  *|* *List* *[* *str* *|* *Tuple* *[* *str* *,* *str* *]* *]*  *|* *None*) â Sort specification in various formats:
    - str: single field name
    - Tuple[str, str]: (field_name, "ASC"|"DESC")
    - List: list of field names or tuples
  * **asc** (*bool*) â Default sort direction when not specified (only used when sort_spec is a string).
...
* **Return type:**
  self
* **Raises:**
  * **TypeError** â If sort_spec is not a valid type.
  * **ValueError** â If direction is not "ASC" or "DESC".
...
* **Parameters:**
  * **vector** (*List* *[* *float* *]*) â The vector to perform the range query with.
  * **vector_field_name** (*str*) â The name of the vector field to search
    against in the database.
  * **return_fields** (*List* *[* *str* *]*) â The declared fields to return with search
    results.
  ...
  * **dtype** (*str* *,* *optional*) â The dtype of the vector. Defaults to
    "float32".
  * **distance_threshold** (*float*) â The threshold for vector distance.
    A smaller threshold indicates a stricter semantic search.
    Defaults to 0.2.
  * **epsilon** (*Optional* *[* *float* *]*) â The relative factor for vector range queries,
  ...
  * **search_window_size** (*Optional* *[* *int* *]*) â The size of the search window for SVS-VAMANA range searches.
    Increasing this value generally yields more accurate but slower search results.
    Defaults to None, which uses the index-defined value (typically 10).
  * **use_search_history** (*Optional* *[* *str* *]*) â For SVS-VAMANA indexes, controls whether to use the
    search buffer or entire search history. Options are "OFF", "ON", or "AUTO".
  ...
  * **search_buffer_capacity** (*Optional* *[* *int* *]*) â Tuning parameter for SVS-VAMANA indexes using
    ...
    candidates to collect in the first level of search before the re-ranking level.
    Defaults to None, which uses the index-defined value (typically SEARCH_WINDOW_SIZE).
  * **num_results** (*int*) â The MAX number of results to return.
    Defaults to 10.
  * **return_score** (*bool* *,* *optional*) â Whether to return the vector
    distance. Defaults to True.
  * **dialect** (*int* *,* *optional*) â The RediSearch query dialect.
...
* **Parameters:**
  **distance_threshold** (*float*) â Vector distance threshold.
* **Raises:**
  * **TypeError** â If distance_threshold is not a float or int
  * **ValueError** â If distance_threshold is negative
...
* **Parameters:**
  **epsilon** (*float*) â The relative factor for vector range queries,
  setting boundaries for candidates within radius \* (1 + epsilon).
* **Raises:**
  * **TypeError** â If epsilon is not a float or int
  * **ValueError** â If epsilon is negative
...
* **Parameters:**
  **search_window_size** (*int*) â The size of the search window for SVS-VAMANA range searches.
* **Raises:**
  * **TypeError** â If search_window_size is not an integer
  * **ValueError** â If search_window_size is not positive
...
* **Parameters:**
  **use_search_history** (*str*) â Controls whether to use the search buffer or entire history.
  Must be one of "OFF", "ON", or "AUTO".
* **Raises:**
  * **TypeError** â If use_search_history is not a string
  * **ValueError** â If use_search_history is not one of the valid options
...
* **Parameters:**
  * **text** (*str*) â The text to search for.
  * **text_field_name** (*str*) â The text field name to search in.
  * **vector** (*Union* *[* *bytes* *,* *List* *[* *float* *]* *]*) â The vector to perform vector similarity search.
  * **vector_field_name** (*str*) â The vector field name to search in.
  * **text_scorer** (*str* *,* *optional*) â The text scorer to use. Options are {TFIDF, TFIDF.DOCNORM,
    BM25, DISMAX, DOCSCORE, BM25STD}. Defaults to "BM25STD".
  * **filter_expression** (*Optional* *[*[*FilterExpression*]() *]* *,* *optional*) â The filter expression to use.
    Defaults to None.
  * **alpha** (*float* *,* *optional*) â The weight of the vector similarity. Documents will be scored
    as: hybrid_score = (alpha) \* vector_score + (1-alpha) \* text_score.
    Defaults to 0.7.
  * **dtype** (*str* *,* *optional*) â The data type of the vector. Defaults to "float32".
  * **num_results** (*int* *,* *optional*) â The number of results to return. Defaults to 10.
  * **return_fields** (*Optional* *[* *List* *[* *str* *]* *]* *,* *optional*) â The fields to return. Defaults to None.
  * **stopwords** (*Optional* *[* *Union* *[* *str* *,* *Set* *[* *str* *]* *]* *]* *,* *optional*) â 
  ...
  * **dialect** (*int* *,* *optional*) â The Redis dialect version. Defaults to 2.
  * **text_weights** (*Optional* *[* *Dict* *[* *str* *,* *float* *]* *]*) â The importance weighting of individual words
...
* **Raises:**
  * **ValueError** â If the text string is empty, or if the text string becomes empty after
        stopwords are removed.
  * **TypeError** â If the stopwords are not a set, list, or tuple of strings.
...
* **Parameters:**
  * **text_weights** â Dictionary of word:weight mappings
...
* **Parameters:**
  * **text** (*str*) â The text string to perform the text search with.
  * **text_field_name** (*Union* *[* *str* *,* *Dict* *[* *str* *,* *float* *]* *]*) â The name of the document field to perform
    text search on, or a dictionary mapping field names to their weights.
  * **text_scorer** (*str* *,* *optional*) â The text scoring algorithm to use.
  ...
  * **return_score** (*bool* *,* *optional*) â Whether to return the text score.
    Defaults to True.
  * **dialect** (*int* *,* *optional*) â The RediSearch query dialect.
    Defaults to 2.
  * **sort_by** (*Optional* *[* *SortSpec* *]*) â The field(s) to order the results by. Can be:
  ...
  * **in_order** (*bool*) â Requires the terms in the field to have
    the same order as the terms in the query filter, regardless of
    the offsets between them. Defaults to False.
  * **params** (*Optional* *[* *Dict* *[* *str* *,* *Any* *]* *]* *,* *optional*) â The parameters for the query.
    Defaults to None.
  * **stopwords** (*Optional* *[* *Union* *[* *str* *,* *Set* *[* *str* *]* *]*) â 

    The set of stop words to remove
    from the query text (client-side filtering). If a language like âenglishâ or âspanishâ is provided
    ...
    then no words will be removed. Defaults to âenglishâ.
  ...
  * **text_weights** (*Optional* *[* *Dict* *[* *str* *,* *float* *]* *]*) â The importance weighting of individual words
    ...
    text_scorer score.
* **Raises:**
  * **ValueError** â if stopwords language string cannot be loaded.
  * **TypeError** â If stopwords is not a valid iterable set of strings.
...
* **Parameters:**
  **field_weights** (*str* *|* *Dict* *[* *str* *,* *float* *]*) â Either a single field name or dictionary of field:weight mappings
...
* **Parameters:**
  * **filter_expression** (*Optional* *[* *Union* *[* *str* *,* [*FilterExpression*]() *]* *]*) â The optional filter
    expression to query with. Defaults to â\*â.
  * **return_fields** (*Optional* *[* *List* *[* *str* *]* *]* *,* *optional*) â The fields to return.
  * **num_results** (*Optional* *[* *int* *]* *,* *optional*) â The number of results to return. Defaults to 10.
  * **dialect** (*int* *,* *optional*) â The query dialect. Defaults to 2.
  * **sort_by** (*Optional* *[* *SortSpec* *]* *,* *optional*) â The field(s) to order the results by. Can be:
    ...
    Defaults to None.
  * **in_order** (*bool* *,* *optional*) â Requires the terms in the field to have the same order as the
    terms in the query filter. Defaults to False.
  * **params** (*Optional* *[* *Dict* *[* *str* *,* *Any* *]* *]* *,* *optional*) â The parameters for the query. Defaults to None.
* **Raises:**
  **TypeError** â If filter_expression is not of type redisvl.query.FilterExpression
...
* **Parameters:**
  * **filter_expression** (*Optional* *[* *Union* *[* *str* *,* [*FilterExpression*]() *]* *]*) â The filter expression to
...
score = (w_1 \* score_1 + w_2 \* score_2 + w_3 \* score_3 + â¦ )

Vectors may be of different size and datatype, but must be indexed using the âcosineâ distance_metric.
...
* **Parameters:**
  * **vectors** (*Union* *[*[*Vector*]() *,* *List* *[*[*Vector*]() *]* *]*) â The Vectors to perform vector similarity search.
  * **return_fields** (*Optional* *[* *List* *[* *str* *]* *]* *,* *optional*) â The fields to return. Defaults to None.
  * **filter_expression** (*Optional* *[* *Union* *[* *str* *,* [*FilterExpression*]() *]* *]*) â The filter expression to use.
    Defaults to None.
  * **num_results** (*int* *,* *optional*) â The number of results to return. Defaults to 10.
  * **dialect** (*int* *,* *optional*) â The Redis dialect version. Defaults to 2.
