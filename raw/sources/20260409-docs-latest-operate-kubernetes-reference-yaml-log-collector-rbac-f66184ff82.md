...
url: https://redis.io/docs/latest/operate/kubernetes/reference/yaml/log-collector-rbac/
retrieved_utc: '2026-04-09T20:45:58.009560+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/reference/yaml/log-collector-rbac/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"collection-modes","title":"Collection modes"},{"id":"restricted-mode-rbac","title":"restricted mode RBAC"},{"id":"all-mode-rbac","title":"all mode RBAC"},{"children":[{"id":"namespace-requirements","title":"Namespace requirements"},{"id":"role-binding-configuration","title":"Role binding configuration"},{"id":"manual-deployment","title":"Manual deployment"}],"id":"apply-the-configuration","title":"Apply the configuration"},{"id":"usage","title":"Usage"},{"children":[{"id":"best-practices","title":"Best practices"},{"id":"secrets-permission-explanation","title":"Secrets permission explanation"}],"id":"security-considerations","title":"Security considerations"},{"children":[{"id":"permission-errors","title":"Permission errors"},{"id":"missing-resources","title":"Missing resources"}],"id":"troubleshooting","title":"Troubleshooting"},{"id":"next-steps","title":"Next steps"},{"id":"related-documentation","title":"Related documentation"}]}
