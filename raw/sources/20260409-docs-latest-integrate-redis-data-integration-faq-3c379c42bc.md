---
title: FAQ
url: https://redis.io/docs/latest/integrate/redis-data-integration/faq/
retrieved_utc: '2026-04-09T20:45:57.899128+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/faq/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"which-license-does-rdi-use","title":"Which license does RDI use?"},{"id":"how-does-rdi-track-data-changes-in-the-source-database","title":"How does RDI track data changes in the source database?"},{"id":"how-much-data-can-rdi-process","title":"How much data can RDI process?"},{"id":"can-rdi-work-with-any-redis-database","title":"Can RDI work with any Redis database?"},{"id":"can-rdi-automatically-track-changes-to-the-source-database-schema","title":"Can RDI automatically track changes to the source database schema?"},{"id":"should-i-be-concerned-when-the-log-says-rdi-is-out-of-memory-rdi-oom","title":"Should I be concerned when the log says RDI is out of memory? {#rdi-oom}"},{"id":"what-happens-when-rdi-cant-write-to-the-target-redis-database","title":"What happens when RDI can't write to the target Redis database?"},{"id":"what-does-rdi-do-if-the-data-is-corrupted-or-invalid","title":"What does RDI do if the data is corrupted or invalid?"},{"id":"can-i-use-rdi-without-persistence-enabled","title":"Can I use RDI without persistence enabled?"}]}
