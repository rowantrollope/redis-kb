...
url: https://redis.io/docs/latest/operate/rs/clusters/logging/alerts-events/
retrieved_utc: '2026-04-09T20:45:57.707264+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/logging/alerts-events/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"alerts","title":"Alerts"},{"id":"events","title":"Events"}]}
