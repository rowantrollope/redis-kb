...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/
retrieved_utc: '2026-04-09T20:46:00.181729+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/8-0-2-releases/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"detailed-release-notes","title":"Detailed release notes"},{"id":"rhel9-based-image","title":"RHEL9-based image"},{"id":"known-limitations","title":"Known limitations"}]}
