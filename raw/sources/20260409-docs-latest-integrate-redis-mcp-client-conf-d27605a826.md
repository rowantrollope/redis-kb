...
url: https://redis.io/docs/latest/integrate/redis-mcp/client-conf/
retrieved_utc: '2026-04-09T20:45:55.406226+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-mcp/client-conf/index.html.md
---
...
```json metadata
{
  ...
  "group": "service",
  "tableOfContents": {"sections":[{"id":"smithery","title":"Smithery"},{"children":[{"id":"augment-code","title":"Augment Code"},{"id":"claude-desktop","title":"Claude Desktop"},{"id":"openai-agents","title":"OpenAI Agents"},{"id":"vs-code-with-github-copilot","title":"VS Code with GitHub Copilot"}],"id":"manual-configuration","title":"Manual configuration"},{"id":"redis-cloud-mcp","title":"Redis Cloud MCP"}]}
...
(see [Redis Cloud REST API]() for more
information).
