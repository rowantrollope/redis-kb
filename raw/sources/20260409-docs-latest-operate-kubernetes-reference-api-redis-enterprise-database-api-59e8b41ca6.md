...
url: https://redis.io/docs/latest/operate/kubernetes/reference/api/redis_enterprise_database_api/
retrieved_utc: '2026-04-09T20:45:56.445289+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/reference/api/redis_enterprise_database_api/index.html.md
---
...
<sup><sup>[â© Parent](#specalertsettings)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>integer</td>
        <td>
          The sourceâs RDB size to be transferred during the syncing phase.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>integer</td>
        <td>
          Number of bytes transferred from the sourceâs RDB during the syncing phase.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td>status</td>
