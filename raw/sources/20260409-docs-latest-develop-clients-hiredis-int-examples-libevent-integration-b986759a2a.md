...
url: https://redis.io/docs/latest/develop/clients/hiredis/int-examples/libevent-integration/
retrieved_utc: '2026-04-09T20:45:58.587378+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/hiredis/int-examples/libevent-integration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install-libevent","title":"Install libevent"},{"id":"create-a-simple-app","title":"Create a simple app"},{"id":"run-the-code","title":"Run the code"}]}
