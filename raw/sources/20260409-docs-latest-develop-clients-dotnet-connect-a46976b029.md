...
url: https://redis.io/docs/latest/develop/clients/dotnet/connect/
retrieved_utc: '2026-04-09T20:45:55.444038+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/dotnet/connect/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"basic-connection","title":"Basic connection"},{"id":"connect-to-a-redis-cluster","title":"Connect to a Redis cluster"},{"id":"connect-to-your-production-redis-with-tls","title":"Connect to your production Redis with TLS"},{"id":"multiplexing","title":"Multiplexing"}]}
