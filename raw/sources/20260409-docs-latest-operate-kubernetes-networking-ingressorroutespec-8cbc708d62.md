...
url: https://redis.io/docs/latest/operate/kubernetes/networking/ingressorroutespec/
retrieved_utc: '2026-04-09T20:45:56.443062+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/networking/ingressorroutespec/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install-ingress-controller","title":"Install Ingress controller"},{"id":"configure-dns","title":"Configure DNS"},{"children":[{"id":"nginx-or-haproxy-ingress-controllers","title":"NGINX or HAproxy ingress controllers"},{"id":"openshift-routes","title":"OpenShift routes"}],"id":"edit-the-rec-spec","title":"Edit the REC spec"}]}
