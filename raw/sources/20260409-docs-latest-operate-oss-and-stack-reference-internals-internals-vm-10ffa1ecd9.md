...
url: https://redis.io/docs/latest/operate/oss_and_stack/reference/internals/internals-vm/
retrieved_utc: '2026-04-09T20:45:52.035729+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/reference/internals/internals-vm/index.html.md
---
...
{
  "title": "Virtual memory (deprecated)",
  "description": "A description of the Redis virtual memory system that was deprecated in 2.4 and removed in 2.6. This document exists for historical interest.",
