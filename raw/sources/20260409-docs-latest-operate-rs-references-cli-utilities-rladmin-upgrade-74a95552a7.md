...
url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/upgrade/
retrieved_utc: '2026-04-09T20:45:36.299226+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/upgrade/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"upgrade-db","title":"upgrade db"}]}
