...
url: https://redis.io/docs/latest/operate/rs/security/encryption/tls/tls-protocols/
retrieved_utc: '2026-04-09T20:45:57.759994+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/encryption/tls/tls-protocols/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"edit-tls-settings-in-the-ui-edit-tls-ui","title":"Edit TLS settings in the UI {#edit-tls-ui}"},{"id":"control-plane-tls","title":"Control plane TLS"},{"id":"data-plane-tls","title":"Data plane TLS"},{"id":"discovery-service-tls","title":"Discovery service TLS"}],"id":"configure-tls-protocol","title":"Configure TLS protocol"}]}
