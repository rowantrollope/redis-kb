...
url: https://redis.io/docs/latest/operate/kubernetes/flex/
retrieved_utc: '2026-04-09T20:45:57.503969+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/flex/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"automatic-data-tiering","title":"Automatic data tiering"},{"id":"utilization-aware-ram-population","title":"Utilization-aware RAM population"},{"id":"storage-engine","title":"Storage engine"}],"id":"how-flex-works","title":"How Flex works"},{"id":"compatibility","title":"Compatibility"},{"id":"when-to-use-flex","title":"When to use Flex"},{"children":[{"id":"differences-between-flex-and-auto-tiering","title":"Differences between Flex and Auto Tiering"}],"id":"flex-and-auto-tiering","title":"Flex and Auto Tiering"},{"id":"next-steps","title":"Next steps"}]}
...
Flex replaces [Auto Tiering]() (formerly known as Redis on Flash). Redis Enterprise selects the implementation based on your database version:
...
For Redis Enterprise for Kubernetes version 7.22.2-22 or earlier, see [Auto Tiering]().
...
- [Plan your deployment](): Review hardware requirements, sizing guidelines, and limitations.
- [Get started](): Configure Flex on your cluster.
- [Scale your deployment](): Learn scaling strategies and best practices.
