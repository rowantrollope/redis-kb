...
retrieved_utc: '2026-04-09T20:45:52.512014+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/sentinel-clients/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"step-1-connect-to-the-first-sentinel","title":"Step 1: connect to the first Sentinel"},{"id":"step-2-ask-for-the-master-address","title":"Step 2: ask for the master address"},{"id":"step-3-call-the-role-command-in-the-target-instance","title":"Step 3: call the ROLE command in the target instance"}],"id":"redis-service-discovery-via-sentinel","title":"Redis service discovery via Sentinel"},{"id":"handle-reconnections","title":"Handle reconnections"},{"id":"sentinel-failover-disconnection","title":"Sentinel failover disconnection"},{"id":"connect-to-replicas","title":"Connect to replicas"},{"id":"connection-pools","title":"Connection pools"},{"id":"error-reporting","title":"Error reporting"},{"id":"sentinels-list-automatic-refresh","title":"Sentinels list automatic refresh"},{"id":"subscribe-to-sentinel-events-to-improve-responsiveness","title":"Subscribe to Sentinel events to improve responsiveness"},{"id":"additional-information","title":"Additional information"}]}
