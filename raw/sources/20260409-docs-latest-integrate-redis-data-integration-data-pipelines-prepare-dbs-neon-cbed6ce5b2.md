...
retrieved_utc: '2026-04-09T20:45:54.438760+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/neon/index.html.md
---

# Prepare Neon for RDI
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"1-enable-logical-replication-in-neon","title":"1. Enable logical replication in Neon"},{"id":"2-create-a-replication-role-for-rdi","title":"2. Create a replication role for RDI"},{"id":"3-grant-database-and-table-privileges","title":"3. Grant database and table privileges"},{"id":"4-allow-inbound-traffic-to-neon","title":"4. Allow inbound traffic to Neon"}]}
