...
url: https://redis.io/docs/latest/operate/rc/security/aws-transit-gateway/
retrieved_utc: '2026-04-09T20:45:59.601400+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/security/aws-transit-gateway/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"considerations","title":"Considerations"},{"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"associate-resource-share-with-redis-cloud-associate-resource-share","title":"Associate resource share with Redis Cloud {#associate-resource-share}"},{"id":"accept-resource-share-and-create-attachment-accept-resource-share","title":"Accept resource share and create attachment {#accept-resource-share}"},{"id":"add-consumer-cidrs","title":"Add consumer CIDRs"},{"id":"update-aws-route-tables-update-route-tables","title":"Update AWS route tables {#update-route-tables}"}],"id":"aws-transit-gateway","title":"AWS Transit Gateway"},{"id":"continue-learning-with-redis-university","title":"Continue learning with Redis University"}]}
...
1. [Create a database with Redis Cloud Pro]() from the [Redis Cloud console](https://cloud.redis.io/#/).
...
If you use Redis Cloud Bring your own Cloud, you will need to set its IAM Instance Policy to include Transit Gateway. See [Create IAM resources using the AWS console]() for more information.
...
If you've enabled the database's [CIDR allow list](), you must also [add the Transit Gateway's IP address to the CIDR allow list]() to connect to the database via the private endpoint.
