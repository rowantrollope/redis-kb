...
url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/extensions/
retrieved_utc: '2026-04-09T20:45:53.828189+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/extensions/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"compiling","title":"Compiling"},{"id":"loading","title":"Loading"}],"id":"registering-and-loading-extensions","title":"Registering and loading extensions"},{"children":[{"id":"example-init-function","title":"Example init function"}],"id":"initializing-an-extension","title":"Initializing an extension"},{"id":"calling-your-custom-functions","title":"Calling your custom functions"},{"children":[{"id":"rsqueryexpanderctx","title":"RSQueryExpanderCtx"},{"id":"rstoken","title":"RSToken"}],"id":"the-query-expander-api","title":"The query expander API"},{"children":[{"id":"rsscoringfunctionctx","title":"RSScoringFunctionCtx"},{"id":"rsindexresult","title":"RSIndexResult"},{"id":"rsdocumentmetadata","title":"RSDocumentMetadata"}],"id":"the-scoring-function-api","title":"The scoring function API"},{"id":"example-query-expander","title":"Example query expander"},{"id":"example-scoring-function","title":"Example scoring function"}]}
