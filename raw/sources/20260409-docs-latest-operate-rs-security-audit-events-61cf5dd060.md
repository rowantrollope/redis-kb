...
url: https://redis.io/docs/latest/operate/rs/security/audit-events/
retrieved_utc: '2026-04-09T20:45:55.183522+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/audit-events/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"cluster-audits","title":"Cluster audits"},{"id":"database-audits","title":"Database audits"},{"id":"policy-defaults-for-new-databases","title":"Policy defaults for new databases"}],"id":"enable-audit-notifications","title":"Enable audit notifications"},{"children":[{"id":"new-connection","title":"New connection"},{"id":"authentication-request","title":"Authentication request"},{"id":"database-disconnect","title":"Database disconnect"}],"id":"notification-examples","title":"Notification examples"},{"id":"notification-field-reference","title":"Notification field reference"},{"id":"status-result-codes","title":"Status result codes"}]}
