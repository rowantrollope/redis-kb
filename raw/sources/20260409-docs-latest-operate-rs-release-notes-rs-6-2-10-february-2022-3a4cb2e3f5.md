...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-10-february-2022/
retrieved_utc: '2026-04-09T20:45:59.409874+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-10-february-2022/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"features-and-enhancements","title":"Features and enhancements"},{"children":[{"id":"prerequisites-and-notes","title":"Prerequisites and notes"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"}],"id":"version-changes","title":"Version changes"},{"id":"redis-modules","title":"Redis modules"},{"id":"interface-enhancements","title":"Interface enhancements"},{"id":"additional-enhancements","title":"Additional enhancements"},{"children":[{"id":"issues-resolved-in-build-96","title":"Issues resolved in build 96"},{"id":"issues-resolved-in-build-100","title":"Issues resolved in build 100"},{"id":"issues-resolved-in-build-121","title":"Issues resolved in build 121"},{"id":"issues-resolved-in-build-129","title":"Issues resolved in build 129"}],"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"installation-limitations","title":"Installation limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"known-issues","title":"Known issues"},{"children":[{"id":"open-source-redis-security-fixes-compatibility","title":"Open Source Redis Security fixes compatibility"}],"id":"security","title":"Security"}]}
...
- [RediSearch v2.2.6]()
- [RedisJSON v2.0.6]()
- [RedisBloom v2.2.9](release-notes/)
- [RedisGraph v2.4.12]()
...
- [RediSearch v2.4.6]()
- [RedisJSON v2.0.8]()
- [RedisBloom v2.2.14](release-notes/)
- [RedisGraph v2.8.12]()
- [RedisTimeSeries v1.6.9]()

For help upgrading a module, see [Add a module to a cluster](#upgrading-the-module-for-the-database). 
...
- RS67434 - Version 6.2.10 fixes the mTLS handshake between the [syncer process](#syncer-process) and the [proxy (DMC)](https://docs.redis.com/latest//rs/references/terminology/#proxy), where the proxy presented a leaf certificate without its full chain to the syncer. After upgrading to 6.2.10, syncer connections using invalid certificates will break the synchronization between Active-Active instances or deployments using Replica Of when TLS is enabled. To ensure certificates are valid before upgrading do the following: 
    ...
    - For Active-Passive (Replica Of) databases: use the admin console to verify that the destination syncer has the correct certificate for the source proxy (DMC).  For details, see [Configure TLS for Replica Of](create/#configure-tls-on-replica-database).
...
- RS78486 - Fix known issue from 6.2.10 build 100 - When usingÂ rladmin tune dbÂ to change the replica buffer size, the command appears to succeed, but the change does not take effect. 
...
- [CVE-2021-41099](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-41099) - Redis Enterprise is not impacted by the CVE that was found and fixed in open source Redis because the proto-max-bulk-len CONFIG is blocked in Redis Enterprise. Additional information about the open source Redis fix is on [the Redis GitHub page](https://github.com/redis/redis/releases) (Redis 6.2.6, Redis 6.0.16)security fixes for [recent CVEâs](https://github.com/redis/redis/security/advisories). Redis Enterprise has already included the fixes for the relevant CVEâs. Some CVEâs announced for Open Source Redis do not affect Redis Enterprise due to different and additional functionality available in Redis Enterprise that is not available in Open Source Redis.
