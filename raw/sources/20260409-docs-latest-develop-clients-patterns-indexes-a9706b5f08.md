...
retrieved_utc: '2026-04-09T20:45:51.971989+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/patterns/indexes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"hashes-and-json-indexes","title":"Hashes and JSON indexes"},{"children":[{"id":"use-object-ids-as-associated-values","title":"Use object IDs as associated values"},{"id":"update-simple-sorted-set-indexes","title":"Update simple sorted set indexes"},{"id":"turn-multi-dimensional-data-into-linear-data","title":"Turn multi-dimensional data into linear data"},{"id":"limits-of-the-score","title":"Limits of the score"}],"id":"simple-numerical-indexes-with-sorted-sets","title":"Simple numerical indexes with sorted sets"},{"id":"time-series-indexes","title":"Time series indexes"},{"children":[{"id":"a-first-example-completion","title":"A first example: completion"},{"id":"add-frequency-into-the-mix","title":"Add frequency into the mix"},{"id":"normalize-strings-for-case-and-accents","title":"Normalize strings for case and accents"},{"id":"add-auxiliary-information-in-the-index","title":"Add auxiliary information in the index"},{"id":"numerical-padding","title":"Numerical padding"},{"id":"use-numbers-in-binary-form","title":"Use numbers in binary form"}],"id":"lexicographical-indexes","title":"Lexicographical indexes"},{"id":"composite-indexes","title":"Composite indexes"},{"id":"update-lexicographical-indexes","title":"Update lexicographical indexes"},{"id":"represent-and-query-graphs-using-a-hexastore","title":"Represent and query graphs using a hexastore"},{"id":"multi-dimensional-indexes","title":"Multi-dimensional indexes"},{"id":"multi-dimensional-indexes-with-negative-or-floating-point-numbers","title":"Multi-dimensional indexes with negative or floating point numbers"},{"id":"non-range-indexes","title":"Non-range indexes"},{"id":"index-inconsistency","title":"Index inconsistency"}]}
