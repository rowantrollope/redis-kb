...
url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/gc/
retrieved_utc: '2026-04-09T20:45:52.231605+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/gc/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"the-need-for-garbage-collection","title":"The need for garbage collection"},{"children":[{"id":"gc-on-numeric-indexes","title":"GC on numeric indexes"}],"id":"garbage-collecting-a-single-term-index","title":"Garbage collecting a single-term index"},{"id":"fork-gc","title":"FORK GC"}]}
