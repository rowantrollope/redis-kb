...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-64/
retrieved_utc: '2026-04-09T20:45:59.289616+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-64/index.html.md
---
...
- RS105335 - Added error handling to [`CLIENT NO-TOUCH`]() to return an error if the Redis database version is earlier than 7.2.0 or the command is restricted by ACL rules (handles `CLIENT NO-TOUCH` [command limitations](https://docs.redis.com/latest/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52/#command-limitations)).
...
- RS107718 - When `cm_server` is disabled through `optional_services`, envoy (the clusterâs reverse proxy) now stops listening on the `cm_server` port.
