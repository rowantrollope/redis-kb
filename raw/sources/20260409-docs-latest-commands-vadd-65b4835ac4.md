...
retrieved_utc: '2026-04-09T20:45:36.582679+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/vadd/index.html.md
---
...
So, the additional amount of memory is approximately `0.33 Ã 64 Ã 8 â 169.6` bytes per node, bringing the total memory to ~1193 bytes.
