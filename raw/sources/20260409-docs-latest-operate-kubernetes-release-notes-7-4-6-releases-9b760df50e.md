...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-6-releases/
retrieved_utc: '2026-04-09T20:46:00.656463+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-6-releases/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"detailed-release-notes","title":"Detailed release notes"},{"children":[{"id":"validatingwebhookconfiguration","title":"ValidatingWebhookConfiguration"},{"id":"openshift-scc","title":"OpenShift SCC"},{"id":"upcoming-changes","title":"Upcoming Changes"}],"id":"breaking-changes","title":"Breaking changes"},{"id":"security","title":"Security"},{"id":"supported-distributions","title":"Supported distributions"},{"id":"known-limitations","title":"Known limitations"}]}
