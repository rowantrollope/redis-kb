...
url: https://redis.io/docs/latest/develop/ai/notebook-collection/
retrieved_utc: '2026-04-09T20:45:57.222820+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/notebook-collection/index.html.md
---
...
```json metadata
{
  ...
  "categories": ["docs","develop","stack","oss","rc","rs"],
  "tableOfContents": {"sections":[{"id":"additional-resources","title":"Additional resources"}]}
