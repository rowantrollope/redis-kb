...
url: https://redis.io/docs/latest/operate/kubernetes/networking/cluster-aware-clients/
retrieved_utc: '2026-04-09T20:46:01.048196+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/networking/cluster-aware-clients/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"limitations","title":"Limitations"},{"children":[{"id":"edit-rec-redisenterprisecluster-edit-rec","title":"Edit REC (RedisEnterpriseCluster) {#edit-rec}"},{"id":"edit-redb-redisenterprisedatabase-edit-redb","title":"Edit REDB (RedisEnterpriseDatabase) {#edit-redb}"}],"id":"enable-oss-cluster-api","title":"Enable OSS Cluster API"},{"id":"connect-clients","title":"Connect clients"}]}
