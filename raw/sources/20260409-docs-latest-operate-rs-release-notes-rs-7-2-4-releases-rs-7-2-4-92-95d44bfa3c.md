...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-92/
retrieved_utc: '2026-04-09T20:45:59.031479+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-92/index.html.md
---
...
- The following predefined roles and ACLs are removed automatically when you upgrade the cluster, unless they are associated with any users or databases, as planned in the Redis Enterprise Software version 7.2.4-52 [deprecation notice]():
...
- RS114185 - Resolved a [known issue]() regarding cluster upgrade failures due to a `Failed to get default_suffix` error, which appears in `dmcproxy.log`.
