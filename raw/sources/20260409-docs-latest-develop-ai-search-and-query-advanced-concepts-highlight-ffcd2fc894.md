...
retrieved_utc: '2026-04-09T20:45:56.721992+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/highlight/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"summarization","title":"Summarization"},{"id":"highlighting","title":"Highlighting"}],"id":"command-syntax","title":"Command syntax"}]}
