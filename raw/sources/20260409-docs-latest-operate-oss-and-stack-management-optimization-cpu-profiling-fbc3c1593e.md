...
retrieved_utc: '2026-04-09T20:45:51.603916+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/cpu-profiling/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"ensuring-the-cpu-is-your-bottleneck","title":"Ensuring the CPU is your bottleneck"},{"id":"build-prerequisites","title":"Build Prerequisites"}],"id":"filling-the-performance-checklist","title":"Filling the performance checklist"},{"children":[{"id":"tool-prerequisites","title":"Tool prerequisites"}],"id":"a-set-of-instruments-to-identify-performance-regressions-andor-potential-on-cpu-performance-improvements","title":"A set of instruments to identify performance regressions and/or potential on-CPU performance improvements"},{"children":[{"id":"sampling-stack-traces-using-perf","title":"Sampling stack traces using perf"},{"id":"sampling-stack-traces-using-bccbpfs-profile","title":"Sampling stack traces using bcc/BPF's profile"},{"id":"visualizing-the-recorded-profile-information-using-flame-graphs","title":"Visualizing the recorded profile information using Flame Graphs"}],"id":"hotspot-analysis-with-perf-or-ebpf-stack-traces-sampling","title":"Hotspot analysis with perf or eBPF (stack traces sampling)"},{"id":"call-counts-analysis-with-bccbpf","title":"Call counts analysis with bcc/BPF"},{"id":"hardware-event-counting-with-performance-monitoring-counters-pmcs","title":"Hardware event counting with Performance Monitoring Counters (PMCs)"}]}
...
The following steps rely on Linux perf_events (aka ["perf"](https://man7.org/linux/man-pages/man1/perf.1.html)), [bcc/BPF tracing tools](https://github.com/iovisor/bcc), and Brendan Gregâs [FlameGraph repo](https://github.com/brendangregg/FlameGraph).
...
- Cloned Brendan Gregâs [FlameGraph repo](https://github.com/brendangregg/FlameGraph) and made accessible the `difffolded.pl` and `flamegraph.pl` files, to generated the collapsed stack traces and Flame Graphs.
