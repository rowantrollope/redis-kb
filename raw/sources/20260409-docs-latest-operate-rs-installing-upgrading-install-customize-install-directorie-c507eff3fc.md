...
url: https://redis.io/docs/latest/operate/rs/installing-upgrading/install/customize-install-directories/
retrieved_utc: '2026-04-09T20:45:56.291766+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/installing-upgrading/install/customize-install-directories/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"considerations","title":"Considerations"},{"id":"specify-file-locations","title":"Specify file locations"},{"id":"configure-different-mount-points-for-data-and-log-directories-config-diff-data-log-dirs","title":"Configure different mount points for data and log directories {#config-diff-data-log-dirs}"},{"id":"customize-storage-paths","title":"Customize storage paths"},{"id":"limitations","title":"Limitations"}]}
...
When you install Redis Software to custom directories, you can specify custom storage paths for persistent and ephemeral storage during [cluster setup]() or when [adding nodes]().
