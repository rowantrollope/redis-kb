...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17/
retrieved_utc: '2026-04-09T20:46:00.264163+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-2-17/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"new-features","title":"New features"},{"id":"enhancements","title":"Enhancements"},{"id":"redis-database-versions","title":"Redis database versions"},{"id":"redis-feature-sets","title":"Redis feature sets"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"redis-database-version-8-breaking-changes-redis-8-breaking-changes","title":"Redis database version 8 breaking changes {#redis-8-breaking-changes}"},{"id":"reserved-ports","title":"Reserved ports"},{"id":"deprecations","title":"Deprecations"},{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"known-issues","title":"Known issues"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
|---------------|------------------------------------|
| RAM-only | [Search and query]()<br />[JSON]()<br />[Time series]()<br />[Probabilistic]()  |
| Flash-enabled ([Redis Flex]()) | [JSON]()<br />[Probabilistic]() |
| [Active-Active]()<sup>[1](#enabled-modules-table-note-1)</sup> | [Search and query]()<br />[JSON]() |
