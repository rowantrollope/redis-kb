...
url: https://redis.io/docs/latest/develop/tools/insight/insight-stream-consumer/
retrieved_utc: '2026-04-09T20:45:53.335033+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/tools/insight/insight-stream-consumer/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"adding-new-entries","title":"Adding new entries"},{"id":"consumer-groups","title":"Consumer groups"},{"id":"managing-streams-in-redis-insight","title":"Managing streams in Redis Insight"},{"children":[{"id":"setup","title":"Setup"},{"id":"run-the-producer","title":"Run the producer"},{"id":"run-the-consumer","title":"Run the consumer"},{"id":"run-a-consumer-group","title":"Run a consumer group"},{"id":"view-the-stream-in-redis-insight","title":"View the stream in Redis Insight"}],"id":"monitor-temperature-and-humidity-from-sensors-in-redis-insight","title":"Monitor temperature and humidity from sensors in Redis Insight"},{"id":"related-topics","title":"Related topics"}]}
...
For more conceptual information about streams, see [Redis Streams](). 
...
3. Install [Redis](). In Docker, check that Redis is running locally on the default port 6379 (with no password set). 
