...
url: https://redis.io/docs/latest/develop/reference/modules/modules-native-types/
retrieved_utc: '2026-04-09T20:45:51.795873+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/modules/modules-native-types/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview-of-native-types","title":"Overview of native types"},{"children":[{"id":"why-module-types-require-nine-character-names","title":"Why module types require nine character names"},{"id":"set-and-get-keys","title":"Set and get keys"},{"id":"free-method","title":"Free method"},{"id":"rdb-load-and-save-methods","title":"RDB load and save methods"},{"id":"aof-rewriting","title":"AOF rewriting"},{"id":"allocate-memory","title":"Allocate memory"}],"id":"register-a-new-data-type","title":"Register a new data type"}]}
