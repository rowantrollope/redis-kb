...
url: https://redis.io/docs/latest/operate/rs/clusters/optimize/memtier-benchmark/
retrieved_utc: '2026-04-09T20:46:02.109293+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/optimize/memtier-benchmark/index.html.md
---
...
{
  "title": "Benchmarking Redis Software",
  "description": "Use the `memtier_benchmark` tool to perform a performance benchmark of Redis Software.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"populate-a-database-with-testing-data","title":"Populate a database with testing data"}]}
