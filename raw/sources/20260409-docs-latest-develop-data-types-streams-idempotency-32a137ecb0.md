...
url: https://redis.io/docs/latest/develop/data-types/streams/idempotency/
retrieved_utc: '2026-04-09T20:45:54.263088+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/data-types/streams/idempotency/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"manual-mode-idmp","title":"Manual mode (IDMP)"},{"id":"automatic-mode-idmpauto","title":"Automatic mode (IDMPAUTO)"}],"id":"idempotency-modes","title":"Idempotency modes"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"expiration-behavior","title":"Expiration behavior"},{"id":"determine-optimal-configuration-values","title":"Determine optimal configuration values"}],"id":"stream-configuration","title":"Stream configuration"},{"id":"producer-isolation","title":"Producer isolation"},{"id":"monitoring","title":"Monitoring"},{"children":[{"id":"producer-id-selection","title":"Producer ID selection"},{"id":"configuration-tuning","title":"Configuration tuning"},{"id":"error-handling","title":"Error handling"}],"id":"best-practices","title":"Best practices"},{"id":"performance-characteristics","title":"Performance characteristics"},{"id":"persistence","title":"Persistence"}]}
...
1. Redis generates an iid based on each messageâs content.

If the same message is added to the stream more than once, the same iid would need to be provided by the producer.
For (1), this is the producerâs responsibility, and for (2), Redis will calculate the same iid, as long as the message content hasnât changed.
