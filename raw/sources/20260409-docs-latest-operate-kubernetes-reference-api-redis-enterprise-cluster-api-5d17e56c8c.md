...
url: https://redis.io/docs/latest/operate/kubernetes/reference/api/redis_enterprise_cluster_api/
retrieved_utc: '2026-04-09T20:45:56.458270+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/reference/api/redis_enterprise_cluster_api/index.html.md
---
...
<sup><sup>[â© Parent](#specauditing)</sup></sup>
...
### spec.backup.s3
<sup><sup>[â© Parent](#specbackup)</sup></sup>
...
<sup><sup>[â© Parent](#specbootstrapperresources)</sup></sup>
...
<sup><sup>[â© Parent](#specldap)</sup></sup>
...
<sup><sup>[â© Parent](#specldapauthenticationquery)</sup></sup>
...
<sup><sup>[â© Parent](#specldapauthorizationquery)</sup></sup>
...
<sup><sup>[â© Parent](#specossclustersettings)</sup></sup>
...
<sup><sup>[â© Parent](#specredisenterprisenoderesources)</sup></sup>
...
<sup><sup>[â© Parent](#specredisenterpriseservicesconfiguration)</sup></sup>
...
<sup><sup>[â© Parent](#specsecuritycontext)</sup></sup>
...
<sup><sup>[â© Parent](#specservices)</sup></sup>
...
<sup><sup>[â© Parent](#specservicesriggerspec)</sup></sup>
...
<sup><sup>[â© Parent](#specservicesriggerspecextraenvvars)</sup></sup>
...
<sup><sup>[â© Parent](#specservicesriggerspecextraenvvarsvaluefrom)</sup></sup>
...
### spec.sso.saml
<sup><sup>[â© Parent](#specsso)</sup></sup>
...
<sup><sup>[â© Parent](#specssosaml)</sup></sup>
...
<sup><sup>[â© Parent](#specusagemeter)</sup></sup>
...
<sup><sup>[â© Parent](#specusagemetercallhomeclient)</sup></sup>
...
<sup><sup>[â© Parent](#specusagemetercallhomeclientresources)</sup></sup>
...
<sup><sup>[â© Parent](#specuserdefinedmodules)</sup></sup>
...
<sup><sup>[â© Parent](#specuserdefinedmodulessource)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>[]object</td>
        <td>
          Versions of open source databases bundled by Redis Enterprise Software - please note that in order to use a specific version it should be supported by the âupgradePolicyâ - âmajorâ or âlatestâ according to the desired version (major/minor)<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
<sup><sup>[â© Parent](#status)</sup></sup>
