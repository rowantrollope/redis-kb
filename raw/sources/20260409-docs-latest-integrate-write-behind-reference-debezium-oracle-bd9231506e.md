...
url: https://redis.io/docs/latest/integrate/write-behind/reference/debezium/oracle/
retrieved_utc: '2026-04-09T20:46:06.032812+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/write-behind/reference/debezium/oracle/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"applicationproperties","title":"application.properties"}]}
