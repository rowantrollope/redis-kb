...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/examples/
retrieved_utc: '2026-04-09T20:45:53.555248+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/examples/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"auditing-and-logging","title":"Auditing and logging"},{"id":"enrich-and-transform-data","title":"Enrich and transform data"},{"id":"batch-operations","title":"Batch operations"},{"id":"automatic-expiration","title":"Automatic expiration"}]}
