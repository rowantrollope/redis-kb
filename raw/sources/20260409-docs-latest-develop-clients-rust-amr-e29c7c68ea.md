...
retrieved_utc: '2026-04-09T20:45:55.965160+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/rust/amr/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install","title":"Install"},{"children":[{"id":"entraidcredentialsprovider-for-a-service-principal","title":"EntraIdCredentialsProvider for a service principal"},{"id":"entraidcredentialsprovider-for-a-managed-identity","title":"EntraIdCredentialsProvider for a managed identity"}],"id":"create-a-entraidcredentialsprovider-instance","title":"Create a EntraIdCredentialsProvider instance"},{"id":"advanced-configuration","title":"Advanced configuration"},{"id":"connect","title":"Connect"}]}
