...
url: https://redis.io/docs/latest/operate/kubernetes/security/allow-resource-adjustment/
retrieved_utc: '2026-04-09T20:46:00.940975+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/allow-resource-adjustment/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"default-behavior","title":"Default behavior"},{"id":"enable-automatic-resource-adjustment","title":"Enable automatic resource adjustment"},{"id":"openshift-upgrades","title":"OpenShift upgrades"},{"id":"new-openshift-installations","title":"New OpenShift installations"},{"id":"sysresource","title":"SYS_RESOURCE"},{"id":"choose-whether-to-enable-automatic-resource-adjustment","title":"Choose whether to enable automatic resource adjustment"}]}
...
If running with automatic resource adjustment enabled, manually reapply the [security context constraints (SCC)](https://docs.openshift.com/container-platform/4.8/authentication/managing-security-context-constraints.html) file ([`scc.yaml`]()).
