...
retrieved_utc: '2026-04-09T20:45:54.458578+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/python/quickstart/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"redisgears-basics","title":"RedisGears basics"},{"id":"batch-processing","title":"Batch processing"},{"id":"event-processing","title":"Event processing"},{"id":"next-steps","title":"Next steps"}]}
