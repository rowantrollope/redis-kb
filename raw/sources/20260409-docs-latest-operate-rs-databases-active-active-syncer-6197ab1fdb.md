...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/syncer/
retrieved_utc: '2026-04-09T20:46:00.375802+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/syncer/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"syncer-in-active-active-replication","title":"Syncer in Active-Active replication"}],"id":"syncer-process","title":"Syncer process"},{"children":[{"id":"unrecoverable-syncer-errors","title":"Unrecoverable syncer errors"}],"id":"troubleshooting-syncer-errors","title":"Troubleshooting syncer errors"}]}
