...
retrieved_utc: '2026-04-09T20:45:52.388712+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/use-cases/session-store/nodejs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"how-it-works","title":"How it works"},{"children":[{"id":"data-model","title":"Data model"}],"id":"the-nodejs-session-store","title":"The Node.js session store"},{"id":"session-store-implementation","title":"Session store implementation"},{"id":"prerequisites","title":"Prerequisites"},{"id":"running-the-demo","title":"Running the demo"},{"id":"cookie-handling","title":"Cookie handling"},{"children":[{"id":"secure-the-session-cookie","title":"Secure the session cookie"},{"id":"keep-session-data-lightweight","title":"Keep session data lightweight"},{"id":"handle-expiration-deliberately","title":"Handle expiration deliberately"},{"id":"use-a-framework-integration-where-appropriate","title":"Use a framework integration where appropriate"}],"id":"production-usage","title":"Production usage"},{"id":"next-steps","title":"Next steps"}]}
