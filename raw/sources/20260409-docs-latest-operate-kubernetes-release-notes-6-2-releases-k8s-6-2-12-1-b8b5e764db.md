...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-12-1/
retrieved_utc: '2026-04-09T20:45:58.409943+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-12-1/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"images","title":"Images"},{"id":"feature-improvements","title":"Feature improvements"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"api-changes","title":"API changes"},{"children":[{"id":"support-added","title":"Support added"},{"id":"deprecated","title":"Deprecated"},{"id":"no-longer-supported","title":"No longer supported"}],"id":"compatibility-notes","title":"Compatibility notes"},{"children":[{"id":"supported-upgrade-paths","title":"Supported upgrade paths"}],"id":"before-upgrading","title":"Before upgrading"},{"children":[{"id":"large-clusters","title":"Large clusters"}],"id":"known-limitations","title":"Known limitations"}]}
