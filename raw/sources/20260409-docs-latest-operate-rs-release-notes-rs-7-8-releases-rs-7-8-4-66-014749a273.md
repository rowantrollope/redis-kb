...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-66/
retrieved_utc: '2026-04-09T20:46:00.026108+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-4-66/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"new-features","title":"New features"},{"id":"redis-database-versions","title":"Redis database versions"},{"id":"redis-module-feature-sets","title":"Redis module feature sets"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"known-issues","title":"Known issues"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
- Added support for Ubuntu 22. See [Upgrade a cluster's operating system]() for detailed upgrade instructions.
