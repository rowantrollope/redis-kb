...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/crdbs/
retrieved_utc: '2026-04-09T20:46:03.515099+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/crdbs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"}],"id":"get-all-active-active-databases-get-all-crdbs","title":"Get all Active-Active databases {#get-all-crdbs}"},{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-an-active-active-database-get-crdb","title":"Get an Active-Active database {#get-crdb}"},{"children":[{"id":"request-patch-request","title":"Request {#patch-request}"},{"id":"response-patch-response","title":"Response {#patch-response}"}],"id":"update-an-active-active-database-patch-crdbs","title":"Update an Active-Active database {#patch-crdbs}"},{"children":[{"id":"request-post-request","title":"Request {#post-request}"},{"id":"response-post-response","title":"Response {#post-response}"}],"id":"create-an-active-active-database-post-crdb","title":"Create an Active-Active database {#post-crdb}"},{"children":[{"id":"request-delete-request","title":"Request {#delete-request}"},{"id":"response-delete-response","title":"Response {#delete-response}"}],"id":"delete-an-active-active-database-delete-crdb","title":"Delete an Active-Active database {#delete-crdb}"}]}
