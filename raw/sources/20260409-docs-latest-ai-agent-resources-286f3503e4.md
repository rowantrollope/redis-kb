...
url: https://redis.io/docs/latest/ai-agent-resources/
retrieved_utc: '2026-04-09T20:46:01.829696+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/ai-agent-resources/index.html.md
---
...
```json metadata
{
  ...
  "categories": null,
  "tableOfContents": {"sections":[{"id":"llmstxt-index-of-documentation","title":"llms.txt index of documentation"},{"id":"markdown-documentation-format","title":"Markdown documentation format"},{"children":[{"id":"ndjson-feed-all-pages","title":"NDJSON feed (all pages)"},{"id":"per-page-json","title":"Per-page JSON"},{"id":"json-schema","title":"JSON schema"},{"id":"verifying-contenthash","title":"Verifying content_hash"}],"id":"json-documentation-feeds","title":"JSON documentation feeds"},{"id":"api-references","title":"API references"},{"id":"data-type-comparisons","title":"Data type comparisons"},{"id":"redis-patterns-for-coding-agents","title":"Redis patterns for coding agents"},{"id":"error-handling","title":"Error handling"}]}
...
See [Compare data types]() for advice 
