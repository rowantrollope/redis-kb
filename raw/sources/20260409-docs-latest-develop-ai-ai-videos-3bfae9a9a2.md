...
url: https://redis.io/docs/latest/develop/ai/ai-videos/
retrieved_utc: '2026-04-09T20:45:58.746204+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/ai-videos/index.html.md
---
...
| Retrieval-Augmented Generation (RAG) is one of the most powerful architectural patterns in GenAI todayâcombining the strengths of large language models (LLMs) with real-time, external context from your own data. In this session, learn why it matters and how each componentâfrom query rewriting to dense retrieval to semantic chunkingâworks behind the scenes to power more accurate, grounded, and up-to-date responses. | Are you interested in building LLM applications that actually work? Your chunking strategy makes all the difference. In this video, get a  break down of the science of text chunking so your embeddings can start answering the right questions to your users. | Everyoneâs talking about embedding models latelyâbut what do they actually do, and why does it matter? This video breaks it down in simple terms and shows how embeddings power search, recommendations, and AI features behind the scenes. |
