...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisbloom/redisbloom-2.2-release-notes/
retrieved_utc: '2026-04-09T20:46:00.897305+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisbloom/redisbloom-2.2-release-notes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"requirements","title":"Requirements"},{"id":"v2218-july-2022","title":"v2.2.18 (July 2022)"},{"id":"v2217-june-2022","title":"v2.2.17 (June 2022)"},{"id":"v2215-may-2022","title":"v2.2.15 (May 2022)"},{"id":"v2214-march-2022","title":"v2.2.14 (March 2022)"},{"id":"v2212-february-2022","title":"v2.2.12 (February 2022)"},{"id":"v229-november-2021","title":"v2.2.9 (November 2021)"},{"id":"v226-august-2021","title":"v2.2.6 (August 2021)"},{"id":"v224-july-2020","title":"v2.2.4 (July 2020)"},{"id":"v223-july-2020","title":"v2.2.3 (July 2020)"},{"id":"v222-march-2020","title":"v2.2.2 (March 2020)"},{"id":"v221-january-2020","title":"v2.2.1 (January 2020)"},{"id":"v220-december-2019","title":"v2.2.0 (December 2019)"}]}
...
- Bug fixes:
    ...
    - [#478](https://github.com/RedisBloom/RedisBloom/pull/478) [`BF.INFO`]() reports an inaccurate result about the memory footprint
...
- Bug fixes:
    ...
    - [#451](https://github.com/RedisBloom/RedisBloom/pull/451) [`TOPK.INCRBY`](): fix calculation when old fingerprint count is reduced to 0
    - [#462](https://github.com/RedisBloom/RedisBloom/pull/462) [`CF.RESERVE`](): fix potential crash on incorrect number of parameters
    - [#434](https://github.com/RedisBloom/RedisBloom/pull/434) [`CF.INSERT`](): fix crash when capacity is negative
    - [#450](https://github.com/RedisBloom/RedisBloom/pull/450) [`TOPK.INCRBY`](): limit increment to 100,000 to prevent potential long freezes
...
- Bug fixes:
    ...
    - [#392](https://github.com/RedisBloom/RedisBloom/pull/392) Fixed a potential crash on Bloom filter expansion when loading from [AOF]()
...
- Added functionality
    ...
    - CMS
        - #[97](https://github.com/RedisBloom/RedisBloom/issues/97) `CMS.INCRBY` returns count instead of âOKâ
...
- Minor bug fixes
    ...
    - Cuckoo
        ...
        - #[130](https://github.com/RedisBloom/RedisBloom/issues/130) Number of deletes wasnât saved to RDB
    - General
