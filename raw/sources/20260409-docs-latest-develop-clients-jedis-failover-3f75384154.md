...
url: https://redis.io/docs/latest/develop/clients/jedis/failover/
retrieved_utc: '2026-04-09T20:45:57.949549+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/jedis/failover/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"circuit-breaker-configuration","title":"Circuit breaker configuration"},{"id":"retry-configuration","title":"Retry configuration"},{"id":"general-failover-configuration","title":"General failover configuration"},{"id":"failover-callbacks","title":"Failover callbacks"}],"id":"failover-configuration","title":"Failover configuration"},{"id":"failback-configuration","title":"Failback configuration"},{"children":[{"id":"pingstrategy-default","title":"PingStrategy (default)"},{"id":"lagawarestrategy-preview","title":"LagAwareStrategy (preview)"},{"id":"custom-health-check-strategy","title":"Custom health check strategy"},{"id":"disable-health-checks","title":"Disable health checks"}],"id":"health-check-configuration","title":"Health check configuration"},{"children":[{"id":"manual-failback","title":"Manual failback"}],"id":"managing-databases-at-runtime","title":"Managing databases at runtime"},{"id":"behavior-when-all-endpoints-are-unhealthy","title":"Behavior when all endpoints are unhealthy"},{"children":[{"id":"excessive-or-constant-health-check-failures","title":"Excessive or constant health check failures"},{"id":"slow-failback-after-recovery","title":"Slow failback after recovery"}],"id":"troubleshooting","title":"Troubleshooting"}]}
...
the circuit breaker (see [Detecting connection problems]() for more information on how the
...
in the [Retry configuration]() section). However, if the number of
