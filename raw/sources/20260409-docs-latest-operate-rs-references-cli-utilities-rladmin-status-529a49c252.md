...
url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/status/
retrieved_utc: '2026-04-09T20:46:07.785671+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/status/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"status","title":"status"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns-returns-dbs","title":"Returns {#returns-dbs}"},{"id":"example","title":"Example"}],"id":"status-databases","title":"status databases"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns-returns-endpoints","title":"Returns {#returns-endpoints}"},{"id":"example","title":"Example"}],"id":"status-endpoints","title":"status endpoints"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"status-modules","title":"status modules"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns-returns-nodes","title":"Returns {#returns-nodes}"},{"id":"example","title":"Example"}],"id":"status-nodes","title":"status nodes"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns-returns-shards","title":"Returns {#returns-shards}"},{"id":"example","title":"Example"}],"id":"status-shards","title":"status shards"}]}
...
| BACKUP_PROGRESS | The databaseâs backup progress |
| MISSING_BACKUP_TIME | How long ago a backup was done |
| REDIS_VERSION | The databaseâs Redis version |
...
| ADDRESS | The nodeâs internal IP address |
| EXTERNAL ADDRESS | The nodeâs external IP address |
| HOSTNAME | Node name |
...
| SHA | The nodeâs SHA hash |
| RACK-ID | The nodeâs rack ID |
| STATUS | The nodeâs status |
...
| ROLE | The shardâs role: primary (`master`) or replica (`slave`) |
| SLOTS | Redis keys slot range of the shard |
| USED_MEMORY | Memory used by the shard |
| BACKUP_PROGRESS | The shardâs backup progress |
| RAM_FRAG | The shardâs RAM fragmentation caused by deleted data or expired keys. A large value can indicate inefficient memory allocation. |
| FLASH_FRAG | For Auto Tiering databases, the shardâs flash fragmentation |
| WATCHDOG_STATUS | The shard is being monitored by the node watchdog and the shard is healthy |
| STATUS | The shardâs status |
