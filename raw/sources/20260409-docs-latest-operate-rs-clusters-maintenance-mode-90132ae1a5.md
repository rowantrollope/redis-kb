...
url: https://redis.io/docs/latest/operate/rs/clusters/maintenance-mode/
retrieved_utc: '2026-04-09T20:45:58.589297+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/clusters/maintenance-mode/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"prevent-replica-shard-migration","title":"Prevent replica shard migration"},{"id":"demote-a-master-node","title":"Demote a master node"},{"id":"verify-maintenance-mode-activation","title":"Verify maintenance mode activation"}],"id":"activate-maintenance-mode","title":"Activate maintenance mode"},{"children":[{"id":"specify-a-snapshot","title":"Specify a snapshot"},{"id":"skip-shard-restoration","title":"Skip shard restoration"},{"id":"reset-node-status","title":"Reset node status"}],"id":"deactivate-maintenance-mode","title":"Deactivate maintenance mode"},{"id":"cluster-status-example","title":"Cluster status example"},{"children":[{"id":"activate-maintenance-mode-rest-api","title":"Activate maintenance mode (REST API)"},{"id":"deactivate-maintenance-mode-rest-api","title":"Deactivate maintenance mode (REST API)"},{"id":"track-action-status","title":"Track action status"}],"id":"maintenance-mode-rest-api","title":"Maintenance mode REST API"}]}
...
When you turn off maintenance mode, you can restore the node configuration from a maintenance mode snapshot or any snapshots previously created by [`rladmin node <node_id> snapshot create`](). If you do not specify a snapshot, Redis Software uses the latest maintenance mode snapshot by default.
