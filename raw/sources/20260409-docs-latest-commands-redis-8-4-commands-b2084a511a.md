...
url: https://redis.io/docs/latest/commands/redis-8-4-commands/
retrieved_utc: '2026-04-09T20:45:51.893114+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/redis-8-4-commands/index.html.md
---
...
<details>
<summary><strong><a href="/commands/delex/">DELEX</a></strong> - Conditionally removes the specified key based on value or hash digest comparison. <span style="color: #e74c3c;">â­ New in 8.4</span></summary>

**Syntax:** `DELEX key [IFEQÂ ifeq-value | IFNEÂ ifne-value | IFDEQÂ ifdeq-digest |
  IFDNEÂ ifdne-digest]`
...
<details>
<summary><strong><a href="/commands/digest/">DIGEST</a></strong> - Returns the hash digest of a string value as a hexadecimal string. <span style="color: #e74c3c;">â­ New in 8.4</span></summary>
...
<details>
<summary><strong><a href="/commands/msetex/">MSETEX</a></strong> - Atomically sets multiple string keys with a shared expiration in a single operation. <span style="color: #e74c3c;">â­ New in 8.4</span></summary>

**Syntax:** `MSETEX numkeys key value [key value ...] [NX | XX] [EXÂ seconds |
...
**Syntax:** `XACKDEL key group [KEEPREF | DELREF | ACKED] IDSÂ numids id [id ...]`
...
**Syntax:** `XDELEX key [KEEPREF | DELREF | ACKED] IDSÂ numids id [id ...]`
...
<details>
<summary><strong><a href="/commands/ft.hybrid/">FT.HYBRID</a></strong> - Performs hybrid search combining text search and vector similarity search <span style="color: #e74c3c;">â­ New in 8.4</span></summary>

**Syntax:** `FT.HYBRID index SEARCH query [SCORERÂ scorer]
  [YIELD SCORE ASÂ yield score as] VSIM field vector [KNN count KÂ k
  [EF RUNTIMEÂ ef runtime] [YIELD SCORE ASÂ yield score as] | RANGE
  count RADIUSÂ radius [EPSILONÂ epsilon]
  [YIELD SCORE ASÂ yield score as]] [FILTERÂ filter] [COMBINE <RRF
  count [CONSTANTÂ constant] [WINDOWÂ window]
  [YIELD SCORE ASÂ yield score as] | LINEAR count [ALPHAÂ alpha
  BETAÂ beta] [WINDOWÂ window] [YIELD SCORE ASÂ yield score as]>]
  [LIMIT offset num] [SORTBYÂ sortby [ASC | DESC] | NOSORT] [PARAMS
  nargs name value [name value ...]] [TIMEOUTÂ timeout]
  [FORMATÂ format] [LOADÂ count field [field ...]] [LOAD *] [GROUPBY
  ...
  arg [arg ...] [ASÂ name] [REDUCE <COUNT | COUNT DISTINCT |
  COUNT DISTINCTISH | SUM | MIN | MAX | AVG | STDDEV | QUANTILE |
  TOLIST | FIRST VALUE | RANDOM SAMPLE> nargs arg [arg ...]
  [ASÂ name] ...]]] [APPLYÂ expression ASÂ name [APPLYÂ expression
  ASÂ name ...]] [FILTERÂ filter]`
...
<details>
<summary><strong><a href="/commands/vrange/">VRANGE</a></strong> - Return elements in a lexicographical range <span style="color: #e74c3c;">â­ New in 8.4</span></summary>
...
<details>
<summary><strong><a href="/commands/cluster-migration/">CLUSTER MIGRATION</a></strong> - Start, monitor, and cancel atomic slot migration tasks. <span style="color: #e74c3c;">â­ New in 8.4</span></summary>

**Syntax:** `CLUSTER MIGRATION <IMPORTÂ start-slot end-slot [start-slot end-slot ...]
  | CANCELÂ <IDÂ task-id | ALL> | STATUSÂ <IDÂ task-id | ALL>`
...
**Syntax:** `CLUSTER SLOT-STATS <SLOTSRANGEÂ start-slot end-slot | ORDERBYÂ metric
