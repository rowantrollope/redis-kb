...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/openshift-operatorhub/
retrieved_utc: '2026-04-09T20:45:59.172135+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/openshift-operatorhub/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install-the-redis-enterprise-operator","title":"Install the Redis Enterprise operator"},{"id":"security-context-constraints","title":"Security context constraints"},{"id":"create-redis-enterprise-custom-resources","title":"Create Redis Enterprise custom resources"}]}
