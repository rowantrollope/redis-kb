...
url: https://redis.io/docs/latest/develop/reference/key-specs/
retrieved_utc: '2026-04-09T20:45:52.549188+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/key-specs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"index","title":"index"},{"id":"keyword","title":"keyword"}],"id":"beginsearch","title":"begin_search"},{"children":[{"id":"range","title":"range"},{"id":"keynum","title":"keynum"}],"id":"findkeys","title":"find_keys"},{"id":"notes","title":"notes"},{"children":[{"id":"access-type-flags","title":"Access type flags"},{"id":"logical-operation-flags","title":"Logical operation flags"},{"id":"miscellaneous-flags","title":"Miscellaneous flags"},{"id":"incomplete","title":"incomplete"},{"id":"variableflags","title":"variable_flags"}],"id":"flags","title":"flags"},{"children":[{"id":"set-key-specifications","title":"SET key specifications"},{"id":"zunion-key-specifications","title":"ZUNION key specifications"}],"id":"examples","title":"Examples"}]}
...
It can continue using the legacy _first key_, _last key_ and _step_ scheme along with the [_movablekeys_ flag]() that remain unchanged.
