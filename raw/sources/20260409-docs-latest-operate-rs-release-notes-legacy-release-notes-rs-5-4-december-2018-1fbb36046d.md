...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-december-2018/
retrieved_utc: '2026-04-09T20:46:00.073997+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-december-2018/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"redis-50-ga-redis-streams","title":"Redis 5.0 GA - Redis Streams"},{"id":"redis-graph-module","title":"Redis graph module"},{"id":"active-active-redis-crdb-creation-in-non-clustering-mode-activeactive-redis-crdb-creation-in-nonclustering-mode","title":"Active-Active Redis (CRDB) - Creation in non-clustering mode {#activeactive-redis-crdb-creation-in-nonclustering-mode}"},{"id":"high-availability-for-replica-shards","title":"High availability for replica shards"}],"id":"new-features","title":"New features"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"product-version-lifecycle","title":"Product version lifecycle"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"installation","title":"Installation"},{"id":"upgrade","title":"Upgrade"},{"id":"cluster-api","title":"Cluster API"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
1. Non-clustering mode - Creates a CRDB that consists of one shard only in a non-clustering mode so that [multi-key command limitations]() do not apply.

### High availability for replica shards

When [replica high availability]() is enabled and a master shard fails, a replica (formerly _slave_) shard is automatically promoted to a master shard to maintain data availability. This creates a single point of failure until a new replica shard is manually created.
