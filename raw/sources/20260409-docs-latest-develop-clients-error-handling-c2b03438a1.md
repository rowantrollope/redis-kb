...
retrieved_utc: '2026-04-09T20:45:57.854431+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/error-handling/index.html.md
---
...
```json metadata
{
  ...
  "relatedPages": ["/develop/clients/redis-py/error-handling","/develop/clients/dotnet/error-handling","/develop/clients/nodejs/error-handling","/develop/clients/jedis/error-handling","/develop/clients/go/error-handling"],
  "scope": "overview",
  "tableOfContents": {"sections":[{"children":[{"id":"connection-errors","title":"Connection errors"},{"id":"command-errors","title":"Command errors"},{"id":"data-errors","title":"Data errors"},{"id":"resource-errors","title":"Resource errors"}],"id":"categories-of-errors","title":"Categories of errors"},{"children":[{"id":"pattern-1-fail-fast","title":"Pattern 1: Fail fast"},{"id":"pattern-2-graceful-degradation","title":"Pattern 2: Graceful degradation"},{"id":"pattern-3-retry-with-backoff","title":"Pattern 3: Retry with backoff"},{"id":"pattern-4-log-and-continue","title":"Pattern 4: Log and continue"}],"id":"error-handling-patterns","title":"Error handling patterns"},{"id":"decision-tree-how-to-handle-errors","title":"Decision tree: How to handle errors"},{"children":[{"id":"what-to-log","title":"What to log"},{"id":"what-to-monitor","title":"What to monitor"}],"id":"logging-and-monitoring","title":"Logging and monitoring"},{"children":[{"id":"catching-all-exceptions","title":"Catching all exceptions"},{"id":"not-distinguishing-error-types","title":"Not distinguishing error types"},{"id":"ignoring-connection-pool-errors","title":"Ignoring connection pool errors"}],"id":"common-mistakes","title":"Common mistakes"},{"id":"client-specific-error-handling","title":"Client-specific error handling"}]}
...
information for you (see [Observability]()
