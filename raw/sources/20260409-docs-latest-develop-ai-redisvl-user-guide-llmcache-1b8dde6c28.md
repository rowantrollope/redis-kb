---
title: LLM Caching
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/llmcache/
retrieved_utc: '2026-04-09T20:45:52.670839+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/llmcache/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"id":"initializing-semanticcache","title":"Initializing `SemanticCache`"},{"id":"basic-cache-usage","title":"Basic Cache Usage"},{"id":"customize-the-distance-threshold","title":"Customize the Distance Threshold"},{"id":"utilize-ttl","title":"Utilize TTL"},{"id":"simple-performance-testing","title":"Simple Performance Testing"},{"id":"cache-access-controls-tags-filters","title":"Cache Access Controls, Tags \u0026 Filters"}]}
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  3.79it/s]
...
```
    ...
    âââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¼ââââââââââââââââââ¤
    â prompt          â prompt          â TEXT            â WEIGHT          â 1               â                 â                 â                 â                 â                 â                 â
    â response        â response        â TEXT            â WEIGHT          â 1               â                 â                 â                 â                 â                 â                 â
    â inserted_at     â inserted_at     â NUMERIC         â                 â                 â                 â                 â                 â                 â                 â                 â
    â updated_at      â updated_at      â NUMERIC         â                 â                 â                 â                 â                 â                 â                 â                 â
    â prompt_vector   â prompt_vector   â VECTOR          â algorithm       â FLAT            â data_type       â FLOAT32         â dim             â 768             â distance_metric â COSINE          â
    â°ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ´ââââââââââââââââââ¯
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  7.79it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 19.62it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 18.65it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  7.81it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  8.37it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.23it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  8.53it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 12.54it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  8.09it/s]
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 12.93it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 20.90it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.24it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.85it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.98it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.65it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.65it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.84it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 20.67it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.08it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.14it/s]
...
```
    ...
    â num_terms                   â 19         â
    â max_doc_id                  â 3          â
    â num_records                 â 29         â
    â percent_indexed             â 1          â
    â hash_indexing_failures      â 0          â
    â number_of_uses              â 19         â
    â bytes_per_record_avg        â 75.9655151 â
    â doc_table_size_mb           â 1.34468078 â
    â inverted_sz_mb              â 0.00210094 â
    â key_table_size_mb           â 2.76565551 â
    â offset_bits_per_record_avg  â 8          â
    â offset_vectors_sz_mb        â 2.09808349 â
    â offsets_per_term_avg        â 0.75862067 â
    â records_per_doc_avg         â 29         â
    â sortable_values_size_mb     â 0          â
    â total_indexing_time         â 14.3260002 â
    â total_inverted_index_blocks â 21         â
    â vector_index_sz_mb          â 3.01609802 â
    â°ââââââââââââââââââââââââââââââ´âââââââââââââ¯
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 17.15it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.23it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.71it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.36it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.08it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  8.74it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  8.01it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.70it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 16.74it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 19.91it/s]
