...
url: https://redis.io/docs/latest/operate/rs/security/certificates/ocsp-stapling/
retrieved_utc: '2026-04-09T20:45:57.839337+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/certificates/ocsp-stapling/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"ocsp-stapling-overview","title":"OCSP stapling overview"},{"children":[{"id":"cluster-manager-ui-method","title":"Cluster Manager UI method"},{"id":"rest-api-method","title":"REST API method"},{"id":"rladmin-method","title":"rladmin method"}],"id":"set-up-ocsp-stapling","title":"Set up OCSP stapling"}]}
...
1. Update the cluster's OCSP settings with the [`rladmin cluster ocsp config`]() command if you don't want to use their default values.
