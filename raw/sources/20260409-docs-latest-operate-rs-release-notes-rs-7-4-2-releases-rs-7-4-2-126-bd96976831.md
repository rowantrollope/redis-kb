...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-126/
retrieved_utc: '2026-04-09T20:45:59.080733+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-126/index.html.md
---
...
- New Cluster Manager UI enhancements:
    ...
    - You can choose the Redis database version during [database creation]().
...
| RHEL 7 &<br />compatible distros<sup>[1](#table-note-1)</sup> | â | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
