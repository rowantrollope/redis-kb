...
url: https://redis.io/docs/latest/operate/rc/security/aws-privatelink/
retrieved_utc: '2026-04-09T20:45:59.601649+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/security/aws-privatelink/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"limitations","title":"Limitations"},{"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"associate-redis-cloud-resource-share-with-a-principal-associate-resource-share","title":"Associate Redis Cloud resource share with a principal {#associate-resource-share}"},{"id":"add-a-connection-add-connection","title":"Add a connection {#add-connection}"}],"id":"set-up-privatelink-connection","title":"Set up PrivateLink connection"},{"id":"connect-to-your-database-and-metrics-endpoint-with-privatelink","title":"Connect to your database and metrics endpoint with PrivateLink"},{"id":"disassociate-connection","title":"Disassociate connection"}]}
...
- You cannot use the [OSS Cluster API]() with PrivateLink yet. Support for the OSS Cluster API will be supported in the near future.
