...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-2-4-releases/
retrieved_utc: '2026-04-09T20:46:00.858498+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-2-4-releases/index.html.md
---
...
Pay particular attention to the [cluster recovery limitation]() if you use manually uploaded modules.
