...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-12-january-2021/
retrieved_utc: '2026-04-09T20:45:59.493454+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-12-january-2021/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"upgrade-instructions","title":"Upgrade instructions"},{"id":"product-lifecycle-information","title":"Product lifecycle information"},{"id":"deprecation-notice","title":"Deprecation Notice"}],"id":"version-information","title":"Version information"},{"id":"new-features","title":"New Features"},{"id":"redis-modules","title":"Redis modules"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"installation-limitations","title":"Installation limitations"}],"id":"known-limitations","title":"Known limitations"}]}
...
- [Synchronization](#syncer-process) can now be [distributed across the nodes]() of Active-Active or Active-Passive databases
...
- Automatic recovery of the [syncer process](#syncer-process)s from out-of-memory (preview mode)
...
1. Enable the syncer automatic recovery using the REST API:
    ...
    ```sh
    curl -v -k -u <username>:<password> -X PUT -H "Content-Type: application/json" -d â{crdt_syncer_auto_oom_unlatch":true}â http://<cluster_address>:8080/v1/bdbs/<database_ID>
    ```
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [2.0.6]()
- [RedisJSON](https://redislabs.com/redis-enterprise/redis-json/), version [1.0.4]()
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.2.11]()
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.4.7]()
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.4]()
...
- RS51144 - Fixed a bug in the syncer process that was stopping synchronization between all instances in some scenarios of network disconnection of one or more participatingÂ clusters.
