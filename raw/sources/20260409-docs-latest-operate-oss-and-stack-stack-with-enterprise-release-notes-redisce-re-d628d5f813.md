...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.2-release-notes/
retrieved_utc: '2026-04-09T20:45:58.760682+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.2-release-notes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"security-fixes","title":"Security fixes"}],"id":"redis-open-source-825-february-2026","title":"Redis Open Source 8.2.5 (February 2026)"},{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"performance-and-resource-utilization-improvements","title":"Performance and resource utilization improvements"},{"id":"metrics","title":"Metrics"},{"id":"configuration-parameters","title":"Configuration parameters"}],"id":"redis-open-source-824-february-2026","title":"Redis Open Source 8.2.4 (February 2026)"},{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"bug-fixes","title":"Bug fixes"}],"id":"redis-open-source-823-november-2025","title":"Redis Open Source 8.2.3 (November 2025)"},{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"new-features","title":"New Features"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"performance-and-resource-utilization","title":"Performance and resource utilization"},{"id":"metrics","title":"Metrics"}],"id":"redis-open-source-822-october-2025","title":"Redis Open Source 8.2.2 (October 2025)"},{"children":[{"id":"bug-fixes","title":"Bug fixes"},{"id":"performance-and-resource-utilization","title":"Performance and resource utilization"}],"id":"redis-open-source-821-august-2025","title":"Redis Open Source 8.2.1 (August 2025)"},{"children":[{"id":"headlines","title":"Headlines"},{"id":"major-changes-compared-to-80","title":"Major changes compared to 8.0"},{"id":"binary-distributions","title":"Binary distributions"},{"id":"redis-800-was-tested-on-the-following-operating-systems","title":"Redis 8.0.0 was tested on the following operating systems"},{"id":"security-fixes-compared-to-82-rc1","title":"Security fixes (compared to 8.2-RC1)"},{"id":"new-features-compared-to-82-rc1","title":"New Features (compared to 8.2-RC1)"},{"id":"bug-fixes-compared-to-82-rc1","title":"Bug fixes (compared to 8.2-RC1)"},{"id":"performance-and-resource-utilization-improvements-compared-to-82-rc1","title":"Performance and resource utilization improvements (compared to 8.2-RC1)"},{"id":"modules-api","title":"Modules API"}],"id":"redis-open-source-82-august-2025","title":"Redis Open Source 8.2 (August 2025)"},{"children":[{"id":"headlines","title":"Headlines"},{"id":"security-fixes-compared-to-82-m01","title":"Security fixes (compared to 8.2-M01)"},{"id":"new-features-compared-to-82-m01","title":"New Features (compared to 8.2-M01)"},{"id":"bug-fixes-compared-to-82-m01","title":"Bug fixes (compared to 8.2-M01)"},{"id":"performance-and-resource-utilization-improvements-compared-to-82-m01","title":"Performance and resource utilization improvements (compared to 8.2-M01)"},{"id":"metrics","title":"Metrics"}],"id":"redis-open-source-82-rc1-july-2025","title":"Redis Open Source 8.2-RC1 (July 2025)"}]}
...
- [#J1374](https://github.com/RedisJSON/RedisJSON/issues/1374) `JSON.DEL` doesnât delete all matching object members / array elements (MOD-11032, MOD-11067)
...
- [#14074](https://github.com/redis/redis/pull/14074) Reduce the overhead associated with tracking `malloc`âs usable memory.
- [#13900](https://github.com/redis/redis/pull/13900) Optimize the clientâs cron to avoid blocking the main thread.
