...
url: https://redis.io/docs/latest/develop/clients/dotnet/vecsearch/
retrieved_utc: '2026-04-09T20:45:57.159238+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/dotnet/vecsearch/index.html.md
---
...
```json metadata
{
  ...
  "relatedPages": ["/develop/clients/dotnet/queryjson","/develop/clients/dotnet/vecsets","/develop/ai/search-and-query"],
  "scope": "example",
  "tableOfContents": {"sections":[{"id":"initialize","title":"Initialize"},{"id":"import-dependencies","title":"Import dependencies"},{"id":"define-a-function-to-obtain-the-embedding-model","title":"Define a function to obtain the embedding model"},{"id":"define-a-function-to-generate-an-embedding","title":"Define a function to generate an embedding"},{"id":"generate-an-embedding-from-azure-openai","title":"Generate an embedding from Azure OpenAI"},{"id":"create-the-index","title":"Create the index"},{"id":"add-data","title":"Add data"},{"id":"run-a-query","title":"Run a query"},{"id":"declare-textdata-and-transformedtextdata","title":"Declare TextData and TransformedTextData"},{"id":"run-the-code","title":"Run the code"},{"id":"differences-with-json-documents","title":"Differences with JSON documents"},{"id":"learn-more","title":"Learn more"}]}
...
when you add them with [`HashSet()`](), as long as
