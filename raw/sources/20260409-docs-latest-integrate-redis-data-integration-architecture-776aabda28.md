---
title: Architecture
url: https://redis.io/docs/latest/integrate/redis-data-integration/architecture/
retrieved_utc: '2026-04-09T20:45:56.189179+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/architecture/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"at-least-once-delivery-guarantee","title":"At-least-once delivery guarantee"},{"id":"checkpointing","title":"Checkpointing"},{"id":"backpressure-mechanism","title":"Backpressure mechanism"},{"id":"supported-sources","title":"Supported sources"},{"children":[{"id":"rdi-on-your-own-vms","title":"RDI on your own VMs"},{"id":"rdi-on-kubernetes","title":"RDI on Kubernetes"},{"id":"secrets-and-security-considerations","title":"Secrets and security considerations"}],"id":"how-rdi-is-deployed","title":"How RDI is deployed"}]}
