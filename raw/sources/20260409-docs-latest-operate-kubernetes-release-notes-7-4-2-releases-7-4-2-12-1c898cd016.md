...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-2-releases/7-4-2-12/
retrieved_utc: '2026-04-09T20:45:53.382050+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-4-2-releases/7-4-2-12/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"enhancements","title":"Enhancements"},{"id":"resolved-issues","title":"Resolved issues"},{"id":"api-changes","title":"API changes"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"supported-distributions","title":"Supported distributions"}],"id":"version-changes","title":"Version changes"},{"children":[{"id":"openshift-images","title":"OpenShift images"},{"id":"olm-bundle","title":"OLM bundle"}],"id":"downloads","title":"Downloads"},{"children":[{"id":"new-limitations","title":"New limitations"},{"id":"existing-limitations","title":"Existing limitations"}],"id":"known-limitations","title":"Known limitations"}]}
...
For a list of fixes related to CVEs, see the [Redis Enterprise 7.4.2-129 release notes]().
...
- **The REDB "redisVersion" field canât be used for memcached databases(RED-119152)**
