...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-10-81/
retrieved_utc: '2026-04-09T20:45:59.973913+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-8-0-releases/rs-8-0-10-81/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"enhancements","title":"Enhancements"},{"id":"redis-database-versions","title":"Redis database versions"},{"id":"redis-feature-sets","title":"Redis feature sets"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"known-issues","title":"Known issues"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
- Added license information to [usage reports](), including activation date, expiration date, shard limits, and shard usage.
