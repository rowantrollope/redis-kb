...
url: https://redis.io/docs/latest/operate/rs/networking/cluster-dns/
retrieved_utc: '2026-04-09T20:46:03.434610+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/networking/cluster-dns/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"cluster-name-and-connection-management","title":"Cluster name and connection management"},{"id":"url-based-connections","title":"URL-based connections"},{"children":[{"id":"define-domain-using-dns","title":"Define domain using DNS"},{"id":"zero-configuration-using-mdns-zeroconfiguration-using-mdns-development-option-only","title":"Zero-configuration using mDNS {#zeroconfiguration-using-mdns-development-option-only}"}],"id":"identify-the-cluster","title":"Identify the cluster"},{"id":"ip-based-connections","title":"IP-based connections"}]}
