...
retrieved_utc: '2026-04-09T20:45:54.044457+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/write-behind/configuration-guide/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"children":[{"id":"for-relational-datastores","title":"For relational datastores"},{"id":"for-non-relational-datastores","title":"For non-relational datastores"}],"id":"overview","title":"Overview"},{"children":[{"id":"account-permissions","title":"Account permissions"},{"id":"sql-server-authentication","title":"SQL Server authentication"},{"id":"windows-authentication","title":"Windows authentication"}],"id":"microsoft-sql-server","title":"Microsoft SQL Server"}]}
