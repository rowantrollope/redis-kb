...
url: https://redis.io/docs/latest/commands/redis-6-2-commands/
retrieved_utc: '2026-04-09T20:45:53.482786+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/redis-6-2-commands/index.html.md
---
...
<details>
<summary><strong><a href="/commands/getdel/">GETDEL</a></strong> - Returns the string value of a key after deleting the key. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/getex/">GETEX</a></strong> - Returns the string value of a key after setting its expiration time. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `GETEX key [EXÂ seconds | PXÂ milliseconds | EXATÂ unix-time-seconds |
...
**Syntax:** `SET key value [NX | XX | IFEQÂ ifeq-value | IFNEÂ ifne-value |
...
<details>
<summary><strong><a href="/commands/hrandfield/">HRANDFIELD</a></strong> - Returns one or more random fields from a hash. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `HSCAN key cursor [MATCHÂ pattern] [COUNTÂ count] [NOVALUES]`
...
<details>
<summary><strong><a href="/commands/blmove/">BLMOVE</a></strong> - Pops an element from a list, pushes it to another list and returns it. Blocks until an element is available otherwise. Deletes the list if the last element was moved. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/lmove/">LMOVE</a></strong> - Returns an element after popping it from one list and pushing it to another. Deletes the list if the last element was moved. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `LPOS key element [RANKÂ rank] [COUNTÂ num-matches] [MAXLENÂ len]`
...
<details>
<summary><strong><a href="/commands/smismember/">SMISMEMBER</a></strong> - Determines whether multiple members belong to a set. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `SSCAN key cursor [MATCHÂ pattern] [COUNTÂ count]`
...
<details>
<summary><strong><a href="/commands/zdiff/">ZDIFF</a></strong> - Returns the difference between multiple sorted sets. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/zdiffstore/">ZDIFFSTORE</a></strong> - Stores the difference of multiple sorted sets in a key. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/zinter/">ZINTER</a></strong> - Returns the intersect of multiple sorted sets. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `ZINTER numkeys key [key ...] [WEIGHTSÂ weight [weight ...]]
...
**Syntax:** `ZINTERSTORE destination numkeys key [key ...] [WEIGHTSÂ weight
...
<details>
<summary><strong><a href="/commands/zmscore/">ZMSCORE</a></strong> - Returns the score of one or more members in a sorted set. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/zrandmember/">ZRANDMEMBER</a></strong> - Returns one or more random members from a sorted set. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `ZRANGE key start stop [BYSCORE | BYLEX] [REV] [LIMITÂ offset count]
  [WITHSCORES]`
...
**Syntax:** `ZRANGEBYLEX key min max [LIMITÂ offset count]`
...
**Syntax:** `ZRANGEBYSCORE key min max [WITHSCORES] [LIMITÂ offset count]`
...
<details>
<summary><strong><a href="/commands/zrangestore/">ZRANGESTORE</a></strong> - Stores a range of members from sorted set in a key. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `ZRANGESTORE dst src min max [BYSCORE | BYLEX] [REV] [LIMITÂ offset
  count]`
...
**Syntax:** `ZREVRANGEBYLEX key max min [LIMITÂ offset count]`
...
**Syntax:** `ZREVRANGEBYSCORE key max min [WITHSCORES] [LIMITÂ offset count]`
...
**Syntax:** `ZSCAN key cursor [MATCHÂ pattern] [COUNTÂ count]`
...
<details>
<summary><strong><a href="/commands/zunion/">ZUNION</a></strong> - Returns the union of multiple sorted sets. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `ZUNION numkeys key [key ...] [WEIGHTSÂ weight [weight ...]]
  [AGGREGATEÂ <SUM | MIN | MAX>] [WITHSCORES]`
...
**Syntax:** `ZUNIONSTORE destination numkeys key [key ...] [WEIGHTSÂ weight
  [weight ...]] [AGGREGATEÂ <SUM | MIN | MAX>]`
...
**Syntax:** `XADD key [NOMKSTREAM] [KEEPREF | DELREF | ACKED] [<MAXLEN | MINID>
  [= | ~] threshold [LIMITÂ count]] <* | id> field value [field value
  ...]`
...
<details>
<summary><strong><a href="/commands/xautoclaim/">XAUTOCLAIM</a></strong> - Changes, or acquires, ownership of messages in a consumer group, as if the messages were delivered to as consumer group member. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `XAUTOCLAIM key group consumer min-idle-time start [COUNTÂ count]
  [JUSTID]`
...
**Syntax:** `XCLAIM key group consumer min-idle-time id [id ...] [IDLEÂ ms]
  [TIMEÂ unix-time-milliseconds] [RETRYCOUNTÂ count] [FORCE] [JUSTID]
  [LASTIDÂ lastid]`
...
<details>
<summary><strong><a href="/commands/xgroup-createconsumer/">XGROUP CREATECONSUMER</a></strong> - Creates a consumer in a consumer group. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `XGROUP SETID key group <id | $> [ENTRIESREADÂ entries-read]`
...
**Syntax:** `XINFO STREAM key [FULL [COUNTÂ count]]`
...
**Syntax:** `XPENDING key group [[IDLEÂ min-idle-time] start end count [consumer]]`
...
**Syntax:** `XRANGE key start end [COUNTÂ count]`
...
**Syntax:** `XREAD [COUNTÂ count] [BLOCKÂ milliseconds] STREAMSÂ key [key ...] id
  [id ...]`
...
**Syntax:** `XREADGROUP GROUPÂ group consumer [COUNTÂ count] [BLOCKÂ milliseconds]
  [CLAIMÂ min-idle-time] [NOACK] STREAMSÂ key [key ...] id [id ...]`
...
**Syntax:** `XREVRANGE key end start [COUNTÂ count]`
...
**Syntax:** `XSETID key last-id [ENTRIESADDEDÂ entries-added]
...
**Syntax:** `XTRIM key <MAXLEN | MINID> [= | ~] threshold [LIMITÂ count] [KEEPREF
  | DELREF | ACKED]`
...
**Syntax:** `BITFIELD key [GETÂ encoding offset | [OVERFLOWÂ <WRAP | SAT | FAIL>]
  <SETÂ encoding offset value | INCRBYÂ encoding offset increment>
  [GETÂ encoding offset | [OVERFLOWÂ <WRAP | SAT | FAIL>]
  <SETÂ encoding offset value | INCRBYÂ encoding offset increment>
  ...]]`
...
**Syntax:** `BITFIELD RO key [GETÂ encoding offset [GET encoding offset ...]]`
...
<details>
<summary><strong><a href="/commands/geosearch/">GEOSEARCH</a></strong> - Queries a geospatial index for members inside an area of a box or a circle. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `GEOSEARCH key <FROMMEMBERÂ member | FROMLONLATÂ longitude latitude>
  <BYRADIUSÂ radius <M | KM | FT | MI> | BYBOXÂ width height <M | KM |
  FT | MI>> [ASC | DESC] [COUNTÂ count [ANY]] [WITHCOORD] [WITHDIST]
  [WITHHASH]`
...
<details>
<summary><strong><a href="/commands/geosearchstore/">GEOSEARCHSTORE</a></strong> - Queries a geospatial index for members inside an area of a box or a circle, optionally stores the result. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `GEOSEARCHSTORE destination source <FROMMEMBERÂ member |
...
**Syntax:** `JSON.GET key [INDENTÂ indent] [NEWLINEÂ newline] [SPACEÂ space] [path
  [path ...]]`
...
**Syntax:** `FT.AGGREGATE index query [VERBATIM] [LOADÂ count field [field ...]]
  [TIMEOUTÂ timeout] [LOAD *] [GROUPBYÂ nargs property [property ...]
  [REDUCEÂ function nargs arg [arg ...] [ASÂ name] [REDUCEÂ function
  nargs arg [arg ...] [ASÂ name] ...]] [GROUPBYÂ nargs property
  [property ...] [REDUCEÂ function nargs arg [arg ...] [ASÂ name]
  [REDUCEÂ function nargs arg [arg ...] [ASÂ name] ...]] ...]]
  [SORTBYÂ nargs [property <ASC | DESC> [property <ASC | DESC> ...]]
  [MAXÂ num]] [APPLYÂ expression ASÂ name [APPLYÂ expression ASÂ name
  ...]] [LIMIT offset num] [FILTERÂ filter] [WITHCURSOR
  [COUNTÂ read size] [MAXIDLEÂ idle time]] [PARAMS nargs name value
  [name value ...]]
  [SCORER scorer]
 [ADDSCORES]
  [DIALECTÂ dialect]`
...
**Syntax:** `FT.CREATE index [ONÂ <HASH | JSON>] [PREFIXÂ count prefix [prefix
  ...]] [FILTERÂ filter] [LANGUAGEÂ default lang]
  [LANGUAGE FIELDÂ lang attribute] [SCOREÂ default score]
  [SCORE FIELDÂ score attribute] [PAYLOAD FIELDÂ payload attribute]
  [MAXTEXTFIELDS] [TEMPORARYÂ seconds] [NOOFFSETS] [NOHL] [NOFIELDS]
  [NOFREQS] [STOPWORDSÂ count [stopword [stopword ...]]]
  [SKIPINITIALSCAN] SCHEMA field name [ASÂ alias] <TEXT | TAG |
  NUMERIC | GEO | VECTOR> [WITHSUFFIXTRIE] [SORTABLE [UNF]]
  [NOINDEX] [field name [ASÂ alias] <TEXT | TAG | NUMERIC | GEO |
...
**Syntax:** `FT.CURSOR READ index cursor id [COUNTÂ read size]`
...
**Syntax:** `FT.EXPLAIN index query [DIALECTÂ dialect]`
...
**Syntax:** `FT.EXPLAINCLI index query [DIALECTÂ dialect]`
...
**Syntax:** `FT.SEARCH index query [NOCONTENT] [VERBATIM] [NOSTOPWORDS]
  [WITHSCORES] [WITHPAYLOADS] [WITHSORTKEYS] [FILTERÂ numeric field
  min max [FILTERÂ numeric field min max ...]] [GEOFILTERÂ geo field
  lon lat radius <m | km | mi | ft> [GEOFILTERÂ geo field lon lat
  radius <m | km | mi | ft> ...]] [INKEYSÂ count key [key ...]]
  [INFIELDSÂ count field [field ...]] [RETURNÂ count identifier
  [ASÂ property] [identifier [ASÂ property] ...]] [SUMMARIZE
  [FIELDSÂ count field [field ...]] [FRAGSÂ num] [LENÂ fragsize]
  [SEPARATORÂ separator]] [HIGHLIGHT [FIELDSÂ count field [field ...]]
  [TAGS open close]] [SLOPÂ slop] [TIMEOUTÂ timeout] [INORDER]
  [LANGUAGEÂ language] [EXPANDERÂ expander] [SCORERÂ scorer]
  [EXPLAINSCORE] [PAYLOADÂ payload] [SORTBYÂ sortby [ASC | DESC]]
...
**Syntax:** `FT.SPELLCHECK index query [DISTANCEÂ distance] [TERMSÂ <INCLUDE |
...
**Syntax:** `TS.ADD key timestamp value [RETENTIONÂ retentionPeriod]
  [ENCODINGÂ <COMPRESSED | UNCOMPRESSED>] [CHUNK SIZEÂ size]
  [DUPLICATE POLICYÂ policy] 
  [ON DUPLICATEÂ <BLOCK | FIRST | LAST | MIN | MAX | SUM>]
...
**Syntax:** `TS.ALTER key [RETENTIONÂ retentionPeriod] [CHUNK SIZEÂ size]
  [DUPLICATE POLICYÂ <BLOCK | FIRST | LAST | MIN | MAX | SUM>]
  [IGNORE ignoreMaxTimediff ignoreMaxValDiff] 
  [LABELS [label value ...]]`
...
**Syntax:** `TS.CREATE key [RETENTIONÂ retentionPeriod] [ENCODINGÂ <COMPRESSED |
  UNCOMPRESSED>] [CHUNK SIZEÂ size] [DUPLICATE POLICYÂ <BLOCK | FIRST |
  LAST | MIN | MAX | SUM>]
  [IGNOREÂ ignoreMaxTimediffÂ ignoreMaxValDiff]
  [LABELSÂ [label value ...]]`
...
**Syntax:** `TS.CREATERULE sourceKey destKey AGGREGATIONÂ <AVG | FIRST | LAST |
...
**Syntax:** `TS.DECRBY key value [TIMESTAMPÂ timestamp]
  [RETENTIONÂ retentionPeriod] [ENCODINGÂ <COMPRESSED|UNCOMPRESSED>] [CHUNK SIZEÂ size]
 [DUPLICATE POLICYÂ policy] [LABELSÂ [label value ...]]`
...
**Syntax:** `TS.INCRBY key value [TIMESTAMPÂ timestamp]
  [RETENTIONÂ retentionPeriod] [ENCODINGÂ <COMPRESSED|UNCOMPRESSED>] [CHUNK SIZEÂ size]
 [DUPLICATE POLICYÂ policy] [LABELSÂ [label value ...]]`
...
**Syntax:** `TS.MGET [LATEST] [WITHLABELS | <SELECTED LABELS label1 [label1 ...]>]
  FILTERÂ <l=v | l!=v | l= | l!= | l=(v1,v2,...) | l!=(v1,v2,...)
...
**Syntax:** `TS.MRANGE fromTimestamp toTimestamp [LATEST] [FILTER BY TSÂ Timestamp
  [Timestamp ...]] [FILTER BY VALUE min max] [WITHLABELS |
  <SELECTED LABELS label1 [label1 ...]>] [COUNTÂ count] [[ALIGNÂ value]
  AGGREGATIONÂ <AVG | FIRST | LAST | MIN | MAX | SUM | RANGE | COUNT
  | STD.P | STD.S | VAR.P | VAR.S | TWA> bucketDuration
  [BUCKETTIMESTAMP] [EMPTY]] FILTERÂ <l=v | l!=v | l= | l!= |
...
**Syntax:** `TS.MREVRANGE fromTimestamp toTimestamp [LATEST]
  [FILTER BY TSÂ Timestamp [Timestamp ...]] [FILTER BY VALUE min max]
  [WITHLABELS | <SELECTED LABELS label1 [label1 ...]>] [COUNTÂ count]
  [[ALIGNÂ value] AGGREGATIONÂ <AVG | FIRST | LAST | MIN | MAX | SUM |
  RANGE | COUNT | STD.P | STD.S | VAR.P | VAR.S | TWA>
  bucketDuration [BUCKETTIMESTAMP] [EMPTY]] FILTERÂ <l=v | l!=v | l=
...
**Syntax:** `TS.RANGE key fromTimestamp toTimestamp [LATEST]
  [FILTER BY TSÂ Timestamp [Timestamp ...]] [FILTER BY VALUE min max]
  [COUNTÂ count] [[ALIGNÂ value] AGGREGATIONÂ <AVG | FIRST | LAST | MIN
...
<details>
<summary><strong><a href="/commands/client-info/">CLIENT INFO</a></strong> - Returns information about the connection. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `CLIENT KILL <ip:port | <[IDÂ client-id] | [TYPEÂ <NORMAL | MASTER |
...
**Syntax:** `CLIENT LIST [TYPEÂ <NORMAL | MASTER | REPLICA | PUBSUB>]
...
**Syntax:** `CLIENT TRACKING <ON | OFF> [REDIRECTÂ client-id] [PREFIXÂ prefix
...
<details>
<summary><strong><a href="/commands/client-trackinginfo/">CLIENT TRACKINGINFO</a></strong> - Returns information about server-assisted client-side caching for the connection. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/client-unpause/">CLIENT UNPAUSE</a></strong> - Resumes processing commands from paused clients. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
**Syntax:** `HELLO [protover [AUTHÂ username password] [SETNAMEÂ clientname]]`
...
<details>
<summary><strong><a href="/commands/reset/">RESET</a></strong> - Resets the connection. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>
...
<details>
<summary><strong><a href="/commands/failover/">FAILOVER</a></strong> - Starts a coordinated failover from a server to one of its replicas. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `FAILOVER [TOÂ host port [FORCE]] [ABORT] [TIMEOUTÂ milliseconds]`
...
**Syntax:** `LOLWUT [VERSIONÂ version]`
...
**Syntax:** `MEMORY USAGE key [SAMPLESÂ count]`
...
**Syntax:** `CLUSTER SETSLOT slot <IMPORTINGÂ node-id | MIGRATINGÂ node-id |
  NODEÂ node-id | STABLE>`
...
<details>
<summary><strong><a href="/commands/copy/">COPY</a></strong> - Copies the value of a key to a new key. <span style="color: #e74c3c;">â­ New in 6.2</span></summary>

**Syntax:** `COPY source destination [DBÂ destination-db] [REPLACE]`
...
**Syntax:** `MIGRATE host port <key | ""> destination-db timeout [COPY] [REPLACE]
  [AUTHÂ password | AUTH2Â username password] [KEYSÂ key [key ...]]`
...
**Syntax:** `SCAN cursor [MATCHÂ pattern] [COUNTÂ count] [TYPEÂ type]`
...
**Syntax:** `SORT key [BYÂ pattern] [LIMITÂ offset count] [GETÂ pattern [GET pattern
  ...]] [ASC | DESC] [ALPHA] [STOREÂ destination]`
