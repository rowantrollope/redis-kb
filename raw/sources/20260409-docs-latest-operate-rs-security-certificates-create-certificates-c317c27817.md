...
url: https://redis.io/docs/latest/operate/rs/security/certificates/create-certificates/
retrieved_utc: '2026-04-09T20:45:54.108169+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/certificates/create-certificates/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"generate-self-signed-certs-script-options","title":"Generate self-signed certs script options"},{"id":"step-1-generate-new-certificates","title":"Step 1: Generate new certificates"},{"id":"step-2-locate-the-new-certificate-files","title":"Step 2: Locate the new certificate files"},{"id":"step-3-set-permissions","title":"Step 3: Set permissions"},{"id":"step-4-replace-existing-certificates-replace-self-signed","title":"Step 4: Replace existing certificates {#replace-self-signed}"}],"id":"renew-self-signed-certificates","title":"Renew self-signed certificates"},{"children":[{"id":"tls-certificate-guidelines","title":"TLS certificate guidelines"},{"id":"create-certificates","title":"Create certificates"}],"id":"create-ca-signed-certificates","title":"Create CA-signed certificates"}]}
