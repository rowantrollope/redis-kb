...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/peer_stats/
retrieved_utc: '2026-04-09T20:46:06.115296+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/peer_stats/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"}],"id":"get-all-crdb-peer-stats-get-all-bdbs-peerstats","title":"Get all CRDB peer stats {#get-all-bdbs-peer_stats}"},{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-crdb-peer-stats-get-bdbs-peerstats","title":"Get CRDB peer stats {#get-bdbs-peer_stats}"}]}
