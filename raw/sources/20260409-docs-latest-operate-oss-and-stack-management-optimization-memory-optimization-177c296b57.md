...
retrieved_utc: '2026-04-09T20:45:51.725347+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/memory-optimization/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"redis-62","title":"Redis \u003c= 6.2"},{"id":"redis-70","title":"Redis \u003e= 7.0"},{"id":"redis-72","title":"Redis \u003e= 7.2"}],"id":"special-encoding-of-small-aggregate-data-types","title":"Special encoding of small aggregate data types"},{"id":"using-32-bit-instances","title":"Using 32-bit instances"},{"id":"bit-and-byte-level-operations","title":"Bit and byte level operations"},{"id":"use-hashes-when-possible","title":"Use hashes when possible"},{"id":"using-hashes-to-abstract-a-very-memory-efficient-plain-key-value-store-on-top-of-redis","title":"Using hashes to abstract a very memory-efficient plain key-value store on top of Redis"},{"id":"memory-allocation","title":"Memory allocation"}]}
