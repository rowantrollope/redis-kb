...
url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/node/snapshot/
retrieved_utc: '2026-04-09T20:46:07.591541+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/cli-utilities/rladmin/node/snapshot/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"node-snapshot-create","title":"node snapshot create"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"node-snapshot-delete","title":"node snapshot delete"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"node-snapshot-list","title":"node snapshot list"},{"children":[{"id":"parameters","title":"Parameters"},{"id":"returns","title":"Returns"},{"id":"example","title":"Example"}],"id":"node-snapshot-restore","title":"node snapshot restore"}]}
