...
url: https://redis.io/docs/latest/integrate/uptrace-with-redis-enterprise/
retrieved_utc: '2026-04-09T20:45:53.664819+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/uptrace-with-redis-enterprise/index.html.md
---
...
{
  "title": "Uptrace with Redis Software",
  "description": "To collect, view, and monitor metrics data from your databases and other cluster components, you can connect Uptrace to your Redis Software cluster using OpenTelemetry Collector.",
  "categories": ["docs","integrate","rs"],
  "group": "observability",
  "tableOfContents": {"sections":[{"id":"install-collector-and-uptrace","title":"Install Collector and Uptrace"},{"id":"scrape-prometheus-metrics","title":"Scrape Prometheus metrics"},{"id":"view-metrics","title":"View metrics"},{"id":"monitor-metrics","title":"Monitor metrics"}]}
