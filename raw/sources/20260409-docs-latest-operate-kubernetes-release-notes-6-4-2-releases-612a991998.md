...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/
retrieved_utc: '2026-04-09T20:46:00.958028+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"supported-upgrade-paths","title":"Supported upgrade paths"},{"id":"openshift-versions-6212-or-earlier","title":"OpenShift versions 6.2.12 or earlier"},{"id":"large-clusters","title":"Large clusters"}],"id":"before-upgrading","title":"Before upgrading"},{"id":"security","title":"Security"}]}
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2 release notes]().
