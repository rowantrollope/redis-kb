...
url: https://redis.io/docs/latest/develop/clients/lettuce/amr/
retrieved_utc: '2026-04-09T20:45:52.120454+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/lettuce/amr/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install","title":"Install"},{"children":[{"id":"configuration-for-a-service-principal-serv-principal","title":"Configuration for a service principal {#serv-principal}"},{"id":"configuration-for-a-managed-identity-mgd-identity","title":"Configuration for a managed identity {#mgd-identity}"}],"id":"create-a-tokenbasedrediscredentialsprovider-instance","title":"Create a TokenBasedRedisCredentialsProvider instance"},{"id":"connect-using-the-withauthentication-option","title":"Connect using the withAuthentication() option"}]}
...
[TLS connection]() for more information.
