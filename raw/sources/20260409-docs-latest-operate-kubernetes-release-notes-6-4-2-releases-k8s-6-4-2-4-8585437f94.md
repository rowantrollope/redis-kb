...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/k8s-6-4-2-4/
retrieved_utc: '2026-04-09T20:45:58.380220+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/k8s-6-4-2-4/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"openshift-images","title":"OpenShift images"},{"id":"openshift-olm-bundles","title":"OpenShift OLM bundles"}],"id":"images","title":"Images"},{"id":"new-features","title":"New features"},{"id":"feature-improvements","title":"Feature improvements"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"api-changes","title":"API changes"},{"children":[{"id":"deprecated-features","title":"Deprecated features"},{"id":"supported-distributions","title":"Supported distributions"}],"id":"compatibility-notes","title":"Compatibility notes"},{"id":"before-upgrading","title":"Before upgrading"},{"id":"active-active-preview-known-limitations","title":"Active-Active preview known limitations"},{"children":[{"id":"large-clusters","title":"Large clusters"}],"id":"known-limitations","title":"Known limitations"}]}
...
* Resharding fails for rack-aware databases with no replication (RED-97971)
  ...
  Workaround:
    Before resharding your database, [turn off rack awareness](). Set the `spec.rackAware` field in your REDB custom resource to `false`.
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2-43 release notes]().