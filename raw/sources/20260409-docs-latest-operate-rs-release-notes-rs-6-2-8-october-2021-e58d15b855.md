...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-8-october-2021/
retrieved_utc: '2026-04-09T20:45:59.412519+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-8-october-2021/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"features-and-enhancements","title":"Features and enhancements"},{"children":[{"id":"prerequisites-and-notes","title":"Prerequisites and notes"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"},{"id":"redis-modules","title":"Redis modules"}],"id":"version-changes","title":"Version changes"},{"children":[{"id":"user-interface-fixes","title":"User interface fixes"},{"id":"additional-fixes","title":"Additional fixes"},{"id":"fixes-on-build-53","title":"Fixes on build #53"}],"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"installation-limitations","title":"Installation limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"known-issues","title":"Known issues"},{"children":[{"id":"open-source-redis-security-fix-compatibility","title":"Open source Redis security fix compatibility"}],"id":"security","title":"Security"}]}
...
- RS60877 - Fixed reset of Active-Active database compression level, in cases where the compression level wasnât set to default, when changing any other configuration via the DB configuration page
