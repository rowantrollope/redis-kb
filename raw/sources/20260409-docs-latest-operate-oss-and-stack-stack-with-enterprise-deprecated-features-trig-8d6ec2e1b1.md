...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/quick_start_cli/
retrieved_utc: '2026-04-09T20:45:52.441536+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/quick_start_cli/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"connect-to-redis-stack","title":"Connect to Redis Stack"},{"id":"load-a-library","title":"Load a library"},{"id":"uploading-an-external-file","title":"Uploading an external file"},{"id":"creating-triggers","title":"Creating triggers"}]}
