---
title: "Redis latency diagnosis official docs"
url: "https://redis.io/docs/latest/operate/oss_and_stack/management/optimization/latency/"
retrieved_utc: "2026-04-09T20:34:18.425404+00:00"
tags: ['ad-hoc']
---
...
- Book a meeting
- Login
- Redis Software latest ▼ ▲ latest v7.22 v7.8 v7.4 Redis Cloud Redis for Kubernetes latest ▼ ▲ latest v7.22 v7.8.6 v7.8.4 v7.4.6 Redis Open Source Install and upgrade Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference Redis Insight Redis Data Integration (RDI)
- Redis Cloud Redis for Kubernetes latest ▼ ▲ latest v7.22 v7.8.6 v7.8.4 v7.4.6 Redis Open Source Install and upgrade Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference Redis Insight Redis Data Integration (RDI)
- Redis for Kubernetes latest ▼ ▲ latest v7.22 v7.8.6 v7.8.4 v7.4.6 Redis Open Source Install and upgrade Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference Redis Insight Redis Data Integration (RDI)
- Redis Open Source Install and upgrade Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference Redis Insight Redis Data Integration (RDI)
- Install and upgrade Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference
- Manage Redis Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging Redis Open Source and Redis Software Reference
- Administration Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Security Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Configuration High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- High availability with Sentinel Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Replication Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Scale with Redis Cluster Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Persistence Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Optimization Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization Troubleshooting Debugging
- Benchmarking CPU profiling Latency diagnosis Latency monitoring Memory optimization
- CPU profiling Latency diagnosis Latency monitoring Memory optimization
- Latency diagnosis Latency monitoring Memory optimization
- Latency monitoring Memory optimization
- Memory optimization
...
of slow commands is the use of the KEYS command in production environments. KEYS , as documented in the Redis documentation, should only be used for
...
^C`
The interesting part of the output for our needs are the two columns si and so , that counts the amount of memory swapped from/to the swap file. If
