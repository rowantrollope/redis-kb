...
retrieved_utc: '2026-04-09T20:45:51.532326+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/aggregations/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"core-concepts","title":"Core concepts"},{"children":[{"id":"parameters-in-detail","title":"Parameters in detail"}],"id":"aggregate-request-format","title":"Aggregate request format"},{"children":[{"id":"example-1-unique-users-by-hour-ordered-chronologically","title":"Example 1: unique users by hour, ordered chronologically."},{"id":"example-2-sort-visits-to-a-specific-url-by-day-and-country","title":"Example 2: Sort visits to a specific URL by day and country:"}],"id":"example","title":"Example"},{"children":[{"id":"supported-groupby-reducers","title":"Supported GROUPBY reducers"}],"id":"groupby-reducers","title":"GROUPBY reducers"},{"children":[{"id":"literals-inside-expressions","title":"Literals inside expressions"},{"id":"arithmetic-operations","title":"Arithmetic operations"},{"id":"list-of-field-apply-functions","title":"List of field APPLY functions"},{"id":"list-of-numeric-apply-functions","title":"List of numeric APPLY functions"},{"id":"list-of-string-apply-functions","title":"List of string APPLY functions"},{"id":"list-of-datetime-apply-functions","title":"List of date/time APPLY functions"},{"id":"list-of-geo-apply-functions","title":"List of geo APPLY functions"}],"id":"apply-expressions","title":"APPLY expressions"},{"id":"filter-expressions","title":"FILTER expressions"},{"children":[{"id":"cursor-settings","title":"Cursor settings"},{"id":"other-cursor-commands","title":"Other cursor commands"}],"id":"cursor-api","title":"Cursor API"}]}
...
* **LIMIT {offset} {num}**. Limit the number of results to return just `num` results starting at index `offset` (zero based). AS mentioned above, it is much more efficient to use `SORTBY â¦ MAX` if you are interested in just limiting the output of a sort operation.
...
During a cursorâs lifetime, CURSOR READ may return results that exclude newer updates.
