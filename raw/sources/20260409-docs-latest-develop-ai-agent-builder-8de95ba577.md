...
url: https://redis.io/docs/latest/develop/ai/agent-builder/
retrieved_utc: '2026-04-09T20:45:57.690138+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/agent-builder/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"get-started","title":"Get started"},{"id":"what-are-ai-agents","title":"What are AI agents?"},{"id":"what-you-can-build","title":"What you can build"},{"id":"features","title":"Features"},{"id":"after-you-generate-your-code","title":"After you generate your code"},{"children":[{"id":"ai-agent-resources","title":"AI agent resources"},{"id":"redis-ai-documentation","title":"Redis AI documentation"},{"id":"community-and-support","title":"Community and support"}],"id":"learn-more","title":"Learn more"}]}
...
- [Redis Vector Search]() - Semantic search capabilities 
- [Redis Streams](/develop/data-types/streams/) - Real-time data and conversation history
- [AI Notebooks Collection]() - Interactive tutorials and examples 
- [Ecosystem Integrations]() - Redis with AI frameworks
...
- Watch [AI Video Collection]() for tutorials and demonstrations
