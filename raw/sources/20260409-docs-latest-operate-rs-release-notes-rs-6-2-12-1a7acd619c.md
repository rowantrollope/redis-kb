...
retrieved_utc: '2026-04-09T20:45:59.387562+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-12/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"features-and-enhancements","title":"Features and enhancements"},{"children":[{"id":"prerequisites-and-notes","title":"Prerequisites and notes"},{"id":"future-deprecation-notice","title":"Future deprecation notice"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"}],"id":"version-changes","title":"Version changes"},{"id":"redis-modules","title":"Redis modules"},{"id":"interface-enhancements","title":"Interface enhancements"},{"id":"additional-enhancements","title":"Additional enhancements"},{"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"installation-limitations","title":"Installation limitations"}],"id":"known-limitations","title":"Known limitations"},{"children":[{"id":"open-source-redis-security-fixes-compatibility","title":"Open Source Redis Security fixes compatibility"}],"id":"security","title":"Security"}]}
...
- Session and security attributes in the admin console
    ...
    You can now use the admin console to configure [password complexity rules](#password-complexity-rules), [user login lockout](access-control/manage-users/login-lockout/#user-login-lockout), and [session timeout](access-control/manage-users/login-lockout/#session-timeout).  
...
- If you are using the earlier cluster-based LDAP mechanism, you _must_ migrate to the role-based mechanism _before_ upgrading to v6.2.12.  For details, see [Migrate to role-based LDAP]().
...
- [RediSearch v2.4.9]()
- [RedisJSON v2.0.11]()
- [RedisBloom v2.2.17](release-notes/)
- [RedisGraph v2.8.15]()
