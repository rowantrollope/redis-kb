---
title: Vectorizers
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/vectorizers/
retrieved_utc: '2026-04-09T20:45:53.021428+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/vectorizers/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"openai","title":"OpenAI"},{"id":"azure-openai","title":"Azure OpenAI"},{"id":"huggingface","title":"Huggingface"},{"id":"vertexai","title":"VertexAI"},{"id":"cohere","title":"Cohere"},{"id":"voyageai","title":"VoyageAI"},{"id":"mistral-ai","title":"Mistral AI"},{"id":"amazon-bedrock","title":"Amazon Bedrock"},{"id":"custom-vectorizers","title":"Custom Vectorizers"}],"id":"creating-text-embeddings","title":"Creating Text Embeddings"},{"id":"search-with-provider-embeddings","title":"Search with Provider Embeddings"},{"id":"selecting-your-float-data-type","title":"Selecting your float data type"}]}
