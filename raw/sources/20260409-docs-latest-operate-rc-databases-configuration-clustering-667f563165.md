...
url: https://redis.io/docs/latest/operate/rc/databases/configuration/clustering/
retrieved_utc: '2026-04-09T20:46:03.163473+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/configuration/clustering/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"how-data-is-distributed","title":"How data is distributed"},{"id":"multi-key-operations-multikey-operations","title":"Multi-key operations {#multikey-operations}"},{"children":[{"id":"redis-hashing-policy","title":"Redis hashing policy"},{"id":"standard-hashing-policy","title":"Standard hashing policy"},{"id":"custom-hashing-policy","title":"Custom hashing policy"},{"id":"custom-hashing-policy-notes-and-limitations","title":"Custom hashing policy notes and limitations"}],"id":"hashing-policies-and-hash-tags-manage-the-hashing-policy","title":"Hashing policies and hash tags {#manage-the-hashing-policy}"},{"id":"oss-cluster-api-oss-cluster-api","title":"OSS Cluster API {#oss-cluster-api}"}]}
...
The Redis hashing policy is identical to the [hashing policy used by Redis Open Source](). This policy is recommended for most users and you should select it if any of the following conditions apply:
...
2. Using multiple curly brackets: when a keyâs name contains multiple curly brackets, the Standard hashing calculation might be different than the Redis hashing policy. 
...
- Using multiple curly brackets within a keyâs name 
...
(using [`FLUSHDB`]()) before they're applied. 
...
Review [OSS Cluster API architecture]() to determine if you should enable this feature for your database.