---
title: Subpath proxy
url: https://redis.io/docs/latest/operate/redisinsight/proxy/
retrieved_utc: '2026-04-09T20:45:53.618529+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/redisinsight/proxy/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"using-redis-insight-behind-a-reverse-proxy","title":"Using Redis Insight behind a reverse proxy"},{"children":[{"id":"docker-compose-file","title":"Docker compose file"},{"id":"nginx-config","title":"nginx config"},{"id":"login-page","title":"Login page"},{"id":"after-login","title":"After login"}],"id":"example","title":"Example"}]}
