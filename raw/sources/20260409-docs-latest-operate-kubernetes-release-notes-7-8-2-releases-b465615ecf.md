...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-8-2-releases/
retrieved_utc: '2026-04-09T20:46:00.573291+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/7-8-2-releases/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"detailed-release-notes","title":"Detailed release notes"},{"children":[{"id":"rhel9-based-images","title":"RHEL9-based images"}],"id":"breaking-changes","title":"Breaking changes"},{"children":[{"id":"new-limitations","title":"New limitations"},{"id":"existing-limitations","title":"Existing limitations"}],"id":"known-limitations","title":"Known limitations"}]}
