...
retrieved_utc: '2026-04-09T20:46:03.404825+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/config-get/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"parameter","multiple":true,"name":"parameter","type":"string"}],
