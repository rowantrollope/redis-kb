...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/redis-pack-4-5-0-may-2017/
retrieved_utc: '2026-04-09T20:46:00.558247+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/redis-pack-4-5-0-may-2017/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"the-new-discovery-service-with-supportfor-redis-sentinel-api","title":"The new discovery service with supportfor Redis Sentinel API"},{"id":"building-large-databases-with-ram-and-flash-memory-in-auto-tiering-v20","title":"Building large databases with RAM and Flash memory in Auto Tiering v2.0"},{"id":"additionalcapabilities","title":"AdditionalÂ capabilities"}],"id":"new-features","title":"New features"},{"id":"important-fixes","title":"Important fixes"}]}
...
- RP13711 - Disabling IPv6 may cause startup of node services to fail
    (NGINX) on RHEL 7
- RP12747 - Calculation can be incorrect for memory quotaÂ for
    databases
