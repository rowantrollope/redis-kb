...
url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/design/
retrieved_utc: '2026-04-09T20:45:51.724572+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/design/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"intro-redis-string-dma","title":"Intro: Redis String DMA"},{"id":"inverted-index-encoding","title":"Inverted index encoding"},{"id":"document-and-result-ranking","title":"Document and result ranking"},{"id":"index-ppecs-and-field-weights","title":"Index ppecs and field weights"},{"id":"query-execution-engine","title":"Query execution engine"},{"id":"numeric-filters","title":"Numeric filters"},{"id":"auto-complete-and-fuzzy-suggestions","title":"Auto-complete and fuzzy suggestions"}]}
