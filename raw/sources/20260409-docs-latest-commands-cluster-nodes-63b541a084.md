...
retrieved_utc: '2026-04-09T20:46:03.027958+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/cluster-nodes/index.html.md
---
...
```json metadata
{
  ...
  "since": "3.0.0",
  "arity": 2,
  "tableOfContents": {"sections":[{"id":"serialization-format","title":"Serialization format"},{"id":"notes-on-published-config-epochs","title":"Notes on published config epochs"},{"id":"special-slot-entries","title":"Special slot entries"},{"id":"redis-software-and-redis-cloud-compatibility","title":"Redis Software and Redis Cloud compatibility"},{"id":"return-information","title":"Return information"}]}
...
hash slots and node addresses should use [`CLUSTER SHARDS`]() instead.
