...
url: https://redis.io/docs/latest/develop/ai/redisvl/api/session_manager/
retrieved_utc: '2026-04-09T20:46:05.441516+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/session_manager/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-semanticsessionmanagername-sessiontagnone-prefixnone-vectorizernone-distancethreshold03-redisclientnone-redisurlredislocalhost6379-connectionkwargs-overwritefalse-kwargs","title":"class SemanticSessionManager(name, sessiontag=None, prefix=None, vectorizer=None, distancethreshold=0.3, redisclient=None, redisurl='redis://localhost:6379', connection_kwargs={}, overwrite=False, **kwargs)"}],"id":"semanticsessionmanager","title":"SemanticSessionManager"},{"children":[{"id":"class-standardsessionmanagername-sessiontagnone-prefixnone-redisclientnone-redisurlredislocalhost6379-connectionkwargs-kwargs","title":"class StandardSessionManager(name, sessiontag=None, prefix=None, redisclient=None, redisurl='redis://localhost:6379', connectionkwargs={}, **kwargs)"}],"id":"standardsessionmanager","title":"StandardSessionManager"}]}

,
  "codeExamples": [{"id":"semantic-session-manager-api"},{"id":"standard-session-manager-api"}]
}
```
...
* **Parameters:**
  ...
  * **prefix** (*Optional* *[* *str* *]*) â Prefix for the keys for this session data.
...
* **Parameters:**
  **id** (*Optional* *[* *str* *]*) â The id of the session entry to delete.
...
* **Parameters:**
  * **prompt** (*str*) â The message text to search for in session memory
