...
retrieved_utc: '2026-04-09T20:46:05.150585+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/json.set/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"name":"key","type":"key"},{"name":"path","type":"string"},{"name":"value","type":"string"},{"arguments":[{"name":"nx","token":"NX","type":"pure-token"},{"name":"xx","token":"XX","type":"pure-token"}],"name":"condition","optional":true,"type":"oneof"}],
