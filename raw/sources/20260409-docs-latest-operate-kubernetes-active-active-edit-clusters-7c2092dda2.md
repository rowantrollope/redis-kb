...
url: https://redis.io/docs/latest/operate/kubernetes/active-active/edit-clusters/
retrieved_utc: '2026-04-09T20:45:57.116011+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/active-active/edit-clusters/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"collect-rec-credentials","title":"Collect REC credentials"},{"id":"create-rerc","title":"Create RERC"},{"id":"edit-reaadb-spec","title":"Edit REAADB spec"}],"id":"add-a-participating-cluster","title":"Add a participating cluster"},{"id":"remove-a-participating-cluster","title":"Remove a participating cluster"}]}
