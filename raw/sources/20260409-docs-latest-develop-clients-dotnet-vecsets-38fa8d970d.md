...
url: https://redis.io/docs/latest/develop/clients/dotnet/vecsets/
retrieved_utc: '2026-04-09T20:45:57.431011+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/dotnet/vecsets/index.html.md
---
...
```json metadata
{
  ...
  "relatedPages": ["/develop/clients/dotnet/vecsearch"],
  "scope": "example",
  "tableOfContents": {"sections":[{"id":"initialize","title":"Initialize"},{"id":"access-the-model","title":"Access the model"},{"id":"create-the-data","title":"Create the data"},{"id":"add-the-data-to-a-vector-set","title":"Add the data to a vector set"},{"id":"query-the-vector-set","title":"Query the vector set"},{"id":"more-information","title":"More information"}]}

,
  "codeExamples": [{"codetabsId":"home_vecsets-stepimport","description":"Foundational: Import required libraries for vector sets, embeddings, and Redis operations","difficulty":"beginner","id":"import","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepimport"}]},{"codetabsId":"home_vecsets-stepmodel","description":"Practical pattern: Initialize a SentenceTransformer model to generate vector embeddings from text","difficulty":"beginner","id":"model","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepmodel"}]},{"codetabsId":"home_vecsets-stepdata_classes","description":"Foundational: Define data classes for the embedding model\u0026amp;#39;s input and output structures","difficulty":"beginner","id":"data_classes","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepdata_classes"}]},{"codetabsId":"home_vecsets-stepget_embedding","description":"Foundational: Create a function to generate vector embeddings from text using the prediction engine","difficulty":"beginner","id":"get_embedding","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepget_embedding"}]},{"codetabsId":"home_vecsets-stepdata","description":"Foundational: Define sample data with text descriptions for vector embedding and storage","difficulty":"beginner","id":"data","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepdata"}]},{"codetabsId":"home_vecsets-stepadd_data","description":"Foundational: Add vector embeddings and attributes to a vector set using VADD command","difficulty":"beginner","id":"add_data","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepadd_data"}]},{"codetabsId":"home_vecsets-stepbasic_query","description":"Vector similarity search: Find semantically similar items in a vector set using VSIM command","difficulty":"intermediate","id":"basic_query","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepbasic_query"}]},{"codetabsId":"home_vecsets-steplimited_query","description":"Vector similarity search with limits: Restrict results to the top K most similar items using the count parameter","difficulty":"intermediate","id":"limited_query","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-steplimited_query"}]},{"codetabsId":"home_vecsets-stepentertainer_query","description":"Semantic search: Leverage text embeddings to find semantically similar items even when exact keywords don\u0026amp;#39;t match","difficulty":"intermediate","id":"entertainer_query","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepentertainer_query"}]},{"codetabsId":"home_vecsets-stepfiltered_query","description":"Filtered vector search: Combine vector similarity with attribute filters to narrow results based on metadata conditions","difficulty":"advanced","id":"filtered_query","languages":[{"id":"dotnet-Sync","panelId":"panel_Csharp-Sync_home_vecsets-stepfiltered_query"}]}]
}
...
[`VectorSetAdd()`]() command to set the embedding.
...
or by using the [`VectorSetGetAttributesJson()`]() method.
...
the query vector to [`VectorSetSimilaritySearch()`]() to 
