...
url: https://redis.io/docs/latest/operate/kubernetes/security/manage-rec-credentials/
retrieved_utc: '2026-04-09T20:46:00.530837+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/manage-rec-credentials/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"retrieve-the-current-username-and-password","title":"Retrieve the current username and password"},{"children":[{"id":"change-the-rec-password-for-the-current-username","title":"Change the REC password for the current username"},{"id":"change-both-the-rec-username-and-password","title":"Change both the REC username and password"},{"id":"update-the-credentials-secret-in-vault","title":"Update the credentials secret in Vault"}],"id":"change-the-redis-enterprise-cluster-rec-credentials","title":"Change the Redis Enterprise cluster (REC) credentials"}]}
