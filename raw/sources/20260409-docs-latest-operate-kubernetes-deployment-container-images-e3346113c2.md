...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/container-images/
retrieved_utc: '2026-04-09T20:46:00.483431+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/container-images/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"find-container-sources","title":"Find container sources"},{"id":"create-a-private-container-registry","title":"Create a private container registry"},{"id":"push-images-to-a-private-container-registry","title":"Push images to a private container registry"},{"children":[{"id":"specify-the-operator-image-source","title":"Specify the operator image source"},{"id":"specify-the-redis-enterprise-cluster-images-source","title":"Specify the Redis Enterprise cluster images source"}],"id":"configure-deployments-to-use-a-private-container-registry","title":"Configure deployments to use a private container registry"},{"id":"admission-controller","title":"Admission controller"},{"id":"rate-limiting-with-dockerhub","title":"Rate limiting with DockerHub"}]}
