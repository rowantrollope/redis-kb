---
title: Monitoring v2
url: https://redis.io/docs/latest/operate/rs/monitoring/metrics_stream_engine/
retrieved_utc: '2026-04-09T20:45:58.605623+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/monitoring/metrics_stream_engine/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"integrate-with-external-monitoring-tools","title":"Integrate with external monitoring tools"},{"id":"prometheus-metrics-v2","title":"Prometheus metrics v2"},{"id":"transition-from-prometheus-v1-to-prometheus-v2","title":"Transition from Prometheus v1 to Prometheus v2"}]}
