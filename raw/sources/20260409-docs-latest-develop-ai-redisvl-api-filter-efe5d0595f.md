---
title: Filter
url: https://redis.io/docs/latest/develop/ai/redisvl/api/filter/
retrieved_utc: '2026-04-09T20:46:04.006157+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/filter/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-filterexpressionfilternone-operatornone-leftnone-rightnone","title":"class FilterExpression(_filter=None, operator=None, left=None, right=None)"}],"id":"filterexpression","title":"FilterExpression"},{"children":[{"id":"class-tagfield","title":"class Tag(field)"}],"id":"tag","title":"Tag"},{"children":[{"id":"class-textfield","title":"class Text(field)"}],"id":"text","title":"Text"},{"children":[{"id":"class-numfield","title":"class Num(field)"}],"id":"num","title":"Num"},{"children":[{"id":"class-geofield","title":"class Geo(field)"}],"id":"geo","title":"Geo"},{"children":[{"id":"class-georadiuslongitude-latitude-radius1-unitkm","title":"class GeoRadius(longitude, latitude, radius=1, unit='km')"}],"id":"georadius","title":"GeoRadius"}]}

,
  "codeExamples": [{"id":"filter-api"}]
}
```
...
* **Parameters:**
  **other** (*Union* *[* *List* *[* *str* *]* *,* *str* *]*) â The tag(s) to filter on.
* **Return type:**
...
* **Parameters:**
  **other** (*str*) â The text value to filter on.
* **Return type:**
  [FilterExpression](#filterexpression)
...
* **Parameters:**
  **other** (*int*) â The value to filter on.
* **Return type:**
  [FilterExpression](#filterexpression)
...
* **Parameters:**
  **other** ([GeoRadius](#georadius)) â The geographic spec to filter on.
* **Return type:**
  [FilterExpression](#filterexpression)
...
* **Parameters:**
  * **longitude** (*float*) â The longitude of the center of the radius.
  * **latitude** (*float*) â The latitude of the center of the radius.
  * **radius** (*int* *,* *optional*) â The radius of the circle. Defaults to 1.
  * **unit** (*str* *,* *optional*) â The unit of the radius. Defaults to "km".
* **Raises:**
  **ValueError** â If the unit is not one of "m", "km", "mi", or "ft".
