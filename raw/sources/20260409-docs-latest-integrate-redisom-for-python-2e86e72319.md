...
url: https://redis.io/docs/latest/integrate/redisom-for-python/
retrieved_utc: '2026-04-09T20:45:53.875863+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redisom-for-python/index.html.md
---
...
```json metadata
{
  ...
  "group": "library",
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"requirements","title":"Requirements"},{"id":"get-the-source-code","title":"Get the Source Code"},{"id":"start-a-redis-stack-database-or-configure-your-redis-cloud-credentials","title":"Start a Redis Stack Database, or Configure your Redis Cloud Credentials"},{"id":"create-a-python-virtual-environment-and-install-the-dependencies","title":"Create a Python Virtual Environment and Install the Dependencies"},{"id":"start-the-flask-application","title":"Start the Flask Application"},{"id":"load-the-sample-data","title":"Load the Sample Data"},{"id":"problems","title":"Problems?"}],"id":"getting-started","title":"Getting Started"},{"children":[{"id":"building-a-person-model-with-redis-om","title":"Building a Person Model with Redis OM"},{"id":"adding-new-people","title":"Adding New People"},{"id":"examining-the-data-in-redis","title":"Examining the data in Redis"},{"id":"find-a-person-by-id","title":"Find a Person by ID"},{"id":"find-people-with-matching-first-and-last-name","title":"Find People with Matching First and Last Name"},{"id":"find-people-within-a-given-age-range","title":"Find People within a Given Age Range"},{"id":"find-people-in-a-given-city-with-a-specific-skill","title":"Find People in a Given City with a Specific Skill"},{"id":"find-people-using-full-text-search-on-their-personal-statements","title":"Find People using Full Text Search on their Personal Statements"},{"id":"update-a-persons-age","title":"Update a Person's Age"},{"id":"delete-a-person","title":"Delete a Person"},{"id":"setting-an-expiry-time-for-a-person","title":"Setting an Expiry Time for a Person"}],"id":"create-read-update-and-delete-data","title":"Create, Read, Update and Delete Data"},{"id":"shutting-down-redis-docker","title":"Shutting Down Redis (Docker)"}]}
...
For more information on the JSON Path syntax used to query JSON documents in Redis, see the [documentation]().
