...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/planning/
retrieved_utc: '2026-04-09T20:45:55.860673+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/planning/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"participating-clusters","title":"Participating clusters"},{"id":"memory-limits","title":"Memory limits"},{"children":[{"id":"network-ports","title":"Network ports"},{"id":"network-time-service-network-time-service","title":"Network Time Service {#network-time-service}"}],"id":"networking","title":"Networking"},{"id":"redis-modules-redis-modules","title":"Redis modules {#redis-modules}"},{"id":"limitations","title":"Limitations"}]}
