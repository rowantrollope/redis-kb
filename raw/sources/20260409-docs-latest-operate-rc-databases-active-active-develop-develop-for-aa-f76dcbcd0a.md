...
url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/develop-for-aa/
retrieved_utc: '2026-04-09T20:45:54.156930+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/develop-for-aa/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"lua-scripts","title":"Lua scripts"},{"id":"eviction","title":"Eviction"},{"id":"expiration","title":"Expiration"},{"id":"tombstones","title":"Tombstones"},{"id":"out-of-memory-oom-outofmemory-oom","title":"Out-of-Memory (OOM) {#outofmemory-oom}"},{"id":"active-active-database-key-counts","title":"Active-Active database key counts"},{"id":"info","title":"INFO"}]}
...
The default policy for Active-Active databases is _noeviction_ mode. Redis Software version 6.0.20 and later support all eviction policies for Active-Active databases, unless [Redis Flex or Auto Tiering]() (previously known as Redis on Flash) is enabled.

For details, see [eviction for Active-Active databases (Redis Software)]() or [eviction for Active-Active databases (Redis Cloud)]().
