...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-54/
retrieved_utc: '2026-04-09T20:45:59.362085+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-4-2-releases/rs-7-4-2-54/index.html.md
---
...
- Added full support for TLS 1.3:
    ...
    - TLS 1.3 cipher suites are now configurable for database connections. See [Configure cipher suites]() for details.

    - TLS 1.3 can be set as the minimum TLS version. See [Configure TLS protocol]() for details.

- Automatic recovery of databases from persistence files is configurable using the REST API. See [Configure automatic recovery]() for details.

- New clusters fully support IPv6, including for internal traffic. See [Enable IPv6 for internal traffic]() for details.
...
- New Cluster Manager UI enhancements:
    ...
    - Configure [TLS cipher suites]() and [minimum TLS protocol]().
...
- Improved `actions` REST API:
    ...
    - Improved `progress` field returned by [`GET /v1/actions`]() requests.
...
- [`GET /v1/users`]() REST API requests include a new `status` field in the response, which indicates whether the user can sign in:
...
- Type of `progress` field returned by [`GET /v1/actions`]() request modified from `integer` to `float`.
...
| [**End-of-life date**]() | â | July<br />2025 | Feb<br />2025 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 |
| **Ubuntu**<sup>[1](#table-note-1)</sup> |
| 20.04 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[6](#table-note-6)</sup> | â | â | â | â | â |
...
| 16.04 | â | <span title="End of life">&#x274c;</span> | <span title="Deprecated">&#x26A0;&#xFE0F;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
| **RHEL & CentOS**<sup>[2](#table-note-2)</sup>
| 9.0-9.3 | <span title="Supported">&#x2705;</span> | â | â | â | â | â | â | â |
| 8.9| <span title="Supported">&#x2705;</span> | â | â | â | â | â | â | â |
| 8.8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[8](#table-note-8)</sup> | â | â | â | â | â |
| 8.7 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â | â | â | â |
| 8.5-8.6 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â |
| 8.0-8.4 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â |
...
| 8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â |
...
| 8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â | â | â |
| **Amazon Linux** |
| 2 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[7](#table-note-7)</sup> | â | â | â | â | â |
...
2. <a name="table-note-2" style="display: block; height: 80px; margin-top: -80px;"></a>RHEL and CentOS deployments require [firewall configuration]().
...
8. <a name="table-note-8" style="display: block; height: 80px; margin-top: -80px;"></a>Redis Enterprise Software [6.4.2-103]() and later supports RHEL 8.8.
