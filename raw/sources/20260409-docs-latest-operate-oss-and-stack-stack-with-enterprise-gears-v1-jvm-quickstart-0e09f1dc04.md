---
title: "RedisGears JVM\xC2\_quick start"
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/jvm/quickstart/
retrieved_utc: '2026-04-09T20:45:54.453390+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/gears-v1/jvm/quickstart/index.html.md
---
...
```json metadata
{
  "title": "RedisGears JVMÂ quick start",
  "description": "A quick start to learn how to use RedisGears with Java.",
  "categories": ["docs","operate","stack"],
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"create-a-maven-project","title":"Create a Maven project"},{"id":"build-a-jar","title":"Build a JAR"},{"id":"upload-the-jar","title":"Upload the JAR"},{"id":"run-redisgears-java-code","title":"Run RedisGears Java code"}],"id":"tutorial","title":"Tutorial"},{"children":[{"id":"batch-processing","title":"Batch processing"},{"id":"event-processing","title":"Event processing"}],"id":"example-code","title":"Example code"}]}
...
If you use the [`GearsBuilder.run()`]() function within your code, then the functions you add to the pipeline will run exactly once when you use `RG.JEXECUTE` with your JAR file.
...
If you use the [`GearsBuilder.register()`]() function in your code, then the functions you add to the pipeline will run every time a certain database event occurs.
