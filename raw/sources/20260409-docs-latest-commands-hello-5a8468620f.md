...
retrieved_utc: '2026-04-09T20:46:04.489548+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/hello/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"arguments":[{"display_text":"protover","name":"protover","type":"integer"},{"arguments":[{"display_text":"username","name":"username","type":"string"},{"display_text":"password","name":"password","type":"string"}],"name":"auth","optional":true,"token":"AUTH","type":"block"},{"display_text":"clientname","name":"clientname","optional":true,"token":"SETNAME","type":"string"}],"name":"arguments","optional":true,"type":"block"}],
  "syntax_fmt": "HELLO [protover [AUTHÂ username password] [SETNAMEÂ clientname]]",
  "complexity": "O(1)",
  "group": "connection",
