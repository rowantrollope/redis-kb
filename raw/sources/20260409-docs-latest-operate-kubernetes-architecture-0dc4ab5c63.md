...
url: https://redis.io/docs/latest/operate/kubernetes/architecture/
retrieved_utc: '2026-04-09T20:45:51.538125+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/architecture/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"lifecycle","title":"Lifecycle"},{"id":"architecture","title":"Architecture"},{"id":"operator","title":"Operator"},{"id":"namespace","title":"Namespace"},{"id":"custom-resources","title":"Custom resources"},{"id":"custom-resource-definitions","title":"Custom resource definitions"},{"id":"redisenterprisecluster-rec","title":"RedisEnterpriseCluster REC"},{"id":"redisenterprisedatabase-redb","title":"RedisEnterpriseDatabase REDB"},{"children":[{"id":"rec-credentials","title":"REC credentials"},{"id":"rec-certificates","title":"REC certificates"},{"id":"client-certificates","title":"Client certificates"}],"id":"security","title":"Security"},{"children":[{"id":"redis-flex","title":"Redis Flex"}],"id":"storage","title":"Storage"},{"id":"networking","title":"Networking"},{"id":"services-rigger","title":"Services Rigger"},{"id":"active-active-databases","title":"Active-Active databases"},{"id":"redisenterpriseremotecluster-rerc","title":"RedisEnterpriseRemoteCluster RERC"},{"id":"redisenterpriseactiveactivedatabase-reaadb","title":"RedisEnterpriseActiveActiveDatabase REAADB"},{"id":"metrics","title":"Metrics"}]}
