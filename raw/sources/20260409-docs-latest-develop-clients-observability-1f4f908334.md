...
retrieved_utc: '2026-04-09T20:45:58.637988+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/observability/index.html.md
---
...
```json metadata
{
  ...
  "topics": ["observability","monitoring","performance","metrics","logging","tracing"],
  "relatedPages": ["/develop/clients/redis-py/produsage","/develop/clients/nodejs/produsage","/develop/clients/go/produsage"],
  "scope": "overview",
  "tableOfContents": {"sections":[{"id":"tracing-overview","title":"Tracing overview"},{"id":"metrics-overview","title":"Metrics overview"},{"id":"redis-metric-groups","title":"Redis metric groups"},{"id":"metrics-reference","title":"Metrics reference"}]}
