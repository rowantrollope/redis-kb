...
url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/oracle/
retrieved_utc: '2026-04-09T20:45:51.820020+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/oracle/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"children":[{"id":"1-configure-oracle-logminer","title":"1. Configure Oracle LogMiner"},{"id":"2-enable-supplemental-logging-supp-logging","title":"2. Enable supplemental logging {#supp-logging}"},{"id":"3-check-the-redo-log-sizing","title":"3. Check the redo log sizing"},{"id":"4-set-the-archive-log-destination","title":"4. Set the Archive log destination"},{"id":"5-create-a-user-for-the-connector-create-dbz-user","title":"5. Create a user for the connector {#create-dbz-user}"},{"id":"6-configuration-is-complete-logminer-complete","title":"6. Configuration is complete {#logminer-complete}"}],"id":"logminer","title":"LogMiner"},{"children":[{"id":"1-configure-recovery-area","title":"1. Configure recovery area"},{"id":"2-enable-goldengate-replication","title":"2. Enable GoldenGate replication"},{"id":"3-configure-xstream","title":"3. Configure XStream"},{"id":"4-enable-supplemental-logging","title":"4. Enable supplemental logging"},{"id":"5-create-xstream-users","title":"5. Create XStream users"},{"id":"6-create-an-xstream-outbound-server","title":"6. Create an XStream outbound server"},{"id":"7-add-a-custom-docker-image-for-the-debezium-server","title":"7. Add a custom Docker image for the Debezium server"},{"id":"8-make-rdi-use-the-custom-image-vm-installation","title":"8. Make RDI use the custom image (VM installation)"},{"id":"9-enable-the-oracle-configuration-in-rdi","title":"9. Enable the Oracle configuration in RDI"},{"id":"10-configuration-is-complete-xstream-complete","title":"10. Configuration is complete {#xstream-complete}"}],"id":"xstream","title":"XStream"},{"children":[{"id":"create-a-custom-debezium-server-image","title":"Create a custom Debezium Server image"},{"id":"configure-rdi-for-xmltype-support","title":"Configure RDI for XMLTYPE support"},{"id":"test-xmltype-support","title":"Test XMLTYPE support"}],"id":"support-for-oracle-xmltype-columns-optional","title":"Support for Oracle XMLTYPE columns (optional)"},{"children":[{"id":"how-does-cdb-differ-from-non-cdb","title":"How does CDB differ from Non-CDB?"},{"id":"how-does-single-instance-differ-from-rac","title":"How does single-instance differ from RAC?"},{"id":"in-rac-setups-do-you-need-to-execute-steps-on-all-nodes","title":"In RAC setups, do you need to execute steps on all nodes?"},{"id":"why-are-two-xstream-tablespaces-required","title":"Why are two XStream tablespaces required?"},{"id":"what-is-the-xstream-outbound-server","title":"What is the XStream outbound server?"}],"id":"faq","title":"FAQ"}]}
...
**CDB (Container Database â multitenant)**
...
- `xstream_adm_tbs` â XStream administrator tablespace.
- `xstream_tbs` â XStream user (connect) tablespace.
...
- Debezium/RDI uses Oracleâs supported XStream API.
