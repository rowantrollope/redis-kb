...
url: https://redis.io/docs/latest/develop/reference/modules/modules-api-ref/
retrieved_utc: '2026-04-09T20:45:51.576221+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/modules/modules-api-ref/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"sections","title":"Sections"},{"children":[{"id":"redismodulealloc","title":"RedisModule_Alloc"},{"id":"redismoduletryalloc","title":"RedisModule_TryAlloc"},{"id":"redismodulecalloc","title":"RedisModule_Calloc"},{"id":"redismoduletrycalloc","title":"RedisModule_TryCalloc"},{"id":"redismodulerealloc","title":"RedisModule_Realloc"},{"id":"redismoduletryrealloc","title":"RedisModule_TryRealloc"},{"id":"redismodulefree","title":"RedisModule_Free"},{"id":"redismodulestrdup","title":"RedisModule_Strdup"},{"id":"redismodulepoolalloc","title":"RedisModule_PoolAlloc"}],"id":"heap-allocation-raw-functions","title":"Heap allocation raw functions"},{"children":[{"id":"redismoduleiskeyspositionrequest","title":"RedisModule_IsKeysPositionRequest"},{"id":"redismodulekeyatposwithflags","title":"RedisModule_KeyAtPosWithFlags"},{"id":"redismodulekeyatpos","title":"RedisModule_KeyAtPos"},{"id":"redismoduleischannelspositionrequest","title":"RedisModule_IsChannelsPositionRequest"},{"id":"redismodulechannelatposwithflags","title":"RedisModule_ChannelAtPosWithFlags"},{"id":"redismodulecreatecommand","title":"RedisModule_CreateCommand"},{"id":"redismodulegetcommand","title":"RedisModule_GetCommand"},{"id":"redismodulecreatesubcommand","title":"RedisModule_CreateSubcommand"},{"id":"redismoduleaddaclcategory","title":"RedisModule_AddACLCategory"},{"id":"redismodulesetcommandaclcategories","title":"RedisModule_SetCommandACLCategories"},{"id":"redismodulesetcommandinfo","title":"RedisModule_SetCommandInfo"}],"id":"commands-api","title":"Commands API"},{"children":[{"id":"redismoduleismodulenamebusy","title":"RedisModule_IsModuleNameBusy"},{"id":"redismodulemilliseconds","title":"RedisModule_Milliseconds"},{"id":"redismodulemonotonicmicroseconds","title":"RedisModule_MonotonicMicroseconds"},{"id":"redismodulemicroseconds","title":"RedisModule_Microseconds"},{"id":"redismodulecachedmicroseconds","title":"RedisModule_CachedMicroseconds"},{"id":"redismoduleblockedclientmeasuretimestart","title":"RedisModule_BlockedClientMeasureTimeStart"},{"id":"redismoduleblockedclientmeasuretimeend","title":"RedisModule_BlockedClientMeasureTimeEnd"},{"id":"redismoduleyield","title":"RedisModule_Yield"},{"id":"redismodulesetmoduleoptions","title":"RedisModule_SetModuleOptions"},{"id":"redismodulesignalmodifiedkey","title":"RedisModule_SignalModifiedKey"}],"id":"module-information-and-time-measurement","title":"Module information and time measurement"},{"children":[{"id":"redismoduleautomemory","title":"RedisModule_AutoMemory"}],"id":"automatic-memory-management-for-modules","title":"Automatic memory management for modules"},{"children":[{"id":"redismodulecreatestring","title":"RedisModule_CreateString"},{"id":"redismodulecreatestringprintf","title":"RedisModule_CreateStringPrintf"},{"id":"redismodulecreatestringfromlonglong","title":"RedisModule_CreateStringFromLongLong"},{"id":"redismodulecreatestringfromulonglong","title":"RedisModule_CreateStringFromULongLong"},{"id":"redismodulecreatestringfromdouble","title":"RedisModule_CreateStringFromDouble"},{"id":"redismodulecreatestringfromlongdouble","title":"RedisModule_CreateStringFromLongDouble"},{"id":"redismodulecreatestringfromstring","title":"RedisModule_CreateStringFromString"},{"id":"redismodulecreatestringfromstreamid","title":"RedisModule_CreateStringFromStreamID"},{"id":"redismodulefreestring","title":"RedisModule_FreeString"},{"id":"redismoduleretainstring","title":"RedisModule_RetainString"},{"id":"redismoduleholdstring","title":"RedisModule_HoldString"},{"id":"redismodulestringptrlen","title":"RedisModule_StringPtrLen"},{"id":"redismodulestringtolonglong","title":"RedisModule_StringToLongLong"},{"id":"redismodulestringtoulonglong","title":"RedisModule_StringToULongLong"},{"id":"redismodulestringtodouble","title":"RedisModule_StringToDouble"},{"id":"redismodulestringtolongdouble","title":"RedisModule_StringToLongDouble"},{"id":"redismodulestringtostreamid","title":"RedisModule_StringToStreamID"},{"id":"redismodulestringcompare","title":"RedisModule_StringCompare"},{"id":"redismodulestringappendbuffer","title":"RedisModule_StringAppendBuffer"},{"id":"redismoduletrimstringallocation","title":"RedisModule_TrimStringAllocation"}],"id":"string-objects-apis","title":"String objects APIs"},{"children":[{"id":"reply-with-collection-functions","title":"Reply with collection functions"},{"id":"redismodulewrongarity","title":"RedisModule_WrongArity"},{"id":"redismodulereplywithlonglong","title":"RedisModule_ReplyWithLongLong"},{"id":"redismodulereplywitherror","title":"RedisModule_ReplyWithError"},{"id":"redismodulereplywitherrorformat","title":"RedisModule_ReplyWithErrorFormat"},{"id":"redismodulereplywithsimplestring","title":"RedisModule_ReplyWithSimpleString"},{"id":"redismodulereplywitharray","title":"RedisModule_ReplyWithArray"},{"id":"redismodulereplywithmap","title":"RedisModule_ReplyWithMap"},{"id":"redismodulereplywithset","title":"RedisModule_ReplyWithSet"},{"id":"redismodulereplywithattribute","title":"RedisModule_ReplyWithAttribute"},{"id":"redismodulereplywithnullarray","title":"RedisModule_ReplyWithNullArray"},{"id":"redismodulereplywithemptyarray","title":"RedisModule_ReplyWithEmptyArray"},{"id":"redismodulereplysetarraylength","title":"RedisModule_ReplySetArrayLength"},{"id":"redismodulereplysetmaplength","title":"RedisModule_ReplySetMapLength"},{"id":"redismodulereplysetsetlength","title":"RedisModule_ReplySetSetLength"},{"id":"redismodulereplysetattributelength","title":"RedisModule_ReplySetAttributeLength"},{"id":"redismodulereplywithstringbuffer","title":"RedisModule_ReplyWithStringBuffer"},{"id":"redismodulereplywithcstring","title":"RedisModule_ReplyWithCString"},{"id":"redismodulereplywithstring","title":"RedisModule_ReplyWithString"},{"id":"redismodulereplywithemptystring","title":"RedisModule_ReplyWithEmptyString"},{"id":"redismodulereplywithverbatimstringtype","title":"RedisModule_ReplyWithVerbatimStringType"},{"id":"redismodulereplywithverbatimstring","title":"RedisModule_ReplyWithVerbatimString"},{"id":"redismodulereplywithnull","title":"RedisModule_ReplyWithNull"},{"id":"redismodulereplywithbool","title":"RedisModule_ReplyWithBool"},{"id":"redismodulereplywithcallreply","title":"RedisModule_ReplyWithCallReply"},{"id":"redismodulereplywithdouble","title":"RedisModule_ReplyWithDouble"},{"id":"redismodulereplywithbignumber","title":"RedisModule_ReplyWithBigNumber"},{"id":"redismodulereplywithlongdouble","title":"RedisModule_ReplyWithLongDouble"}],"id":"reply-apis","title":"Reply APIs"},{"children":[{"id":"redismodulereplicate","title":"RedisModule_Replicate"},{"id":"redismodulereplicateverbatim","title":"RedisModule_ReplicateVerbatim"}],"id":"commands-replication-api","title":"Commands replication API"},{"children":[{"id":"redismodulegetclientid","title":"RedisModule_GetClientId"},{"id":"redismodulegetclientusernamebyid","title":"RedisModule_GetClientUserNameById"},{"id":"redismodulegetclientinfobyid","title":"RedisModule_GetClientInfoById"},{"id":"redismodulegetclientnamebyid","title":"RedisModule_GetClientNameById"},{"id":"redismodulesetclientnamebyid","title":"RedisModule_SetClientNameById"},{"id":"redismodulepublishmessage","title":"RedisModule_PublishMessage"},{"id":"redismodulepublishmessageshard","title":"RedisModule_PublishMessageShard"},{"id":"redismodulegetselecteddb","title":"RedisModule_GetSelectedDb"},{"id":"redismodulegetcontextflags","title":"RedisModule_GetContextFlags"},{"id":"redismoduleavoidreplicatraffic","title":"RedisModule_AvoidReplicaTraffic"},{"id":"redismoduleselectdb","title":"RedisModule_SelectDb"},{"id":"redismodulekeyexists","title":"RedisModule_KeyExists"},{"id":"redismoduleopenkey","title":"RedisModule_OpenKey"},{"id":"redismodulegetopenkeymodesall","title":"RedisModule_GetOpenKeyModesAll"},{"id":"redismoduleclosekey","title":"RedisModule_CloseKey"},{"id":"redismodulekeytype","title":"RedisModule_KeyType"},{"id":"redismodulevaluelength","title":"RedisModule_ValueLength"},{"id":"redismoduledeletekey","title":"RedisModule_DeleteKey"},{"id":"redismoduleunlinkkey","title":"RedisModule_UnlinkKey"},{"id":"redismodulegetexpire","title":"RedisModule_GetExpire"},{"id":"redismodulesetexpire","title":"RedisModule_SetExpire"},{"id":"redismodulegetabsexpire","title":"RedisModule_GetAbsExpire"},{"id":"redismodulesetabsexpire","title":"RedisModule_SetAbsExpire"},{"id":"redismodulecreatekeymetaclass","title":"RedisModule_CreateKeyMetaClass"},{"id":"redismodulereleasekeymetaclass","title":"RedisModule_ReleaseKeyMetaClass"},{"id":"redismodulesetkeymeta","title":"RedisModule_SetKeyMeta"},{"id":"redismodulegetkeymeta","title":"RedisModule_GetKeyMeta"},{"id":"redismoduleresetdataset","title":"RedisModule_ResetDataset"},{"id":"redismoduledbsize","title":"RedisModule_DbSize"},{"id":"redismodulerandomkey","title":"RedisModule_RandomKey"},{"id":"redismodulegetkeynamefromoptctx","title":"RedisModule_GetKeyNameFromOptCtx"},{"id":"redismodulegettokeynamefromoptctx","title":"RedisModule_GetToKeyNameFromOptCtx"},{"id":"redismodulegetdbidfromoptctx","title":"RedisModule_GetDbIdFromOptCtx"},{"id":"redismodulegettodbidfromoptctx","title":"RedisModule_GetToDbIdFromOptCtx"}],"id":"db-and-key-apis-generic-api","title":"DB and Key APIs â Generic API"},{"children":[{"id":"redismodulestringset","title":"RedisModule_StringSet"},{"id":"redismodulestringdma","title":"RedisModule_StringDMA"},{"id":"redismodulestringtruncate","title":"RedisModule_StringTruncate"}],"id":"key-api-for-string-type","title":"Key API for String type"},{"children":[{"id":"redismodulelistpush","title":"RedisModule_ListPush"},{"id":"redismodulelistpop","title":"RedisModule_ListPop"},{"id":"redismodulelistget","title":"RedisModule_ListGet"},{"id":"redismodulelistset","title":"RedisModule_ListSet"},{"id":"redismodulelistinsert","title":"RedisModule_ListInsert"},{"id":"redismodulelistdelete","title":"RedisModule_ListDelete"}],"id":"key-api-for-list-type","title":"Key API for List type"},{"children":[{"id":"redismodulezsetadd","title":"RedisModule_ZsetAdd"},{"id":"redismodulezsetincrby","title":"RedisModule_ZsetIncrby"},{"id":"redismodulezsetrem","title":"RedisModule_ZsetRem"},{"id":"redismodulezsetscore","title":"RedisModule_ZsetScore"}],"id":"key-api-for-sorted-set-type","title":"Key API for Sorted Set type"},{"children":[{"id":"redismodulezsetrangestop","title":"RedisModule_ZsetRangeStop"},{"id":"redismodulezsetrangeendreached","title":"RedisModule_ZsetRangeEndReached"},{"id":"redismodulezsetfirstinscorerange","title":"RedisModule_ZsetFirstInScoreRange"},{"id":"redismodulezsetlastinscorerange","title":"RedisModule_ZsetLastInScoreRange"},{"id":"redismodulezsetfirstinlexrange","title":"RedisModule_ZsetFirstInLexRange"},{"id":"redismodulezsetlastinlexrange","title":"RedisModule_ZsetLastInLexRange"},{"id":"redismodulezsetrangecurrentelement","title":"RedisModule_ZsetRangeCurrentElement"},{"id":"redismodulezsetrangenext","title":"RedisModule_ZsetRangeNext"},{"id":"redismodulezsetrangeprev","title":"RedisModule_ZsetRangePrev"}],"id":"key-api-for-sorted-set-iterator","title":"Key API for Sorted Set iterator"},{"children":[{"id":"redismodulehashset","title":"RedisModule_HashSet"},{"id":"redismodulehashget","title":"RedisModule_HashGet"},{"id":"redismodulehashfieldminexpire","title":"RedisModule_HashFieldMinExpire"}],"id":"key-api-for-hash-type","title":"Key API for Hash type"},{"children":[{"id":"redismodulestreamadd","title":"RedisModule_StreamAdd"},{"id":"redismodulestreamdelete","title":"RedisModule_StreamDelete"},{"id":"redismodulestreamiteratorstart","title":"RedisModule_StreamIteratorStart"},{"id":"redismodulestreamiteratorstop","title":"RedisModule_StreamIteratorStop"},{"id":"redismodulestreamiteratornextid","title":"RedisModule_StreamIteratorNextID"},{"id":"redismodulestreamiteratornextfield","title":"RedisModule_StreamIteratorNextField"},{"id":"redismodulestreamiteratordelete","title":"RedisModule_StreamIteratorDelete"},{"id":"redismodulestreamtrimbylength","title":"RedisModule_StreamTrimByLength"},{"id":"redismodulestreamtrimbyid","title":"RedisModule_StreamTrimByID"}],"id":"key-api-for-stream-type","title":"Key API for Stream type"},{"children":[{"id":"redismodulefreecallreply","title":"RedisModule_FreeCallReply"},{"id":"redismodulecallreplytype","title":"RedisModule_CallReplyType"},{"id":"redismodulecallreplylength","title":"RedisModule_CallReplyLength"},{"id":"redismodulecallreplyarrayelement","title":"RedisModule_CallReplyArrayElement"},{"id":"redismodulecallreplyinteger","title":"RedisModule_CallReplyInteger"},{"id":"redismodulecallreplydouble","title":"RedisModule_CallReplyDouble"},{"id":"redismodulecallreplybignumber","title":"RedisModule_CallReplyBigNumber"},{"id":"redismodulecallreplyverbatim","title":"RedisModule_CallReplyVerbatim"},{"id":"redismodulecallreplybool","title":"RedisModule_CallReplyBool"},{"id":"redismodulecallreplysetelement","title":"RedisModule_CallReplySetElement"},{"id":"redismodulecallreplymapelement","title":"RedisModule_CallReplyMapElement"},{"id":"redismodulecallreplyattribute","title":"RedisModule_CallReplyAttribute"},{"id":"redismodulecallreplyattributeelement","title":"RedisModule_CallReplyAttributeElement"},{"id":"redismodulecallreplypromisesetunblockhandler","title":"RedisModule_CallReplyPromiseSetUnblockHandler"},{"id":"redismodulecallreplypromiseabort","title":"RedisModule_CallReplyPromiseAbort"},{"id":"redismodulecallreplystringptr","title":"RedisModule_CallReplyStringPtr"},{"id":"redismodulecreatestringfromcallreply","title":"RedisModule_CreateStringFromCallReply"},{"id":"redismodulesetcontextuser","title":"RedisModule_SetContextUser"},{"id":"redismodulecall","title":"RedisModule_Call"},{"id":"redismodulecallreplyproto","title":"RedisModule_CallReplyProto"}],"id":"calling-redis-commands-from-modules","title":"Calling Redis commands from modules"},{"children":[{"id":"redismodulecreatedatatype","title":"RedisModule_CreateDataType"},{"id":"redismodulemoduletypesetvalue","title":"RedisModule_ModuleTypeSetValue"},{"id":"redismodulemoduletypegettype","title":"RedisModule_ModuleTypeGetType"},{"id":"redismodulemoduletypegetvalue","title":"RedisModule_ModuleTypeGetValue"}],"id":"modules-data-types","title":"Modules data types"},{"children":[{"id":"redismoduleisioerror","title":"RedisModule_IsIOError"},{"id":"redismodulesaveunsigned","title":"RedisModule_SaveUnsigned"},{"id":"redismoduleloadunsigned","title":"RedisModule_LoadUnsigned"},{"id":"redismodulesavesigned","title":"RedisModule_SaveSigned"},{"id":"redismoduleloadsigned","title":"RedisModule_LoadSigned"},{"id":"redismodulesavestring","title":"RedisModule_SaveString"},{"id":"redismodulesavestringbuffer","title":"RedisModule_SaveStringBuffer"},{"id":"redismoduleloadstring","title":"RedisModule_LoadString"},{"id":"redismoduleloadstringbuffer","title":"RedisModule_LoadStringBuffer"},{"id":"redismodulesavedouble","title":"RedisModule_SaveDouble"},{"id":"redismoduleloaddouble","title":"RedisModule_LoadDouble"},{"id":"redismodulesavefloat","title":"RedisModule_SaveFloat"},{"id":"redismoduleloadfloat","title":"RedisModule_LoadFloat"},{"id":"redismodulesavelongdouble","title":"RedisModule_SaveLongDouble"},{"id":"redismoduleloadlongdouble","title":"RedisModule_LoadLongDouble"}],"id":"rdb-loading-and-saving-functions","title":"RDB loading and saving functions"},{"children":[{"id":"redismoduledigestaddstringbuffer","title":"RedisModule_DigestAddStringBuffer"},{"id":"redismoduledigestaddlonglong","title":"RedisModule_DigestAddLongLong"},{"id":"redismoduledigestendsequence","title":"RedisModule_DigestEndSequence"},{"id":"redismoduleloaddatatypefromstringencver","title":"RedisModule_LoadDataTypeFromStringEncver"},{"id":"redismoduleloaddatatypefromstring","title":"RedisModule_LoadDataTypeFromString"},{"id":"redismodulesavedatatypetostring","title":"RedisModule_SaveDataTypeToString"},{"id":"redismodulegetkeynamefromdigest","title":"RedisModule_GetKeyNameFromDigest"},{"id":"redismodulegetdbidfromdigest","title":"RedisModule_GetDbIdFromDigest"}],"id":"key-digest-api-debug-digest-interface-for-modules-types","title":"Key digest API (DEBUG DIGEST interface for modules types)"},{"children":[{"id":"redismoduleemitaof","title":"RedisModule_EmitAOF"}],"id":"aof-api-for-modules-data-types","title":"AOF API for modules data types"},{"children":[{"id":"redismodulegetkeynamefromio","title":"RedisModule_GetKeyNameFromIO"},{"id":"redismodulegetkeynamefrommodulekey","title":"RedisModule_GetKeyNameFromModuleKey"},{"id":"redismodulegetdbidfrommodulekey","title":"RedisModule_GetDbIdFromModuleKey"},{"id":"redismodulegetdbidfromio","title":"RedisModule_GetDbIdFromIO"}],"id":"io-context-handling","title":"IO context handling"},{"children":[{"id":"redismodulelog","title":"RedisModule_Log"},{"id":"redismodulelogioerror","title":"RedisModule_LogIOError"},{"id":"redismoduleassert","title":"RedisModule__Assert"},{"id":"redismodulelatencyaddsample","title":"RedisModule_LatencyAddSample"}],"id":"logging","title":"Logging"},{"children":[{"id":"redismoduleregisterauthcallback","title":"RedisModule_RegisterAuthCallback"},{"id":"redismoduleblockclient","title":"RedisModule_BlockClient"},{"id":"redismoduleblockclientonauth","title":"RedisModule_BlockClientOnAuth"},{"id":"redismoduleblockclientgetprivatedata","title":"RedisModule_BlockClientGetPrivateData"},{"id":"redismoduleblockclientsetprivatedata","title":"RedisModule_BlockClientSetPrivateData"},{"id":"redismoduleblockclientonkeys","title":"RedisModule_BlockClientOnKeys"},{"id":"redismoduleblockclientonkeyswithflags","title":"RedisModule_BlockClientOnKeysWithFlags"},{"id":"redismodulesignalkeyasready","title":"RedisModule_SignalKeyAsReady"},{"id":"redismoduleunblockclient","title":"RedisModule_UnblockClient"},{"id":"redismoduleabortblock","title":"RedisModule_AbortBlock"},{"id":"redismodulesetdisconnectcallback","title":"RedisModule_SetDisconnectCallback"},{"id":"redismoduleisblockedreplyrequest","title":"RedisModule_IsBlockedReplyRequest"},{"id":"redismoduleisblockedtimeoutrequest","title":"RedisModule_IsBlockedTimeoutRequest"},{"id":"redismodulegetblockedclientprivatedata","title":"RedisModule_GetBlockedClientPrivateData"},{"id":"redismodulegetblockedclientreadykey","title":"RedisModule_GetBlockedClientReadyKey"},{"id":"redismodulegetblockedclienthandle","title":"RedisModule_GetBlockedClientHandle"},{"id":"redismoduleblockedclientdisconnected","title":"RedisModule_BlockedClientDisconnected"}],"id":"blocking-clients-from-modules","title":"Blocking clients from modules"},{"children":[{"id":"redismodulegetthreadsafecontext","title":"RedisModule_GetThreadSafeContext"},{"id":"redismodulegetdetachedthreadsafecontext","title":"RedisModule_GetDetachedThreadSafeContext"},{"id":"redismodulefreethreadsafecontext","title":"RedisModule_FreeThreadSafeContext"},{"id":"redismodulethreadsafecontextlock","title":"RedisModule_ThreadSafeContextLock"},{"id":"redismodulethreadsafecontexttrylock","title":"RedisModule_ThreadSafeContextTryLock"},{"id":"redismodulethreadsafecontextunlock","title":"RedisModule_ThreadSafeContextUnlock"}],"id":"thread-safe-contexts","title":"Thread Safe Contexts"},{"children":[{"id":"redismodulesubscribetokeyspaceevents","title":"RedisModule_SubscribeToKeyspaceEvents"},{"id":"redismoduleunsubscribefromkeyspaceevents","title":"RedisModule_UnsubscribeFromKeyspaceEvents"},{"id":"redismoduleaddpostnotificationjob","title":"RedisModule_AddPostNotificationJob"},{"id":"redismodulegetnotifykeyspaceevents","title":"RedisModule_GetNotifyKeyspaceEvents"},{"id":"redismodulenotifykeyspaceevent","title":"RedisModule_NotifyKeyspaceEvent"}],"id":"module-keyspace-notifications-api","title":"Module Keyspace Notifications API"},{"children":[{"id":"redismoduleregisterclustermessagereceiver","title":"RedisModule_RegisterClusterMessageReceiver"},{"id":"redismodulesendclustermessage","title":"RedisModule_SendClusterMessage"},{"id":"redismodulegetclusternodeslist","title":"RedisModule_GetClusterNodesList"},{"id":"redismodulefreeclusternodeslist","title":"RedisModule_FreeClusterNodesList"},{"id":"redismodulegetmyclusterid","title":"RedisModule_GetMyClusterID"},{"id":"redismodulegetclustersize","title":"RedisModule_GetClusterSize"},{"id":"redismodulegetclusternodeinfo","title":"RedisModule_GetClusterNodeInfo"},{"id":"redismodulesetclusterflags","title":"RedisModule_SetClusterFlags"},{"id":"redismoduleclusterdisabletrim","title":"RedisModule_ClusterDisableTrim"},{"id":"redismoduleclusterenabletrim","title":"RedisModule_ClusterEnableTrim"},{"id":"redismoduleclusterkeyslot","title":"RedisModule_ClusterKeySlot"},{"id":"redismoduleclusterkeyslotc","title":"RedisModule_ClusterKeySlotC"},{"id":"redismoduleclustercanonicalkeynameinslot","title":"RedisModule_ClusterCanonicalKeyNameInSlot"},{"id":"redismoduleclustercanaccesskeysinslot","title":"RedisModule_ClusterCanAccessKeysInSlot"},{"id":"redismoduleclusterpropagateforslotmigration","title":"RedisModule_ClusterPropagateForSlotMigration"},{"id":"redismoduleclustergetlocalslotranges","title":"RedisModule_ClusterGetLocalSlotRanges"},{"id":"redismoduleclusterfreeslotranges","title":"RedisModule_ClusterFreeSlotRanges"}],"id":"modules-cluster-api","title":"Modules Cluster API"},{"children":[{"id":"redismodulecreatetimer","title":"RedisModule_CreateTimer"},{"id":"redismodulestoptimer","title":"RedisModule_StopTimer"},{"id":"redismodulegettimerinfo","title":"RedisModule_GetTimerInfo"}],"id":"modules-timers-api","title":"Modules Timers API"},{"children":[{"id":"redismoduleeventloopadd","title":"RedisModule_EventLoopAdd"},{"id":"redismoduleeventloopdel","title":"RedisModule_EventLoopDel"},{"id":"redismoduleeventloopaddoneshot","title":"RedisModule_EventLoopAddOneShot"}],"id":"modules-eventloop-api","title":"Modules EventLoop API"},{"children":[{"id":"redismodulecreatemoduleuser","title":"RedisModule_CreateModuleUser"},{"id":"redismodulefreemoduleuser","title":"RedisModule_FreeModuleUser"},{"id":"redismodulesetmoduleuseracl","title":"RedisModule_SetModuleUserACL"},{"id":"redismodulesetmoduleuseraclstring","title":"RedisModule_SetModuleUserACLString"},{"id":"redismodulegetmoduleuseraclstring","title":"RedisModule_GetModuleUserACLString"},{"id":"redismodulegetcurrentusername","title":"RedisModule_GetCurrentUserName"},{"id":"redismodulegetmoduleuserfromusername","title":"RedisModule_GetModuleUserFromUserName"},{"id":"redismoduleaclcheckcommandpermissions","title":"RedisModule_ACLCheckCommandPermissions"},{"id":"redismoduleaclcheckkeypermissions","title":"RedisModule_ACLCheckKeyPermissions"},{"id":"redismoduleaclcheckkeyprefixpermissions","title":"RedisModule_ACLCheckKeyPrefixPermissions"},{"id":"redismoduleaclcheckchannelpermissions","title":"RedisModule_ACLCheckChannelPermissions"},{"id":"redismoduleacladdlogentry","title":"RedisModule_ACLAddLogEntry"},{"id":"redismoduleacladdlogentrybyusername","title":"RedisModule_ACLAddLogEntryByUserName"},{"id":"redismoduleauthenticateclientwithuser","title":"RedisModule_AuthenticateClientWithUser"},{"id":"redismoduleauthenticateclientwithacluser","title":"RedisModule_AuthenticateClientWithACLUser"},{"id":"redismoduledeauthenticateandcloseclient","title":"RedisModule_DeauthenticateAndCloseClient"},{"id":"redismoduleredactclientcommandargument","title":"RedisModule_RedactClientCommandArgument"},{"id":"redismodulegetclientcertificate","title":"RedisModule_GetClientCertificate"}],"id":"modules-acl-api","title":"Modules ACL API"},{"children":[{"id":"redismodulecreatedict","title":"RedisModule_CreateDict"},{"id":"redismodulefreedict","title":"RedisModule_FreeDict"},{"id":"redismoduledictsize","title":"RedisModule_DictSize"},{"id":"redismoduledictsetc","title":"RedisModule_DictSetC"},{"id":"redismoduledictreplacec","title":"RedisModule_DictReplaceC"},{"id":"redismoduledictset","title":"RedisModule_DictSet"},{"id":"redismoduledictreplace","title":"RedisModule_DictReplace"},{"id":"redismoduledictgetc","title":"RedisModule_DictGetC"},{"id":"redismoduledictget","title":"RedisModule_DictGet"},{"id":"redismoduledictdelc","title":"RedisModule_DictDelC"},{"id":"redismoduledictdel","title":"RedisModule_DictDel"},{"id":"redismoduledictiteratorstartc","title":"RedisModule_DictIteratorStartC"},{"id":"redismoduledictiteratorstart","title":"RedisModule_DictIteratorStart"},{"id":"redismoduledictiteratorstop","title":"RedisModule_DictIteratorStop"},{"id":"redismoduledictiteratorreseekc","title":"RedisModule_DictIteratorReseekC"},{"id":"redismoduledictiteratorreseek","title":"RedisModule_DictIteratorReseek"},{"id":"redismoduledictnextc","title":"RedisModule_DictNextC"},{"id":"redismoduledictprevc","title":"RedisModule_DictPrevC"},{"id":"redismoduledictnext","title":"RedisModule_DictNext"},{"id":"redismoduledictprev","title":"RedisModule_DictPrev"},{"id":"redismoduledictcomparec","title":"RedisModule_DictCompareC"},{"id":"redismoduledictcompare","title":"RedisModule_DictCompare"}],"id":"modules-dictionary-api","title":"Modules Dictionary API"},{"children":[{"id":"redismoduleinfoaddsection","title":"RedisModule_InfoAddSection"},{"id":"redismoduleinfobegindictfield","title":"RedisModule_InfoBeginDictField"},{"id":"redismoduleinfoenddictfield","title":"RedisModule_InfoEndDictField"},{"id":"redismoduleinfoaddfieldstring","title":"RedisModule_InfoAddFieldString"},{"id":"redismoduleinfoaddfieldcstring","title":"RedisModule_InfoAddFieldCString"},{"id":"redismoduleinfoaddfielddouble","title":"RedisModule_InfoAddFieldDouble"},{"id":"redismoduleinfoaddfieldlonglong","title":"RedisModule_InfoAddFieldLongLong"},{"id":"redismoduleinfoaddfieldulonglong","title":"RedisModule_InfoAddFieldULongLong"},{"id":"redismoduleregisterinfofunc","title":"RedisModule_RegisterInfoFunc"},{"id":"redismodulegetserverinfo","title":"RedisModule_GetServerInfo"},{"id":"redismodulefreeserverinfo","title":"RedisModule_FreeServerInfo"},{"id":"redismoduleserverinfogetfield","title":"RedisModule_ServerInfoGetField"},{"id":"redismoduleserverinfogetfieldc","title":"RedisModule_ServerInfoGetFieldC"},{"id":"redismoduleserverinfogetfieldsigned","title":"RedisModule_ServerInfoGetFieldSigned"},{"id":"redismoduleserverinfogetfieldunsigned","title":"RedisModule_ServerInfoGetFieldUnsigned"},{"id":"redismoduleserverinfogetfielddouble","title":"RedisModule_ServerInfoGetFieldDouble"}],"id":"modules-info-fields","title":"Modules Info fields"},{"children":[{"id":"redismodulegetrandombytes","title":"RedisModule_GetRandomBytes"},{"id":"redismodulegetrandomhexchars","title":"RedisModule_GetRandomHexChars"}],"id":"modules-utility-apis","title":"Modules utility APIs"},{"children":[{"id":"redismoduleexportsharedapi","title":"RedisModule_ExportSharedAPI"},{"id":"redismodulegetsharedapi","title":"RedisModule_GetSharedAPI"}],"id":"modules-api-exporting-importing","title":"Modules API exporting / importing"},{"children":[{"id":"redismoduleregistercommandfilter","title":"RedisModule_RegisterCommandFilter"},{"id":"redismoduleunregistercommandfilter","title":"RedisModule_UnregisterCommandFilter"},{"id":"redismodulecommandfilterargscount","title":"RedisModule_CommandFilterArgsCount"},{"id":"redismodulecommandfilterargget","title":"RedisModule_CommandFilterArgGet"},{"id":"redismodulecommandfilterarginsert","title":"RedisModule_CommandFilterArgInsert"},{"id":"redismodulecommandfilterargreplace","title":"RedisModule_CommandFilterArgReplace"},{"id":"redismodulecommandfilterargdelete","title":"RedisModule_CommandFilterArgDelete"},{"id":"redismodulecommandfiltergetclientid","title":"RedisModule_CommandFilterGetClientId"},{"id":"redismodulemallocsize","title":"RedisModule_MallocSize"},{"id":"redismodulemallocusablesize","title":"RedisModule_MallocUsableSize"},{"id":"redismodulemallocsizestring","title":"RedisModule_MallocSizeString"},{"id":"redismodulemallocsizedict","title":"RedisModule_MallocSizeDict"},{"id":"redismodulegetusedmemoryratio","title":"RedisModule_GetUsedMemoryRatio"}],"id":"module-command-filter-api","title":"Module Command Filter API"},{"children":[{"id":"redismodulescancursorcreate","title":"RedisModule_ScanCursorCreate"},{"id":"redismodulescancursorrestart","title":"RedisModule_ScanCursorRestart"},{"id":"redismodulescancursordestroy","title":"RedisModule_ScanCursorDestroy"},{"id":"redismodulescan","title":"RedisModule_Scan"},{"id":"redismodulescankey","title":"RedisModule_ScanKey"}],"id":"scanning-keyspace-and-hashes","title":"Scanning keyspace and hashes"},{"children":[{"id":"redismodulefork","title":"RedisModule_Fork"},{"id":"redismodulesendchildheartbeat","title":"RedisModule_SendChildHeartbeat"},{"id":"redismoduleexitfromchild","title":"RedisModule_ExitFromChild"},{"id":"redismodulekillforkchild","title":"RedisModule_KillForkChild"}],"id":"module-fork-api","title":"Module fork API"},{"children":[{"id":"redismodulesubscribetoserverevent","title":"RedisModule_SubscribeToServerEvent"},{"id":"redismoduleissubeventsupported","title":"RedisModule_IsSubEventSupported"}],"id":"server-hooks-implementation","title":"Server hooks implementation"},{"children":[{"id":"redismoduleregisterstringconfig","title":"RedisModule_RegisterStringConfig"},{"id":"redismoduleregisterboolconfig","title":"RedisModule_RegisterBoolConfig"},{"id":"redismoduleregisterenumconfig","title":"RedisModule_RegisterEnumConfig"},{"id":"redismoduleregisternumericconfig","title":"RedisModule_RegisterNumericConfig"},{"id":"redismoduleloaddefaultconfigs","title":"RedisModule_LoadDefaultConfigs"},{"id":"redismoduleloadconfigs","title":"RedisModule_LoadConfigs"}],"id":"module-configurations-api","title":"Module Configurations API"},{"children":[{"id":"redismodulerdbstreamcreatefromfile","title":"RedisModule_RdbStreamCreateFromFile"},{"id":"redismodulerdbstreamfree","title":"RedisModule_RdbStreamFree"},{"id":"redismodulerdbload","title":"RedisModule_RdbLoad"},{"id":"redismodulerdbsave","title":"RedisModule_RdbSave"},{"id":"redismodulegetinternalsecret","title":"RedisModule_GetInternalSecret"}],"id":"rdb-loadsave-api","title":"RDB load/save API"},{"children":[{"id":"redismoduleconfigiteratorcreate","title":"RedisModule_ConfigIteratorCreate"},{"id":"redismoduleconfigiteratorrelease","title":"RedisModule_ConfigIteratorRelease"},{"id":"redismoduleconfiggettype","title":"RedisModule_ConfigGetType"},{"id":"redismoduleconfigiteratornext","title":"RedisModule_ConfigIteratorNext"},{"id":"redismoduleconfigget","title":"RedisModule_ConfigGet"},{"id":"redismoduleconfiggetbool","title":"RedisModule_ConfigGetBool"},{"id":"redismoduleconfiggetenum","title":"RedisModule_ConfigGetEnum"},{"id":"redismoduleconfiggetnumeric","title":"RedisModule_ConfigGetNumeric"},{"id":"redismoduleconfigset","title":"RedisModule_ConfigSet"},{"id":"redismoduleconfigsetbool","title":"RedisModule_ConfigSetBool"},{"id":"redismoduleconfigsetenum","title":"RedisModule_ConfigSetEnum"},{"id":"redismoduleconfigsetnumeric","title":"RedisModule_ConfigSetNumeric"}],"id":"config-access-api","title":"Config access API"},{"children":[{"id":"redismodulesetlru","title":"RedisModule_SetLRU"},{"id":"redismodulegetlru","title":"RedisModule_GetLRU"},{"id":"redismodulesetlfu","title":"RedisModule_SetLFU"},{"id":"redismodulegetlfu","title":"RedisModule_GetLFU"}],"id":"key-eviction-api","title":"Key eviction API"},{"children":[{"id":"redismodulegetmoduleoptionsall","title":"RedisModule_GetModuleOptionsAll"},{"id":"redismodulegetcontextflagsall","title":"RedisModule_GetContextFlagsAll"},{"id":"redismodulegetkeyspacenotificationflagsall","title":"RedisModule_GetKeyspaceNotificationFlagsAll"},{"id":"redismodulegetserverversion","title":"RedisModule_GetServerVersion"},{"id":"redismodulegettypemethodversion","title":"RedisModule_GetTypeMethodVersion"},{"id":"redismodulemoduletypereplacevalue","title":"RedisModule_ModuleTypeReplaceValue"},{"id":"redismodulegetcommandkeyswithflags","title":"RedisModule_GetCommandKeysWithFlags"},{"id":"redismodulegetcommandkeys","title":"RedisModule_GetCommandKeys"},{"id":"redismodulegetcurrentcommandname","title":"RedisModule_GetCurrentCommandName"}],"id":"miscellaneous-apis","title":"Miscellaneous APIs"},{"children":[{"id":"redismoduleregisterdefragfunc","title":"RedisModule_RegisterDefragFunc"},{"id":"redismoduleregisterdefragfunc2","title":"RedisModule_RegisterDefragFunc2"},{"id":"redismoduleregisterdefragcallbacks","title":"RedisModule_RegisterDefragCallbacks"},{"id":"redismoduledefragshouldstop","title":"RedisModule_DefragShouldStop"},{"id":"redismoduledefragcursorset","title":"RedisModule_DefragCursorSet"},{"id":"redismoduledefragcursorget","title":"RedisModule_DefragCursorGet"},{"id":"redismoduledefragalloc","title":"RedisModule_DefragAlloc"},{"id":"redismoduledefragallocraw","title":"RedisModule_DefragAllocRaw"},{"id":"redismoduledefragfreeraw","title":"RedisModule_DefragFreeRaw"},{"id":"redismoduledefragredismodulestring","title":"RedisModule_DefragRedisModuleString"},{"id":"redismoduledefragredismoduledict","title":"RedisModule_DefragRedisModuleDict"},{"id":"redismodulegetkeynamefromdefragctx","title":"RedisModule_GetKeyNameFromDefragCtx"},{"id":"redismodulegetdbidfromdefragctx","title":"RedisModule_GetDbIdFromDefragCtx"}],"id":"defrag-api","title":"Defrag API"},{"id":"function-index","title":"Function index"}]}
...
If cluster mode is disabled, the array will include all slots (0â16383).
