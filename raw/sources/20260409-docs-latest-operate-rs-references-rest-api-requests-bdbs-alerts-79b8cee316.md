...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/alerts/
retrieved_utc: '2026-04-09T20:46:01.892403+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/alerts/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"},{"id":"status-codes-get-all-status-codes","title":"Status codes {#get-all-status-codes}"}],"id":"get-all-database-alerts-get-all-bdbs-alerts","title":"Get all database alerts {#get-all-bdbs-alerts}"},{"children":[{"id":"request-get-request-alerts","title":"Request {#get-request-alerts}"},{"id":"response-get-response-alerts","title":"Response {#get-response-alerts}"},{"id":"status-codes-get-status-codes-alerts","title":"Status codes {#get-status-codes-alerts}"}],"id":"get-database-alerts-get-bdbs-alerts","title":"Get database alerts {#get-bdbs-alerts}"},{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-database-alert-get-bdbs-alert","title":"Get database alert {#get-bdbs-alert}"},{"children":[{"id":"request-post-request","title":"Request {#post-request}"},{"id":"response-post-response","title":"Response {#post-response}"},{"id":"status-codes-post-status-codes","title":"Status codes {#post-status-codes}"}],"id":"update-database-alert-post-bdbs-alerts","title":"Update database alert {#post-bdbs-alerts}"}]}
