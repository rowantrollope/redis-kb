...
retrieved_utc: '2026-04-09T20:46:01.632470+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/acl-genpass/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"display_text":"bits","name":"bits","optional":true,"type":"integer"}],
