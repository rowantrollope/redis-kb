...
retrieved_utc: '2026-04-09T20:45:51.598546+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/administration/configuration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"search-bg-index-sleep-gap","title":"search-bg-index-sleep-gap"},{"id":"search-bg-index-sleep-duration-us","title":"search-bg-index-sleep-duration-us"},{"id":"search-concurrent-write-mode","title":"search-concurrent-write-mode"},{"id":"search-conn-per-shard","title":"search-conn-per-shard"},{"id":"search-cursor-max-idle","title":"search-cursor-max-idle"},{"id":"search-cursor-read-size","title":"search-cursor-read-size"},{"id":"search-cursor-reply-threshold","title":"search-cursor-reply-threshold"},{"id":"search-default-dialect","title":"search-default-dialect"},{"id":"search-ext-load","title":"search-ext-load"},{"id":"search-fork-gc-clean-numeric-empty-nodes","title":"search-fork-gc-clean-numeric-empty-nodes"},{"id":"search-fork-gc-clean-threshold","title":"search-fork-gc-clean-threshold"},{"id":"search-fork-gc-retry-interval","title":"search-fork-gc-retry-interval"},{"id":"search-fork-gc-run-interval","title":"search-fork-gc-run-interval"},{"id":"search-fork-gc-sleep-before-exit","title":"search-fork-gc-sleep-before-exit"},{"id":"search-friso-ini","title":"search-friso-ini"},{"id":"gcpolicy","title":"GC_POLICY"},{"id":"search-gc-scan-size","title":"search-gc-scan-size"},{"id":"search-index-cursor-limit","title":"search-index-cursor-limit"},{"id":"search-max-aggregate-results","title":"search-max-aggregate-results"},{"id":"search-max-doctablesize","title":"search-max-doctablesize"},{"id":"search-max-expansions","title":"search-max-expansions"},{"id":"search-max-prefix-expansions","title":"search-max-prefix-expansions"},{"id":"search-max-search-results","title":"search-max-search-results"},{"id":"search-min-operation-workers","title":"search-min-operation-workers"},{"id":"search-min-phonetic-term-len","title":"search-min-phonetic-term-len"},{"id":"search-min-prefix","title":"search-min-prefix"},{"id":"search-min-stem-len","title":"search-min-stem-len"},{"id":"search-multi-text-slop","title":"search-multi-text-slop"},{"id":"search-no-mem-pools","title":"search-no-mem-pools"},{"id":"search-no-gc","title":"search-no-gc"},{"id":"search-on-timeout","title":"search-on-timeout"},{"id":"search-partial-indexed-docs","title":"search-partial-indexed-docs"},{"id":"search-raw-docid-encoding","title":"search-raw-docid-encoding"},{"id":"search-threads","title":"search-threads"},{"id":"search-io-threads","title":"search-io-threads"},{"id":"search-tiered-hnsw-buffer-limit","title":"search-tiered-hnsw-buffer-limit"},{"id":"search-timeout","title":"search-timeout"},{"id":"search-topology-validation-timeout","title":"search-topology-validation-timeout"},{"id":"search-union-iterator-heap","title":"search-union-iterator-heap"},{"id":"search-upgrade-index","title":"search-upgrade-index"},{"id":"search-vss-max-resize","title":"search-vss-max-resize"},{"id":"search-workers-priority-bias-threshold","title":"search-workers-priority-bias-threshold"},{"id":"search-workers","title":"search-workers"},{"id":"search-on-oom","title":"search-on-oom"}],"id":"redis-search-configuration-parameters","title":"Redis Search configuration parameters"},{"id":"set-configuration-parameters-at-module-load-time-deprecated","title":"Set configuration parameters at module load-time (deprecated)"},{"id":"set-configuration-parameters-at-run-time-for-supported-parameters-deprecated","title":"Set configuration parameters at run-time (for supported parameters, deprecated)"}]}
...
The default
[DIALECT]()
to be used by [`FT.CREATE`](), [`FT.AGGREGATE`](), [`FT.EXPLAIN`](), [`FT.EXPLAINCLI`](), and [`FT.SPELLCHECK`]().
See [Query dialects]()
