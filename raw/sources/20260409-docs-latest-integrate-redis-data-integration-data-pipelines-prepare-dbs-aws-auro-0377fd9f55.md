...
retrieved_utc: '2026-04-09T20:45:51.831945+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/aws-aurora-rds/aws-aur-pgsql/index.html.md
---
...
```json metadata
{
  ...
  "categories": ["docs","integrate","rs","rc","rdi"],
  "group": "di",
  "tableOfContents": {"sections":[{"id":"create-and-apply-parameter-group","title":"Create and apply parameter group"},{"id":"create-debezium-user","title":"Create Debezium user"}]}

,
  "codeExamples": [{"id":"create-a-parameter-group"},{"id":"apply-the-parameter-group"},{"id":"apply-the-parameter-group-to-the-database"},{"id":"reboot-the-database-instance"},{"id":"connect-to-postgresql-as-the-postgres-user"},{"id":"grant-the-user-the-necessary-replication-permissions"},{"id":"grant-the-user-access-to-the-database"},{"id":"allow-connection-from-debezium-user"},{"id":"grant-usage-to-schema"},{"id":"grant-privileges-for-the-future"},{"id":"create-publication"}]
}
```
