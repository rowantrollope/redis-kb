---
title: Logs
url: https://redis.io/docs/latest/operate/kubernetes/logs/
retrieved_utc: '2026-04-09T20:45:58.586652+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/logs/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"log-collection-and-access","title":"Log collection and access"},{"id":"log-storage-and-access","title":"Log storage and access"}]}
