---
title: Redis 8.6
url: https://redis.io/docs/latest/develop/whats-new/8-6/
retrieved_utc: '2026-04-09T20:45:52.514141+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/whats-new/8-6/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"security-improvements","title":"Security improvements"},{"children":[{"id":"stream-idempotency","title":"Stream idempotency"},{"id":"enhanced-memory-management","title":"Enhanced memory management"},{"id":"hot-key-detection","title":"Hot key detection"},{"id":"tls-certificate-based-authentication","title":"TLS certificate-based authentication"},{"id":"enhanced-time-series-capabilities","title":"Enhanced time series capabilities"},{"id":"memory-monitoring-and-analytics","title":"Memory monitoring and analytics"}],"id":"new-features","title":"New features"},{"children":[{"id":"performance-optimizations","title":"Performance optimizations"},{"id":"replication-improvements","title":"Replication improvements"}],"id":"improvements","title":"Improvements"},{"id":"configuration-enhancements","title":"Configuration enhancements"},{"id":"modules-api-enhancements","title":"Modules API enhancements"},{"id":"enhanced-monitoring-and-metrics","title":"Enhanced monitoring and metrics"},{"id":"component-versions","title":"Component versions"},{"id":"known-limitations","title":"Known limitations"}]}
