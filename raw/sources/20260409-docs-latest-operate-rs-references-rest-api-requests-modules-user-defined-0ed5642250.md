...
retrieved_utc: '2026-04-09T20:45:36.423803+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/modules/user-defined/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-local-artifacts-request","title":"Request {#get-local-artifacts-request}"},{"id":"response-get-local-artifacts-response","title":"Response {#get-local-artifacts-response}"},{"id":"status-codes-get-local-artifacts-status-codes","title":"Status codes {#get-local-artifacts-status-codes}"}],"id":"list-custom-module-artifacts-get-local-user-defined-artifacts","title":"List custom module artifacts {#get-local-user-defined-artifacts}"},{"children":[{"id":"request-post-user-defined-request","title":"Request {#post-user-defined-request}"},{"id":"response-post-user-defined-response","title":"Response {#post-user-defined-response}"},{"id":"status-codes-post-user-defined-status-codes","title":"Status codes {#post-user-defined-status-codes}"}],"id":"upload-custom-module-configuration-post-user-defined-module","title":"Upload custom module configuration {#post-user-defined-module}"},{"children":[{"id":"request-post-local-artifacts-request","title":"Request {#post-local-artifacts-request}"},{"id":"response-post-local-artifacts-response","title":"Response {#post-local-artifacts-response}"},{"id":"status-codes-post-local-artifacts-status-codes","title":"Status codes {#post-local-artifacts-status-codes}"}],"id":"upload-custom-module-artifact-to-a-node-post-local-user-defined-artifacts","title":"Upload custom module artifact to a node {#post-local-user-defined-artifacts}"},{"children":[{"id":"request-delete-user-defined-request","title":"Request {#delete-user-defined-request}"},{"id":"response-delete-user-defined-response","title":"Response {#delete-user-defined-response}"},{"id":"status-codes-delete-user-defined-status-codes","title":"Status codes {#delete-user-defined-status-codes}"}],"id":"delete-custom-module-delete-user-defined-module","title":"Delete custom module {#delete-user-defined-module}"},{"children":[{"id":"request-delete-local-artifacts-request","title":"Request {#delete-local-artifacts-request}"},{"id":"response-delete-local-artifacts-response","title":"Response {#delete-local-artifacts-response}"},{"id":"status-codes-delete-local-artifacts-status-codes","title":"Status codes {#delete-local-artifacts-status-codes}"}],"id":"delete-custom-module-artifact-from-a-nodedelete-local-user-defined-artifacts","title":"Delete custom module artifact from a node{#delete-local-user-defined-artifacts}"}]}
