...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/usage_report/
retrieved_utc: '2026-04-09T20:45:36.466934+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/usage_report/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-usage-report-get-usage-report","title":"Get usage report {#get-usage-report}"}]}
