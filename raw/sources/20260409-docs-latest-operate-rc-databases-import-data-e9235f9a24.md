...
url: https://redis.io/docs/latest/operate/rc/databases/import-data/
retrieved_utc: '2026-04-09T20:45:55.542117+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/import-data/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"import-from-a-redis-server-redis-server","title":"Import from a Redis server {#redis-server}"},{"id":"restore-from-an-rdb-file","title":"Restore from an RDB file"}]}
