...
url: https://redis.io/docs/latest/operate/rs/databases/import-export/replica-of/
retrieved_utc: '2026-04-09T20:46:06.934413+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/import-export/replica-of/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"replica-of-status","title":"Replica Of status"},{"id":"synchronization-errors","title":"Synchronization errors"}],"id":"replication-process","title":"Replication process"},{"id":"encryption","title":"Encryption"},{"id":"data-compression-for-replica-of","title":"Data compression for Replica Of"},{"children":[{"id":"synchronization-in-active-passive-replication","title":"Synchronization in Active-Passive Replication"}],"id":"database-clustering-sharding-implications","title":"Database clustering (sharding) implications"},{"id":"active-passive-replication-backlog","title":"Active-Passive replication backlog"}]}
...
You can [create Active-Passive]() databases on Redis Software or Redis Cloud.
...
A destination database can have a maximum of thirty-two (32)Â source
databases.
...
Compressing the data does haveÂ trade-offs, which is why it should not
