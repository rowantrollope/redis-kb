...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/synchronization-mode/
retrieved_utc: '2026-04-09T20:45:59.619980+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/synchronization-mode/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"configure-distributed-synchronization","title":"Configure distributed synchronization"},{"id":"verify-database-synchronization","title":"Verify database synchronization"}]}

,
  "codeExamples": []
}
```Replicated databases, such as [Replica Of]() and [Active-Active]() databases,
