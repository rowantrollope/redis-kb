...
url: https://redis.io/docs/latest/operate/rs/databases/configure/db-defaults/
retrieved_utc: '2026-04-09T20:45:54.144656+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/configure/db-defaults/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"edit-database-defaults","title":"Edit database defaults"},{"children":[{"id":"endpoint-configuration","title":"Endpoint configuration"},{"id":"database-proxy","title":"Database proxy"},{"id":"shards-placement","title":"Shards placement"},{"id":"database-version","title":"Database version"},{"id":"internode-encryption","title":"Internode encryption"}],"id":"database-defaults-db-defaults","title":"Database defaults {#db-defaults}"}]}
...
Redis Software uses [proxies]() to manage and optimize access to database shards. Each node in the cluster runs a single proxy process, which can be active (receives incoming traffic) or passive (waits for failovers).
