...
url: https://redis.io/docs/latest/operate/rs/security/access-control/manage-passwords/rotate-passwords/
retrieved_utc: '2026-04-09T20:45:59.241095+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/access-control/manage-passwords/rotate-passwords/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"password-rotation-policies","title":"Password rotation policies"},{"id":"rotate-password","title":"Rotate password"},{"id":"replace-all-passwords","title":"Replace all passwords"}]}
