...
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/hybrid_queries/
retrieved_utc: '2026-04-09T20:45:52.443703+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/hybrid_queries/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"tag-filters","title":"Tag Filters"},{"id":"numeric-filters","title":"Numeric Filters"},{"id":"timestamp-filters","title":"Timestamp Filters"},{"id":"text-filters","title":"Text Filters"},{"id":"geographic-filters","title":"Geographic Filters"}],"id":"hybrid-queries","title":"Hybrid Queries"},{"children":[{"id":"intersection-and","title":"Intersection (\"and\")"},{"id":"union-or","title":"Union (\"or\")"},{"id":"dynamic-combination","title":"Dynamic Combination"}],"id":"combining-filters","title":"Combining Filters"},{"id":"non-vector-queries","title":"Non-vector Queries"},{"id":"count-queries","title":"Count Queries"},{"id":"range-queries","title":"Range Queries"},{"children":[{"id":"raw-redis-query-string","title":"Raw Redis Query String"}],"id":"advanced-query-modifiers","title":"Advanced Query Modifiers"}]}
