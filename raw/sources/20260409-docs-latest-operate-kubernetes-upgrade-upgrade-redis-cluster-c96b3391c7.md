...
url: https://redis.io/docs/latest/operate/kubernetes/upgrade/upgrade-redis-cluster/
retrieved_utc: '2026-04-09T20:45:54.346478+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/upgrade/upgrade-redis-cluster/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"kubernetes-version","title":"Kubernetes version"},{"id":"redis-operator-version","title":"Redis operator version"},{"id":"redis-database-version","title":"Redis database version"},{"id":"user-defined-modules","title":"User-defined modules"},{"id":"valid-license","title":"Valid license"}],"id":"prerequisites","title":"Prerequisites"},{"id":"upgrade-with-helm-charts","title":"Upgrade with Helm charts"},{"children":[{"id":"download-the-bundle","title":"Download the bundle"},{"id":"apply-the-bundle","title":"Apply the bundle"},{"id":"reapply-the-admission-controller-webhook-reapply-webhook","title":"Reapply the admission controller webhook {#reapply-webhook}"},{"id":"verify-the-operator-is-running","title":"Verify the operator is running"}],"id":"upgrade-the-operator","title":"Upgrade the operator"},{"children":[{"id":"edit-redisenterpriseimagespec-in-the-rec-spec","title":"Edit redisEnterpriseImageSpec in the REC spec"},{"id":"reapply-roles-and-role-bindings","title":"Reapply roles and role bindings"},{"id":"monitor-the-upgrade","title":"Monitor the upgrade"}],"id":"upgrade-the-redis-enterprise-cluster-rec","title":"Upgrade the Redis Enterprise cluster (REC)"},{"children":[{"id":"upgrade-redb","title":"Upgrade REDB"},{"id":"upgrade-reaadb","title":"Upgrade REAADB"},{"id":"upgrade-with-user-defined-modules","title":"Upgrade with user-defined modules"},{"id":"upgrade-policy","title":"Upgrade policy"}],"id":"upgrade-databases","title":"Upgrade databases"},{"children":[{"id":"user-defined-modules","title":"User-defined modules"},{"id":"invalid-module-version","title":"Invalid module version"},{"id":"invalid-database-version","title":"Invalid database version"}],"id":"troubleshooting","title":"Troubleshooting"}]}
...
Check [Supported Kubernetes distributions]() to make sure your Kubernetes distribution is supported by your target Redis Enterprise operator version. If not, upgrade your Kubernetes distribution before upgrading the Redis operator.

### Redis operator version

Check the [Redis Enterprise for Kubernetes release notes]() for the minimum operator version required for your target upgrade. Some versions may require intermediate upgrades.

### Redis database version

Check the release notes for your target version to determine the minimum Redis database version required. See [upgrade databases](#upgrade-databases) for detailed steps. You can find your database version in the [REDB `spec.redisVersion` field]().
...
For detailed Helm upgrade instructions, see [Upgrade the chart]().
...
Before beginning the upgrade of the Redis Enterprise cluster, check the [Redis Enterprise for Kubernetes release notes]() to find the Redis Enterprise image tag for your target version.
...
If a user-defined module is used by any database in the cluster, the module must be defined in the REC custom resource before upgrading the database. See [Add user-defined modules to the REC]() for detailed instructions.
