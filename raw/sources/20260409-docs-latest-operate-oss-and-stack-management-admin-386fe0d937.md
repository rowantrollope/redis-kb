...
retrieved_utc: '2026-04-09T20:45:51.537799+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/management/admin/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"linux","title":"Linux"},{"id":"memory","title":"Memory"},{"id":"imaging","title":"Imaging"},{"id":"replication","title":"Replication"},{"id":"security","title":"Security"}],"id":"redis-setup-tips","title":"Redis setup tips"},{"id":"running-redis-on-ec2","title":"Running Redis on EC2"},{"id":"upgrading-or-restarting-a-redis-instance-without-downtime","title":"Upgrading or restarting a Redis instance without downtime"}]}
