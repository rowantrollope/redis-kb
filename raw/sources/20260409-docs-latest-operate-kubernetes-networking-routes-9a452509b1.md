...
url: https://redis.io/docs/latest/operate/kubernetes/networking/routes/
retrieved_utc: '2026-04-09T20:45:55.254191+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/networking/routes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-openshift-route","title":"Create OpenShift route"},{"id":"access-database","title":"Access database"}]}
