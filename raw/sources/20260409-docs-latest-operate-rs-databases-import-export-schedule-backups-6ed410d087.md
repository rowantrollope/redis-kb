...
url: https://redis.io/docs/latest/operate/rs/databases/import-export/schedule-backups/
retrieved_utc: '2026-04-09T20:45:57.370248+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/import-export/schedule-backups/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"schedule-periodic-backups","title":"Schedule periodic backups"},{"id":"default-backup-start-time","title":"Default backup start time"},{"children":[{"id":"ftp-server","title":"FTP server"},{"id":"sftp-server","title":"SFTP server"},{"id":"local-mount-point","title":"Local mount point"},{"id":"aws-simple-storage-service","title":"AWS Simple Storage Service"},{"id":"google-cloud-storage","title":"Google Cloud Storage"},{"id":"azure-blob-storage","title":"Azure Blob Storage"}],"id":"supported-storage-locations-supported-storage-locations","title":"Supported storage locations {#supported-storage-locations}"}]}
...
When saved to a local mount point or a cloud provider, backup locations need to be available to [the group and user]() running Redis Software, `redislabs:redislabs` by default.  
