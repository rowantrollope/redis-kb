...
retrieved_utc: '2026-04-09T20:45:35.814030+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/ts.mrevrange/index.html.md
---
...
- [Array reply](): timestamp-value pairs ([Integer reply](), [Double reply]()) representing all samples/aggregations matching the range in reverse chronological order
