...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-105/
retrieved_utc: '2026-04-09T20:45:59.004264+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-105/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"enhancements","title":"Enhancements"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"security","title":"Security"}]}
...
- LDAP authentication timeout `directory_timeout_s` is now configurable using a [`PUT /v1/cluster/ldap`]() REST API request.
...
- RS107974: Increased retry count for join requests in case the local CCS isnât available.
...
| [**End-of-life date**]() | â | Feb<br />2025 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 | Aug<br />2024 |
...
| 8.9| <span title="Supported">&#x2705;</span></span><sup>[9](#table-note-9)</sup> | â | â | â | â | â | â |
| 8.8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[8](#table-note-8)</sup> | â | â | â | â | â |
...
9. <a name="table-note-9" style="display: block; height: 80px; margin-top: -80px;"></a>Redis Enterprise Software [7.2.4-105]() and later supports RHEL 8.9.
