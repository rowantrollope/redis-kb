...
url: https://redis.io/docs/latest/operate/rs/security/access-control/manage-passwords/active-active-admin-credentials/
retrieved_utc: '2026-04-09T20:46:00.389220+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/access-control/manage-passwords/active-active-admin-credentials/index.html.md
---
...
1. Update the Active-Active database credentials using the [`crdb-cli crdb update`]() command:
