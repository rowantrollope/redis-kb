...
url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/mongodb/
retrieved_utc: '2026-04-09T20:45:52.385811+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/mongodb/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"summary","title":"Summary"},{"id":"1-configure-oplog-size","title":"1. Configure oplog size"},{"id":"2-create-a-mongodb-user-for-rdi","title":"2. Create a MongoDB user for RDI"},{"id":"3-connection-string-format","title":"3. Connection string format"},{"id":"4-enable-change-streams-and-prepost-images-only-if-using-a-custom-key","title":"4. Enable change streams and pre/post images (only if using a custom key)"},{"id":"5-mongodb-atlas-specific-requirements","title":"5. MongoDB Atlas specific requirements"},{"id":"6-network-and-security","title":"6. Network and security"},{"id":"7-configuration-is-complete","title":"7. Configuration is complete"},{"id":"see-also","title":"See also"}]}
