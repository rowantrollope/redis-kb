---
title: Development
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/development/
retrieved_utc: '2026-04-09T20:45:52.840542+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/development/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"example-project-setup","title":"Example project setup"},{"id":"example-function-using-a-third-party-npm-package","title":"Example function using a third-party npm package"}]}
