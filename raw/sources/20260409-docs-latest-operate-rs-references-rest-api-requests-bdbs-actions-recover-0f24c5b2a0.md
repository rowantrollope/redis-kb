...
retrieved_utc: '2026-04-09T20:46:06.583204+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/actions/recover/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-recovery-plan-get-bdbs-actions-recover","title":"Get recovery plan {#get-bdbs-actions-recover}"},{"children":[{"id":"request-post-request","title":"Request {#post-request}"},{"id":"response-post-response","title":"Response {#post-response}"}],"id":"recover-database-post-bdbs-actions-recover","title":"Recover database {#post-bdbs-actions-recover}"}]}
