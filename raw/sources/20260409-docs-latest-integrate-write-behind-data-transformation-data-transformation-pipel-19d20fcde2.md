...
retrieved_utc: '2026-04-09T20:45:55.493544+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/write-behind/data-transformation/data-transformation-pipeline/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"children":[{"id":"example","title":"Example"}],"id":"default-job","title":"Default job"},{"children":[{"id":"job-yaml-structure","title":"Job YAML structure"},{"id":"example","title":"Example"},{"id":"deploy-configuration","title":"Deploy configuration"},{"id":"deploy-configuration-on-kubernetes","title":"Deploy configuration on Kubernetes"}],"id":"jobs","title":"Jobs"}]}
