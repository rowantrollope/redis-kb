...
url: https://redis.io/docs/latest/operate/rs/databases/durability-ha/discovery-service/
retrieved_utc: '2026-04-09T20:45:56.295095+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/durability-ha/discovery-service/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"how-discovery-service-works","title":"How discovery service works"},{"id":"redis-client-support","title":"Redis client support"}]}
...
We recommend these clients that are tested for use with theÂ [Discovery Service]() that uses the Redis Sentinel API:
