...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-4-june-2019/
retrieved_utc: '2026-04-09T20:46:00.140361+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-4-4-june-2019/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"active-active-redis-with-rof-activeactive-redis-with-rof","title":"Active-Active Redis with RoF {#activeactive-redis-with-rof}"},{"id":"support-for-multiple-modules","title":"Support for multiple modules"}],"id":"new-features","title":"New features"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"information","title":"Information"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"upgrade","title":"Upgrade"},{"id":"subscriptions","title":"Subscriptions"},{"id":"cluster-api","title":"Cluster API"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
- Node upgrade fails if the SSL certificates were configured in version 5.0.2 or above by manually updating the certificates on the disk instead of [updating them through the API](). For assistance with this issue, [contact Redis support](https://redislabs.com/company/support/).
