...
url: https://redis.io/docs/latest/operate/kubernetes/active-active/global-db-secret/
retrieved_utc: '2026-04-09T20:45:57.978711+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/active-active/global-db-secret/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"set-global-database-secret","title":"Set global database secret"}]}
