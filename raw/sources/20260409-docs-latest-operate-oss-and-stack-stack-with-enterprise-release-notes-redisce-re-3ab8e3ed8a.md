...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.6-release-notes/
retrieved_utc: '2026-04-09T20:45:55.780786+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.6-release-notes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"bug-fixes","title":"Bug fixes"}],"id":"redis-open-source-862-march-2026","title":"Redis Open Source 8.6.2 (March 2026)"},{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"bug-fixes","title":"Bug fixes"}],"id":"redis-open-source-861-february-2026","title":"Redis Open Source 8.6.1 (February 2026)"},{"children":[{"id":"major-changes-compared-to-84","title":"Major changes compared to 8.4"},{"id":"binary-distributions","title":"Binary distributions"},{"id":"operating-systems-we-test-redis-86-on","title":"Operating systems we test Redis 8.6 on"},{"id":"new-features-compared-to-86-rc1","title":"New Features (compared to 8.6-RC1)"},{"id":"performance-and-resource-utilization-improvements-compared-to-86-rc1","title":"Performance and resource utilization improvements (compared to 8.6-RC1)"},{"id":"configuration-parameters","title":"Configuration parameters"},{"id":"metrics","title":"Metrics"},{"id":"known-bugs-and-limitations","title":"Known bugs and limitations"}],"id":"redis-open-source-860-february-2026","title":"Redis Open Source 8.6.0 (February 2026)"},{"children":[{"id":"binary-distributions","title":"Binary distributions"},{"id":"operating-systems-we-test-redis-86-on","title":"Operating systems we test Redis 8.6 on"},{"id":"new-features-compared-to-840","title":"New Features (compared to 8.4.0)"},{"id":"security-and-privacy-fixes","title":"Security and privacy fixes"},{"id":"bug-fixes-compared-to-840","title":"Bug fixes (compared to 8.4.0)"},{"id":"performance-and-resource-utilization-improvements-compared-to-840","title":"Performance and resource utilization improvements (compared to 8.4.0)"},{"id":"modules-api","title":"Modules API"},{"id":"configuration-parameters","title":"Configuration parameters"},{"id":"metrics","title":"Metrics"},{"id":"known-bugs-and-limitations","title":"Known bugs and limitations"}],"id":"redis-open-source-86-rc1-january-2026","title":"Redis Open Source 8.6-RC1 (January 2026)"}]}
...
- [#14623](https://github.com/redis/redis/pull/14623) Streams: `XTRIM`/`XADD` with approx mode (`~`) donât delete entries for `DELREF`/`ACKED` strategies.
...
### Metrics
- [#14610](https://github.com/redis/redis/pull/14610) `acl_access_denied_tls_cert` - failed TLS certificateâbased authentication attempts.
