...
url: https://redis.io/docs/latest/operate/rs/databases/configure/database-persistence/
retrieved_utc: '2026-04-09T20:45:56.444109+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/configure/database-persistence/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"configure-database-persistence","title":"Configure database persistence"},{"id":"data-persistence-options","title":"Data persistence options"},{"id":"select-a-persistence-strategy","title":"Select a persistence strategy"},{"id":"append-only-file-aof-vs-snapshot-rdb","title":"Append-only file (AOF) vs snapshot (RDB)"},{"id":"active-active-data-persistence","title":"Active-Active data persistence"},{"id":"auto-tiering-data-persistence","title":"Auto Tiering data persistence"}]}
