...
url: https://redis.io/docs/latest/operate/rc/databases/rdi/rds-proxy/
retrieved_utc: '2026-04-09T20:46:01.093397+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/rdi/rds-proxy/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"iam-permissions","title":"IAM permissions"}],"id":"create-rds-proxy","title":"Create RDS Proxy"},{"id":"get-the-rds-proxy-ip-address","title":"Get the RDS Proxy IP address"},{"id":"configure-the-network-load-balancer","title":"Configure the Network Load Balancer"},{"id":"next-steps","title":"Next steps"}]}
...
When you [create the Network Load Balancer](), use the RDS Proxy IP address instead of the database IP address:
...
4. Complete the remaining Network Load Balancer setup as described in the [main setup guide]().

## Next steps

After setting up RDS Proxy and the Network Load Balancer:

1. [Create an endpoint service]() through AWS PrivateLink.
2. [Share your source database credentials]() with Redis Cloud.
3. Continue with the [RDI pipeline configuration]().
