...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/previous-releases/k8s-6-0-6-23/
retrieved_utc: '2026-04-09T20:45:59.453593+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/previous-releases/k8s-6-0-6-23/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"images","title":"Images"},{"id":"new-features","title":"New features"},{"id":"important-fixes","title":"Important fixes"},{"id":"known-limitations","title":"Known limitations"},{"id":"deprecation-notice","title":"Deprecation notice"},{"id":"compatibility-updates","title":"Compatibility updates"}]}
