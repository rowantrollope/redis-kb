...
url: https://redis.io/docs/latest/operate/rs/installing-upgrading/upgrading/upgrade-active-active/
retrieved_utc: '2026-04-09T20:45:59.105084+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/installing-upgrading/upgrading/upgrade-active-active/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"upgrade-an-active-active-database","title":"Upgrade an Active-Active database"},{"id":"check-database-status","title":"Check database status"},{"children":[{"id":"crdb-protocol-version-guidelines","title":"CRDB protocol version guidelines"}],"id":"upgrade-database-instances","title":"Upgrade database instances"},{"children":[{"id":"feature-version-guidelines","title":"Feature version guidelines"}],"id":"upgrade-featureset-version","title":"Upgrade featureset version"},{"id":"update-module-information","title":"Update module information"}]}
...
1. If your Active-Active database uses modules, [update module information](#update-module-information). To check if your database uses modules, run [`rladmin status modules`]():
...
To check the status of an Active-Active database instance, run [`rladmin status`]():
...
1. Upgrade the Redis database version and enabled modules with [`rladmin upgrade db`]():
...
If you use `keep_crdt_protocol_version`, make sure that you upgrade the CRDB protocol soon after with the [`rladmin upgrade db`]() command.
...
1. Find the `<CRDB-GUID>` of your Active-Active database.
    ...
    You can use the [`crdb-cli crdb list`]() command:
