...
url: https://redis.io/docs/latest/develop/reference/command-arguments/
retrieved_utc: '2026-04-09T20:45:53.523316+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/command-arguments/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"example","title":"Example"}]}
