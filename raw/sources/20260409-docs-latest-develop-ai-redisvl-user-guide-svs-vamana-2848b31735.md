...
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/svs_vamana/
retrieved_utc: '2026-04-09T20:45:53.879176+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/svs_vamana/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"quick-start-with-compressionadvisor","title":"Quick Start with CompressionAdvisor"},{"id":"creating-an-svs-vamana-index","title":"Creating an SVS-VAMANA Index"},{"id":"loading-sample-data","title":"Loading Sample Data"},{"id":"performing-vector-searches","title":"Performing Vector Searches"},{"children":[{"id":"runtime-parameters-with-range-queries","title":"Runtime Parameters with Range Queries"}],"id":"runtime-parameters-for-performance-tuning","title":"Runtime Parameters for Performance Tuning"},{"id":"understanding-compression-types","title":"Understanding Compression Types"},{"children":[{"id":"lvq-learned-vector-quantization","title":"LVQ (Learned Vector Quantization)"},{"id":"leanvec-compression-dimensionality-reduction","title":"LeanVec (Compression + Dimensionality Reduction)"}],"id":"compression-types-explained","title":"Compression Types Explained"},{"id":"hybrid-queries-with-svs-vamana","title":"Hybrid Queries with SVS-VAMANA"},{"id":"performance-monitoring","title":"Performance Monitoring"},{"id":"manual-configuration-advanced","title":"Manual Configuration (Advanced)"},{"children":[{"id":"when-to-use-svs-vamana","title":"When to Use SVS-VAMANA"},{"id":"parameter-tuning-guidelines","title":"Parameter Tuning Guidelines"},{"id":"performance-considerations","title":"Performance Considerations"}],"id":"best-practices-and-tips","title":"Best Practices and Tips"},{"id":"cleanup","title":"Cleanup"}]}
...
print(f"â Created SVS-VAMANA index: {index.name}")
...
```
    ...
    â Created SVS-VAMANA index: svs_demo
       Algorithm: svs-vamana
       Compression: LeanVec4x8
       Dimensions: 1024
...
print(f"â Loaded {len(data_to_load)} documents into the index")
...
```
    ...
    â Loaded 10 documents into the index
...
print("ð Basic Query (default parameters):")
...
print("ð¯ Tuned Query (higher recall parameters):")
...
print(f"ð¯ Range Query Results: Found {len(results)} vectors within distance threshold 0.3")
...
for priority in priorities:
    ...
    if "reduce" in config:
        print(f"  Dimensionality reduction: {dims} â {config['reduce']}")
...
```
    ...
    MEMORY Priority:
      Compression: LeanVec4x8
      Datatype: float16
      Dimensionality reduction: 1024 â 512
    ...
    SPEED Priority:
      Compression: LeanVec4x8
      Datatype: float16
      Dimensionality reduction: 1024 â 256
...
print("ð Hybrid Search Results (Technology category only):")
print("=" * 55)
...
```
    ...
    ð Hybrid Search Results (Technology category only):
    =======================================================
