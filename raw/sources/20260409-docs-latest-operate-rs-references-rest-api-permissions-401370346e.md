---
title: Permissions
url: https://redis.io/docs/latest/operate/rs/references/rest-api/permissions/
retrieved_utc: '2026-04-09T20:45:58.653814+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/permissions/index.html.md
---
...
{
  "title": "Permissions",
  "description": "Documents the permissions used with Redis Software REST API calls.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"roles","title":"Roles"},{"id":"permissions-list-for-each-role","title":"Permissions list for each role"},{"id":"roles-list-per-permission","title":"Roles list per permission"}]}
