---
title: "Redis persistence official docs"
url: "https://redis.io/docs/latest/operate/oss_and_stack/management/persistence/"
retrieved_utc: "2026-04-09T20:34:18.404486+00:00"
tags: ['ad-hoc']
---
...
You can configure how many times Redis will fsync data on disk. There are
three options:
`fsync`
...
Make a backup copy of your AOF file.
- Fix the original file using the redis-check-aof tool that ships with Redis: $ redis-check-aof --fix <filename>
...
`appenddirname`
- Turn off automatic rewrites with CONFIG SET auto-aof-rewrite-percentage 0 Make sure you don't manually start a rewrite (using BGREWRITEAOF ) during this time.
`CONFIG SET`
...
- How it works
- Append-only file Log rewriting How durable is the append only file? What should I do if my AOF gets truncated? What should I do if my AOF gets corrupted? How it works How I can switch to AOF, if I'm currently using dump.rdb snapshots?
- Log rewriting
- How durable is the append only file?
- What should I do if my AOF gets truncated?
- What should I do if my AOF gets corrupted?
...
- How I can switch to AOF, if I'm currently using dump.rdb snapshots?
- Interactions between AOF and RDB persistence
- Backing up Redis data Backing up AOF persistence
- Backing up AOF persistence
- Disaster recovery
#### Use Cases
#### Industries
