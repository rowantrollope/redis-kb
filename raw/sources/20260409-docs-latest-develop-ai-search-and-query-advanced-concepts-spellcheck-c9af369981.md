---
title: Spellchecking
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/spellcheck/
retrieved_utc: '2026-04-09T20:45:57.602144+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/spellcheck/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"custom-dictionaries","title":"Custom dictionaries"}]}
