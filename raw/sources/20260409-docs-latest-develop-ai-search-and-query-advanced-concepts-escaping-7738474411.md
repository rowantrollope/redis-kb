---
title: Tokenization
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/escaping/
retrieved_utc: '2026-04-09T20:45:54.963487+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/escaping/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"tokenization-rules-for-text-fields","title":"Tokenization rules for text fields"},{"id":"tokenization-rules-for-tag-fields","title":"Tokenization rules for tag fields"}]}
...
-   Converting Latin alphabet characters to lowercase. You can override this by adding the
    [`CASESENSITIVE`]() option in the indexing schema for the tag field.
...
[Query syntax]() and
[Exact match]() pages for more information about escaping
and how to use [DIALECT 2](), which is required for
