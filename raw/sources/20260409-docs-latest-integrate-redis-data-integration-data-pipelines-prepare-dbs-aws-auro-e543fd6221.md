...
retrieved_utc: '2026-04-09T20:45:52.720680+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/aws-aurora-rds/aws-rds-sqlserver/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"create-the-debezium-user","title":"Create the Debezium user"},{"id":"enable-cdc-on-the-database","title":"Enable CDC on the database"}]}

,
  "codeExamples": [{"id":"connect-to-sql-server-as-an-admin-user"},{"id":"grant-the-user-the-necessary-permissions"},{"id":"enable-cdc-for-the-database"},{"id":"enable-cdc-for-each-table-you-want-to-capture"},{"id":"add-the-debezium-user-to-the-cdc-role"}]
}
```
