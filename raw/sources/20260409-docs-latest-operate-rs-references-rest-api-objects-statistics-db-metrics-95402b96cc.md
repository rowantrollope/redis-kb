---
title: DB metrics
url: https://redis.io/docs/latest/operate/rs/references/rest-api/objects/statistics/db-metrics/
retrieved_utc: '2026-04-09T20:46:03.616492+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/objects/statistics/db-metrics/index.html.md
---
...
{
  "title": "DB metrics",
  "description": "Documents the DB metrics used with Redis Software REST API calls.",
...
| conns | float | Number of client connections to the DBâs endpoints |
| disk_frag_ratio | float | Flash fragmentation ratio (used/required). Only returned when BigRedis is enabled. |
| egress_bytes | float | Rate of outgoing network traffic to the DBâs endpoint (bytes/sec) |
...
| ingress_bytes | float | Rate of incoming network traffic to the DBâs endpoint (bytes/sec) |
