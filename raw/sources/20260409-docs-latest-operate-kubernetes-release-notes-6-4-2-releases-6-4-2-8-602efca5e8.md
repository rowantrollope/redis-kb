...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-8/
retrieved_utc: '2026-04-09T20:45:58.330437+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-4-2-releases/6-4-2-8/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"feature-enhancements","title":"Feature enhancements"},{"id":"bug-fixes","title":"Bug fixes"}],"id":"new-in-this-release","title":"New in this release"},{"id":"upgrade-considerations","title":"Upgrade considerations"},{"children":[{"id":"deprecated-features","title":"Deprecated features"},{"id":"supported-distributions","title":"Supported distributions"},{"id":"images","title":"Images"}],"id":"compatibility","title":"Compatibility"},{"children":[{"id":"existing-limitations","title":"Existing limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.4.2-94 release notes]().