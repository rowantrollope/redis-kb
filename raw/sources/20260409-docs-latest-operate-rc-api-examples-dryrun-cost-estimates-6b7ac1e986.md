---
title: Estimate cost
url: https://redis.io/docs/latest/operate/rc/api/examples/dryrun-cost-estimates/
retrieved_utc: '2026-04-09T20:45:57.881829+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/api/examples/dryrun-cost-estimates/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"defining-a-dry-run-request","title":"Defining a dry-run request"},{"children":[{"id":"example-of-a-dry-run-request-response","title":"Example of a dry-run request \u0026 response"},{"id":"viewing-actual-subscription-cost","title":"Viewing actual subscription cost"}],"id":"executing-a-dry-run-request","title":"Executing a dry-run request"}]}
