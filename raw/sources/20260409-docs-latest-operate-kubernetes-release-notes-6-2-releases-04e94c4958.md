...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/
retrieved_utc: '2026-04-09T20:46:01.011701+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/index.html.md
---
...
{
  "title": "6.2.18 release notes",
  "description": "Release notes for the 6.2.x releases of Redis Enterprise Software for Kubernetes.",
  "categories": ["docs","operate","kubernetes"],
  "tableOfContents": {"sections":[{"children":[{"id":"supported-upgrade-paths","title":"Supported upgrade paths"},{"id":"openshift-versions-6212-or-earlier","title":"OpenShift versions 6.2.12 or earlier"},{"id":"large-clusters","title":"Large clusters"}],"id":"before-upgrading","title":"Before upgrading"}]}
