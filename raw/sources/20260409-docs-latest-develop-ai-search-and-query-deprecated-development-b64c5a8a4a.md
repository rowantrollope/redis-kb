...
url: https://redis.io/docs/latest/develop/ai/search-and-query/deprecated/development/
retrieved_utc: '2026-04-09T20:45:52.566647+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/deprecated/development/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"cloning-the-git-repository","title":"Cloning the git repository"},{"id":"working-in-an-isolated-environment","title":"Working in an isolated environment"},{"id":"installing-prerequisites","title":"Installing prerequisites"},{"id":"installing-redis","title":"Installing Redis"},{"id":"getting-help","title":"Getting help"},{"children":[{"id":"diagnosing-the-build-process","title":"Diagnosing the build process"}],"id":"building-from-source","title":"Building from source"},{"id":"running-redis-with-redisearch","title":"Running Redis with RediSearch"},{"id":"running-tests","title":"Running tests"},{"id":"debugging","title":"Debugging"}]}
