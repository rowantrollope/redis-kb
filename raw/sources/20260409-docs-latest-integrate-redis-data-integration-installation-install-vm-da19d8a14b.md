...
url: https://redis.io/docs/latest/integrate/redis-data-integration/installation/install-vm/
retrieved_utc: '2026-04-09T20:45:54.266516+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/installation/install-vm/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"create-the-rdi-database","title":"Create the RDI database"},{"id":"hardware-sizing","title":"Hardware sizing"},{"children":[{"id":"rhel-firewall-rhel","title":"RHEL {#firewall-rhel}"},{"id":"ubuntu-firewall-ubuntu","title":"Ubuntu {#firewall-ubuntu}"}],"id":"vm-installation-requirements","title":"VM Installation Requirements"},{"children":[{"id":"supply-cloud-dns-information","title":"Supply cloud DNS information"},{"id":"installing-with-high-availability","title":"Installing with High Availability"}],"id":"installation-steps","title":"Installation steps"},{"id":"prepare-your-source-database","title":"Prepare your source database"},{"id":"deploy-a-pipeline","title":"Deploy a pipeline"},{"id":"uninstall-rdi","title":"Uninstall RDI"}]}
...
on both VMs as described in [Deploy a pipeline](). If you use `redis-di` to deploy your configuration, you only need to do this on one of the VMs, not both.
...
You may find it useful to trigger a failover deliberately to check that RDI is correctly configured to handle it. See [Test HA failover]() to learn how to do this.
