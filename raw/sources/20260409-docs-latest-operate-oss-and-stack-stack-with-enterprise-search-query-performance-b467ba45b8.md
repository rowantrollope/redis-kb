...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/search/query-performance-factor/
retrieved_utc: '2026-04-09T20:45:55.428579+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/search/query-performance-factor/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"sizing","title":"Sizing"},{"children":[{"id":"cpus-for-query-performance-factor","title":"CPUs for query performance factor"},{"id":"query-performance-factor-versus-cpus","title":"Query performance factor versus CPUs"},{"id":"example-performance-factor-calculation","title":"Example performance factor calculation"}],"id":"calculate-query-performance-factor","title":"Calculate query performance factor"},{"children":[{"id":"redis-software-8x-and-later-config-db-ui-v8","title":"Redis Software 8.x and later {#config-db-ui-v8}"},{"id":"prior-to-redis-software-8-config-db-ui-prior","title":"Prior to Redis Software 8 {#config-db-ui-prior}"}],"id":"configure-query-performance-factor-in-the-cluster-manager-ui","title":"Configure query performance factor in the Cluster Manager UI"},{"children":[{"id":"redis-software-8x-and-later-rest-api-v8","title":"Redis Software 8.x and later {#rest-api-v8}"},{"id":"prior-to-redis-software-8-rest-api-prior","title":"Prior to Redis Software 8 {#rest-api-prior}"}],"id":"configure-query-performance-factor-with-the-rest-api","title":"Configure query performance factor with the REST API"},{"id":"monitoring-redis-search","title":"Monitoring Redis Search"}]}
...
1. In the Cluster Manager UI, [create a new database]() or [edit an existing database]().
...
You can configure the query performance factor when you [create a new database](#create-db-rest-api) or [update an existing database](#update-db-rest-api) using the Redis Software [REST API]().
...
- [Upgrade module]() to set the search moduleâs query performance factor.
