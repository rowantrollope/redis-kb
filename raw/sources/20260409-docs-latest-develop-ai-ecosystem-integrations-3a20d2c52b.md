...
url: https://redis.io/docs/latest/develop/ai/ecosystem-integrations/
retrieved_utc: '2026-04-09T20:45:57.842666+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/ecosystem-integrations/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"additional-integrations","title":"Additional integrations"},{"id":"getting-started","title":"Getting started"}]}
...
| [**LlamaIndex & Redis**](https://docs.llamaindex.ai/en/stable/examples/vector_stores/RedisIndexDemo/) | [**Amazon Bedrock & Redis**]() | [**NVIDIA NIM & Redis**](https://redis.io/blog/use-redis-with-nvidia-nim-to-deploy-genai-apps-faster/) |
...
- [**Redis Cloud on Vercel**](https://redis.io/blog/redis-cloud-now-available-on-vercel-marketplace/): Deploy and manage Redis databases directly from your Vercel dashboard with the Redis Cloud integration. Refer to the [setup guide]() for more details.
...
* [AI notebooks collection]() - Interactive code examples and tutorials
* [AI video collection]() - Video tutorials and demonstrations
* [RAG quickstart guide]() - Get started with Retrieval-Augmented Generation
