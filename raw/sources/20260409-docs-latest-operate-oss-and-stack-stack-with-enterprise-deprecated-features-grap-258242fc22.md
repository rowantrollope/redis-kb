...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/graph/commands/
retrieved_utc: '2026-04-09T20:45:55.948299+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/graph/commands/index.html.md
---
...
1. <a name="table-note-1" style="display: block; height: 80px; margin-top: -80px;"></a>Use [`rladmin`]() or the [REST API]() to change RedisGraph configuration for Redis Software. See [RedisGraph configuration compatibility with Redis Software]() for more information and examples.
