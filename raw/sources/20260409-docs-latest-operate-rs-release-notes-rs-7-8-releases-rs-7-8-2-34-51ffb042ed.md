...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-2-34/
retrieved_utc: '2026-04-09T20:46:00.233945+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-8-releases/rs-7-8-2-34/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"new-features","title":"New features"},{"id":"enhancements","title":"Enhancements"},{"id":"redis-database-versions","title":"Redis database versions"},{"id":"redis-module-feature-sets","title":"Redis module feature sets"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"redis-database-version-74-breaking-changes-redis-74-breaking-changes","title":"Redis database version 7.4 breaking changes {#redis-74-breaking-changes}"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"},{"id":"deprecations","title":"Deprecations"},{"id":"upcoming-changes","title":"Upcoming changes"},{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"known-issues","title":"Known issues"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
- Redis Community Edition and Redis Stack 7.4 features are now available when you [create]() or [upgrade]() a database with database version 7.4, including:
    ...
    - New vector data types to reduce âmemory usage
    
    - Time series insertion filters

    - See the [Redis 7.4 release blog post](https://redis.io/blog/announcing-redis-community-edition-and-redis-stack-74/) and [Redis Community Edition 7.4 release notes]() for details.
...
- When you upgrade a database, the upgrade process also attempts to upgrade database modules by default.
    ...
    - If you [upgrade a database]() using the REST API, you can set `"latest_with_modules": false` in the request body to prevent module upgrades.
...
| 6.2 | [RediSearch 2.6]()<br />[RedisJSON 2.4]()<br />[RedisTimeSeries 1.8]()<br />[RedisBloom 2.4]()<br />[RedisGraph v2.10]()<sup>[1](#module-note-1)</sup>  |
...
- Authentication method changes for [`/v1/users/password`]() REST API requests.
...
- Deprecated `background_op` field from BDB REST API object. Use [`GET /v1/actions/bdb/<bdb_uid>`]() instead.
...
- Deprecated `POST /v1/modules/upgrade/bdb/<uid>` REST API request. Use [`POST /v1/bdbs/<uid>/upgrade`]() to upgrade modules instead.
...
- For Redis Software 6.2.* clusters:
    ...
    1. [Upgrade Redis 6.0 databases]() to Redis 6.2. See the [Redis 6.2 release notes](https://raw.githubusercontent.com/redis/redis/6.2/00-RELEASENOTES) for the list of changes.
...
| [**End-of-life date**]() | Determined after<br />next major release | Nov 2026 | Feb 2026 | Aug 2025 | Feb 2025 |
| **Platforms** | | | | | |
| RHEL 9 &<br />compatible distros<sup>[1](#table-note-1)</sup> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â | â |
| RHEL 9<br />FIPS mode<sup>[5](#table-note-5)</sup> | <span title="Supported">&#x2705;</span> | â | â | â | â |
...
| RHEL 7 &<br />compatible distros<sup>[1](#table-note-1)</sup> | â | â | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> |
| Ubuntu 20.04<sup>[2](#table-note-2)</sup> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â |
| Ubuntu 18.04<sup>[2](#table-note-2)</sup> | â | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> |
| Ubuntu 16.04<sup>[2](#table-note-2)</sup> | â | â | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> |
| Amazon Linux 2 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â |
| Amazon Linux 1 | â | â | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> | <span title="Deprecated" class="font-serif">:warning:</span> |
