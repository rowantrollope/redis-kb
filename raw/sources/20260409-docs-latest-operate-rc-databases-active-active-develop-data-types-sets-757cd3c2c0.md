...
url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/data-types/sets/
retrieved_utc: '2026-04-09T20:46:07.442836+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/data-types/sets/index.html.md
---
...
writes.Â With the OR-Set behavior, writes across multiple Active-Active database instances
are typically unioned except in cases of conflicts. Conflicting instance
writes can happen when aÂ Active-Active database instance deletes an element while the
