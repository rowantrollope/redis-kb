...
url: https://redis.io/docs/latest/operate/rs/databases/active-active/develop/data-types/streams/
retrieved_utc: '2026-04-09T20:46:07.825677+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/active-active/develop/data-types/streams/index.html.md
---
...
<tr>
<td><em>t2</em></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929244828-1]</strong></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929246795-2]</strong></td>
</tr>

<tr>
<td><em>t3</em></td>
<td><em>â Sync â</em></td>
<td><em>â Sync â</em></td>
</tr>

<tr>
<td><em>t4</em></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929244828-1, 1589929246795-2]</strong></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929244828-1, 1589929246795-2]</strong></td>
</tr>
</tbody>
</table>
...
<tr>
<td><em>t3</em></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929244828-1]</strong></code></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929244828-1]</strong></code></td>
</tr>
...
<tr>
<td><em>t6</em></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929246795-2]</strong></code></td>
<td><code>XRANGE messages - +</code> <br/><strong>â [1589929246795-2]</strong></code></td>
</tr>
...
| _t2_   | _â Sync â_                    | _â Sync â_                    |
| _t3_   | `XRANGE x - +`<br/> **â [100-1, 100-1]** | `XRANGE x - +`<br/> **â [100-1, 100-1]** |
...
| _t4_   | `XREAD COUNT 2 STREAMS x 0` <br/>**â [110-1, 120-1]**       |                                                    |
| _t5_   | _â Sync â_                                       | _â Sync â_                                       |
| _t6_   | `XREAD COUNT 2 STREAMS x 120-1` <br/>**â [130-1]**            |                                                    |
| _t7_   | `XREAD STREAMS x 0` <br/>**â[110-1, 115-2, 120-1, 130-1]** | `XREAD STREAMS x 0` <br/>**â[110-1, 115-2, 120-1, 130-1]** |
...
| _t2_   | `XINFO GROUPS x` <br/>**â [group1]**     | `XINFO GROUPS x` <br/>**â [group2]**     |
| _t3_   | _â Sync â_                | â Sync â                |
| _t4_   | `XINFO GROUPS x` <br/>**â [group1, group2]** | `XINFO GROUPS x` <br/>**â [group1, group2]** |
...
| _t2_   | _â Sync â_            | _â Sync â_            |
| _t3_   | `XINFO GROUPS x` <br/>**â [group1]** | `XINFO GROUPS x` <br/>**â [group1]** |
| _t4_   | `DEL x`                   | `XGROUP CREATE x group2 0`    |
| _t5_   | _â Sync â_            | _â Sync â_            |
| _t6_   | `EXISTS x` <br/>**â 0** | `EXISTS x` <br/>**â  0**          |
...
| _t1_   | `XGROUP CREATE x group1 0`    |                         |                       |
| _t2_   | _â Sync â_            | _â Sync â_            |                       |
| _t3_   | `XINFO GROUPS x` <br/>**â [group1]** | `XINFO GROUPS x` <br/>**â  [group1]** | `XINFO GROUPS x` <br/>**â  []** |
| _t4_   |                         | `XGROUP DESTROY x group1`     | `XGROUP CREATE x group1 0` |
| _t5_   | _â Sync â_            | _â Sync â            | â Sync â          |
| _t6_   | `EXISTS x` <br/>**â  0**          | `EXISTS x` <br/>**â 0**          | `EXISTS x` <br/>**â  0**    |
...
| _t3_   | `XREADGROUP GROUP group1 Alice STREAMS messages >` <br/>**â [110-1]** |                          |
| _t4_   | _â Sync â_                                      | _â Sync â_             |
| _t5_   | `XRANGE messages - +` <br/>**â [110-1]**                          | XRANGE messages - + <br/>**â [110-1]** |
| _t6_   | `XINFO GROUPS messages` <br/>**â [group1]**                            | XINFO GROUPS messages <br/>**â [group1]**   |
| _t7_   | `XINFO CONSUMERS messages group1` <br/>**â [Alice]**                      | XINFO CONSUMERS messages group1 <br/>**â []**  |
| _t8_   | `XPENDING messages group1 - + 1` <br/>**â [110-1]**                     | XPENDING messages group1 - + 1<br/>**â []** |
...
| _t5_   | `XREADGROUP GROUP group1 Alice STREAMS x >` <br/>**â [110-0, 120-0, 130-0]** |              |                                                                                                                 |
| _t6_   | `XACK x group1 110-0`                                                   |              |                                                                                                                 |
| _t7_   | _â Sync â_                                                    | _â Sync â_ | 110-0 and its preceding entries (none) were acknowledged. We replicate an XACK effect for 110-0.                |
| _t8_   | `XACK x group1 130-0`                                                   |              |                                                                                                                 |
| _t9_   | _â Sync â_                                                    | _â Sync â_ | 130-0 was acknowledged, but not its preceding entries (120-0). We DO NOT replicate an XACK effect for 130-0     |
| _t10_  | `XACK x group1 120-0`                                                   |              |                                                                                                                 |
| _t11_  | _â Sync â_                                                    | _â Sync â_ | 120-0 and its preceding entries (110-0 through 130-0) were acknowledged. We replicate an XACK effect for 130-0. |
