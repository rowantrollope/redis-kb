...
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/dialects/
retrieved_utc: '2026-04-09T20:45:55.305313+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/dialects/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"dialect-1-deprecated","title":"DIALECT 1 (Deprecated)"},{"id":"dialect-2","title":"DIALECT 2"},{"id":"dialect-3-deprecated","title":"DIALECT 3 (Deprecated)"},{"id":"dialect-4-deprecated","title":"DIALECT 4 (Deprecated)"},{"id":"use-ftexplaincli-to-compare-dialects","title":"Use FT.EXPLAINCLI to compare dialects"},{"id":"change-the-default-dialect","title":"Change the default dialect"}]}

,
  "codeExamples": []
}
```
Redis Open Source currently supports four query dialects for use with the [`FT.SEARCH`](), [`FT.AGGREGATE`](), and other Redis Search commands.
...
Support for vector search also was introduced in the 2.4 release and requires `DIALECT 2`. See [here]() for more details.
`FT.SEARCH ... DIALECT 2`
...
Dialect version 3 was introduced in the [2.6](https://github.com/RediSearch/RediSearch/releases/tag/v2.6.3) release. This version introduced support for multi-value indexing and querying of attributes for any attribute type ( [TEXT](), [TAG](), [NUMERIC](), [GEO]() and [VECTOR]()) defined by a [JSONPath]() leading to an array or multiple scalar values. Support for [GEOSHAPE]() queries was also introduced in this version.
...
The [`FT.EXPLAINCLI`]() command is a powerful tool that provides a window into the inner workings of your queries. It's like a roadmap that details your query's journey from start to finish.
...
[`FT.EXPLAIN`]() doesn't execute the query. It only explains the plan. It's a way to understand how your query is interpreted by Redis Search, which can be invaluable when you're trying to optimize your searches.
