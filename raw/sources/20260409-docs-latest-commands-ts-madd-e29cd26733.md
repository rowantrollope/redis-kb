...
retrieved_utc: '2026-04-09T20:45:35.631768+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/ts.madd/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"arguments":[{"name":"key","type":"key"},{"name":"timestamp","type":"string"},{"name":"value","type":"double"}],"multiple":true,"name":"ktv","type":"block"}],
