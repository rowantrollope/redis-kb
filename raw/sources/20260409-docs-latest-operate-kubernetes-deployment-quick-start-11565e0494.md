...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/quick-start/
retrieved_utc: '2026-04-09T20:45:54.347467+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/quick-start/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"create-a-new-namespace","title":"Create a new namespace"}],"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"download-the-operator-bundle","title":"Download the operator bundle"},{"id":"deploy-the-operator-bundle","title":"Deploy the operator bundle"}],"id":"install-the-operator","title":"Install the operator"},{"id":"create-a-redis-enterprise-cluster-rec","title":"Create a Redis Enterprise cluster (REC)"},{"children":[{"id":"limit-the-webhook-to-the-relevant-namespaces-webhook","title":"Limit the webhook to the relevant namespaces {#webhook}"}],"id":"enable-the-admission-controller","title":"Enable the admission controller"},{"id":"verify-the-admission-controller-is-working","title":"Verify the admission controller is working"},{"id":"add-user-defined-modules-optional","title":"Add user-defined modules (optional)"},{"id":"create-a-redis-enterprise-database-redb","title":"Create a Redis Enterprise Database (REDB)"}]}
...
See [User-defined modules]() for detailed instructions on adding and configuring custom modules.
