...
url: https://redis.io/docs/latest/operate/kubernetes/networking/ingress/
retrieved_utc: '2026-04-09T20:45:53.162411+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/networking/ingress/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"create-an-ingress-resource","title":"Create an Ingress resource"},{"id":"test-your-external-access","title":"Test your external access"}]}
