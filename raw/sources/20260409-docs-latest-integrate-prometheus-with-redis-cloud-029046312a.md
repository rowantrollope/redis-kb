...
url: https://redis.io/docs/latest/integrate/prometheus-with-redis-cloud/
retrieved_utc: '2026-04-09T20:45:53.481060+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/prometheus-with-redis-cloud/index.html.md
---
...
```json metadata
{
  ...
  "group": "observability",
  "tableOfContents": {"sections":[{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"set-up-prometheus","title":"Set up Prometheus"},{"id":"set-up-grafana","title":"Set up Grafana"},{"id":"grafana-dashboards-for-redis-cloud","title":"Grafana dashboards for Redis Cloud"}],"id":"quick-start","title":"Quick start"}]}
...
1. Create a [Redis Cloud Pro database](). 

1. Set up [VPC peering]().

1. Extract the Prometheus endpoint from the private endpoint to your database. The private endpoint is in the [Redis Cloud console](https://cloud.redis.io/) under the [Configuration tab]() of your database. The Prometheus endpoint is on port 8070 of the internal server.
...
See [Prometheus Metrics]() for a list of metrics that Prometheus collects from Redis Software clusters.
...
* The [Active-Active dashboard](https://github.com/redis-field-engineering/redis-enterprise-observability/blob/main/grafana/dashboards/grafana_v9-11/cloud/basic/redis-cloud-active-active-dashboard_v9-11.json) displays metrics specific to [Active-Active databases]().
