...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-4-august-2021/
retrieved_utc: '2026-04-09T20:45:59.462980+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-2-4-august-2021/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"prerequisites-and-notes","title":"Prerequisites and notes"},{"id":"database-upgrade-default-changes","title":"Database upgrade default changes"},{"id":"product-lifecycle-updates","title":"Product lifecycle updates"},{"id":"deprecation-notices","title":"Deprecation notices"}],"id":"version-changes","title":"Version changes"},{"children":[{"id":"internode-encryption","title":"Internode encryption"},{"id":"internal-certificate-management","title":"Internal certificate management"},{"id":"open-source-redis-compatibility","title":"Open source Redis compatibility"},{"id":"redis-modules","title":"Redis modules"},{"id":"internode-encryption-for-modules","title":"Internode encryption for modules"},{"id":"module-related-enhancements","title":"Module-related enhancements"}],"id":"features-and-enhancements","title":"Features and enhancements"},{"id":"resolved-issues","title":"Resolved issues"},{"children":[{"id":"installation-limitations","title":"Installation limitations"}],"id":"known-limitations","title":"Known limitations"},{"id":"known-issues","title":"Known issues"},{"id":"security","title":"Security"}]}
...
To learn more, see [`rladmin upgrade`]().

## Resolved issues

- RS39954 - Changed the UI status indication for the 
[default user]() from `Active/Inactive` to `Enabled/Disabled` 
