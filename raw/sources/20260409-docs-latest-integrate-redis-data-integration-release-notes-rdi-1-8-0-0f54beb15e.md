...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-8-0/
retrieved_utc: '2026-04-09T20:46:01.448031+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-8-0/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.8.0 (May 2025)",
  "description": "Enhanced RDI operator for better pipeline orchestration, resiliency, observability and flexibility; External collector support; Labels and annotations to RDI data plane pods; Custom Debezium image; Calculated TTL for target database.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"headlines","title":"Headlines"},{"children":[{"id":"helm-chart-changes","title":"Helm chart changes"},{"id":"operator-improvements","title":"Operator Improvements"},{"id":"other-features-improvements-and-enhancements","title":"Other Features, Improvements and Enhancements"},{"id":"fixes","title":"Fixes"}],"id":"detailed-changes","title":"Detailed changes"},{"id":"limitations","title":"Limitations"},{"children":[{"id":"high-availability-upgrade-issue","title":"High Availability upgrade issue"}],"id":"known-issues","title":"Known Issues"}]}
