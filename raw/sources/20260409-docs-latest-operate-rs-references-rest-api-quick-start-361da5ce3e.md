...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/quick-start/
retrieved_utc: '2026-04-09T20:45:55.671623+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/quick-start/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"fundamentals","title":"Fundamentals"},{"children":[{"id":"get-request","title":"GET request"},{"id":"put-request","title":"PUT request"}],"id":"curl-example-requests","title":"cURL example requests"},{"children":[{"id":"python","title":"Python"},{"id":"nodejs","title":"node.js"}],"id":"client-examples","title":"Client examples"},{"id":"more-info","title":"More info"}]}
...
For more information, see [Redis Software REST API]().
