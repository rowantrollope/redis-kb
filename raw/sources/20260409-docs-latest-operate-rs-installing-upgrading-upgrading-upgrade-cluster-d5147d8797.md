...
retrieved_utc: '2026-04-09T20:45:56.620687+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/installing-upgrading/upgrading/upgrade-cluster/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"supported-upgrade-paths","title":"Supported upgrade paths"},{"id":"upgrade-prerequisites","title":"Upgrade prerequisites"},{"id":"in-place-upgrade","title":"In-place upgrade"},{"children":[{"id":"extra-node-upgrade-method-extra-node-upgrade","title":"Extra node upgrade method {#extra-node-upgrade}"},{"id":"replace-node-upgrade-method-replace-node-upgrade","title":"Replace node upgrade method {#replace-node-upgrade}"}],"id":"rolling-upgrade","title":"Rolling upgrade"},{"id":"after-cluster-upgrade","title":"After cluster upgrade"}]}
...
- [Upgrade your databases]() to a version that is supported by the target Redis Software version before upgrading the cluster. We recommend you upgrade the databases to the latest supported version if possible. Make sure to test the upgrade in a non-production environment to determine any impact.
...
1.  Run the install command. See [installation script options]() for a list of command-line options you can add to the following command. You cannot use options marked as "new installs only" during an in-place upgrade.
