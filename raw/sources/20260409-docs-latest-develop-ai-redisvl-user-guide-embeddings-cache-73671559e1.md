...
url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/embeddings_cache/
retrieved_utc: '2026-04-09T20:45:53.999849+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/user_guide/embeddings_cache/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"id":"setup","title":"Setup"},{"id":"initializing-the-embeddingscache","title":"Initializing the EmbeddingsCache"},{"children":[{"id":"storing-embeddings","title":"Storing Embeddings"},{"id":"retrieving-embeddings","title":"Retrieving Embeddings"},{"id":"checking-existence","title":"Checking Existence"},{"id":"removing-entries","title":"Removing Entries"}],"id":"basic-usage","title":"Basic Usage"},{"children":[{"id":"key-based-operations","title":"Key-Based Operations"},{"id":"batch-operations","title":"Batch Operations"},{"id":"working-with-ttl-time-to-live","title":"Working with TTL (Time-To-Live)"}],"id":"advanced-usage","title":"Advanced Usage"},{"id":"async-support","title":"Async Support"},{"id":"real-world-example","title":"Real-World Example"},{"id":"performance-benchmark","title":"Performance Benchmark"},{"id":"common-use-cases-for-embedding-caching","title":"Common Use Cases for Embedding Caching"},{"id":"cleanup","title":"Cleanup"},{"id":"summary","title":"Summary"}]}
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  4.09it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  3.18it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.37it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00,  9.04it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 20.84it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.04it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.62it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.71it/s]
...
```
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 21.51it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.21it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.96it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.28it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.69it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 22.98it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.17it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 24.12it/s]
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.37it/s]
    ...
    Batches: 100%|ââââââââââ| 1/1 [00:00<00:00, 23.69it/s]
