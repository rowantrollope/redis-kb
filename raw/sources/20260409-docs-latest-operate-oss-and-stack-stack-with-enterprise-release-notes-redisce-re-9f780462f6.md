...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.4-release-notes/
retrieved_utc: '2026-04-09T20:45:57.397916+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/release-notes/redisce/redisos-8.4-release-notes/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"security-fixes","title":"Security fixes"}],"id":"redis-open-source-842-february-2026","title":"Redis Open Source 8.4.2 (February 2026)"},{"children":[{"id":"security-fixes","title":"Security fixes"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"performance-and-resource-utilization-improvements","title":"Performance and resource utilization improvements"},{"id":"metrics","title":"Metrics"},{"id":"configuration-parameters","title":"Configuration parameters"}],"id":"redis-open-source-841-february-2026","title":"Redis Open Source 8.4.1 (February 2026)"},{"children":[{"id":"major-changes-compared-to-redis-82","title":"Major changes compared to Redis 8.2"},{"id":"binary-distributions","title":"Binary distributions"},{"id":"redis-84-was-tested-on-the-following-operating-systems","title":"Redis 8.4 was tested on the following operating systems"},{"id":"bug-fixes-compared-to-84-rc1","title":"Bug fixes (compared to 8.4-RC1)"},{"id":"performance-and-resource-utilization-improvements-compared-to-84-rc1","title":"Performance and resource utilization improvements (compared to 8.4-RC1)"},{"id":"known-bugs-and-limitations","title":"Known bugs and limitations"}],"id":"redis-open-source-840-november-2025","title":"Redis Open Source 8.4.0 (November 2025)"},{"children":[{"id":"binary-distributions","title":"Binary distributions"},{"id":"redis-84-was-tested-on-the-following-operating-systems","title":"Redis 8.4 was tested on the following operating systems"},{"id":"new-features-compared-to-823","title":"New Features (compared to 8.2.3)"},{"id":"bug-fixes-compared-to-823","title":"Bug fixes (compared to 8.2.3)"},{"id":"performance-and-resource-utilization-improvements-compared-to-823","title":"Performance and resource utilization improvements (compared to 8.2.3)"},{"id":"configuration-parameters","title":"Configuration parameters"},{"id":"known-bugs-and-limitations","title":"Known bugs and limitations"}],"id":"redis-open-source-84-rc1-november-2025","title":"Redis Open Source 8.4-RC1 (November 2025)"}]}
...
- Metrics from `FT.HYBRID` command arenât displayed on `FT.INFO` and `INFO`.
...
- When executing `FT.SEARCH`, `FT.AGGREGATE`, `FT.CURSOR`, `FT.HYBRID`, `TS.MGET`, `TS.MRANGE`, `TS.MREVRANGE` and `TS.QUERYINDEX` while an atomic slot migration process is in progress, the results may be partial or contain duplicates.
- `FT.PROFILE`, `FT.EXPLAIN` and `FT.EXPLACINCLI` donât contain the `FT.HYBRID` option.
- Metrics from `FT.HYBRID` command arenât displayed on `FT.INFO` and `INFO`.
- Option `EXPLAINSCORE`, `SHARD_K_RATIO`, `YIELD_DISTANCE_AS`, and `WITHCURSOR` with `FT.HYBRID` are not available
- Post-filtering (after `COMBINE` step) using FILTER is not available.
