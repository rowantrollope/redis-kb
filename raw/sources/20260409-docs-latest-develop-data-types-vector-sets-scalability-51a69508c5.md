---
title: Scalability
url: https://redis.io/docs/latest/develop/data-types/vector-sets/scalability/
retrieved_utc: '2026-04-09T20:45:55.713460+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/data-types/vector-sets/scalability/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"example-strategy","title":"Example strategy"}],"id":"multi-instance-scalability","title":"Multi-instance scalability"},{"id":"key-properties","title":"Key properties"},{"id":"availability-benefits","title":"Availability benefits"},{"id":"latency-considerations","title":"Latency considerations"},{"id":"summary","title":"Summary"},{"id":"see-also","title":"See also"}]}
...
- Write operations ([`VADD`](), [`VREM`]()) scale linearlyâyou can insert in parallel across instances.
- Read operations ([`VSIM`]()) do not scale linearlyâyou must query all shards for a full result set.
