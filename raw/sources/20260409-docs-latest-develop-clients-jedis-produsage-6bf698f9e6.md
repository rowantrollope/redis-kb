...
url: https://redis.io/docs/latest/develop/clients/jedis/produsage/
retrieved_utc: '2026-04-09T20:45:58.659297+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/jedis/produsage/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"checklist","title":"Checklist"},{"children":[{"id":"connection-pooling","title":"Connection pooling"},{"id":"connection-retries","title":"Connection retries"},{"id":"client-side-caching","title":"Client-side caching"},{"id":"timeouts","title":"Timeouts"},{"id":"health-checks","title":"Health checks"},{"id":"exception-handling","title":"Exception handling"},{"id":"dns-cache-and-redis","title":"DNS cache and Redis"}],"id":"recommendations","title":"Recommendations"}]}
