...
url: https://redis.io/docs/latest/develop/clients/php/vecsearch/
retrieved_utc: '2026-04-09T20:45:56.371834+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/php/vecsearch/index.html.md
---
...
The `CreateArguments` parameter to [`ftcreate()`]()
...
when you add them with [`hmset()`](), as long as
