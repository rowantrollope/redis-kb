...
url: https://redis.io/docs/latest/operate/rs/security/encryption/internode-encryption/
retrieved_utc: '2026-04-09T20:45:55.260260+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/security/encryption/internode-encryption/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"enable-data-internode-encryption","title":"Enable data internode encryption"},{"id":"change-cluster-policy","title":"Change cluster policy"},{"children":[{"id":"encryption-ciphers-and-settings","title":"Encryption ciphers and settings"},{"id":"certificate-authority-and-rotation","title":"Certificate authority and rotation"}],"id":"self-signed-certificates","title":"Self-signed certificates"},{"children":[{"id":"certificate-requirements","title":"Certificate requirements"},{"id":"upload-customer-provided-certificates","title":"Upload customer-provided certificates"},{"id":"certificate-expiration-and-rotation","title":"Certificate expiration and rotation"},{"id":"performance-recommendations","title":"Performance recommendations"}],"id":"customer-provided-certificates","title":"Customer-provided certificates"}]}
...
To use the same certificate for data and control plane internode encryption, run the following [`rladmin cluster certificate`]() command:
...
To use separate certificates for data and control plane internode encryption, run the following [`rladmin cluster certificate`]() command:
...
To use the same certificate for data and control plane internode encryption, send a [`PUT /v1/cluster/certificates`]() request:
...
To use separate certificates for data and control plane internode encryption, send a [`PUT /v1/cluster/certificates`]() request:
