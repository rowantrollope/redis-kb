...
url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/app-failover-active-active/
retrieved_utc: '2026-04-09T20:46:01.035815+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/app-failover-active-active/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"local-failures","title":"Local Failures"},{"id":"replication-failures","title":"Replication Failures"}],"id":"detecting-failure","title":"Detecting Failure"},{"children":[{"id":"failing-over","title":"Failing over"}],"id":"impact-of-sharding-on-failure-detection","title":"Impact of sharding on failure detection"},{"id":"failback-decision","title":"Failback decision"},{"id":"replica-configuration-changes","title":"Replica Configuration Changes"}]}
...
You can also use [database availability API requests]() to determine if a database replica is available to handle read and write operations. The lag-aware database availability requests considers CRDT replication lag as a health check criterion to prevent reading stale data during failback scenarios.
