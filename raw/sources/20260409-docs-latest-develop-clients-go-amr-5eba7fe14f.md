...
url: https://redis.io/docs/latest/develop/clients/go/amr/
retrieved_utc: '2026-04-09T20:45:55.214867+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/go/amr/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"install","title":"Install"},{"children":[{"id":"streamingcredentialsprovider-for-a-service-principal","title":"StreamingCredentialsProvider for a service principal"},{"id":"streamingcredentialsprovider-for-a-managed-identity","title":"StreamingCredentialsProvider for a managed identity"},{"id":"custom-configuration","title":"Custom configuration"}],"id":"create-a-streamingcredentialsprovider-instance","title":"Create a StreamingCredentialsProvider instance"},{"id":"connect","title":"Connect"},{"id":"more-information","title":"More information"}]}
