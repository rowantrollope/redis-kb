...
url: https://redis.io/docs/latest/develop/clients/dotnet/condexec/
retrieved_utc: '2026-04-09T20:45:58.468364+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/dotnet/condexec/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"when-conditions","title":"When conditions"},{"id":"transaction-conditions","title":"Transaction conditions"}]}
...
example, the [`SET`]() command has the
variants [`SETEX`]() (set when the key exists),
and [`SETNX`]() (set when the key doesn't exist).
...
[`WATCH`]() commands in a way that is
