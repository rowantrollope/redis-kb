---
title: Configuration
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/configuration/
retrieved_utc: '2026-04-09T20:45:52.575223+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/deprecated-features/triggers-and-functions/configuration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"bootstrap-configuration","title":"Bootstrap configuration"},{"id":"runtime-configuration","title":"Runtime configuration"},{"children":[{"id":"execution-threads","title":"execution-threads"},{"id":"library-fatal-failure-policy","title":"library-fatal-failure-policy"},{"id":"v8-maxmemory","title":"v8-maxmemory"},{"id":"v8-library-initial-memory-usage","title":"v8-library-initial-memory-usage"},{"id":"v8-library-initial-memory-limit","title":"v8-library-initial-memory-limit"},{"id":"v8-library-memory-usage-delta","title":"v8-library-memory-usage-delta"},{"id":"lock-redis-timeout","title":"lock-redis-timeout"},{"id":"db-loading-lock-redis-timeout","title":"db-loading-lock-redis-timeout"},{"id":"remote-task-default-timeout","title":"remote-task-default-timeout"},{"id":"error-verbosity","title":"error-verbosity"}],"id":"configurations","title":"Configurations"}]}
