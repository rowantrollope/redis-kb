...
url: https://redis.io/docs/latest/operate/redisinsight/configuration/
retrieved_utc: '2026-04-09T20:45:53.080417+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/redisinsight/configuration/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"configuration-environment-variables","title":"Configuration environment variables"},{"children":[{"id":"preconfigure-database-connections-using-environment-variables","title":"Preconfigure database connections using environment variables"},{"id":"preconfigure-database-connections-using-a-json-file","title":"Preconfigure database connections using a JSON file"}],"id":"preconfigure-database-connections","title":"Preconfigure database connections"},{"id":"use-redis-insight-behind-a-reverse-proxy","title":"Use Redis Insight behind a reverse proxy"}]}
