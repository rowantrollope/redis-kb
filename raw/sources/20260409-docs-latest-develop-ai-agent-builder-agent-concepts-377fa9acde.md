...
url: https://redis.io/docs/latest/develop/ai/agent-builder/agent-concepts/
retrieved_utc: '2026-04-09T20:45:54.234047+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/agent-builder/agent-concepts/index.html.md
---
...
- [Learn more about Redis Vector Search â]()
...
- [Explore Redis data structures â](/develop/data-types/)
...
[Build a conversational agent â](../)
</div>
...
[Build a recommendation agent â](../)
</div>
...
- [Learn about Redis Streams â](/develop/data-types/streams/)
...
- [Learn about Redis Hashes â](/develop/data-types/hashes/)
...
- [Learn about Redis JSON â](/develop/data-types/json/)
...
- [Learn about Redis Sets â](/develop/data-types/sets/)
...
- [Learn about Redis Vector Sets â]()
...
- [Learn about Redis Sorted Sets â](/develop/data-types/sorted-sets/)
...
- [Redis performance optimization â]()
...
Agents maintain memory, plan multi-step tasks, and learn from interactionsâunlike simple chatbots.
...
**Get started:**
- [Use the agent builder]() to generate your code and get started
- [Redis quick start guide]() for setting up Redis

**Learn more:**
- [Redis Vector Search documentation]()
- [RedisVL Python library]() for vector operations and AI workflows
- [Redis data structures guide](/develop/data-types/)
- [Redis client libraries]() for your programming language

**Deploy and scale:**
- [Redis Cloud]() for managed Redis hosting
- [Redis Software]() for on-premises deployment
