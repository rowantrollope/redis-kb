...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/release-notes-redis-enterprise-software-v5-0-2/
retrieved_utc: '2026-04-09T20:46:00.446537+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/release-notes-redis-enterprise-software-v5-0-2/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"crdbs","title":"CRDBs"},{"id":"modules","title":"Modules"},{"id":"other","title":"Other"}],"id":"new-features","title":"New features"},{"id":"important-fixes","title":"Important fixes"},{"id":"known-limitations","title":"Known limitations"}]}
...
- RS16153 --Â SupervisordÂ version update
- RS16667 - Fixed issue with 'rladminÂ status' timeout
- RS17746 - Fixed upgrade issue when -s option used
- RS17997,Â RS18088 - Upgrade issues when using non-default socket
    file path
- RS8584 --Â Endpoint migration provided misleading plan message
...
- RS19002 - Fixed wrong message whenÂ an upgrade of aÂ quorum node with
    all-nodes policy takes place

**Important Fixes in Build #30:**

- RS19701 - FixedÂ high CPU usage on large scale clusters
- RS19869- AddedÂ support for Redis
    version 4.0.9
- RS20153- Fixed Redis important security issues related to the Lua
    scripting engine
- RS19852- Fixed proxy crash which might happen forÂ SSL-enabled
    DBs
...
- Since Redis Enterprise CRDBs have counters, unlike traditional Redis
    ...
    the database.
- This version of RS comes with a pre-bundledÂ python which might
    over-ride your default installed python version, this can be solved
    by changing your PATH environmentÂ variable.
