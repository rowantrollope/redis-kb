...
url: https://redis.io/docs/latest/develop/ai/redisvl/api/router/
retrieved_utc: '2026-04-09T20:46:07.337695+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/redisvl/api/router/index.html.md
---
...
```json metadata
{
  ...
  "description": "",
  "categories": null,
  "tableOfContents": {"sections":[{"children":[{"id":"class-semanticroutername-routes-vectorizernone-routingconfignone-redisclientnone-redisurlredislocalhost6379-overwritefalse-connectionkwargs","title":"class SemanticRouter(name, routes, vectorizer=None, routingconfig=None, redisclient=None, redisurl='redis://localhost:6379', overwrite=False, connectionkwargs={})"}],"id":"semantic-router","title":"Semantic Router"},{"children":[{"id":"class-routingconfig-maxk1-aggregationmethoddistanceaggregationmethodavg","title":"class RoutingConfig(*, maxk=1, aggregationmethod=DistanceAggregationMethod.avg)"}],"id":"routing-config","title":"Routing Config"},{"children":[{"id":"class-route-name-references-metadata-distancethreshold05","title":"class Route(*, name, references, metadata={}, distance_threshold=0.5)"}],"id":"route","title":"Route"},{"children":[{"id":"class-routematch-namenone-distancenone","title":"class RouteMatch(*, name=None, distance=None)"}],"id":"route-match","title":"Route Match"},{"children":[{"id":"class-distanceaggregationmethodvalue-namesnot-given-values-modulenone-qualnamenone-typenone-start1-boundarynone","title":"class DistanceAggregationMethod(value, names=\u003cnot given\u003e, *values, module=None, qualname=None, type=None, start=1, boundary=None)"}],"id":"distance-aggregation-method","title":"Distance Aggregation Method"}]}

,
  "codeExamples": [{"id":"semantic-router-api"}]
}
```
...
* **Parameters:**
  ...
  * **redis_client** (*Optional* *[* *SyncRedisClient* *]* *,* *optional*) â Redis client for connection. Defaults to None.
  * **redis_url** (*str* *,* *optional*) â The redis url. Defaults to redis://localhost:6379.
  * **overwrite** (*bool* *,* *optional*) â Whether to overwrite existing index. Defaults to False.
...
* **Parameters:**
  * **router_name** (*str*) â The name of the router.
  * **references** (*Union* *[* *str* *,* *List* *[* *str* *]* *]*) â The reference or list of references to add.
  * **route_name** (*str*)
* **Returns:**
...
* **Parameters:**
  * **Optional** (*keys*) â The name of the router.
  * **Optional** â The reference or list of references to delete.
  * **Optional** â List of fully qualified keys (prefix:router:reference_id) to delete.
  * **route_name** (*str*)
...
* **Parameters:**
  **data** (*Dict* *[* *str* *,* *Any* *]*) â The dictionary containing the semantic router data.
* **Returns:**
  The semantic router instance.
* **Return type:**
  [SemanticRouter](#semanticrouter)
* **Raises:**
  **ValueError** â If required data is missing or invalid.
...
* **Return type:**
  [SemanticRouter](#semanticrouter)
* **Raises:**
  * **ValueError** â If the file path is invalid.
  * **FileNotFoundError** â If the file does not exist.
...
* **Parameters:**
  **route_name** (*str*) â Name of the route.
* **Returns:**
...
* **Parameters:**
  **route_name** (*str*) â Name of the route to remove.
* **Return type:**
  None
...
* **Parameters:**
  * **statement** (*Optional* *[* *str* *]*) â The input statement to be queried.
  * **vector** (*Optional* *[* *List* *[* *float* *]* *]*) â The input vector to be queried.
  * **max_k** (*Optional* *[* *int* *]*) â The maximum number of top matches to return.
  * **distance_threshold** (*Optional* *[* *float* *]*) â The threshold for semantic distance.
  * **aggregation_method** (*Optional* *[*[DistanceAggregationMethod](#distanceaggregationmethod) *]*) â The aggregation method used for vector distances.
* **Returns:**
...
* **Parameters:**
  **route_thresholds** (*Dict* *[* *str* *,* *float* *]*) â Dictionary of route names and their distance thresholds.
...
* **Parameters:**
  **routing_config** ([RoutingConfig](#routingconfig)) â The new routing configuration.
