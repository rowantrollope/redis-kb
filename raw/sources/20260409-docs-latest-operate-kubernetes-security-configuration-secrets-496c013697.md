...
url: https://redis.io/docs/latest/operate/kubernetes/security/configuration-secrets/
retrieved_utc: '2026-04-09T20:46:00.803903+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/configuration-secrets/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"determine-your-cluster-fqdn","title":"Determine your cluster FQDN"},{"id":"use-a-kubernetes-secret-recommended","title":"Use a Kubernetes Secret (recommended)"},{"id":"embed-license-directly-in-rec-specification","title":"Embed license directly in REC specification"}],"id":"license-configuration","title":"License configuration"},{"children":[{"id":"default-behavior","title":"Default behavior"},{"id":"customize-the-credential-secret","title":"Customize the credential secret"}],"id":"cluster-credential-configuration","title":"Cluster credential configuration"},{"children":[{"id":"client-certificates-for-mtls","title":"Client certificates for mTLS"},{"id":"service-certificates","title":"Service certificates"},{"id":"internode-encryption-certificates","title":"Internode encryption certificates"}],"id":"tls-certificate-configuration","title":"TLS certificate configuration"},{"id":"best-practices","title":"Best practices"},{"id":"see-also","title":"See also"}]}
...
For detailed instructions, see [Customize the credential secret name]().
...
2. Add the secret to your REDB using the `clientAuthenticationCertificates` property. See [Add client certificates]() for details.
...
Reference these secrets in your REC specification under `spec.certificates`. See [Internode encryption]() for complete configuration details.
...
- [Redis Enterprise Cluster API reference]()
