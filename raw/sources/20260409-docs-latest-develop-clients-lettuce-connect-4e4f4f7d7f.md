...
url: https://redis.io/docs/latest/develop/clients/lettuce/connect/
retrieved_utc: '2026-04-09T20:45:52.110114+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/clients/lettuce/connect/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"basic-connection","title":"Basic connection"},{"id":"connect-to-a-redis-cluster","title":"Connect to a Redis cluster"},{"id":"asynchronous-connection","title":"Asynchronous connection"},{"id":"reactive-connection","title":"Reactive connection"},{"children":[{"id":"tls-connection","title":"TLS connection"}],"id":"connect-to-a-redis-cluster","title":"Connect to a Redis cluster"},{"id":"connection-management-in-lettuce","title":"Connection Management in Lettuce"},{"id":"connection-pooling","title":"Connection pooling"},{"id":"connect-using-smart-client-handoffs-sch","title":"Connect using Smart client handoffs (SCH)"}]}
