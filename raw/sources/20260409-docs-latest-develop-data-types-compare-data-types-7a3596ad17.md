...
retrieved_utc: '2026-04-09T20:45:51.593401+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/data-types/compare-data-types/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"strings","title":"Strings"},{"id":"hashes","title":"Hashes"},{"id":"json","title":"JSON"},{"id":"lists","title":"Lists"},{"id":"sets","title":"Sets"},{"id":"sorted-sets","title":"Sorted sets"},{"id":"streams","title":"Streams"}],"id":"data-type-features","title":"Data type features"},{"children":[{"id":"documents","title":"Documents"},{"id":"collections","title":"Collections"},{"id":"sequences","title":"Sequences"}],"id":"choose-a-data-type","title":"Choose a data type"}]}
