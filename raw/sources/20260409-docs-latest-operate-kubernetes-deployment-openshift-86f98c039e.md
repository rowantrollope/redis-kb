...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/
retrieved_utc: '2026-04-09T20:45:55.107035+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/openshift/index.html.md
---
...
{
  "title": "Deploy Redis Enterprise for Kubernetes with OpenShift",
  "description": "A quick introduction to the steps necessary to get a Redis Enterprise cluster installed in your OpenShift Kubernetes cluster",
  "categories": ["docs","operate","kubernetes"],
  "tableOfContents": {"sections":[{"id":"for-openshift-via-the-operatorhub","title":"For OpenShift via the OperatorHub"},{"id":"for-openshift-via-the-cli","title":"For OpenShift via the CLI"},{"id":"version-compatibility","title":"Version compatibility"}]}
