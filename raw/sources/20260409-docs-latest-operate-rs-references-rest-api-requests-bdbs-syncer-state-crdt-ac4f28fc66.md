...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/syncer_state/crdt/
retrieved_utc: '2026-04-09T20:46:03.522188+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/bdbs/syncer_state/crdt/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-crdb-syncer-state-get-syncer-state","title":"Get CRDB syncer state {#get-syncer-state}"}]}
