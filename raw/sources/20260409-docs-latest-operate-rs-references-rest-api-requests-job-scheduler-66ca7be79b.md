...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/job_scheduler/
retrieved_utc: '2026-04-09T20:46:04.920223+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/job_scheduler/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"}],"id":"get-job-scheduler-settings-get-job-scheduler","title":"Get job scheduler settings {#get-job-scheduler}"},{"children":[{"id":"permissions","title":"Permissions"},{"id":"request-put-request","title":"Request {#put-request}"},{"id":"response-put-response","title":"Response {#put-response}"}],"id":"update-job-scheduler-settings-put-job-scheduler","title":"Update job scheduler settings {#put-job-scheduler}"}]}
