...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/redis-enterprise-5/
retrieved_utc: '2026-04-09T20:46:00.509448+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/redis-enterprise-5/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"children":[{"id":"support-for-redis-cluster-api","title":"Support for Redis Cluster API"},{"id":"geo-distributed-active-active-conflict-free-replicated-databases-crdb-geodistributed-activeactive-conflictfree-replicated-databases-crdb","title":"Geo-distributed Active-Active conflict-free replicated databases (CRDB) {#geodistributed-activeactive-conflictfree-replicated-databases-crdb}"},{"id":"redis-modules","title":"Redis modules"}],"id":"new-features","title":"New features"},{"id":"support-for-docker","title":"Support for Docker"},{"id":"ldap-integration","title":"LDAP Integration"},{"id":"additionalcapabilities","title":"AdditionalÂ capabilities"},{"id":"information","title":"Information"},{"children":[{"id":"500-31-5-0-031","title":"5.0.0-31 {#5-0-031}"}],"id":"important-fixes","title":"Important fixes"}]}
...
For more information, go toÂ [quick start with Redis Enterprise on
Docker]().
...
- In the node bootstrap API, the structure of the JSON has changed for
    adding an external IP duringÂ the bootstrap process.
