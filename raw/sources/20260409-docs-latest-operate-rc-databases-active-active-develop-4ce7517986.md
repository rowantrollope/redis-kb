...
url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/
retrieved_utc: '2026-04-09T20:46:01.096783+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/index.html.md
---
...
configured in the Active-Active database. For unidirectional replication, see [Active-Passive replication]().
...
[Learn more about
synchronization for
each supported data type]() and [how to develop applications]() with them on Redis Cloud.