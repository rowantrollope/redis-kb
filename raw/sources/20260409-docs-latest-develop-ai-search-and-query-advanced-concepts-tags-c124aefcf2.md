---
title: Tag fields
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/tags/
retrieved_utc: '2026-04-09T20:45:56.147999+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/tags/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"key-differences","title":"Key differences"}],"id":"tag-fields-vs-text-fields","title":"Tag fields vs text fields"},{"children":[{"id":"index-structure","title":"Index structure"},{"id":"tokenization-differences","title":"Tokenization differences"}],"id":"technical-details","title":"Technical details"},{"children":[{"id":"separator-options","title":"Separator options"},{"id":"case-sensitivity","title":"Case sensitivity"},{"id":"examples","title":"Examples"}],"id":"create-a-tag-field","title":"Create a tag field"},{"children":[{"id":"basic-tag-query-syntax","title":"Basic tag query syntax"},{"id":"single-tag-match","title":"Single tag match"},{"id":"multiple-tag-match-or","title":"Multiple tag match (OR)"},{"id":"combining-with-other-queries","title":"Combining with other queries"},{"id":"prefix-matching","title":"Prefix matching"},{"id":"negative-matching","title":"Negative matching"}],"id":"query-tag-fields","title":"Query tag fields"},{"children":[{"id":"or-vs-and-logic","title":"OR vs AND logic"},{"id":"practical-example","title":"Practical example"}],"id":"advanced-tag-queries","title":"Advanced tag queries"},{"children":[{"id":"defining-tags-with-special-characters","title":"Defining tags with special characters"},{"id":"querying-tags-with-special-characters","title":"Querying tags with special characters"},{"id":"characters-that-need-escaping","title":"Characters that need escaping"},{"id":"spaces-in-tags","title":"Spaces in tags"},{"id":"best-practices","title":"Best practices"}],"id":"handle-special-characters","title":"Handle special characters"},{"children":[{"id":"multiple-tag-fields-versus-a-single-tag-field","title":"Multiple TAG fields versus a single TAG field"},{"id":"performance-comparison","title":"Performance comparison"},{"id":"choose-tag-fields-based-on-your-use-case","title":"Choose TAG fields based on your use case"}],"id":"performance-and-architecture-considerations","title":"Performance and architecture considerations"},{"id":"an-e-commerce-use-case","title":"An e-commerce use case"},{"id":"next-steps","title":"Next steps"}]}
...
See [Query syntax]() for complete escaping rules.
...
- Learn about [tokenization rules]() for tag fields
- Explore [field and type options]() for other field types
- See [query syntax]() for advanced query patterns
