...
url: https://redis.io/docs/latest/operate/rs/databases/import-export/export-data/
retrieved_utc: '2026-04-09T20:45:55.498900+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/import-export/export-data/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"storage-space-requirements","title":"Storage space requirements"},{"id":"export-database-data","title":"Export database data"},{"children":[{"id":"ftp-server","title":"FTP server"},{"id":"local-mount-point","title":"Local mount point"},{"id":"sftp-server","title":"SFTP server"},{"id":"aws-simple-storage-service","title":"AWS Simple Storage Service"},{"id":"google-cloud-storage","title":"Google Cloud Storage"},{"id":"azure-blob-storage","title":"Azure Blob Storage"}],"id":"supported-storage-locations-supported-storage-locations","title":"Supported storage locations {#supported-storage-locations}"}]}
...
When saved to a local mount point or a cloud provider, export locations need to be available to [the group and user]() running Redis Software, `redislabs:redislabs` by default.  
