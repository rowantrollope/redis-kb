...
url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-6-0-april-2020/
retrieved_utc: '2026-04-09T20:45:59.558976+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/legacy-release-notes/rs-5-6-0-april-2020/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"upgrade","title":"Upgrade"},{"id":"end-of-life","title":"End of life"}],"id":"information","title":"Information"},{"children":[{"id":"redis-software-installer","title":"Redis Software installer"},{"id":"hyperloglog-on-active-active","title":"Hyperloglog on Active-Active"},{"id":"redisjson-on-auto-tiering","title":"RedisJSON on Auto Tiering"},{"id":"oss-cluster-api-support","title":"OSS Cluster API support"},{"id":"replica-ha-defaults-for-active-active","title":"Replica HA defaults for Active-Active"},{"id":"cloud-backup-locations-support","title":"Cloud backup locations support"},{"id":"red-hat-enterprise-linux-77-78","title":"Red Hat Enterprise Linux 7.7, 7.8"}],"id":"new-features","title":"New features"},{"id":"redis-modules","title":"Redis modules"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"active-active-databases","title":"Active-Active databases"},{"id":"upgrade-notes","title":"Upgrade notes"},{"id":"modules-upgrade","title":"Modules upgrade"},{"id":"cluster-api","title":"Cluster API"},{"id":"discover-service","title":"Discover service"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
- For Active-Active databases, you must upgrade the [feature set version](#upgrade-activeactive-databases).

### End of life

- End of Life (EOL) for Redis Enterprise Software 5.6 and previous RS versions can be found [here]().
...
For more information, check out the [HyperLogLog on Active-Active documentation](develop/hyperloglog-active-active.md).

### RedisJSON on Auto Tiering

RS 5.6.0 adds support for [Auto Tiering]() databases with [Redis Modules](https://docs.redis.com/latest/modules). [RedisJSON]() is the first module to be available to run on a database with Auto Tiering enabled.
...
You can configure [Active-Active]() databases to use the [OSS Cluster API](https://docs.redis.com/latest/rs/clusters/optimize/oss-cluster-api/) using the admin console.
...
To enhance the availability and the consistency of [Active-Active geo-distributed Redis](),
[Replica HA]() is enabled by default for all existing and new Active-Active Redis Databases.
...
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.1](release-notes/redisbloom/redisbloom-2.2-release-notes)
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.10](release-notes/redisgraph/redisgraph-2.0-release-notes)
- [RedisJson](https://redislabs.com/redis-enterprise/redis-json/), version [1.0.4](release-notes/redisjson/redisjson-1.0-release-notes)
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.11](release-notes/redisearch/redisearch-1.6-release-notes) (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.3](release-notes/redistimeseries/redistimeseries-1.2-release-notes)
...
- RS43996 - Fixed a bug in the upgrade process when usingÂ ./install.sh -y and firewalld is not running.
...
With build 5.6.0-39:
- RS45627, RS47382 - Fixed bugs causing clients to disconnect when using XREAD and XREADGROUP commands in blocking mode on other clientsâ connections.
- RS44656 - Fixed a bug causing TLS mode for clients connections to toggle between âall communicationâ to âfor crdb communication onlyâ when performing a global configuration change.
...
- [RS 5.4.2]() introduced new Active-Active Redis Database capabilities that improve its compatibility with open source Redis.
    ...
    you must [upgrade the Active-Active Redis Database protocol]().
...
- Node upgrade fails if the SSL certificates were configured in version 5.0.2 or above by manually updating the certificates on the disk instead of [updating them through the API]().
