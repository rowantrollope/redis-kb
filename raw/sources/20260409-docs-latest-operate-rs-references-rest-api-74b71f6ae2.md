...
retrieved_utc: '2026-04-09T20:46:07.020000+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/index.html.md
---
...
- [Redis Software REST API quick start]() with examples
...
The Redis Software REST API uses [Self-signed certificates]() to ensure the product is secure. When you use the default self-signed certificates, the HTTPS requests will fail with `SSL certificate problem: self signed certificate` unless you turn off SSL certificate verification.
...
If you are using a [Redis Software Docker image](), run the following command to start the Docker image with port 9443 exposed:
