...
retrieved_utc: '2026-04-09T20:45:52.440427+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/spanner/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"1-prepare-for-snapshot","title":"1. Prepare for snapshot"},{"id":"2-prepare-for-streaming","title":"2. Prepare for streaming"},{"children":[{"id":"authentication-methods","title":"Authentication methods"}],"id":"3-create-a-service-account","title":"3. Create a service account"},{"id":"4-set-up-secrets-for-kubernetes-deployment-optional","title":"4. Set up secrets for Kubernetes deployment (optional)"},{"id":"5-configure-rdi-for-spanner","title":"5. Configure RDI for Spanner"},{"id":"6-additional-kubernetes-configuration","title":"6. Additional Kubernetes configuration"},{"id":"7-configuration-is-complete","title":"7. Configuration is complete"}]}

,
  "codeExamples": [{"id":"create-the-service-account"},{"id":"grant-required-roles"},{"id":"download-the-service-account-key"}]
}
```
