...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-3/
retrieved_utc: '2026-04-09T20:46:01.428724+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-12-3/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.12.3 (July 2025)",
  "description": "Fixed operator excessive CPU usage and log flooding. Fixed reset jobs not being able to pull images from private registries.",
