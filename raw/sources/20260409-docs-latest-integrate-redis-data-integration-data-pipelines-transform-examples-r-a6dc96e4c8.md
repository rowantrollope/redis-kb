...
retrieved_utc: '2026-04-09T20:45:57.379559+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/transform-examples/redis-expiration-example/index.html.md
---

# Set custom expiration times / TTL
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"static-expiration-time","title":"Static expiration time"},{"id":"dynamic-expiration-time","title":"Dynamic expiration time"},{"id":"dynamic-expiration-time-based-on-a-date-datetime-or-timestamp-field","title":"Dynamic expiration time based on a date, datetime, or timestamp field"}]}
