...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-8-september-2020/
retrieved_utc: '2026-04-09T20:45:59.537092+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-6-0-8-september-2020/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"upgrade-instructions","title":"Upgrade instructions"},{"id":"end-of-life","title":"End of life"}],"id":"version-information","title":"Version information"},{"children":[{"id":"open-source-redis-6","title":"Open source Redis 6"},{"id":"upgrading-redis-modules-via-rladmin","title":"Upgrading Redis modules via rladmin"}],"id":"new-features","title":"New features"},{"id":"redis-modules","title":"Redis modules"},{"id":"additional-capabilities","title":"Additional capabilities"},{"id":"important-fixes","title":"Important fixes"},{"children":[{"id":"active-active-databases","title":"Active-Active databases"},{"id":"installation-limitations","title":"Installation limitations"},{"id":"upgrade","title":"Upgrade"},{"id":"redis-commands","title":"Redis commands"}],"id":"known-limitations","title":"Known limitations"}]}
...
The [`rladmin` CLI]() introduces several updates to the commands for upgrading modules.
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [2.0]() (updated)
- [RedisJSON](https://redislabs.com/redis-enterprise/redis-json/), version [1.0.4]()
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.19]() (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.7]() (updated)
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.4]() (updated)
...
- RS44656 - A bug causing TLS mode for clients connections to toggle between âall communicationâ to âfor crdb communication onlyâ when performing a global configuration change. ***TBD***
