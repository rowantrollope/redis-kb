...
url: https://redis.io/docs/latest/operate/kubernetes/deployment/helm/
retrieved_utc: '2026-04-09T20:45:55.042729+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/deployment/helm/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"example-values","title":"Example values"}],"id":"prerequisites","title":"Prerequisites"},{"children":[{"id":"install-from-local-directory","title":"Install from local directory"},{"id":"specify-values-during-install","title":"Specify values during install"},{"id":"install-with-values-file","title":"Install with values file"}],"id":"install","title":"Install"},{"id":"migrate-from-a-non-helm-installation","title":"Migrate from a non-Helm installation"},{"id":"upgrade-the-chart","title":"Upgrade the chart"},{"id":"uninstall","title":"Uninstall"},{"id":"known-limitations","title":"Known limitations"}]}
...
If your databases use user-defined modules (custom non-bundled modules), you must take additional steps during the upgrade process. See [Upgrade with user-defined modules]() for details.
