...
url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/data-types/hashes/
retrieved_utc: '2026-04-09T20:46:04.450725+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rc/databases/active-active/develop/data-types/hashes/index.html.md
---
...
```Hashes are great for structured data thatÂ contain a map of fields and
