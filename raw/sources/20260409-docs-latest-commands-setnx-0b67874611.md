...
retrieved_utc: '2026-04-09T20:46:07.385079+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/setnx/index.html.md
---
...
```json metadata
{
  ...
  "since": "1.0.0",
  "arity": 3,
  "key_specs": [{"OW":true,"begin_search":{"spec":{"index":1},"type":"index"},"find_keys":{"spec":{"keystep":1,"lastkey":0,"limit":0},"type":"range"},"insert":true}],
  "tableOfContents": {"sections":[{"id":"examples","title":"Examples"},{"children":[{"id":"handling-deadlocks","title":"Handling deadlocks"}],"id":"design-pattern-locking-with-setnx","title":"Design pattern: Locking with SETNX"},{"id":"redis-software-and-redis-cloud-compatibility","title":"Redis Software and Redis Cloud compatibility"},{"id":"return-information","title":"Return information"}]}
