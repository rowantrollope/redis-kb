...
url: https://redis.io/docs/latest/operate/rs/databases/connect/troubleshooting-guide/
retrieved_utc: '2026-04-09T20:46:00.384712+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/databases/connect/troubleshooting-guide/index.html.md
---
...
{
  "title": "Troubleshooting pocket guide for Redis Software",
  "description": "Troubleshoot issues with Redis Software, including connectivity issues between the database and clients or applications.",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"identify-redis-host-issues","title":"Identify Redis host issues"},{"id":"identify-issues-caused-by-security-hardening","title":"Identify issues caused by security hardening"},{"id":"identify-cluster-issues","title":"Identify cluster issues"},{"id":"troubleshoot-connectivity","title":"Troubleshoot connectivity"},{"id":"troubleshoot-latency","title":"Troubleshoot latency"}]}
...
1. If the endpoint canât be resolved on the cluster node, [contact support](https://redis.com/company/support/).
