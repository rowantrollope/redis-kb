...
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/enterprise-capabilities/
retrieved_utc: '2026-04-09T20:45:53.722908+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/enterprise-capabilities/index.html.md
---
...
{
  "title": "Redis Software and Redis Open Source feature compatibility",
  "description": "Describes the Redis Software features supported by each Redis Open Source feature.",
  "categories": ["docs","operate","stack"],
  "tableOfContents": {"sections":[{"id":"supported-redis-open-source-features","title":"Supported Redis Open Source features"},{"id":"feature-compatibility","title":"Feature compatibility"},{"id":"feature-descriptions","title":"Feature descriptions"},{"id":"footnotes","title":"Footnotes"}]}
...
[^3]: You cannot use search and query with the [OSS Cluster API](). This limitation was fixed in Redis Software version 8.0.
