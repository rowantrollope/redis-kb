...
url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-16-1/
retrieved_utc: '2026-04-09T20:46:01.385558+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/release-notes/rdi-1-16-1/index.html.md
---
...
{
  "title": "Redis Data Integration release notes 1.16.1 (February 2026)",
  "description": "Maintenance release focusing on TLS certificate handling fixes and API v2 pipeline patching. Includes security hardening for the collector API through dependency upgrades (Spring Boot, Netty, Kafka clients, MySQL connector, Logback, Jetty, Spring Security, Spring Framework).",
  "categories": ["docs","operate","rs"],
  "tableOfContents": {"sections":[{"id":"whats-new-in-1161","title":"What's New in 1.16.1"},{"id":"limitations","title":"Limitations"}]}
