---
title: Query syntax
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/query_syntax/
retrieved_utc: '2026-04-09T20:45:55.361404+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/query_syntax/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"basic-syntax","title":"Basic syntax"},{"id":"pure-negative-queries","title":"Pure negative queries"},{"id":"field-modifiers","title":"Field modifiers"},{"children":[{"id":"a-few-notes-on-numeric-predicates","title":"A few notes on numeric predicates"}],"id":"numeric-filters-in-query","title":"Numeric filters in query"},{"id":"tag-filters","title":"Tag filters"},{"id":"geo-filters","title":"Geo filters"},{"id":"polygon-search","title":"Polygon search"},{"id":"vector-search","title":"Vector search"},{"children":[{"id":"a-few-notes-on-prefix-searches","title":"A few notes on prefix searches"}],"id":"prefix-matching","title":"Prefix matching"},{"children":[{"id":"using-a-suffix-trie","title":"Using a suffix trie"}],"id":"infixsuffix-matching","title":"Infix/suffix matching"},{"children":[{"id":"using-a-suffix-trie","title":"Using a suffix trie"}],"id":"wildcard-matching","title":"Wildcard matching"},{"id":"fuzzy-matching","title":"Fuzzy matching"},{"id":"wildcard-queries","title":"Wildcard queries"},{"id":"a-few-query-examples","title":"A few query examples"},{"id":"mapping-common-sql-predicates-to-redis-search","title":"Mapping common SQL predicates to Redis Search"},{"id":"technical-notes","title":"Technical notes"}]}
