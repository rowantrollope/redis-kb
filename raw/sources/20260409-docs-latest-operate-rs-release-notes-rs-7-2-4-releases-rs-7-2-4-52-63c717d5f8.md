...
url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52/
retrieved_utc: '2026-04-09T20:45:59.343000+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"highlights","title":"Highlights"},{"children":[{"id":"new-features","title":"New features"},{"id":"enhancements","title":"Enhancements"},{"id":"resolved-issues","title":"Resolved issues"}],"id":"new-in-this-release","title":"New in this release"},{"children":[{"id":"breaking-changes","title":"Breaking changes"},{"id":"deprecations","title":"Deprecations"},{"id":"upcoming-changes","title":"Upcoming changes"},{"id":"supported-platforms","title":"Supported platforms"}],"id":"version-changes","title":"Version changes"},{"id":"downloads","title":"Downloads"},{"id":"known-issues","title":"Known issues"},{"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
- [Multipart AOF](#append-only-file) (append-only files)
...
[Sharded pub/sub](#sharded-pubsub) is now supported.
...
- Nodes indicate whether itâs a primary or secondary node.
...
- Introduces [Geo Polygon]() Search. Geo range queries now accept the [`GEOSHAPE`]() field type, which supports polygon shapes using [WKT notation](https://en.wikipedia.org/wiki/Well-known_text_representation_of_geometry). `GEOSHAPE` supports `POLYGON` and `POINT` as shape formats and polygon operations.
...
- `%RW~<pattern>`: Alias for `~<pattern>`. Grants read and write access to keys that match the given pattern.
    ...
    See [key permissions](#key-permissions) for more information.

Selectors let you define multiple sets of rules in a single Redis ACL (only supported for databases with Redis version 7.2 or later). A command is allowed if it matches the base rule or any selector in the Redis ACL. See [selectors](#selectors) for more information.
...
- When sending a `PUBSUB SHARDNUMSUB` command in OSS Cluster mode in Redis Enterprise, Redis Enterprise checks the hash slots of the requested channels. Redis Enterprise responds with a `CROSSSLOT` error if the channels donât hash to the same slot, or a `MOVED` error if the channels hash to a different node.
...
- A deprecation notice for SASL-based LDAP was included in [previous Redis Enterprise Software release notes](#deprecation-notices). When you upgrade to Redis Enterprise Software version 7.2.4, all existing "external" users (previously used to support SASL-based LDAP) will be removed.
...
<span title="X icon">&#x274c;</span> End of life â Platform support ended in this version of Redis Enterprise Software.

| Redis Enterprise | 7.2.4 | 6.4.2 | 6.2.18 | 6.2.12 | 6.2.10 | 6.2.8 | 6.2.4 |
|------------------|-------|-------|--------|--------|--------|--------|-------|
| **Ubuntu**<sup>[1](#table-note-1)</sup> |
| 20.04 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[6](#table-note-6)</sup> | â | â | â | â | â |
...
| 8.8 | <span title="Supported">&#x2705;</span> | â | â | â | â | â | â |
| 8.7 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â | â | â | â |
| 8.5-8.6 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â |
| 8.0-8.4 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â |
...
| 8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â |
...
| 8 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | â | â | â | â |
| **Amazon Linux** |
| 2 | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span><sup>[7](#table-note-7)</sup> | â | â | â | â | â |
...
2. <a name="table-note-2" style="display: block; height: 80px; margin-top: -80px;"></a>RHEL and CentOS deployments require OpenSSL 1.0.2 and [firewall configuration]().
...
5. <a name="table-note-5" style="display: block; height: 80px; margin-top: -80px;"></a>See the [Redis Enterprise for Kubernetes documentation]().

6. <a name="table-note-6" style="display: block; height: 80px; margin-top: -80px;"></a>Ubuntu 20.04 support was added in Redis Enterprise Software [6.4.2-43]().

7. <a name="table-note-7" style="display: block; height: 80px; margin-top: -80px;"></a>A release candidate for Amazon Linux 2 support was added in Redis Enterprise Software [6.4.2-61](). Official support for Amazon Linux 2 was added in Redis Enterprise Software [6.4.2-69]().
...
- Using [`XREADGROUP BLOCK`]() with `>` to return all new streams will cause the Redis database to freeze until the shard is restarted. ([#12031](https://github.com/redis/redis/pull/12301))
...
After installing Redis Enterprise Software on the cluster nodes, upload compatible modules toÂ `modulesdir` (`/opt/redislabs/lib/modules`)Â before continuing the recovery process.
