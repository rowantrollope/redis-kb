...
retrieved_utc: '2026-04-09T20:46:04.959401+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/commands/json.arrappend/index.html.md
---
...
```json metadata
{
  ...
  "arguments": [{"name":"key","type":"key"},{"name":"path","type":"string"},{"multiple":true,"name":"value","type":"string"}],
...
With `$`-based path argument (default): [Array reply]() of [integer replies]() or [null replies](), where each element is the array's new length, or `null` if the matching value is not an array.
