...
retrieved_utc: '2026-04-09T20:45:52.093273+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/reference/client-side-caching/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"there-are-two-hard-problems-in-computer-science","title":"There are two hard problems in computer science..."},{"id":"the-redis-implementation-of-client-side-caching","title":"The Redis implementation of client-side caching"},{"id":"two-connections-mode","title":"Two connections mode"},{"id":"what-tracking-tracks","title":"What tracking tracks"},{"children":[{"id":"opt-in","title":"Opt-in"},{"id":"opt-out","title":"Opt-out"}],"id":"opt-in-and-opt-out-caching","title":"Opt-in and Opt-out caching"},{"id":"broadcasting-mode","title":"Broadcasting mode"},{"id":"the-noloop-option","title":"The NOLOOP option"},{"id":"avoiding-race-conditions","title":"Avoiding race conditions"},{"id":"what-to-do-when-losing-connection-with-the-server","title":"What to do when losing connection with the server"},{"id":"what-to-cache","title":"What to cache"},{"id":"other-hints-for-implementing-client-libraries","title":"Other hints for implementing client libraries"},{"id":"limiting-the-amount-of-memory-used-by-redis","title":"Limiting the amount of memory used by Redis"}]}
