...
retrieved_utc: '2026-04-09T20:45:52.390542+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/redis-data-integration/data-pipelines/prepare-dbs/my-sql-mariadb/index.html.md
---
...
```json metadata
{
  ...
  "group": "di",
  "tableOfContents": {"sections":[{"id":"1-create-a-cdc-user","title":"1. Create a CDC user"},{"id":"2-enable-the-binlog","title":"2. Enable the binlog"},{"id":"3-enable-gtids","title":"3. Enable GTIDs"},{"id":"4-configure-session-timeouts","title":"4. Configure session timeouts"},{"id":"5-enable-query-log-events","title":"5. Enable query log events"},{"id":"6-check-binlogrowvalueoptions","title":"6. Check binlogrowvalue_options"},{"id":"7-configuration-is-complete","title":"7. Configuration is complete"}]}

,
  "codeExamples": [{"id":"create-the-cdc-user"},{"id":"grant-the-user-the-necessary-permissions"},{"id":"finalize-the-users-permissions"},{"id":"enable-gtid_mode"},{"id":"enable-enforce_gtid_consistency"},{"id":"confirm-the-changes"}]
}
```
