---
title: "Upgrade a database to Search\xC2\_2.x"
url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/search/redisearch-2-upgrade/
retrieved_utc: '2026-04-09T20:45:56.619862+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/oss_and_stack/stack-with-enterprise/search/redisearch-2-upgrade/index.html.md
---
...
```json metadata
{
  "title": "Upgrade a database to SearchÂ 2.x",
  "description": "Upgrade a database from Search 1.x to SearchÂ 2.x.",
  "categories": ["docs","operate","stack"],
  "tableOfContents": {"sections":[{"id":"prerequisites","title":"Prerequisites"},{"id":"limitations","title":"Limitations"},{"children":[{"id":"add-redisearch-2x-to-the-cluster-add-new-module","title":"Add RediSearch 2.x to the cluster {#add-new-module}"},{"id":"create-a-redisearch-2x-database-create-db","title":"Create a RediSearch 2.x database {#create-db}"},{"id":"migrate-data-migrate-data","title":"Migrate data {#migrate-data}"}],"id":"replicate-data-from-redisearch-1x-to-redisearch-2x","title":"Replicate data from RediSearch 1.x to RediSearch 2.x"}]}
