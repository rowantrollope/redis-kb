...
url: https://redis.io/docs/latest/develop/ai/featureform/features-and-labels/
retrieved_utc: '2026-04-09T20:45:57.910114+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/featureform/features-and-labels/index.html.md
---
...
```json metadata
{
  ...
  "categories": null,
  "tableOfContents": {"sections":[{"id":"entities","title":"Entities"},{"id":"define-features","title":"Define features"},{"id":"aggregate-features","title":"Aggregate features"},{"id":"define-labels","title":"Define labels"},{"id":"point-in-time-correctness","title":"Point-in-time correctness"},{"id":"best-practices","title":"Best practices"},{"id":"what-to-read-next","title":"What to read next"}]}
