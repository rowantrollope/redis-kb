---
title: Archive
url: https://redis.io/docs/latest/operate/kubernetes/kubernetes-archive/
retrieved_utc: '2026-04-09T20:46:01.565755+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/kubernetes-archive/index.html.md
---
...
{
  "title": "Archive",
  "description": "Describes where to view the archive of Redis Enterprise for Kubernetes documentation.",
...
- [Redis Enterprise for Kubernetes v7.2 documentation archive](https://docs.redis.com/7.2/kubernetes/) Â 
