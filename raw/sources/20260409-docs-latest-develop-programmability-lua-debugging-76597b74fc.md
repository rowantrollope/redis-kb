...
url: https://redis.io/docs/latest/develop/programmability/lua-debugging/
retrieved_utc: '2026-04-09T20:45:52.831584+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/programmability/lua-debugging/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"quick-start","title":"Quick start"},{"id":"termination-of-the-debugging-session","title":"Termination of the debugging session"},{"id":"abbreviating-debugging-commands","title":"Abbreviating debugging commands"},{"id":"breakpoints","title":"Breakpoints"},{"id":"dynamic-breakpoints","title":"Dynamic breakpoints"},{"id":"synchronous-mode","title":"Synchronous mode"},{"id":"logging-from-scripts","title":"Logging from scripts"},{"id":"inspecting-the-program-state-with-print-and-eval","title":"Inspecting the program state with print and eval"},{"id":"debugging-clients","title":"Debugging clients"}]}
