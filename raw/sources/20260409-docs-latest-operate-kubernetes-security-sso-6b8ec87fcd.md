...
url: https://redis.io/docs/latest/operate/kubernetes/security/sso/
retrieved_utc: '2026-04-09T20:46:00.589570+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/security/sso/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"idp-requirements","title":"IdP requirements"},{"children":[{"id":"prerequisites","title":"Prerequisites"},{"id":"step-1-upload-service-provider-certificate-and-private-key","title":"Step 1: Upload Service Provider certificate and private key"},{"id":"step-2-download-service-provider-metadata","title":"Step 2: Download Service Provider metadata"},{"id":"step-3-set-up-saml-app-in-your-identity-provider","title":"Step 3: Set up SAML app in your identity provider"},{"id":"step-4-download-identity-provider-metadata","title":"Step 4: Download identity provider metadata"},{"id":"step-5-configure-saml-identity-provider-in-redis-enterprise","title":"Step 5: Configure SAML identity provider in Redis Enterprise"},{"id":"step-6-assign-saml-app-to-users","title":"Step 6: Assign SAML app to users"},{"id":"step-7-activate-sso","title":"Step 7: Activate SSO"}],"id":"enable-sso","title":"Enable SSO"},{"id":"complete-example","title":"Complete example"},{"id":"next-steps","title":"Next steps"}]}
