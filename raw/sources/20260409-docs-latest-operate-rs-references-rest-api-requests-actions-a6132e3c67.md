...
url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/actions/
retrieved_utc: '2026-04-09T20:46:01.753044+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/rs/references/rest-api/requests/actions/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"request-get-all-request","title":"Request {#get-all-request}"},{"id":"response-get-all-response","title":"Response {#get-all-response}"},{"id":"status-codes-get-all-status-codes","title":"Status codes {#get-all-status-codes}"}],"id":"get-all-actions-v1-get-all-actions","title":"Get all actions v1 {#get-all-actions}"},{"children":[{"id":"request-get-all-request-v2","title":"Request {#get-all-request-v2}"},{"id":"response-get-all-response-v2","title":"Response {#get-all-response-v2}"},{"id":"status-codes-get-all-status-codes-v2","title":"Status codes {#get-all-status-codes-v2}"}],"id":"get-all-actions-v2-get-all-actions-v2","title":"Get all actions v2 {#get-all-actions-v2}"},{"children":[{"id":"request-get-request","title":"Request {#get-request}"},{"id":"response-get-response","title":"Response {#get-response}"},{"id":"status-codes-get-status-codes","title":"Status codes {#get-status-codes}"}],"id":"get-a-specific-action-v1-get-action","title":"Get a specific action v1 {#get-action}"},{"children":[{"id":"request-get-request-v2","title":"Request {#get-request-v2}"},{"id":"response-get-response-v2","title":"Response {#get-response-v2}"},{"id":"status-codes-get-status-codes-v2","title":"Status codes {#get-status-codes-v2}"}],"id":"get-a-specific-action-v2-get-action-v2","title":"Get a specific action v2 {#get-action-v2}"}]}
...
Regardless of an actionâs source, each action in the response contains the following attributes: `name`, `action_uid`, `status`, and `progress`.
...
Regardless of an actionâs source, each action in the response contains the following attributes: `name`, `action_uid`, `creation_time`, `status`, and `progress`.
...
Regardless of an actionâs source, each action contains the following attributes: `name`, `action_uid`, `status`, and `progress`.
...
Regardless of an actionâs source, each action contains the following attributes: `name`, `action_uid`, `creation_time`, `status`, and `progress`.
