...
url: https://redis.io/docs/latest/develop/data-types/json/ram/
retrieved_utc: '2026-04-09T20:45:53.433603+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/data-types/json/ram/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"json-string-reuse-mechanism","title":"JSON string reuse mechanism"}]}
...
For some types of JSON values, 8 bytes is all thatâs needed. Nulls and booleans donât require any additional storage. Small integers are stored in static memory because theyâre frequently used, so they also use only the initial 8 bytes. Similarly, empty strings, arrays, and objects donât require any bookkeeping. Instead, they point to static instances of a _null_ string, array, or object. Here are some examples that use the [JSON.DEBUG MEMORY]() command to report on memory consumption:
