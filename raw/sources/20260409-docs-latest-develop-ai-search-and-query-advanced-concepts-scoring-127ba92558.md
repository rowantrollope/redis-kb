...
url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/scoring/
retrieved_utc: '2026-04-09T20:45:56.974253+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/advanced-concepts/scoring/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"tfidf","title":"TFIDF"},{"id":"tfidfdocnorm","title":"TFIDF.DOCNORM"},{"id":"bm25std-default","title":"BM25STD (default)"},{"id":"bm25stdnorm","title":"BM25STD.NORM"},{"id":"bm25stdtanh","title":"BM25STD.TANH"},{"id":"dismax","title":"DISMAX"},{"id":"docscore","title":"DOCSCORE"},{"id":"hamming","title":"HAMMING"}]}
...
`BM25STD.TANH` applies a smooth transformation using the `tanh(x/factor)` function, which avoids collection-dependent statistics and yields faster, more efficient scoring. While this makes it more scalable and consistent across different datasets, the trade-off is reduced accuracy in cases where minâmax normalization provides sharper separation. This method is recommended when performance and throughput are prioritized over fine-grained ranking sensitivity.
