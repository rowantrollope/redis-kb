...
url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-18-3/
retrieved_utc: '2026-04-09T20:45:58.409478+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/release-notes/6-2-releases/k8s-6-2-18-3/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"overview","title":"Overview"},{"id":"images","title":"Images"},{"id":"new-features","title":"New features"},{"id":"feature-improvements","title":"Feature improvements"},{"id":"bug-fixes","title":"Bug fixes"},{"id":"api-changes","title":"API changes"},{"id":"compatibility-notes","title":"Compatibility notes"},{"children":[{"id":"supported-upgrade-paths","title":"Supported upgrade paths"},{"id":"openshift-versions-6212-or-earlier","title":"OpenShift versions 6.2.12 or earlier"},{"id":"large-clusters","title":"Large clusters"}],"id":"before-upgrading","title":"Before upgrading"},{"children":[{"id":"large-clusters","title":"Large clusters"}],"id":"known-limitations","title":"Known limitations"},{"id":"security","title":"Security"}]}
...
* Support for [Redis Flex]() (RED-78613)
...
* `.isRoF` and `.rofRamSize` added to support the [Redis Flex feature]().
...
For a list of fixes related to CVEs, see the [Redis Enterprise 6.2.18-58 release notes]().
