...
url: https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/dev-to-prod-best-practices/
retrieved_utc: '2026-04-09T20:45:52.487953+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/develop/ai/search-and-query/best-practices/dev-to-prod-best-practices/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"children":[{"id":"1-timeout","title":"1. TIMEOUT"},{"id":"2-minprefix","title":"2. MINPREFIX"},{"id":"3-maxprefixexpansions","title":"3. MAXPREFIXEXPANSIONS"},{"id":"4-defaultdialect","title":"4. DEFAULT_DIALECT"}],"id":"configuration-parameter-considerations","title":"Configuration parameter considerations"},{"children":[{"id":"1-correctness","title":"1. Correctness"},{"id":"2-performance","title":"2. Performance"}],"id":"testing","title":"Testing"},{"children":[{"id":"key-considerations","title":"Key considerations:"},{"id":"tools","title":"Tools:"}],"id":"sizing-requirements","title":"Sizing requirements"},{"children":[{"id":"recommendations","title":"Recommendations:"}],"id":"demand-spikes","title":"Demand spikes"}]}
...
- Purpose: specifies the default query dialect used by [`FT.SEARCH`]() and [`FT.AGGREGATE`]() commands.
- Default: [Dialect 1]().
- Recommendations:
  - Update the default to [**Dialect 4**]() for better performance and access to advanced features.
...
- Use the following tools to validate and debug:
  - Redis CLI: use the [`MONITOR`]() command or [profiling features]() in Redis Insight to analyze commands.
  - [`FT.PROFILE`](): Provides detailed insights into individual query execution paths, helping identify bottlenecks and inefficiencies.
