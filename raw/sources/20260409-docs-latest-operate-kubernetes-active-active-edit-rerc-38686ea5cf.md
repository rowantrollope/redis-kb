...
url: https://redis.io/docs/latest/operate/kubernetes/active-active/edit-rerc/
retrieved_utc: '2026-04-09T20:45:58.497430+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/operate/kubernetes/active-active/edit-rerc/index.html.md
---
...
```json metadata
{
  ...
  "tableOfContents": {"sections":[{"id":"edit-rerc","title":"Edit RERC"},{"id":"update-rerc-secret","title":"Update RERC secret"}]}
