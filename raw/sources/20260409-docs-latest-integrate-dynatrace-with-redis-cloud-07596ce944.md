...
url: https://redis.io/docs/latest/integrate/dynatrace-with-redis-cloud/
retrieved_utc: '2026-04-09T20:45:53.540935+00:00'
tags:
- official
- docs
- sitemap
fetched_url: https://redis.io/docs/latest/integrate/dynatrace-with-redis-cloud/index.html.md
---
...
{
  "title": "Dynatrace with Redis Cloud",
  "description": "To collect, view, and monitor metrics data from your databases and other cluster components, you can connect Dynatrace to your Redis Cloud cluster using the Redis Dynatrace Integration.",
  "categories": ["docs","integrate","rs"],
  "group": "observability",
  "tableOfContents": {"sections":[{"id":"install-redis-dynatrace-integration-for-redis-cloud","title":"Install Redis' Dynatrace Integration for Redis Cloud"},{"id":"view-metrics","title":"View metrics"},{"id":"monitor-metrics","title":"Monitor metrics"}]}
